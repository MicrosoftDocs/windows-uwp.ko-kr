...
2.  키보드 접근성 구현
    ...
    * UI에서 사용하는 모든 사용자 지정 컨트롤에 대해 활성화를 위해 올바른 [**AutomationPeer**](https://msdn.microsoft.com/library/windows/apps/BR209185) 지원으로 이러한 컨트롤을 구현했으며 활성화, 통과 및 선택키 또는 바로 가기 키를 지원하도록 필요에 따라 키 처리에 대한 재정의를 정의했는지 확인합니다.
