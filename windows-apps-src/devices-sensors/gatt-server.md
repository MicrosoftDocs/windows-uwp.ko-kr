...
> 서비스 검색 가능와 Connectable 이면 시스템을 사용 하 여 서비스 Uuid 광고 패킷에 추가 됩니다.  광고 패킷 있는 31 바이트만 및 16 부분이 차지 하는 128 비트 UUID!
...
## <a name="send-notifications-to-subscribed-clients"></a>가입된 클라이언트 알림 보내기
