...
ms.locfileid: "5982412"
---
# <a name="developer-program-overview"></a>개발자 프로그램 개요

Xbox Live가 지원 타이틀을 개발 하려는 경우 가지 여러 옵션을 사용할 수 있습니다. 각 다양 한 수준의 기능을 사용할 혹은, 시간 투자 하 고 옵션을 지원 합니다.
...
Xbox One에서 게이머 큐 레이트 스토어 환경을 제공 하는 Xbox에서 Microsoft Store의 새 크리에이터 스 컬렉션 섹션에서 Xbox Live 크리에이터 스 프로그램을 통해 게시 된 게임 판매 합니다. 누구 든 지 수 개발 하 고 게임 및 알아야 하며 예상 게이머에 게 제공 되는 큐 레이트 스토어 환경 콘솔 제공 개방형 플랫폼 보장 사이 균형을 제공 합니다. Windows 10 타이틀 간의 모든 다른 Xbox Live 게임 Microsoft Store에 게시 됩니다.
...
Xbox Live 크리에이터 스 프로그램 타이틀은 다양 한 인기 있는 게임 엔진을 사용 하 여 빌드되는 UWP 게임입니다. Microsoft는 게임 [Unity 게임 엔진](https://unity.com)을 사용 하 여 빌드된 UWP에 Xbox Live 서비스를 통합 하는 것에 대 한 설명서를 제공 합니다. Unity 사용 하 여 Xbox Live 통합을 설명 하는 [설명서](get-started-with-creators/develop-creators-title-with-unity.md) 이 사이트에서 여기에 게임을 찾을 뿐 아니라 다운로드 하 고 Microsoft에서 만든 [Xbox Live Unity 플러그 인](https://github.com/Microsoft/xbox-live-unity-plugin)에 대 한 자세한 수 있습니다.

또한 게임 엔진 [(2 & 3)를 생성](https://www.scirra.com/construct2)하 고 [GameMaker Studio 2](https://www.yoyogames.com/gamemaker)를 사용 하 여 Xbox Live 크리에이터 스 프로그램 타이틀을 빌드할 수 있습니다. 하지만 모두 Xbox Live 지원 게임 엔진 추가, 크리에이터 스 및 Microsoft가 아니라 엔진 지원은 게임에서 처리 됩니다. 자세한 내용과 Construct 또는 GameMaker Studio 2 프로젝트에 Xbox Live 추가 대 한 지원을 각각 각 게임 엔진 설명서를 참조 해야 합니다.
...
엔진에 대 한 다른 게임 개발, [MonoGame](http://www.monogame.net/) 또는 [Xenko](https://xenko.com/)같은 Xbox Live 기능 또는 플러그 인 내재 되어 없는 하지 않는는 타이틀에 Xbox Live를 추가할 여전히 Xbox Live Api를 사용할 수 있습니다. 프로젝트에서 Xbox Live API를 사용하려면 NuGet 패키지가 있는 바이너리에 참조를 추가하거나 API 소스를 추가합니다. NuGet 패키지를 추가하면 쉽게 컴파일하고 소스를 추가하면 쉽게 디버깅할 수 있습니다.

### <a name="support-and-feedback"></a>지원 및 피드백
모든 궁금한 사항이 있으면 [MSDN 포럼](https://social.msdn.microsoft.com/Forums/en-US/home?forum=xboxlivedev)에 대답할 수 있습니다.  요청할 수도 있습니다. 프로그래밍 [스택](http://stackoverflow.com/questions/tagged/xbox-live) 오버플로 관련된 질문 "xbox live" 태그를 사용 하 여 합니다.  Xbox Live 팀 커뮤니티 참여 하는 Api, 도구 및 설명서 수신 두 피드백에 따라 지속적으로 향상 됩니다.

Xbox Live 크리에이터 스 프로그램의 개발자를 위한 [새로운 개념 제출](https://xbox.uservoice.com/forums/363186--new-ideas?category_id=196261) 하거나 우리의 [Xbox 사용자 음성](https://xbox.uservoice.com/forums/363186--new-ideas)에 [기존 개념에 응답할](https://xbox.uservoice.com/forums/251649?category_id=210838) 수 있습니다.

## <a name="idxbox"></a>ID@Xbox

Xbox Live 크리에이터 스 프로그램 다양 한 게임 및 개발자에 게 유용 합니다. 온라인 멀티 플레이어, 도전 과제, 게이머 점수 등 전체 Xbox Live 스택에, 액세스 하려는 또는 Xbox One 하드웨어 개발자 키트를 사용 하 여 장치 제품군의 모든 기능에 액세스 하려는 경우에 [ID@Xbox](http://www.xbox.com/en-US/developers/id) 프로그램이 있습니다.

게임에 ID@Xbox 프로그램 개념을 승인 하 고 혹은 큰 시간 책임은 Xbox One 및 Windows 10에서 전체 인증 통과 해야 합니다.
ID@Xbox타이틀은 저장소와 고객에 게 큰 노출에 대 한 상 작성자 컬렉션의 기본 섹션의 배치를 가져옵니다.

개발자는 ID@Xbox 프로그램에 액세스할 수도 개발자 지원 및 홍보 지원을 개인 백서 및 개발자의 전체 보완 뿐만 아니라 Microsoft 기술 포럼 합니다. [MSDN 포럼](https://social.msdn.microsoft.com/Forums/en-US/home?forum=xboxlivedev) 을 사용 하거나 "xbox live" 태그를 사용 하 여 원하는 경우으로 [Stack Overflow](http://stackoverflow.com/questions/tagged/xbox-live) 에서 관련된 질문을 프로그래밍 요청 계속할 수 있습니다.

## <a name="microsoft-partners"></a>Microsoft 파트너

게임 게시자는 Microsoft 파트너와 작업 하는 개발자 Xbox Live 기능 전체 집합에 액세스할 수 있으며 고 개발, 인증, 릴리스 프로세스에 도움이 되도록 Microsoft 담당자 전용.
...
<tr>
<td>게임 허브</td>
<td>타이틀을 특정 피드 통계, 동영상 및 기타 콘텐츠 표시 타이틀와 관련 된 게임 허브</td>
<td class="xbl-features-automatic">자동</td>
<td class="xbl-features-automatic">자동</td>
</tr>
...
<td>LFG 플레이어를 다른 멀티 플레이어 게임을 예약 하려면 게임의 초과 찾을 수 있습니다.</td>
<td class="xbl-features-automatic">자동</td>
<td class="xbl-features-automatic">자동</td>
</tr>
...
<tr>
<td>다양한 상태</td>
<td>타이틀에서 플레이어에 대 한 자세한 정보를 보여 줍니다.  기본 상태 "사용자가 자동차 레이싱 게임에서", 다양 한 상태 자세한 문자열을 지정할 수 있습니다 표시 될 수 있습니다 "사용자가 운전 SuperCar RainyForest에서"</td>
<td class="xbl-features-required">필수</td>
...
<tr>
<td>평판</td>
<td>플레이어 얻거나 해당 동작을 통해 신뢰도 잃게 됩니다. 동작 매치 메이 킹 사용 되 고 사용자 지정 방식에서 타이틀에서 사용할 수 있습니다.</td>
<td class="xbl-features-optional">선택 사항</td>
<td class="xbl-features-notavailable">지원되지 않음</td>
</tr>
...
<tr>
<td>아레나</td>
<td>플레이어는 토너먼트 스타일 각각에 대해 경쟁 수 있습니다.</td>
<td class="xbl-features-optional">선택 사항</td>
<td class="xbl-features-notavailable">지원되지 않음</td>
</tr>
...
<tr>
<td>Xbox Live 계산</td>
<td>실행 파일 및 타이틀 클라이언트에서 계산을 오프 로드와 통신할 수 있는 자산을 배포 합니다.</td>
<td class="xbl-features-optional">선택 사항</td>
<td class="xbl-features-notavailable">지원되지 않음</td>
</tr>
