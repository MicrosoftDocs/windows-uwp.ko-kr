...
분할 보기 컨트롤에는 확장/축소 가능한 창 및 콘텐츠 영역이 있습니다. 콘텐츠 영역은 항상 표시됩니다. 창은 확장하거나 축소할 수 있으며, 앱 창의 왼쪽 또는 오른쪽에 표시할 수 있습니다. 창에는 다음과 같은 네 가지 모드가 있습니다.
...
## <span id="Examples"></span><span id="examples"></span><span id="EXAMPLES"></span>예
