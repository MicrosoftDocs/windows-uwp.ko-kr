...
| [Mac, 해시 및 서명에](macs-hashes-and-signatures.md)               | 이 문서에서는 UWP 앱에서 MAC(메시지 인증 코드), 해시 및 서명을 사용하여 메시지 변조를 감지하는 방법을 설명합니다.                                                                                                                                                                                                                                                                                                                                                                                |
| [암호화에 대 한 내보내기 제한](export-restrictions-on-cryptography.md) | 이 정보를 사용하여 앱이 Microsoft Store에 나열될 수 없는 방식으로 암호화를 사용하는지 확인할 수 있습니다.                                                                                                                                                                                                                                                                                                                                                                                            |
