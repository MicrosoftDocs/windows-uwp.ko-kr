...
| 멤버| 유형| 설명| 
| --- | --- | --- | 
| continuationToken| 문자열| 결과의 다음 페이지에 액세스 하는 데는 불투명 연속 토큰입니다. 최대 32 자입니다. 호출자는 다음 컬렉션의 항목 집합을 검색 하기 위해 <b>continuationToken</b> 쿼리 매개 변수에서이 값을 제공할 수 있습니다. 이 속성이 <b>null</b>이면 다음 항목이 없는 추가 컬렉션 에서입니다. 이 속성은 필수 이며 컬렉션 <b>skipItems</b>를 사용 하 여 페이징 될 경우에 제공 됩니다.| 
| totalItems| 32 비트의 부호 있는 정수| 컬렉션에서 항목의 총 수입니다. 서비스 컬렉션의 크기에 대 한 실시간 뷰 제공할 수 없는 경우에 제공 되지 않습니다.| 
