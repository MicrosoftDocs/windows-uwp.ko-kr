...
**계정 세부 정보** 섹션에서는 계정의 상태 및 유형을 확인할 수 있습니다. 또한 판매자 ID 및 기타 게시자 ID 정보를 여기 볼 수 있습니다. 이러한 값은 Microsoft에서 고유 하 게 식별 개발자 계정에 할당 하 고 편집할 수 없습니다.
...
- **개발자 센터 참가자 프로그램**: 주에서 [개발자 센터 참가자 프로그램](dev-center-insider-program.md) 추가 되거나 제거를 선택할 수 있습니다 **계정 설정** 페이지입니다.
