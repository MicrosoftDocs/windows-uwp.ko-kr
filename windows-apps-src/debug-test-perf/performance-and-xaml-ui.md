...
아직 수행하지 않은 경우 Windows 10을 대상으로 앱을 포팅하기만 해도 성능이 훨씬 향상됩니다. 여러 XAML 최적화(예: [{x:Bind}](https://docs.microsoft.com/windows/uwp/xaml-platform/x-bind-markup-extension))는 Windows 10 앱에서만 사용할 수 있습니다. [Windows 10으로 앱 포팅](https://docs.microsoft.com/windows/uwp/porting/index) 및 //build/ 세션 [유니버설 Windows 플랫폼으로 전환](https://channel9.msdn.com/Events/Build/2015/3-741)을 참조하세요.
