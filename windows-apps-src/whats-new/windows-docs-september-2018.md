...
우리의 작성자 esteemed Mike Jacobs 중 하나는 일련의 중간의 문서에서는 사진 앱 및 게임 디자인 비전에서 흐림 효과 대 한 시작 했습니다. 이 어디에서 나 시각 효과 대 한 자세히 알고 싶은 경우 [비전 및 사진에 첫 번째 문서](https://medium.com/microsoft-design/science-in-the-system-how-blur-effects-work-8b0590996e09) 를 확인 하 고 [앤티앨리어싱을 그래픽에서 두 번째.](https://medium.com/microsoft-design/science-in-the-system-how-blur-effects-work-part-2-c5589a738515)

![흐림 작업](images/blur-example.jpg)

### <a name="contributing-guidance"></a>영향을 주는 지침

UWP 설명서에 대 한 [관련 지침](https://github.com/MicrosoftDocs/windows-uwp/blob/docs/CONTRIBUTING.md) 을 업데이트 했습니다. 이 새로운 지침 워크플로와 우리의 문서에 기여를 외부에 대 한 설명합니다.
