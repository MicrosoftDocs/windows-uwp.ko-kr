...
종속성 속성은 또는 UI 및 C#, Microsoft Visual Basic 또는 VisualC + + 구성 요소 확장에 대 한 XAML 사용 하 여 Windows 런타임 앱을 정의 하기 위한 프로그래밍 모델의 특정 기능을 지 원하는 (C + + CX) 코드입니다. 이러한 기능은 다음과 같습니다.
...
> [!NOTE]
> 형식은 나열 된 여기 Microsoft.NET 데이터 원본을 지원. C++/CX 데이터 원본은 변경 알림 또는 식별 가능한 동작에 대해 다른 인터페이스를 사용합니다. [데이터 바인딩 심층 분석](https://msdn.microsoft.com/library/windows/apps/mt210946)을 참조하세요.
