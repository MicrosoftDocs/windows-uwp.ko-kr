...
**참고** [**Polyline**](/uwp/api/Windows.UI.Xaml.Shapes.Polyline)에 대해 설정된 [**Points**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.shapes.polyline.points.aspx)에 명시적으로 동일한 시작점과 끝점이 있을 수도 있지만, 이 경우 [**Polygon**](/uwp/api/Windows.UI.Xaml.Shapes.Polygon)을 대신 사용하는 것이 좋습니다.
