...
XAML UI와 브러시 사용에 대한 자세한 내용은 [**브러시**](../graphics/using-brushes.md#xamlcompositionbrushbase) 섹션을 참조하세요.
...
이는 동일한 XAML 구조를 사용하는 이전의 C&#35; 코드에 해당하는 [C++/CX](https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx)입니다.
