...
```
## <a name="step-3-define-your-device-selector"></a>3단계: 사용자 장치 선택기를 정의 합니다.
...
### <a name="option-b-scoping-device-selector-to-connection-type"></a>**옵션 b: 장치 선택기 연결 유형과 범위 지정**
...
## <a name="step-4-enumerate-barcode-scanners"></a>4단계: 바코드 스캐너를 열거 합니다.
...
### <a name="option-a-enumerate-a-snapshot-of-barcode-scanners"></a>**옵션 a: 바코드 스캐너의 스냅숏을 열거합니다**
```Csharp
DeviceInformationCollection deviceCollection = await DeviceInformation.FindAllAsync(selector);
```
...
### <a name="option-b-enumerate-and-watch-for-changes-in-available-barcode-scanners"></a>**옵션 b: 열거 하 고 사용할 수 있는 바코드 스캐너의 변경 내용을 감시합니다**
```Csharp
...
## <a name="step-5-identify-camera-barcode-scanners"></a>5단계: 카메라가 바코드 스캐너를 식별 합니다.
...
## <a name="step-6-claim-the-camera-barcode-scanner"></a>6단계: 카메라가 바코드 스캐너를 클레임 합니다. 
...
## <a name="step-7-system-provided-preview"></a>7단계: 제공 된 시스템 미리 보기
