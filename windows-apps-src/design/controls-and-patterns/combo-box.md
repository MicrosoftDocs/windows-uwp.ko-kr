---
description: 목록 상자와 콤보 상자(드롭다운 목록이라고도 함)를 사용하여 사용자가 선택할 수 있는 항목 목록을 표시하는 방법을 알아봅니다.
title: 콤보 상자 및 목록 상자
...
ms.locfileid: "89173497"
---
# <a name="combo-box-and-list-box"></a>콤보 상자 및 목록 상자

콤보 상자(드롭다운 목록이라고도 함)를 사용하여 사용자가 선택할 수 있는 항목 목록을 표시할 수 있습니다. 콤보 상자는 압축 상태에서 시작하여 선택 가능한 항목 목록을 표시하도록 확장됩니다. ListBox는 콤보 상자와 비슷하지만 접을 수 없거나 압축 상태가 아닙니다. 이 문서 끝부분에서 목록 상자에 대해 자세히 알아볼 수 있습니다.
