...
> **참고**UWP 앱에서 특정 Uri 및 파일 확장명 사용을 위해 예약 기본 제공 앱과 운영 체제에서. 예약된 URI 또는 파일 확장명에 앱을 등록하려고 하면 무시됩니다. 자세한 내용은 [예약된 파일 및 URI 스키마 이름](reserved-uri-scheme-names.md)을 참조하세요.
...
> [!NOTE]
> 파일 계약을 통해 시작 하는 경우 다시 돌아가도록 해야 뒤로 단추는 사용자가 앱의 이전 콘텐츠가 아닌 앱이 시작 화면에 있습니다.
