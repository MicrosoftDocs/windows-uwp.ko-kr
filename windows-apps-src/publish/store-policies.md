...
제품에서 판매한 제품 내 서비스는 법정 통화(예: 미화, 유로 등) 또는 실제 물품이나 서비스로 변환할 수 없습니다.
...
Xbox One을 대상으로 하는 게임 제품은 [Xbox Live 크리에이터스](https://go.microsoft.com/fwlink/?linkid=844722) 또는 [ID@Xbox](http://go.microsoft.com/fwlink/?LinkId=821742) 프로그램을 통해 Xbox Live 서비스를 이용해야 합니다.
...
- 서비스와 사용자 데이터는 게임에서 적절하게 사용해야 합니다. 이 데이터에는 사용 데이터, 계정 ID 및 기타 개인 신원 데이터, 통계, 점수, 등급, 순위, 타 사용자 연결, 기타 사용자의 소셜 활동과 관련된 데이터가 포함되며 이에 제한되지 않습니다.
- Xbox Live 소셜 그래프 데이터(예: 친구 목록)는 어느 것도 저장하면 안 됩니다. 단 Xbox Live 계정을 게임과 연계한 사용자의 계정 ID는 예외입니다.
...
2018년 4월 17일부터 새로 게시된 제품 중에서 주요 기능에 액세스하기 위해 인증이 필요한 앱은 보안 전용 제3자 인증 공급자를 이용해야 하거나 회사 계정으로 게시되어야 합니다. 정책 10.8.3에 설명된 대로 금융 계좌 정보가 필요한 모든 앱은 회사 계정을 사용해야 합니다.
