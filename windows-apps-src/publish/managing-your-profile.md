...
대시보드의 오른쪽 위 모서리에 있는 기어 아이콘을 선택하고 **계정 설정**을 클릭합니다. 여기에서 계정에 대한 세부 정보와 정보를 확인 및 업데이트하고 다양한 계정 관련 작업을 수행할 수 있는 다른 페이지를 연결하는 링크를 찾아볼 수 있습니다.

**계정 세부 정보** 섹션에서는 계정의 상태 및 유형을 확인할 수 있습니다. 또한 판매자 ID, Windows 게시자 ID, Windows Phone 게시자 ID를 포함한 게시자 ID도 볼 수 있습니다. 이러한 값은 개발자 계정을 고유하게 식별할 수 있도록 Microsoft에서 할당합니다. 따라서 이러한 값을 편집할 수 없습니다.
...
- **검증 상태**: 계정에 대한 검증 프로세스가 진행 중일 때(예를 들어, 먼저 로그인을 할 때나 연락처 정보를 대대적으로 업데이트 하는 경우) 여기에서 검증 상태를 검토할 수 있습니다.
- **개발자 센터 참가자 프로그램 **: **계정 설정** 메인 페이지에서 [개발자 센터 참가자 프로그램](dev-center-insider-program.md)을 옵트인(opt in)하거나 옵트아웃(opt out) 할 수 있습니다.
- **사용자**: 개발자 센터 계정에 사용자를 추가하고 역할 및 사용 권한을 할당합니다. 자세한 내용은 [계정 사용자 관리](manage-account-users.md)를 참조하세요.
- **코드 사용**: 일부 프로그램에서는 계정의 기능을 확장할 수 있도록 코드를 제공할 수 있습니다. 이러한 코드를 사용하는 경우 여기에 코드를 입력할 수 있습니다.
...
- **Windows Phone 잠금 해제**: [테스트를 위해 잠금을 해제한 Windows Phone 8 또는 Windows Phone 8.1 장치](http://go.microsoft.com/fwlink/p/?LinkId=533897)에 대한 세부 정보를 확인합니다.
- **Xbox One 개발 콘솔**: [개발할 수 있는 Xbox One 콘솔](../xbox-apps/devkit-activation.md)을 보고 관리합니다. 
