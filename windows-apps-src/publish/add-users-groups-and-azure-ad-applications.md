...
1.  (아래에 있는 **계정 설정**) **사용자가** 페이지에서 **추가 사용자가**선택한 **만들기 새 사용자**를 선택 합니다.
...
1.  (아래에 있는 **계정 설정**) **사용자가** 페이지에서 **추가 그룹**을 클릭 합니다.
...
(아래에 있는 **계정 설정**) **사용자가** 페이지에서 해당 검색 기록을 검토 하려면 사용자에 대 한 **마지막 작업** 아래에 표시 된 링크를 선택 합니다. 지난 30일 동안 사용자가 방문한 모든 페이지의 URL을 볼 수 있습니다.
