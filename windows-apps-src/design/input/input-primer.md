...
Windows10, **Cortana** 확장성을 사용 하면 사용자의 음성 명령을 처리 하 고 단일 작업을 수행 하는 응용 프로그램을 시작할 수 있습니다.
...
[휴대폰용 Continuum](http://go.microsoft.com/fwlink/p/?LinkID=699431), 호환 가능한 Windows10 모바일 장치에 대 한 새로운 환경을 사용 하 여 사용자가 마우스 및 키보드는 휴대폰을 노트북 처럼 작동 하도록 휴대폰이 연결할 수 있습니다.
