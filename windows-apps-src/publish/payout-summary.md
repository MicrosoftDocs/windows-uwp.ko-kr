...
- 지불 또는 트랜잭션 기록 페이지에서이 페이지에 액세스 하는 경우 필터는를 통과 하지 않습니다. 데이터 내보내기 페이지에서 다시 실행 해야 합니다.
...
| claimId                        | 항상 비어 있습니다.                                                                                                                     |
| paymentId                      | 지불의 고유 식별자입니다. 이 번호는 일반적으로 은행 명세서에서 볼 수 있습니다.                                                 |
| paymentStatus                  | 지급 상태                                                                                                                           |
| paymentStatusDescription       | 지불 상태 설명                                                                                                   |
...
| invoiceNumber                  | 항상 비어 있습니다.                                                                                                                     |
| SubscriptionId                 | 항상 비어 있습니다.                                                                                                                     |
| Subscription.subscriptionstartdate          | 항상 비어 있습니다.                                                                                                                     |
| Subscription.subscriptionenddate            | 항상 비어 있습니다.                                                                                                                     |
| resellerId                     | 항상 비어 있습니다.                                                                                                                     |
| resellerName                   | 항상 비어 있습니다.                                                                                                                     |
| distributorId                  | 항상 비어 있습니다.                                                                                                                     |
| distributorName                | 항상 비어 있습니다.                                                                                                                     |
| agreementNumber                | 항상 비어 있습니다.                                                                                                                     |
| agreementStartDate             | 항상 비어 있습니다.                                                                                                                     |
| agreementEndDate               | 항상 비어 있습니다.                                                                                                                     |
| 작업                       | 항상 비어 있습니다.                                                                                                                     |
...
| purchaseTypeCode               | 항상 비어 있습니다.                                                                                                                     |
| purchaseOrderType              | 항상 비어 있습니다.                                                                                                                     |
| purchaseOrderCoverageStartDate | 항상 비어 있습니다.                                                                                                                     |
| purchaseOrderCoverageEndDate   | 항상 비어 있습니다.                                                                                                                     |
| externalReferenceId            | 항상 비어 있습니다.                                                                                                                     |
| externalReferenceIdLabel       | 항상 비어 있습니다.                                                                                                                     |

## <a name="payout-statement-download-export-legacy"></a>지급 문 다운로드 내보내기 (레거시)

이전 지급 요약 페이지에서 제한 된 시간 동안에는 지급 문을 다운로드할 수 있습니다. 이 보고서에는 다음 필드가 포함 되어 있습니다.
