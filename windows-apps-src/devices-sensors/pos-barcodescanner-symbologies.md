...
해당 특성을 수정 하는 데 마쳤으며 설정할 준비가 되 면, [SetSymbologyAttributesAsync](https://docs.microsoft.com/uwp/api/windows.devices.pointofservice.claimedbarcodescanner.setsymbologyattributesasync)호출할 수 있습니다. 이 메서드는 **true** 이면 특성 성공적으로 설정 **하는 부울**을 반환 합니다.
...
* **범위**: **DecodeLength1** 및 **DecodeLength2** 싱글바이트 문자 사이의 길이 디코딩합니다. 순서 **DecodeLength1** 와 **DecodeLength2** do (하나 수 다른 보다 높거나 낮은) 중요 하지 않습니다.
