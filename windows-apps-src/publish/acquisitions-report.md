...
> [!IMPORTANT]
> **합병** 보고서에는 환불, 반전을 예상, 지불 거절 등에 대 한 데이터가 포함 되지 않습니다. 응용 프로그램의 진행을 예상 하려면 [지급 summary](/partner-center/payout-statement)를 방문 하세요. **예약** 섹션에서 **예약 된 트랜잭션 다운로드** 링크를 클릭 합니다.
>
