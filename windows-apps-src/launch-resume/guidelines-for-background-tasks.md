...
|사용 가능한 트리거 | 프로세스에서 백그라운드 작업 트리거를 지원 하지 않습니다. [DeviceUseTrigger](https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.background.deviceusetrigger.aspx?f=255&MSPPError=-2147217396)하십시오 [DeviceServicingTrigger](https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.background.deviceservicingtrigger.aspx) 하 고 **IoTStartupTask**합니다. |
...
**사용 하 여 [BackgroundTaskDeferral](https://msdn.microsoft.com/library/windows/apps/hh700499):** 백그라운드 작업 클래스에서 비동기 코드를 실행 하는 경우에 지연 사용 해야 합니다. 그렇지 않으면 백그라운드 작업을 종료할 수 있습니다 중간 경우 합니다 [실행](https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.background.ibackgroundtask.run.aspx) 메서드가 반환 되는 (또는 [OnBackgroundActivated](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.application.onbackgroundactivated.aspx) 메서드 프로세스에서 백그라운드 작업의 경우). 자세한 내용은 [Out-of-process 백그라운드 작업 만들기 및 등록](create-and-register-a-background-task.md)을 참조하세요.
...
**앱 업데이트를 준비 합니다.** 앱을 업데이트할 경우 만들기 및 등록 된 **ServicingComplete** 백그라운드 작업 (참조 [SystemTriggerType](https://msdn.microsoft.com/library/windows/apps/br224839)) 등록 및 앱의 이전 버전에 대 한 백그라운드 작업을 해제 하는 새 버전에 대 한 백그라운드 작업입니다. 이때 포그라운드에서 실행 컨텍스트 외부에서 필요한 앱 업데이트도 수행하는 것이 좋습니다.
