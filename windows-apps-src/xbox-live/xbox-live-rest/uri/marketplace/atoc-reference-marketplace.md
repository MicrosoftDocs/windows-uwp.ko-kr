...
&nbsp;&nbsp;인벤토리 현재 제공 되는 사용자와 관련 된 설정에 액세스 합니다.
...
&nbsp;&nbsp;지정된 된 EDS 버전에 대 한 지원 되는 모든 mediaGroups 나열 되어 있습니다.
...
&nbsp;&nbsp;지정된 된 EDS 버전에 대 한 지원 되는 모든 mediaItemTypes에 액세스합니다.
