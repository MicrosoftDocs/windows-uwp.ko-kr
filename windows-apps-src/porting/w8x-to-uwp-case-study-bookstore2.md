...
이전 사례 연구와 [유니버설 8.1 앱이 있는 경우](w8x-to-uwp-root.md)에 설명 된 것과) (of 살펴보겠습니다 옵션 포트로 것 처럼 프로젝트의 내용을 Shared는 Windows10를 대상으로 하는 범용 디바이스 패밀리입니다.
