...
**InitialUploadResponse** 를 반환한 후 업로드 해당 개체에 반환 되는 **uploadUri** 를 통해 수행 됩니다. 클라이언트 해야 분할 파일 **expectedBlocks** 순차적 블록에서는 각 2MB 보다 더 큰 합니다. 동시에 업로드할 수 있습니다.
...
> [!NOTE] 
> 업로드 성공적으로 완료 되 면 하는 경우에 추가 처리 발생는 수 업로드 또는 메타 데이터에 대 한 상관 이유로 클립 거부 보완 프로세스 합니다.
