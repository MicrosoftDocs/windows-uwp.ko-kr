...
-   **S\_OK**: 그래픽 장치를 활성화, 비활성화 되었거나 현재 그래픽 장치를 무효화 하지 않고 다시 설정 하는 경우 반환 됩니다. 예를 들면 앱이 [WARP(Windows Advanced Rasterization Platform)](https://msdn.microsoft.com/library/windows/desktop/gg615082)를 사용 중이며 하드웨어 어댑터가 사용 가능해질 때 이 오류 코드가 반환될 수 있습니다.
