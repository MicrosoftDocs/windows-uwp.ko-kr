...
> [!NOTE]
> 지급을 받을 자격을 갖추려면 수익이 적절한 [지급 임계값](payment-thresholds-methods-and-timeframes.md)에 도달해야 합니다. 수익이 지급 임계값보다 작으면 이 임계값이 충족될 때까지 **보류** 범주로 남아 있습니다. 앱 수익의 지급 임계값에 대한 자세한 내용은 [앱 개발자 계약](https://msdn.microsoft.com/library/windows/apps/hh694058)을 참조하세요. 광고 수익의 지급 임계값은 미화 50달러(또는 현지 통화로 환산한 동일한 금액)입니다. 
>
