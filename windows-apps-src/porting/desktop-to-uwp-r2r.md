...
대상.NET Framework 4.6.2 하도록 프로젝트를 구성 해야.NET Framework 4.6.2 개발 도구 또는 최신 합니다. 이러한 도구.NET 데스크톱 개발 워크 로드에서 선택적 구성 요소와 Visual Studio 설치 관리자를 통해 사용할 수 있습니다.
...
여러 프로젝트를 솔루션에 있는 경우만 입력 지점 프로젝트 (대개 실행 파일을 생성 하는 프로젝트)에 x86 또는 x64 컴파일됩니다. 기본 프로젝트에서 참조 추가 바이너리 AnyCPU로 컴파일된 경우에 기본 프로젝트에서 지정 된 아키텍처를 사용 하 여 처리 됩니다.
...
**Q 합니다. 새 이진 수행.NET Framework 4.7.2 하지 않은 컴퓨터에서 작동 하나요?**
...
A. 이 버전 Live 이동 현재 사용할 수 있는 라이선스가 포함 되어 있습니다.
