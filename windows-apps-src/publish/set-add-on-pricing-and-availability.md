...
> [!TIP]
> 구독 추가 기능에 대 한 최신 제출에서 더 높은 기본 가격을 선택 하 여 또는 가격 증가 하는 가격 변경 예약 하 여 추가 기능을 게시 한 후 가격을 인상 수 없습니다. 이러한 메서드 중 하나를 사용 하 여 더 낮은 가격을 선택할 수 있지만 가격 낮아지면 팟캐스트의 되 면 해당 새 가격 보다 높은 발생 할 수 없습니다. 이 인해 것이 구독 추가 기능에 대 한 적절 한 기준 가격을 선택 하도록 하려면 특히 중요 합니다. 
