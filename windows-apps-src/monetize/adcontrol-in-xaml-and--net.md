...
2.  파트너 센터에서로 이동 합니다 [앱 내 광고](../publish/in-app-ads.md) 페이지 및 [ad 단위 만들기](set-up-ad-units-in-your-app.md#live-ad-units)합니다. 광고 단위 유형으로 **배너**를 지정합니다. 광고 단위 ID와 응용 프로그램 ID를 적어둡니다.
    > [!NOTE]
...
4.  코드 테스트 ad 단위 값으로 바꿉니다 (**ApplicationId** 하 고 **AdUnitId**) 파트너 센터에서 생성 된 실시간 값을 사용 하 여 합니다.
