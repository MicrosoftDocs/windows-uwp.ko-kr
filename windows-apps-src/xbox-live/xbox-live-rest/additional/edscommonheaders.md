...
| <b>xbl 클라이언트 유형 x</b>| 클라이언트 유형 헤더| 예| 고유한 클라이언트 유형 가져오려면 팀에 게 말하십시오.|
...
| <b>xbl 부모 ig x</b>| "Chained" 호출에 대 한 이전 인상을 Guid| 아니요 (이지만 권장)| BI 관련성에 중요 합니다. 예를 들어 찾아보기 호출 IG는 호출 세부 정보는 다음에 대 한 부모 IG 합니다.|
| <b>delid</b>| 대리자 Identity| 아니요| 내부 서비스가 사용 사용자를 대신 하 여 작동 합니다.|
...
| <b>x-xbl-오류</b>| 오류| 아니요| 다양 한 데이터 공급자에서 오류 목록입니다.|
| <b>x-xbl-traceid</b>| 로그에서 추적 Id| 예| 요청 특정 로그를 추적 하는 데 사용 합니다.|
| <b>x 서버 이름</b>| 난독 처리 된 요청을 처리 하는 서버 이름| 예| 내부 디버깅에 사용 됩니다.|
