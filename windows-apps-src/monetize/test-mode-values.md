...
중간 광고 및 배너 광고에 사용할 테스트 값은 다음과 같습니다.
...
> **중요**&nbsp;&nbsp;**AdControl**에서 라이브 광고의 크기는 **Width** 및 **Height** 속성으로 정의됩니다. 최상의 결과를 얻으려면 코드의 **Width** 및 **Height** 속성이 [배너 광고에 지원되는 광고 크기](supported-ad-sizes-for-banner-ads.md) 중 하나인지 확인합니다. **Width** 및 **Height** 속성은 라이브 광고의 크기에 따라 변경되지 않습니다.
