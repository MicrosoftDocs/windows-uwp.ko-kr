...
XAML에서는 _AttachedPropertyProvider.PropertyName_ 구문을 사용하여 연결된 속성을 설정합니다. 다음은 XAML에서 [**Canvas.Left**](https://docs.microsoft.com/dotnet/api/system.windows.controls.canvas.left)를 설정할 수 있는 방법을 보여 주는 예입니다.
