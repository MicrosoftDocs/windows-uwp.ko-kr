---
Description: 사용자 알림에서 유니버설 해제를 사용 하는 방법에 알아봅니다.
title: 유니버설 해제
...
> [!IMPORTANT]
> **1 주년 업데이트를 설치 해야**: SDK 14393 대상으로 해야 합니다 하 14393 또는 유니버설 해제를 사용 하려면 빌드를 실행할 수 있습니다.

이 시나리오의 일반적인 예는 캘린더 미리 알림입니. 두 디바이스 모두에서 일정 앱을 사용할 수 있습니다. 휴대폰과 데스크톱에서 미리 알림을 받습니다. 데스크톱에서 해제를 클릭합니다. 유니버셜 해제 덕분에 휴대폰의 미리 알림도 해제됩니다! **유니버설 해제를 사용 하도록 설정 하면 코드 한 줄만 필요!**
...
> **RemoteId**: 알림을 고유 하 게 식별 하는 식별자 *장치의*합니다.
...
**알려진 문제**: 검색를 **RemoteId** 를 통해를 `ToastNotificationHistory.GetHistory()` API는 항상 빈 문자열을 반환 하지 않고 **RemoteId** 지정한. 모든 기능이 잘 작동하므로 걱정하지 마세요. 손상된 값만을 검색합니다.
