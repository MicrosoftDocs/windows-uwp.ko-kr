...
장기 실행 펌웨어 업데이트와 같은 일부 중요한 장치 작업은 [**DeviceUseTrigger**](https://msdn.microsoft.com/library/windows/apps/dn297337)로 수행할 수 없습니다. 이러한 작업은 PC에서만 수행할 수 있으며 [**DeviceServicingTrigger**](https://msdn.microsoft.com/library/windows/apps/dn297315)를 사용하는 권한 있는 앱만 수행할 수 있습니다. *권한 있는 앱*은 제조업체가 이러한 작업을 수행할 권한을 부여한 앱입니다. 장치 메타데이터는 장치에 대한 권한 있는 앱(있는 경우)을 지정하는 데 사용합니다. 자세한 내용은 [Microsoft Store 장치 앱용 장치 동기화 및 업데이트](https://go.microsoft.com/fwlink/p/?LinkId=306619)를 참조하세요.
...
| 센서 API      | ![deviceservicingtrigger 범용 센서 api를 지원](images/ap-tools.png) (센서에서 제한 된 [유니버설 장치 제품군](https://msdn.microsoft.com/library/windows/apps/dn894631)) |
...
**중요**    사용 하는 경우 이러한 중요 한 사항을 고려 합니다 [ **DeviceUseTrigger**](https://msdn.microsoft.com/library/windows/apps/dn297337):

-   프로그래밍 방식으로 백그라운드를 실행 하는 기능을 사용 하는 작업은 [ **DeviceUseTrigger** ](https://msdn.microsoft.com/library/windows/apps/dn297337) Windows 8.1 및 Windows Phone 8.1에 처음 도입 되었습니다.
...
| 앱이 실행 중인 장치에서 아직 [DeviceUseTrigger](https://msdn.microsoft.com/library/windows/apps/dn297337)백그라운드 작업의 최대수에 도달하지 않았습니다. | **데스크톱 장치 제품군**: 무제한의 작업을 등록 하 고 동시에 실행할 수 있습니다. **모바일 장치 제품군**: 512MB 장치에서 작업 1 개 그렇지 않으면 2 작업 등록 고 동시에 실행할 수 있습니다. |
