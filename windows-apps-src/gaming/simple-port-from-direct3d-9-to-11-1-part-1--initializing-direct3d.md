...
> **참고**  D3D\_FEATURE\_LEVEL\_9\_1 (셰이더 모델 2.0에 해당)은 Microsoft Store 게임 지 원하는 데 필요한 최소 수준입니다. 9\_1을 지원하지 않으면 게임의 ARM 패키지가 인증에 실패합니다. 게임에 셰이더 모델 3 기능에 대한 렌더링 경로도 포함되어 있는 경우 배열에 D3D\_FEATURE\_LEVEL\_9\_3을 포함해야 합니다.
...
> **참고**  하면 다중 스레딩을 사용 (예를 들어 [**ThreadPool**](https://msdn.microsoft.com/library/windows/apps/br229642) 작업 항목) 렌더링 스레드가 차단 된 동안 다른 작업을 계속 합니다.
