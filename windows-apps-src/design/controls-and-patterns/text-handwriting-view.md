...
[TextBox](/uwp/api/windows.ui.xaml.controls.textbox), [RichEditBox](/uwp/api/windows.ui.xaml.controls.richeditbox) 및 [AutoSuggestBox](/uwp/api/windows.ui.xaml.controls.autosuggestbox) 같은 컨트롤에서 파생된 컨트롤처럼 Windows 텍스트 컨트롤이 지원하는 잉크를 텍스트로 입력을 위한 기본 제공 필기 보기를 사용자 지정합니다.
...
이 예에서는 [TextBox](/uwp/api/windows.ui.xaml.controls.textbox) 컨트롤의 [IsHandwritingViewEnabled](/uwp/api/windows.ui.xaml.controls.textbox.ishandwritingviewenabled) 속성을 false로 설정하여 필기 보기를 사용하지 않겠습니다. 필기 보기를 지원하는 모든 텍스트 컨트롤은 비슷한 속성을 지원합니다.
...
여기서는 [TextBox](/uwp/api/windows.ui.xaml.controls.textbox) [HandwritingView](/uwp/api/windows.ui.xaml.controls.handwritingview)의 [PlacementAlignment](/uwp/api/windows.ui.xaml.controls.handwritingview.placementalignment) 속성을 사용하여 기본 텍스트 컨트롤의 어떤 앵커를 필기 보기 맞춤에 사용할 것인지 지정합니다.
...
애플리케이션에서 이미 강력한 사용자 지정 인식 기능을 제공하는 경우 다음 예제처럼 [AreCandidatesEnabled](/uwp/api/windows.ui.xaml.controls.handwritingview.arecandidatesenabled) 속성을 사용하여 기본 제안을 사용하지 않도록 설정할 수 있습니다.
...
이 예제에서는 [TextBox](/uwp/api/windows.ui.xaml.controls.textbox)의 [TextChanged](/uwp/api/windows.ui.xaml.controls.textbox.textchanged) 이벤트를 수신 대기하다가 텍스트 변경이 HandwritingView에서 시작한 경우 사용자가 선택한 글꼴을 적용합니다(그렇지 않으면 기본 글꼴 적용).
...
[AutoSuggestBox](/uwp/api/windows.ui.xaml.controls.autosuggestbox)처럼 [TextBox](/uwp/api/windows.ui.xaml.controls.textbox) 또는 [RichEditBox](/uwp/api/windows.ui.xaml.controls.richeditbox) 컨트롤을 사용하는 복합 컨트롤 역시 [HandwritingView](/uwp/api/windows.ui.xaml.controls.handwritingview)를 지원합니다.

복합 컨트롤의 [HandwritingView](/uwp/api/windows.ui.xaml.controls.handwritingview)에 액세스하려면 [VisualTreeHelper](/uwp/api/windows.ui.xaml.media.visualtreehelper) API를 사용합니다.

다음 XAML 코드 조각은 [AutoSuggestBox](/uwp/api/windows.ui.xaml.controls.autosuggestbox) 컨트롤을 표시합니다.
...
해당 코드 숨김에서는 [AutoSuggestBox](/uwp/api/windows.ui.xaml.controls.autosuggestbox)에서 [HandwritingView](/uwp/api/windows.ui.xaml.controls.handwritingview)를 해제하는 방법을 보여줍니다.
...
[HandwritingView](/uwp/api/windows.ui.xaml.controls.handwritingview)의 범위에 UI 요소가 포함되는지 확인하고, 그렇지 않으면 포함해야 하는 경우가 있습니다.
...
[HandwritingView](/uwp/api/windows.ui.xaml.controls.handwritingview)의 크기를 설정할 수도 있습니다. 보기가 중요한 UI를 가리지 않아야 할 때 유용한 기능입니다.
...
다음 예제에서는 [Popup](/uwp/api/windows.ui.popups)의 위치를 설정하기 위해 [HandwritingView](/uwp/api/windows.ui.xaml.controls.handwritingview)의 [Opened](/uwp/api/windows.ui.xaml.controls.handwritingview.opened), [Closed](/uwp/api/windows.ui.xaml.controls.handwritingview.closed) 및 [SizeChanged](/uwp/api/windows.ui.xaml.frameworkelement.sizechanged) 이벤트를 수신 대기하는 방법을 보여줍니다.
