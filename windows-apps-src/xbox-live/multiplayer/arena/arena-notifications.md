...
ms.locfileid: "4390637"
---
# <a name="arena-notifications"></a>아레나 알림

Xbox 아레나 표면 알림 참가자에 게 토너먼트 단계를 통해 이러한 도입을 아레나 토너먼트 등록 합니다. 타이틀에서 모든 추가 경고, 홍보, 또는 게임 관련 세부 정보를 제공 해야 합니다.

등록 | 팀 형성 | 토너먼트 상태
--- | --- | ---
등록 준비 완료 팀 | 플레이어는 팀에 연결 | 체크 인 시작
팀 등록 | 플레이어 팀을 떠난 | 토너먼트 시작
체크 인 시작 | 초대장을 전송 하 고 거부 | 토너먼트 완료
