...
ms.locfileid: "74258306"
---
# <a name="surface-dial-interactions"></a>Surface Dial 조작

Surface Studio를 사용 하 여 Surface 전화 접속 이미지 ![](images/windows-wheel/dial-pen-studio-600px.png)  
*Surface Studio 및 Pen이 있는 Surface Dial*([Microsoft 스토어](https://www.microsoft.com/store/d/Surface-Dial/925R551SKTGN?icid=Surface_Accessories_ModB_Surface_Dial_103116)에서 구매 가능)
...
Surface Pen을 사용 하 여 ![표면 전화 걸기](images/windows-wheel/dial-and-pen-400px.png)  
...
Windows 잉크 도구 모음에 대 한 펜 선택 도구를 사용 하 여 ![Surface 다이얼 메뉴](images/windows-wheel/surface-dial-menu-inktoolbar-pen.png)  
*Windows 잉크 도구 모음에 대 한 펜 선택 도구를 사용 하는 Surface 다이얼 메뉴*

Windows 잉크 도구 모음에 대 한 스트로크 크기 도구를 사용 하 여 ![표면 다이얼 메뉴](images/windows-wheel/surface-dial-menu-inktoolbar-strokesize.png)  
*Windows 잉크 도구 모음에 대 한 스트로크 크기 도구를 사용 하는 Surface 다이얼 메뉴*

Windows 잉크 도구 모음에 대 한 눈금자 도구를 사용 하 여 ![Surface 다이얼 메뉴](images/windows-wheel/surface-dial-menu-inktoolbar-ruler.png)  
...
Surface Dial 사용자 지정 도구를 사용 하 여 활성화 된 샘플 앱 UI의 ![이미지](images/windows-wheel/surface-dial-snippet-customtool2.png)  
...
|   |   |   |
| --- | --- | --- |
| 왼쪽<br/>Up<br/>출력 | ![Surface Dial 이미지](images/windows-wheel/surface-dial-rotate.png) | Right<br/>Down<br/>입력 |
|   |   |   |

| 개념적 방향 | Surface Dial에 매핑 | 시계 방향 회전 | 시계 반대 방향 회전 |
| --- | --- | --- | --- |
| 가로 | Surface Dial 위쪽 기준으로 왼쪽 및 오른쪽 매핑 | Right | 왼쪽 |
| 세로 | Surface Dial 왼쪽 기준으로 위쪽 및 아래쪽 매핑 | Down | Up |
| Z축 | 위쪽/오른쪽에 안쪽으로(또는 가깝게) 매핑<br/>아래쪽/왼쪽에 바깥쪽으로(또는 멀게) 매핑 | 입력 | 출력 |
...
Surface Dial 사용자 지정 도구를 사용 하 여 활성화 된 샘플 앱 UI의 ![이미지](images/windows-wheel/surface-dial-snippet-customtool4.png)  
*Surface Dial 사용자 지정 도구를 사용 하 여 활성화 된 샘플 앱 UI*
...
[자습서: UWP 앱의 Surface 전화 걸기 (및 기타 휠 장치) 지원](radialcontroller-walkthrough.md)
...
[초보자를 위한 자습서: UWP 앱의 Surface 다이얼 및 기타 휠 장치 지원](https://github.com/Microsoft/Windows-tutorials-inputs-and-devices/tree/master/GettingStarted-RadialController)
