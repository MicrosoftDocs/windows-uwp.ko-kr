...
<tbody>
<tr class="odd">
<td align="left"><p>[좌표계](coordinate-systems.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[삼각형 보간](triangle-interpolation.md)</p></td>
...
<tr class="even">
<td align="left"><p>[벡터, 꼭짓점 및 사원수](vectors--vertices--and-quaternions.md)</p></td>
<td align="left"><p>Direct3D 전체에서 꼭짓점은 위치 및 방향을 설명합니다. 기본 형식의 각 꼭짓점은 위치, 색, 텍스처 좌표 및 방향을 제공하는 일반적인 벡터로 설명됩니다.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[변환](transforms.md)</p></td>
...
<tr class="even">
<td align="left"><p>[뷰포트 및 클리핑](viewports-and-clipping.md)</p></td>
