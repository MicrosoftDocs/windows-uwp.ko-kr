...
ms.locfileid: "5985432"
---
# <a name="attract-customers-and-promote-your-apps"></a>고객 모집 및 앱 홍보

앱을 Microsoft Store에서 되 면 최대한 많은 고객에 게 차례입니다. [파트너 센터](https://partner.microsoft.com/dashboard) 에 도움이 되는 많은 기능 제품 홍보와 고객 기반, 광고 캠페인, 홍보 코드, 할인 가격 등을 포함 하 여 확장에 제공 합니다.
