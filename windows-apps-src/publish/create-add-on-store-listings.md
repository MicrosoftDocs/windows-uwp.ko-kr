...
추가 기능을 제출 하는 경우 [파트너 센터](https://partner.microsoft.com/dashboard)에 제공한 정보는 **목록을 저장** 단계가 추가 기능을 획득 하는 옵션을 볼 때 고객에 게 표시 됩니다. 고객에게 매력적인 방식으로 추가 기능을 정확히 표현하려면 스토어 목록을 주의해서 고려해야 합니다. 다른 언어에 대한 사용자 지정된 스토어 목록을 제공할 수 있습니다.

> [!TIP]
> 할 수도 있습니다 [가져오기 및 내보내기 스토어 목록](import-and-export-store-listings.md) 파트너 센터에서 직접이 정보를 제공 하는 것이 아니라는.csv 파일이 오프 라인 목록 정보를 입력 하려는 경우 추가 기능에 대 한 합니다. 이 기능은 다양한 언어로 목록을 만들 때 특히 편리할 수 있습니다. 직접 정보를 항상 입력할 수 있지만 [파트너 센터](https://partner.microsoft.com/dashboard) import/export 기능을 사용 하는 대신 합니다.


## <a name="store-listing-languages"></a>스토어 목록 언어

스토어 목록 정보를 입력하기 전에 먼저 [언어](supported-languages.md)를 하나 이상 지정해야 합니다. 하나 이상의 언어에 대한 **스토어 목록** 페이지를 완료해야 합니다. 지 원하는 모든 언어에 대 한 저장소 목록에 앱을 만드는 것이 좋습니다.
