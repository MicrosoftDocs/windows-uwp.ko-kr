...
[앱의 이름을 예약](create-your-app-by-reserving-a-name.md)하는 것이 한 후 언제 든 지 대시보드에서 해당 앱으로 이동, 왼쪽된 탐색 메뉴에서 **서비스** 섹션을 확장 하 수 **지도**선택 합니다. **토큰을 가져올**클릭 하면 지도 서비스 응용 프로그램 ID (**응용 프로그램 Id**)를 생성 하 고 앱에 대 한 인증 토큰 (**AuthenticationToken**) 서비스를 매핑합니다. 언제 든 지 보 돌아올 수 있도록 이러한 값이이 페이지에 저장 됩니다.
