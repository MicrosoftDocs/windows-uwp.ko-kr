...
업데이트를 제출 하려면 파트너 센터에 대 한 추가 기능 페이지로 이동한 다음 **업데이트**를 클릭 합니다. 이렇게 하면 시작 점으로 이전 제출의 정보를 사용 하 여 추가 기능에 대 한 새 제출을 만들어집니다. 를 선택한 후 **스토어에 제출**을 클릭 변경 내용을 확인 합니다.
