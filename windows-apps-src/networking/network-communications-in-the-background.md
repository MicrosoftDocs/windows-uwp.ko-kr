...
- 소켓 브로커. 사용 하는 경우 앱 소켓 오랜 기간 연결에 대 한 다음, 포그라운드를 벗어날 때, 시스템 소켓 브로커에 소켓의 소유권을 위임할 수 것입니다. 그런 다음 브로커:; 소켓에 트래픽이 도착 하면 앱을 활성화 소유권을 다시 앱입니다. 한 앱에는 다음 도착 하는 트래픽을 처리 합니다.
- 컨트롤 채널 트리거 합니다. 
