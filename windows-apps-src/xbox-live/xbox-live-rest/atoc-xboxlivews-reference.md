...
&nbsp;&nbsp;Xbox Live 서비스와 함께 사용 되는 JavaScript 개체 Notation (JSON) 개체에 대 한 참조 자료를 제공 합니다.
...
&nbsp;&nbsp;Xbox Live 서비스에 대 한 보충 참고 자료 권한 부여 유형, 데이터 형식, 표준 HTTP 상태 코드 및 머리글, 페이징 매개 변수 및 엔터테인먼트 검색 서비스 (EDS)에 대 한 정보가 포함 됩니다.
