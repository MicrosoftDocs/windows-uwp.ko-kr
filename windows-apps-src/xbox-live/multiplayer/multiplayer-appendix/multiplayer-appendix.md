...
> **참고**  
이 문서는 고급 API 사용에 대 한입니다.  시작 점으로 개발을 크게 간소화 [멀티 플레이어 관리자 API](../multiplayer-manager.md) 대해를 보십시오.  찾을 경우 지원 되지 않는 시나리오는 멀티 플레이어 관리자를 알고에 댐을 알려 주시기 바랍니다.

멀티 플레이 시스템의 현재 버전은 2015 멀티 플레이어 합니다. 이 버전 추상화 "게임 자" 개념 및 멀티 플레이 세션 디렉터리 (MPSD)를 사용 하 여 게임 세션을 제어 합니다.

> **참고**  
이전 버전의 멀티 플레이 시스템 2014 멀티 플레이어입니다. 이 버전은 게임 타사 및 참여를 통해 당사자에 게 게임 개념을 기반으로 합니다. 이 버전 이제 더 하지만에 대 한 소스 코드는 XDK를 사용 하 여 계속 제공 됩니다. 2014 멀티 플레이 설명서는 XDK 포함 되어 더 이상 없습니다. 이 설명서를 해야 하는 경우는 XDK의 2014 릴리스를 사용 하십시오.
...
[2015 멀티 플레이어에 대 한 제목에 적용할 때 일반적인 문제](common-issues-when-adapting-multiplayer.md)  
...
[멀티 플레이 게임에 대 한 흐름 초대 합니다.](flows-for-multiplayer-game-invites.md) 다른 플레이어 멀티 플레이 게임 초대에 관련 된 경험의 흐름을 설명 합니다.
