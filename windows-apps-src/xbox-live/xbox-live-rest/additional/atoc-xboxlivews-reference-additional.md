...
ms.locfileid: "57636508"
---
# <a name="additional-reference"></a>추가 참조

이 섹션의에서 항목에서는 Xbox Live 서비스 및 엔터테인먼트 검색 서비스 (EDS)에 대 한 보조 참조 자료를 제공합니다.
...
[인증 형식](authorizationtypes.md)

&nbsp;&nbsp;Xbox Live 서비스에서 사용 하는 표준 인증 유형에 대해 설명 합니다.

[데이터 형식 개요](datatypeoverview.md)

&nbsp;&nbsp;Xbox Live 서비스에서 사용 하는 표준 식별 관련 데이터 형식을 설명 합니다.
...
[EDS 일반적인 헤더](edscommonheaders.md)
...
&nbsp;&nbsp;많은 EDS api 일반 쿼리 구체화를 설명합니다.

[비디오에 대 한 역방향 조회 EDS](edsreverselookup.md)

&nbsp;&nbsp;역방향 데이터를 기반으로 비디오를 조회 합니다.

[EDS 테이블](edstables.md)

&nbsp;&nbsp;다양 한 테이블 및 EDS API와 사용 하 여 연결 된 목록을 포함 합니다.

[페이징 매개 변수](pagingparameters.md)

&nbsp;&nbsp;Xbox Live 서비스 요청을 생성할 때 사용할 수 있는 페이징 매개 변수를 설명 합니다.

[표준 HTTP 요청 및 응답 헤더](httpstandardheaders.md)

&nbsp;&nbsp;Xbox Live 서비스 요청을 생성할 때 사용 되는 표준 HTTP 헤더를 설명 합니다.

[표준 HTTP 상태 코드](httpstatuscodes.md)

&nbsp;&nbsp;서비스에서 반환 되는 표준 HTTP 상태 코드를 설명 합니다.
