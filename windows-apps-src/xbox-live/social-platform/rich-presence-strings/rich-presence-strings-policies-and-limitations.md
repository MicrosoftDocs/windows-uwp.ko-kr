...
-   (매개 변수의 값 포함) 총 44 문자 1 줄을 해야 합니다. Xbox 360 다양 한 상태 제한 하는 것과 비슷합니다. 문자열의 길이 증가 수를 확인 하려면 클라이언트를 사용 하 여 작업할 했습니다. 문자열을 더 오래 일 수 있는 경우 공지가 됩니다.
    -   유니코드 문자는 필수 하 고 디스플레이 대 한 인코딩을 u t F-8 작업할 수 있어야 합니다.
-   사용자 이름이 이러한 규칙을 수행 해야 합니다.
    -   허용 된 문자는 'A' 'a' ~ 'z', 'Z' 통해 밑줄 ('\_ '), 및 ' 0'부터 ' 9'입니다.
