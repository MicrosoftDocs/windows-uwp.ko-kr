...
Fluent 디자인 효과 | 이러한 새로운 효과는 Fluent Design 시스템의 일부이며 깊이, 관점 및 동작을 사용하여 사용자가 중요한 UI 요소에 집중할 수 있도록 합니다. </br>* [아크릴 자료](../design/style/acrylic.md) 투명 한 질감을 만드는 브러시의 형식입니다. </br>* [시차 효과](../design/motion/parallax.md)는 앱에 3차원 깊이 및 관점을 추가합니다. </br>* [표시](../design/style/reveal.md) 응용 프로그램의 중요 한 요소를 강조 표시 합니다. </br> 자세한 내용은 [Fluent 디자인 개요](https://fluent.microsoft.com/)를 확인하십시오.
...
내 피플 | 내 피플을 사용하면 사용자가 응용 프로그램에서 바로 작업 표시줄에 연락처를 고정할 수 있습니다. [응용 프로그램 내 사용자 지원을 추가 하는 방법을 알아봅니다.](../contacts-and-calendar/my-people-support.md) </br></br>* [공유 내 사용자](../contacts-and-calendar/my-people-sharing.md) 작업 표시줄에서 바로 응용 프로그램을 통해 파일을 공유할 수 있습니다. </br>* [내 사용자 알림](../contacts-and-calendar/my-people-support.md) 은 사용자가 고정 된 연락처에 보낼 수 있는 알림 메시지의 새 종류입니다.
...
기능 | 설명
 :------ | :------
계정 관리 | 이제 더 많은 유연성이 제공 하면 [파트너 센터 계정을 사용 하 여 Azure AD 테 넌 트를 연결](../publish/associate-azure-ad-with-dev-center.md) 여러 계정 사용자를 추가 합니다. Azure AD 테 넌 트를 여러 단일 파트너 센터 계정을 연결 하거나 단일 연결 수 둘 이상의 파트너 센터 계정 사용 하 여 Azure AD 테 넌 트입니다.
...
스토어 목록 | Store 목록이 잠재 사용자가 참여할 수 있는 새로운 기능으로 향상되었습니다. </br>* 이제 앱의 Store 목록에 [비디오 예고편](../publish/app-screenshots-and-images.md#trailers)을 포함할 수 있습니다. </br></br>* [Store 목록을 가져오고 내보내](../publish/import-and-export-store-listings.md) 빠르게 업데이트할 수 있습니다. 특히 여러 언어로 목록이 있는 경우 더 빠릅니다.
