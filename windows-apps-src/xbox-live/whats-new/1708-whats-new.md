...
피드 LFG, 및 Mixer 자유롭게 Xbox 콘솔, PC, 또는 iOS/Android 장치를 클럽 채팅 등의 기능을 사용 하 여 게임을 서로 연결 하는 Xbox live 구성원 게임 외부 게임의 클럽 유지 하는 모든 Xbox 환경에서 액세스할 수 있습니다.

Api는 만들기 및 게임 내에서 직접 게임의 클럽 관리를 사용할 수 있습니다. 이러한 Api는 xbox::services::clubs 네임 스페이스에 존재합니다.
