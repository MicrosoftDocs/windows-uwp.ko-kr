...
**참고**차이점 **Mode** 속성에 대 한 기본 값으로 변환 하는 태그에서 **{x: Bind}** **{Binding}** 다시 주의 해야 합니다.
