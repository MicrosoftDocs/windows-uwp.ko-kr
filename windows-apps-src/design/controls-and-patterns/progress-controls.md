...
*위쪽에서 아래쪽-부정형 진행률 표시줄 및 확정적이 지 ProgressBar*
...
-   **컨트롤에 정의 된 기간 또는 예측 가능한 끝에 있습니까?**

    확정 ProgressBar를 사용하고 백분율 또는 값을 적절히 업데이트합니다.

-   **사용자 작업의 진행률을 모니터링 하지 않고도 계속 수 있습니까?**
...
-   **사용자는 상황이 알려주도록 해야 합니까?**

    예를 들어 앱이 백그라운드에서 다운로드하고 있을 때 사용자가 다운로드를 시작하지 않았다면 사용자는 이를 알 필요가 없습니다.

-   **작업은 사용자에 게 (그러나 여전히 일부) 최소 관심 이며 사용자 활동을 차단 하지는 백그라운드 작업 인지 확인 합니다.**
