...
샘플은 모두 Xbox Live 크리에이터 스 프로그램 및 ID@Xbox Xbox Live 샘플 GitHub 리 포 찾아보실 Xbox Live API에 대 한 사용 사례를 찾을 수 있습니다[https://github.com/Microsoft/xbox-live-samples](https://github.com/Microsoft/xbox-live-samples)

| 샘플 이름             | 플랫폼 | 언어                     | 설명                                                                                                                                                                                                           |
|:------------------------|:----------|:------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 도전 과제            | UWP, XDK | C + + 11, Unity                   | Xbox LIVE 사용자 로그인에 대 한 도전 과제 정보를 가져오고 성과 수익 시킬 수 있는 사용자의 통계를 변경 하는 이벤트를 전송 하는 방법을 보여 줍니다. |
...
| TCUI                    | UWP      | C + + 11                          | 타이틀을 사용 하는 방법을 보여 줍니다 주식 등 사용자가 선택기를 보여 주는 친구 초대 등의 일반적인 시나리오를 수행 하는 데 사용할 수 있는 UI는 UI를 호출할 수 있습니다. |
...
일부 Xbox Live 샘플 포함 XDK 샘플 GDNP에서 호스팅됩니다. 액세스에 대 한 개발자 계정 관리자에 게 문의 합니다.
