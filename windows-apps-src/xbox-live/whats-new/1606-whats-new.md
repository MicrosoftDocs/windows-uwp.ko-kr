...
> **참고:** (XDK (Xbox 개발자 키트)를 사용 하는 경우 *새로운-2016 년 4 월* 문서에서는 3 월 XDK 릴리스 이후 추가 된 새 기능을 설명 합니다.
...
다음과 같은 새 클래스에 추가 된 합니다 `contextual_search` 게임 클립을 검색 하는 API:
