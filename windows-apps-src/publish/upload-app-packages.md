...
> [!IMPORTANT]
> Windows 10 용 여기.msixupload 또는.appxupload 파일 대신.msix,.appx,.msixbundle, 또는.appxbundle 업로드 하는 것이 좋습니다.  스토어에서의 UWP 앱 패키징에 대한 자세한 내용은 [Visual Studio를 사용하여 UWP 앱 패키징](../packaging/packaging-uwp-apps.md)을 참조하세요.
