...
1. 로그인 [Xbox 개발자 포털](https://xdp.xboxlive.com)만든 개발 계정 또는 [Windows 개발자 센터](https://developer.microsoft.com/dashboard/windows/overview)에서 권한을 부여한 소매 개발자 계정.
1. Xbox Live 정보에 액세스할 수 있는 권한을 앱에 권한을 부여 합니다.
