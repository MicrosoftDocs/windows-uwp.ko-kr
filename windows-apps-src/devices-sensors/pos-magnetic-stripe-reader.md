...
사용 가능한 장치를 열거 하 고 장치 개체를 만들 것을 사용 하려면 먼저 디바이스 클레임 해야 한다는 점에서 유니버설 Windows 플랫폼 (UWP) 응용 프로그램에서 자기 띠 판독기를 사용 하는 것은 다른 지점의 서비스 장치를 사용 하 여 비슷합니다. 자세한 내용은 [서비스 지점 시작](pos-basics.md) 에서 설명서를 따릅니다.
