...
Windows 스토어는 전 세계 200여 이상의 국가와 지역에 있는 고객에게 다가갑니다. 앱을 제공할 지역/국가를 선택할 수 있습니다. 지역/국가 또는 지역/국가 그룹 별로 [가격 책정 및 가용성](set-app-pricing-and-availability.md)을 다양하게 사용자 지정할 수 있는 옵션도 있습니다.

[앱 세계화에 도움이 되는 지침](../globalizing/guidelines-and-checklist-for-globalizing-your-app.md)을 참조해 주세요.
...
다음 지역/국가 중 하나 이상에 앱 또는 추가 기능을 나열하도록 선택할 수 있습니다. 별표가 된 지역/ 국가는 Xbox 스토어를 지원합니다. **시장 선택** 팝업 창의 이름 옆에 **Xbox**가 표시됩니다.
