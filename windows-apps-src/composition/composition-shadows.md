...
DropShadow 프로그램에 대 한 모양을 정의 하는 몇 가지가 있습니다.
...
시각적 개체의 콘텐츠를 일치 하 여 그림자를 원하는 경우에 그림자 마스크 속성에 대 한 시각적 개체의 브러시를 사용 하거나 콘텐츠에서 마스크를 자동으로 상속 하도록 그림자를 설정 합니다. LayerVisual를 사용 하 여, 그림자 기본적으로 마스크를 상속 합니다.
...
시각적 계층에 많은 최적화 효율적이 고 사용할 수 있는 효과에 그림자 생성 설정한 옵션에 따라 상대적으로 비용이 많이 드는 작업 될 수 있습니다. 다음은 다양 한 유형의 그림자에 대 한 높은 수준 '비용'입니다. 참고는 특정 그림자 비용이 많이 드는 수도 있지만 경우에 따라서는 여전히 특정 시나리오에서 자주 사용 하 여 적절할 수 있습니다.
