...
:::row:::
    :::column:::
![색 그라데이션을 보여 주는 이미지의 스크린샷](images/header-color.svg)
### <a name="color"></a>[색상](color.md)
색은 앱의 다양한 수준의 정보를 통해 탐색하는 직관적인 방식을 제공하며 상호 작용 모델을 강화하는 데 중요한 도구 역할을 합니다.
    :::column-end:::
    :::column:::
![입력 체계를 보여 주는 이미지의 스크린샷](images/header-typography.svg)
...
:::row:::
    :::column:::
![강조 표시를 보여 주는 이미지의 스크린샷](images/header-reveal-highlight.svg)
### <a name="reveal-highlight"></a>[강조 표시](reveal.md)
조명을 사용하여 중요한 요소에 빛을 비춥니다.
    :::column-end:::
    :::column:::
![포커스 표시를 보여 주는 이미지의 스크린샷](images/header-reveal-focus.svg)
...
:::row:::
    :::column:::
![사운드를 보여 주는 이미지의 스크린샷](images/header-sound.svg)
### <a name="sound"></a>[소리](sound.md)
소리는 애플리케이션의 사용자 환경을 완성하고 모든 플랫폼에서 Windows 느낌을 일치시키는 데 필요한 추가 오디오 이점을 제공합니다.
    :::column-end:::
    :::column:::
![커서가 깜박인 후 Writing style이라는 단어가 입력되는 짧은 동영상](images/header-writing-style.gif)
