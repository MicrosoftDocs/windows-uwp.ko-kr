...
일부 컨트롤에 대해 자동으로 표시됩니다. 다른 컨트롤의 경우 이 문서의 [다른 컨트롤에서 표시를 사용하도록 설정](#enabling-reveal-on-other-controls) 및 [사용자 지정 컨트롤에서 표시를 사용하도록 설정](#enabling-reveal-on-custom-controls) 섹션에 설명된 것처럼 컨트롤에 특별한 스타일을 지정하여 표시를 사용할 수 있습니다.
...
사용자 지정 또는 다시 템플릿 컨트롤, 또는 사용자 지정 명령 화면에 표시를 사용하면 이러한 팁을 사용하여 효과를 최적화할 수 있습니다.
