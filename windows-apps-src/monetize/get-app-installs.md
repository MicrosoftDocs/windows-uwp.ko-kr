...
| startDate | date | 검색할 설치 데이터의 날짜 범위에 있는 시작 날짜입니다. 기본값은 현재 날짜입니다. |  예  |
...
* [보고서 설치](../publish/acquisitions-report.md)
