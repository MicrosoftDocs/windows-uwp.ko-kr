...
| 멤버| 유형| 설명| 
| --- | --- | --- | 
| continuationToken| 문자열| 불투명 연속 토큰을 결과의 다음 페이지에 액세스 하는 데 사용 합니다. 최대 32 자입니다. 호출자는 다음 일련의 컬렉션에 항목을 검색 하기 위해 <b>continuationToken</b> 쿼리 매개 변수에서이 값을 제공할 수 있습니다. 이 속성이 <b>null</b>이면 다음 항목이 없는 추가 컬렉션에서 합니다. 이 속성은 필수 이며 컬렉션 <b>skipItems</b>를 사용 하 여 페이징 될 경우에 제공 됩니다.| 
