...
ms.locfileid: "7575837"
---
# <a name="error-handling"></a>오류 처리

서비스 호출을 만들 때 개발자는 특별 한 주의 수행 해야 합니다. 항상 타이틀 네트워크 호출을 만들 때 오류를 처리 해야 합니다. 개발 중 일관 되 게 협업 해 서비스 호출에 대해서도 서비스 호출에 대 한 몇 가지 다른 이유가 실제 환경에서 실패할 수 있습니다. 예를 들어 한 호출으로 인해 실패할 수 있습니다.
...
발생 한 오류 처리에서 Xbox 서비스 API (XSAPI) API에 따라 두 가지 스타일 사용 하는:
