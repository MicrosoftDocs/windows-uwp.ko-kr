...
Microsoft Visual Studio 2015 다운로드 및 설치
...
<tbody>
<tr class="odd">
<td align="left"><p>[DirectX 게임 프로젝트 템플릿](user-interface.md)</p></td>
<td align="left"><p>UWP 및 DirectX 게임을 만들기 위한 템플릿에 대해 알아봅니다.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[게임 프로그래밍용 Visual Studio 도구](set-up-visual-studio-for-game-development.md)</p></td>
<td align="left"><p>Visual Studio에서 사용할 수 있는 DirectX 관련 도구 개요.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[그래픽 진단 도구](use-the-directx-runtime-and-visual-studio-graphics-diagnostic-features.md)</p></td>
