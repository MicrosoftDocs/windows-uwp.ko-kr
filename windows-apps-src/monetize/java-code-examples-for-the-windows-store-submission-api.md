...
title: Java 샘플 - 앱, 추가 기능 및 플라이트 제출
ms.date: 07/10/2017
ms.topic: article
...
4. Azure Blob Storage 전송에 대 한 아이콘을 포함 하는 ZIP 보관 파일을 업로드 합니다.
