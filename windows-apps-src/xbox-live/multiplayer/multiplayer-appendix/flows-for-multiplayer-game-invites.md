...
자세한 사용자 환경을 흐름은 다음 예제에 설명 되어 있습니다. 각 표에서 David 및 숙 두 사용자는 예제 흐름을 보여 줍니다. 이러한 흐름 각 열에 표시 되 고 동시에 발생 합니다. <b style="background-color: #FFFF00">강조 표시 된 텍스트</b> 이전 UX 흐름에서 변경 된 조정 보여 줍니다.
...
알림 센터, <b style="background-color: #FFFF00">숙 게임을 시작할 수 및 초대를 수락</b>, <b>초대를 수락</b>또는 <b style="background-color: #FFFF00">거절 초대</b>합니다.
    </td>
  </tr>
  <tr>
...
David 다른 게임으로 전환 하 고 멀티 플레이 메뉴로 이동 합니다.
     <p><br>
Xbox 시스템 UI 싶어합니다 자신의 타사 새로운 전환 하는 경우 게임을는 그 응답할 수 <b>예</b> 또는 <b>아니요</b>David 요청 합니다.
    </td>
...
멀티 플레이 로비에서 David 게임을 시작합니다.
  ...
  <tr>
    ...
    <p><br>
알림 센터에서 숙 선택할 수 있습니다. <ul>
     <li><b>수락 게임 초대</b>: 새 게임 시작 <li><b>게임 초대 거절:</b> 게임이 시작 하지만 숙은 여전히 보유할 하 고 후속 게임 초대를 받게 됩니다.
...
알림은 David 숙 자신의 자에 초대를 나타내는 팝업 됩니다.
    <p><br>
알림 센터 숙에 <b>초대를 수락</b>하는 옵션이 있습니다.
    <p><br>
숙 수락 타사 앱이 맞춥니다.                                                                         </td>
  </tr>
  <tr>
...
알림 자는 게임에서 발견 했음을 나타내는 팝업 됩니다.
    <p><br>
알림 센터에서에 숙은 다음을 수행할 수 있습니다. <ul>
    <li>   <b>게임 초대를 수락:</b> 게임 시작 <li>   <b>게임 초대 거절:</b> 게임 실행 수 없음, 숙은 파티에서 여전히 및 후속 초대를 받게 됩니다.
    <li>   <b style="background-color: #FFFF00">타사 두고: 게임이 시작 숙 보유할에서 제거 됩니다.</b>
    </ul>  
    </td>
  </tr>
</table>
...
**게임 초대 전송** 알림만 원격 대상 멤버를 사용 하 여 게임 세션 설정 된 처음으로 나타납니다. 원격 대상 구성원에 게 전송 하는 후속 요청이 알림이 메시지를 생성 하지 않습니다. 이 제목 **PullReservedPlayersAsync**를 여러 번 호출 하면 반복 된 **게임 초대 전송** 토스트와 스팸 화 되에서 사용자를 방지 합니다.

**참고** **PullReservedPlayersAsync** 를 한 번만 호출 하 고 예약 됨,으로 친구를 원하는 모든 추가 하는 것이 좋습니다.
