...
ms.locfileid: "8332401"
---
# <a name="configure-access-policies-in-partner-center"></a>파트너 센터에서 액세스 정책 구성

[파트너 센터](https://partner.microsoft.com/dashboard) 를 사용 하 여 다른 서비스, 게임 및 앱 타이틀의 Xbox Live 설정 및 데이터에 액세스할 수 있도록 합니다. 예를 들어, 순위표, 웹 사이트에 표시 하는 웹 서비스를 할 수 있습니다 또는 보거나 저장 된 게임 데이터를 수정 하는 게임의 타이틀 저장소에 액세스할 수 있는 도우미 앱을 할 수 있습니다.
...
3. 설정에 대 한 액세스 권한을 부여 하려는 클릭 하 고 추가 응용 프로그램/서비스 단추를 클릭 합니다. 이렇게 하면 해당 설정에 액세스 하도록 구성 된 응용 프로그램/서비스 목록 맨 아래에 새 행을 추가 됩니다.

4. 드롭다운 상자에서 앱 또는 서비스의 유형을 선택 하 고 앱, 제목 id 또는 앱 또는 데이터에 액세스 하는 서비스의 서비스 id를 나타내는 정보 상자에 입력 합니다.

5. 앱 또는 서비스의 데이터를 읽을 수 또는 전체 데이터에 액세스할 수 있는 경우를 선택 합니다.
