...
마지막으로, [**SetPropertiesAsync**](https://docs.microsoft.com/windows/uwp/develop/)를 호출하여 방향 데이터가 포함된 속성 집합을 인코더에 대해 설정하고 [**FlushAsync**](https://docs.microsoft.com/uwp/api/windows.graphics.imaging.bitmapencoder.flushasync)를 호출하여 이미지를 코드 변환합니다.
