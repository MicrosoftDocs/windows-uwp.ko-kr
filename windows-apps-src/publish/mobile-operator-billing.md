...
> **참고** 고객의 통신사가 통신사 청구를 제공하지만 고객이 장치에서 이러한 옵션을 찾을 수 없는 경우 이러한 [단계](http://go.microsoft.com/fwlink/p/?LinkId=523993)를 참조하세요.
...
| 인도                | Idea                                                               |
| 인도네시아            | Telkomsel, HCPT(Hutchinson CP Telecommunications)                 |
| 아일랜드              | O2, Vodafone, 3                                                |
