...
**FocusVisualKind** 속성을 설정 하면 시스템 해당 [UseSystemFocusVisuals](/uwp/api/Windows.UI.Xaml.Controls.Control.UseSystemFocusVisuals) 속성이 **True** (대부분의 컨트롤에 대 한 기본값)로 설정 하는 모든 컨트롤에 포커스 표시 효과 자동으로 적용 합니다. 
