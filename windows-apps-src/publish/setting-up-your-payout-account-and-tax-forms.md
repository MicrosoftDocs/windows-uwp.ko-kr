...
Windows 스토어의 앱 판매에서 번 돈을 받으려면 지급액 계좌를 설정하고 필요한 세금 양식을 입력해야 합니다.
...
> **참고** [특정 지역/국가](account-types-locations-and-fees.md#developer-account-and-app-submission-markets)에서만 무료 앱 목록을 표시할 수 있습니다. 계정이 이러한 시장 중 하나에 등록되어 있는 경우 지급액 계좌를 설정하는 옵션이 제공되지 않습니다.
...
> **참고** 앱으로 번 돈을 지급 받는 방법과 시기에 대한 자세한 내용은 [지급 받기](getting-paid-apps.md)를 참조하세요.
...
> **참고** 몇몇 지역/국가에서는 PayPal을 지급 계좌에 사용할 수 있습니다. 특정 지역/국가에서 PayPal이 지원되는지 확인하려면 [계정 유형, 위치 및 수수료](account-types-locations-and-fees.md#developer-account-and-app-submission-markets)를 참조하고, 자세한 내용은 [PayPal 정보](#paypal)를 읽어보세요.

 
**지급 계좌를 설정하려면**

1.  Windows 개발자 센터 대시보드의 왼쪽 탐색 메뉴에서 **계정 설정**을 클릭합니다.
2.  **계정 설정** 페이지의 왼쪽 탐색 메뉴에서 **지급 계좌**를 클릭합니다.

   > **참고** 이는 중요한 정보이므로 다시 로그인하라는 메시지가 표시될 수 있습니다.

3.  표시되는 화면에서 계좌 정보를 입력합니다.

   > **참고** 계좌 정보를 제공하기 위해 사용하는 필드에는 영숫자 문자만 입력할 수 있습니다.

4.  정보를 저장합니다.

지급액 계좌를 업데이트하거나 변경해야 하는 경우 위와 동일한 단계를 수행하여 현재 정보를 새 정보로 바꿉니다.

> **중요** 지급액 계좌를 변경하면 다음 지급 주기로 지급이 지연됩니다. 처음 지급액 계좌를 설정할 때 그랬던 것처럼 Microsoft에서 계좌 변경을 확인해야 하기 때문입니다. 하지만 계좌가 검증된 후 전체 금액이 지급됩니다. 현재 지급 주기의 모든 지급 대상액이 다음 주기에 추가됩니다. 자세한 내용은 [지급 받기](getting-paid-apps.md)를 참조하세요.
...
러시아에 사는 개발자인 경우, 은행에서 자금을 계좌에 입금하기 전에 은행에 관련 문서를 제공해야 할 수 있습니다. 결제를 받아야 하는 경우, 다음 문서를 이메일로 제공해야 합니다.
...
-   Windows 개발자 센터 대시보드에서 결제 계좌에 입력한 **예금주 이름**은 은행 계좌에 연결된 이름과 정확하게 일치해야 합니다. 예를 들어, 은행 계좌에 중간 이름이 포함되어 있는 경우에는 **예금주 이름**에 중간 이름을 추가하세요.
-   Microsoft에서 은행 계좌로 직접 이체하며, 지급액의 통화는 루블(RUB)입니다.
-   개발자 센터에 라틴어로 입력한 은행 정보는 키릴 문자로 번역됩니다.
-   은행 계좌로 지급되며, 은행 카드로는 지급되지 않습니다.

### 우크라이나

우크라이나에 사는 개발자인 경우, 은행에서 자금을 계좌에 입금하기 전에 은행에 관련 문서를 제공해야 할 수 있습니다. 결제를 받아야 하는 경우, 다음 문서를 이메일로 제공해야 합니다.
...
[개발자 계정을 등록](opening-a-developer-account.md)하고 [지급 계좌](#receiving_payments)를 설정한 후 다음 단계를 완료하여 Windows 스토어용 *세금 프로필*을 만들 수 있습니다.
...
> **중요** 국가 및 지역에 따라 세금 요건이 다릅니다. 세금으로 납부해야 하는 정확한 액수는 앱을 판매하는 국가 및 지역에 따라 다릅니다. Microsoft에서 판매세와 이용세를 대신 납부하는 국가에 대해서는 [앱 개발자 계약](https://msdn.microsoft.com/library/windows/apps/hh694058)을 참조하세요. 다른 국가에서는 등록된 위치에 따라 현지 세무 당국에 직접 앱 판매세와 이용세를 납부해야 할 수도 있습니다. 또한 지급되는 앱 판매 수익에 대해 소득세가 과세될 수 있습니다. 따라서 해당 국가나 지역의 관련 기관에 문의하여 Windows 스토어 개발자 활동에 대한 정확한 세금 정보를 확인하는 것이 좋습니다.
...
완성해야 하는 세금 양식의 온라인 버전이 표시됩니다. 거주 국가 또는 국적과 관계없이 Windows 스토어를 통해 앱 또는 앱에서 바로 구매 제품을 판매하려면 미국 세금 양식을 작성해야 합니다. 특정 미국 영주권 요구 사항을 충족하는 개발자는 IRS W-9 양식을 작성해야 합니다. 미국 이외 지역의 다른 개발자는 IRS W-8 양식을 작성해야 합니다. 세금 프로필을 완성하면 온라인으로 이러한 양식을 작성할 수 있습니다.
...
미국 이외 지역에 거주하는 경우 조세조약 혜택을 활용할 수 있습니다. 이 혜택은 국가별로 다르며, Windows 스토어에서 원천징수하는 세액을 줄이도록 허용할 수 있습니다. W-8BEN 양식의 Part II를 완성하면 조세조약 혜택을 클레임할 수 있습니다. 이러한 혜택을 받을 수 있는지 확인하려면 거주 국가나 지역의 관련 기관에 문의하는 것이 좋습니다.
