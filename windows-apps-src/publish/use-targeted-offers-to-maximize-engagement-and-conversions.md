---
author: JnHs
Description: "특정 고객 세그먼트를 대상으로 개인화된 콘텐츠를 제공해 참여와 유지, 수익을 향상시킵니다."
...
특정 고객 세그먼트를 대상으로 소구력이 있는 개인화된 콘텐츠를 제공해 참여와 유지, 수익 창출을 향상시킵니다. 경우에 따라, 대상 제품을 성공적인 전환을 한 개발자에게 본너스를 지급하는 Microsoft 후원 프로모션과 연결해 더 많은 수익을 전달할 수 있습니다.
...
2. **앱 내 대상 제품 경험을 구현합니다.** 앱 코드에서 *Windows 스토어 대상 제품 API*를 사용하여 특정 사용자를 대상으로 사용 가능한 대상 제품을 검색하고, (프로모션과 관련이 있는 경우)대상 제품을 요구합니다. 또 대상 제품에 대한 앱 내 환경을 만들어야 합니다. 자세한 내용은 [스토어 서비스를 사용하여 대상 제품 관리](../monetize/manage-targeted-offers-using-windows-store-services.md)를 참조하세요.
...
2.  **대상 제품** 페이지에서 사용 가능한 대상 제품을 확인합니다. 구현하고 싶은 대상 제품에 대해 **새 대상 제품 만들기**를 선택합니다. 
    ...
    > [!NOTE]
    > 확인할 수 있는 사용 가능 대상 제품은 시기와 계정 기준에 따라 달라집니다. 처음에는 미리 정의한 세그먼트 기준을 사용하여 하나 이상의 대상 제품을 확인할 수 있습니다. [정의한 고객층](create-customer-segments.md)을 기준으로 대상 제품을 바로 만들 수 있습니다.
...
> 
> 대상 제품 콘텐츠를 고려할 때, 앱 콘텐츠와 마찬가지로 대상 제품의 콘텐츠는 스토어 [콘텐츠 정책](https://msdn.microsoft.com/library/windows/apps/dn764944.aspx#content_policies)을 준수해야 한다는 점에 유의하세요.
> 
