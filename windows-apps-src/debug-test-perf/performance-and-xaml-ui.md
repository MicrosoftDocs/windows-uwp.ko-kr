...
아직 수행 하지 않은 경우에는 Windows 10을 대상으로 하는 응용 프로그램을 이식 하는 것이 중요 한 것으로 나타났습니다. 몇 가지 XAML 최적화 (예: [{X:bind}](https://docs.microsoft.com/windows/uwp/xaml-platform/x-bind-markup-extension))는 Windows 10 앱 에서만 사용할 수 있습니다. [응용 프로그램을 Windows 10으로 포팅](https://docs.microsoft.com/windows/uwp/porting/index) 및 [유니버설 Windows 플랫폼로 이동](https://channel9.msdn.com/Events/Build/2015/3-741)하는 build/session을 참조 하세요.
...
| [UI 스레드 응답을 유지 합니다.](keep-the-ui-thread-responsive.md) | 사용자는 컴퓨터 유형에 관계없이 계산하는 동안 앱이 계속 응답할 것으로 기대합니다. 이는 앱에 따라 다른 항목을 의미합니다. 일부는 이는 더 실제적인 물리학을 제공하거나, 디스크나 웹에서 더 빠르게 데이터를 로드하거나, 빠르게 복잡한 화면을 제공하고 페이지를 탐색하거나, 즉시 방향을 찾거나, 데이터를 빠르게 처리하도록 변환됩니다. 계산 유형에 관계없이 사용자는 앱이 입력한 대로 작동하고 &quot;연산&quot; 중에 응답하지 않는 것으로 보이지 않기를 원합니다. |
