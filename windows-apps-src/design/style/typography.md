...
![커닝 및 추적의 차이](images/kerning-tracking.png)  
  ...
  <div class="side-by-side-content-right">
![단어 및 문자 간격의 차이입니다.](images/word-letter.png) 
  </div>
</div>
</div>
...
![텍스트 왼쪽 맞춤을 표시합니다.](images/alignment.png)  
  ...
  <div class="side-by-side-content-right">
![줄 끝을 맞춰서 표시합니다.](images/line-endings.png) 
  </div>
</div>
</div>
...
<div class="uwpd-image-with-caption">
    ...
    <div>모든 크기는 유효 픽셀 단위입니다. 자세한 내용은 [UWP 앱 디자인 소개](../basics/design-and-ui-intro.md)를 참조하세요.</div>
</div>
...
유형 램프 이상의 추가 계층 구조를 만들려면 보조 텍스트를 60% 불투명도로 설정합니다. [테마 색상표](color.md#themes)에서 BaseMedium을 사용합니다. 기본 텍스트는 항상 100% 불투명도 또는 BaseHigh여야 합니다.
