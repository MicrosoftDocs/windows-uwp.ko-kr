---
Description: 파트너 센터에서 실험을 정의 하 고 앱에서 실험을 코딩 한 후 활성 실험이 준비를 사용 하 여 파트너 센터 실험의 결과 검토 합니다.
...
한 후 [파트너 센터에서 실험을 정의](define-your-experiment-in-the-dev-center-dashboard.md) 및 [실험에 대 한 앱을 코딩](code-your-experiment-in-your-app.md), 실험을 활성화 하 고 파트너 센터를 사용 하 여 실험의 결과 검토할 준비가 됩니다. 필요한 데이터를 모두 얻은 후 실험을 종료하고 모든 앱에서 컨트롤 변형의 변수 값을 계속 사용할지, 아니면 다른 변형 중 하나의 변수 값을 사용하도록 전환할지를 선택할 수 있습니다.
...
파트너 센터에서 실험의 매개 변수를 사용 하 여 만족 한다면 앱 코드 업데이트를 앱에서 실험 데이터 수집을 시작할 수 있도록 실험을 활성화할 수 있습니다. 실험 활성화 되 면 앱 변형 값을 검색 하 고 파트너 센터로 뷰와 변환 이벤트를 보고할 수 있습니다.
...
1. 파트너 센터에서 실험 페이지에 반환 합니다. 자세한 내용은 이전 섹션을 참조하세요.
