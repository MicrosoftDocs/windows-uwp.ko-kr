...
> [!NOTE]
> 내부 논리 [ **StackPanel** ](https://msdn.microsoft.com/library/windows/apps/br209635) 도이 동작을 포함 합니다. **StackPanel** 는 무한 차원 값을 전달 [ **측정값** ](https://msdn.microsoft.com/library/windows/apps/br208952) 방향 차원의 자식에서 제약 조건이 없는 임을 나타내는 자식에서 합니다. 일반적으로 **StackPanel**은 해당 차원에서 증가하는 스택에 모든 자식을 수용하기 위해 동적으로 크기가 조정됩니다.
