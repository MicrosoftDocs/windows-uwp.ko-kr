...
> [!WARNING]
> 어떠한 문자열 식별자 여기 수를 제공 하는 이름은 선택한 언어의 프로그래밍에서 유효한, 하지만 일반적으로 xaml에서 에서도 종속성 속성을 설정할 수 하고자 합니다. XAML에서 설정하도록 하려면 선택하는 속성 이름이 유효한 XAML 이름이어야 합니다. 자세한 내용은 [XAML 개요](xaml-overview.md)를 참조하세요.
