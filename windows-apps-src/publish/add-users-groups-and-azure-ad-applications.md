...
ms.locfileid: "3823097"
---
# <a name="add-users-groups-and-azure-ad-applications-to-your-dev-center-account"></a>개발자 센터 계정에 사용자, 그룹, Azure AD 응용 프로그램 추가

( **계정 설정**)에서 Windows 개발자 센터의 **사용자** 섹션에는 Azure Active Directory를 사용 하 여 개발자 센터 계정에 사용자를 추가할 수 있습니다. 각 사용자에게 계정에 대한 사용 권한을 정의하는 역할(또는 사용자 지정 권한 집합)이 할당됩니다. [사용자 그룹](#groups) 및 [Azure AD 응용 프로그램](#azure-ad-applications)을 추가하여 개발자 센터 계정에 대한 액세스 권한을 부여할 수도 있습니다.
...
1.  대시보드의 오른쪽 위 모서리) (근처 기어 아이콘을 선택 하 고 **계정 설정**를 선택 합니다. **설정** 메뉴에 **사용자**를 선택 합니다.
...
-   **기존 사용자 추가**: 조직의 디렉터리에 이미에 액세스 하도록 허용할 개발자 센터 계정에 위에 설명 된 메서드를 사용 하는 사용자를 선택 합니다.
-   **새 사용자 만들기**: 모두 조직의 디렉터리에 추가할 새로운 사용자 계정 및 개발자 센터 계정 만들기
...
1.  ( **계정 설정**)에서 **사용자가** 페이지에서 **사용자 추가**선택 하 고 **만들기 새 사용자**를 선택 합니다.
...
1.  ( **계정 설정**)에서 **사용자가** 페이지에서 **사용자 추가**선택한 다음 **메일로 사용자 초대**를 선택 합니다.
...
2.  페이지의 맨 아래에 **암호를 재설정** 단추를 선택 합니다.
...
1.  ( **계정 설정**)에서 **사용자가** 페이지에서 **그룹 추가**클릭 합니다.
...
1.  1.  대시보드의 오른쪽 위 모서리) (근처 기어 아이콘을 선택 하 고 **계정 설정**를 선택 합니다. **설정** 메뉴에 **사용자**를 선택 합니다.
...
**사용자가** 페이지 (아래에서 **계정 설정**) 인 검색 기록을 검토할 사용자에 대 한 **마지막 작업** 아래에 표시 된 링크를 선택 합니다. 지난 30일 동안 사용자가 방문한 모든 페이지의 URL을 볼 수 있습니다.

<span id="remove" />

## <a name="remove-users-groups-and-azure-ad-applications"></a>사용자, 그룹 및 Azure AD 응용 프로그램 제거

개발자 센터 계정에서 사용자, 그룹 또는 Azure AD 응용 프로그램을 제거 하려면 **사용자가** 페이지에 해당 이름으로 표시 되는 **제거** 링크를 선택 합니다. 제거하기를 원한다고 확인한 후에는 나중에 다시 추가하지 않는 한 그 사용자, 그룹 또는 Azure AD 응용 프로그램이 더 이상 개발자 센터 계정에 액세스할 수 없게 됩니다.
