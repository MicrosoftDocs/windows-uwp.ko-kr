...
1. 또는에 로그인 [Xbox 개발자 포털](https://xdp.xboxlive.com)만든 개발 계정을 사용 하 여 [Windows 개발자 센터](https://developer.microsoft.com/dashboard/windows/overview)에서 권한을 부여한 소매 개발자 계정을 사용 하 여 합니다.
