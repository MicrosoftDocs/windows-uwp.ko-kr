...
다음 섹션에서는 선언 및 각 선언을 앱에 적용할지 여부를 결정할 때 고려해 야 할 사항 중 일부를 설명 합니다. Note는 이러한 선언에 두는 기본적으로 선택 (아래 설명 된 대로.) 제품의 범주에 따라 추가 선언도 볼 수 있습니다. 모든 선언 검토 하 고 제출에 정확 하 게 반영 해야 합니다.
...
디바이스에서 내부 하드 드라이브에 설치 허용 및 앱 대체 드라이브 또는 이동식 저장소에 설치 하지 못하게 하려는 경우이 확인란의 선택을 취소 합니다.
