...
일반적으로 입력 *finalSize*와 [**ArrangeOverride**](https://msdn.microsoft.com/library/windows/apps/br225995) 구현에서 반환하는 [**Size**](https://msdn.microsoft.com/library/windows/apps/br208711)는 같습니다. 이유에 대한 자세한 내용은 [XAML 사용자 지정 패널 개요](custom-panels-overview.md)의 "**ArrangeOverride**" 섹션을 참조하세요.
