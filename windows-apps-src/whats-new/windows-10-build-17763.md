...
터치를 통해 절전 모드가 해제 | [터치를 통해 절전 모드가 해제](https://docs.microsoft.com/windows/iot-core/learn-about-hardware/wakeontouch) 해당 화면을 터치 할 때 신속 하 게 전환 하는 동안 사용에 없는 동안 끄려면 디바이스의 화면을 수 있습니다. 
Windows.System.Update | 새 [Windows.System.Update 네임 스페이스](https://docs.microsoft.com/uwp/api/windows.system.update) 에 시스템 업데이트의 대화형으로 제어할 수 있습니다. 이 네임 스페이스는 Windows 10 IoT Core 수만 있습니다.
