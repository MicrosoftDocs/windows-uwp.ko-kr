...
[C + + WinRT](/windows/uwp/cpp-and-winrt-apis/intro-to-using-cpp-with-winrt) 제공 합니다 [ **winrt::box_value** ](/uwp/cpp-ref-for-winrt/box-value) 스칼라 값을 사용 하 고로 박싱됩니다 값을 반환 하는 함수를 **IInspectable**합니다. **IInspectable**을 다시 스칼라 값으로 언박싱하기 위해서 [**winrt::unbox_value**](/uwp/cpp-ref-for-winrt/unbox-value) 및 [**winrt::unbox_value_or**](/uwp/cpp-ref-for-winrt/unbox-value-or) 함수가 존재합니다.
