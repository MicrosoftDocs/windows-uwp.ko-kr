...
ms.locfileid: "67468941"
---
# <a name="in-app-ads"></a>인앱 광고

사용 하 여 합니다 **Monetize** &gt; **앱 내 광고** 페이지에서 [파트너 센터](https://partner.microsoft.com/dashboard) 만들고 ad 단위를 관리 하려면:

* [Microsoft Advertising SDK](https://aka.ms/ads-sdk-uwp)를 사용하는 UWP(유니버설 Windows 플랫폼) 앱.
* 이전에 게시 한 Windows 8.x 및 Windows Phone 8.x 앱을 사용 하는 합니다 [Microsoft Advertising SDK에 대 한 Windows 및 Windows Phone 8.x](https://aka.ms/store-8-sdk)합니다.
...
1.  로 이동 합니다 **Monetize** &gt; **앱 내 광고** 파트너 센터에서 페이지를 클릭 **만들기 ad 단위**합니다.
...
4.  **광고 단위 유형** 드롭다운 목록에서 광고 유형을 선택합니다.
    ...
    * 앱에서 배너 광고를 표시 하는 경우 선택할 **배너**합니다.
...
테이블에서 사용 가능한 광고 단위가에 나타나는 새 ad 단위를 만든 후 합니다 **Monetize** &gt; **앱 내 광고** 페이지입니다.

<span id="available-ad-units" />

## <a name="review-and-edit-ad-units"></a>광고 단위 검토 및 편집

이러한 ad 단위 아래쪽 표에 표시 계정에서 하나 이상의 앱에 대 한 ad 단위를 만든 후 합니다 **Monetize** &gt; **앱 내 광고** 페이지입니다. 이 표에는 각 광고 단위에 대한 **응용 프로그램 ID** 및 **광고 단위 ID**와 기타 정보가 표시됩니다. 앱에 광고를 표시하려면 다음과 같이 코드에 이러한 값을 사용해야 합니다. 자세한 내용은 [앱에서 광고 단위 설정](../monetize/set-up-ad-units-in-your-app.md)을 참조하세요.
...
* 앱 표시 되 면 [네이티브 광고](../monetize/native-ads.md), 이러한 값을 전달 합니다 **NativeAdsManagerV2** 생성자입니다.
  > [!IMPORTANT]
...
> [!NOTE]
> ad 단위에는 지난 6 개월 동안 활동이 없는 경우에서는 레이블이 그대로 **비활성**, 결국 파트너 센터에서 제거 합니다. 필터를 사용하여 **활성** 또는 **비활성** 광고 단위만 표시할 수 있습니다. 잘못 **비활성**으로 표시된 광고 단위가 있는 경우 [고객 지원에 문의](https://aka.ms/storesupport)합니다.

<span id="mediation" />

## <a name="mediation-settings"></a>조정 설정

경우 있습니다 [새 UWP ad 단위를 만듭니다](#create-ad-unit) 또는 [기존 UWP ad 단위 편집](#available-ad-units)를 구성 하려면이 섹션의 옵션을 사용 [ad 중재](../monetize/ad-mediation-service.md) ad 단위에 대 한 합니다. 광고 조정을 통해 기타 유료 광고 네트워크의 광고와 Microsoft 앱 프로모션 캠페인 비수익 광고 등 여러 광고 네트워크의 광고를 표시하여 광고 수익과 앱 홍보 기능을 최대화할 수 있습니다. Microsoft는 사용자가 선택한 광고 네트워크의 배너 광고 요청을 조정합니다. 앱에서 UWP 광고 단위가 배너, 중간 광고 또는 기본 광고에 이미 연결되어 있는 경우에는 광고 조정을 지원하기 위해 앱에서 코드를 변경할 필요가 없습니다.
...
2. 에 **앱 내 광고** 페이지로 이동 하는 **중재 설정** 섹션 및 구성 설정입니다.

    * 기본적으로 **Microsoft에 알려주세요 내 설정을 최적화** 확인란을 선택 합니다. 이 옵션을 사용하는 것이 좋습니다. 이 옵션은 기계 학습 알고리즘을 사용, 자동으로 앱이 지원하는 지역/국가에서 광고 수익을 극대화 하는 데 도움이 되는 앱의 광고 조정 설정을 선택합니다. 이 옵션을 사용 하는 경우에 구성에 사용 하려는 ad 네트워크를 선택할 수 있습니다. 구성의 일부가 되도록 않으려면 알고리즘은 앱에 선택한 ad 네트워크에서 광고를만 수신 되는지 확인 하는 광고 네트워크를 선택 취소 합니다.
    * 사용자 고유의 ad 중재 설정을 선택 하려는 경우 선택 **기본 설정을 수정**합니다.

    > [!NOTE]
    > 이 섹션의 나머지 단계를 선택한 경우 해당 파일만 **기본 설정을 수정**합니다.
...
|--------------|---------------|---------------------|
| Oath 및 AppNexus |  네트워크, Oath AppNexus 파트너를 통해 광고를 제공 하는 Microsoft에서 관리 하는 ad 네트워크입니다.<p/>**참고**: Oath 및 AppNexus 항상 평가 됩니다 먼저 합니다 **광고 네트워크 유료** 목록에 대 한 배너 광고 단위가 이러한 유형의 광고에 대 한 낮은 순위를 변경할 수 없습니다. | 배너, 동영상 중간 광고 |
| AppNexus(직접) | 광고를 제공 하려면이 옵션을 선택 [AppNexus](https://www.appnexus.com)합니다. | 동영상 중간 광고, 기본  |
...
경우 있습니다 [ad 단위 만들기](#create-ad-unit) 또는 [기존 ad 단위 선택](#available-ad-units)의 **COPPA 준수** ad 단위에 대해 선택한 앱을 하나 이상 있으면 페이지 맨 아래에 표시 되는 섹션 에 도달한 한 제출 합니다 [저장소에](../publish/the-app-certification-process.md#in-the-store) 앱 인증 프로세스의 단계입니다.
