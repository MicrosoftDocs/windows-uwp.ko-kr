---
title: Windows 10 Fall Creators Update API 변경
description: 개발자는 다음 목록을 사용하여 Windows 10 빌드 16299에서 새롭게 추가되었거나 변경된 네임스페이스를 식별할 수 있습니다.
keywords: 새로운 기능, 새로운 기능, 업데이트, Windows 10, 1709, 가을, 크리에이터스, api, 16299
ms.date: 11/02/2017
ms.topic: article
...
ms.locfileid: "57647958"
---
# <a name="new-apis-in-windows-10-build-16299"></a>Windows 10 빌드 16299의 새로운 API

신규 및 업데이트 API 네임스페이스가 Windows 10 빌드 16299(Fall Creators Update 또는 버전 1709라고도 함)의 개발자들에게 제공되었습니다. 아래는 이 릴리스에서 추가 또는 수정된 네임스페이스에 게시된 설명서의 전체 목록입니다.

이전의 공개 릴리스에 추가된 API에 대한 정보는 [Windows 10 크리에이터스 업데이트의 신규 API](windows-10-build-15063-api-diff.md)를 참조하세요.
...
### <a name="windowsapplicationmodelcallshttpsdocsmicrosoftcomuwpapiwindowsapplicationmodelcalls"></a>[이 windows.applicationmodel.calls](https://docs.microsoft.com/uwp/api/windows.applicationmodel.calls)
...
#### <a name="designmodehttpsdocsmicrosoftcomuwpapiwindowsapplicationmodeldesignmode"></a>[.](https://docs.microsoft.com/uwp/api/windows.applicationmodel.designmode)
...
#### <a name="accelerometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsaccelerometer"></a>[가 속도계](https://docs.microsoft.com/uwp/api/windows.devices.sensors.accelerometer)
...
#### <a name="barometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsbarometer"></a>[지표](https://docs.microsoft.com/uwp/api/windows.devices.sensors.barometer)
...
#### <a name="compasshttpsdocsmicrosoftcomuwpapiwindowsdevicessensorscompass"></a>[나침반](https://docs.microsoft.com/uwp/api/windows.devices.sensors.compass)
...
#### <a name="gyrometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsgyrometer"></a>[회전 계](https://docs.microsoft.com/uwp/api/windows.devices.sensors.gyrometer)
...
#### <a name="inclinometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsinclinometer"></a>[경사 계](https://docs.microsoft.com/uwp/api/windows.devices.sensors.inclinometer)
...
#### <a name="magnetometerhttpsdocsmicrosoftcomuwpapiwindowsdevicessensorsmagnetometer"></a>[지자기 센터](https://docs.microsoft.com/uwp/api/windows.devices.sensors.magnetometer)
...
#### <a name="gamelisthttpsdocsmicrosoftcomuwpapiwindowsgamingpreviewgamesenumerationgamelist"></a>[게임 목록](https://docs.microsoft.com/uwp/api/windows.gaming.preview.gamesenumeration.gamelist)
...
#### <a name="ambientlighthttpsdocsmicrosoftcomuwpapiwindowsuicompositionambientlight"></a>[ambientlight를 함께 사용](https://docs.microsoft.com/uwp/api/windows.ui.composition.ambientlight)
...
#### <a name="compositorhttpsdocsmicrosoftcomuwpapiwindowsuicompositioncompositor"></a>[작성자](https://docs.microsoft.com/uwp/api/windows.ui.composition.compositor)
...
#### <a name="spotlighthttpsdocsmicrosoftcomuwpapiwindowsuicompositionspotlight"></a>[추천](https://docs.microsoft.com/uwp/api/windows.ui.composition.spotlight)
...
#### <a name="comboboxhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscombobox"></a>[콤보 상자](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.combobox)
...
#### <a name="controlhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscontrol"></a>[컨트롤](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### <a name="gridhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsgrid"></a>[표](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.grid)
...
#### <a name="splitviewhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolssplitview"></a>[분할 된 뷰](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.splitview)
...
#### <a name="textboxhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstextbox"></a>[텍스트 상자](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.textbox)
...
#### <a name="blockhttpsdocsmicrosoftcomuwpapiwindowsuixamldocumentsblock"></a>[블록](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.block)

block.horizontaltextalignment <br> block.horizontaltextalignmentproperty

#### <a name="hyperlinkhttpsdocsmicrosoftcomuwpapiwindowsuixamldocumentshyperlink"></a>[하이퍼링크](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.hyperlink)
