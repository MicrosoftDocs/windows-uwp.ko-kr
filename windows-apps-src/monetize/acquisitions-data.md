...
| endDate | date | 검색할 획득 데이터의 날짜 범위에 있는 종료 날짜입니다. 기본값은 현재 날짜입니다.  | 아니요 |
...
| 구매 유형 | 문자열 | 획득 유형을 나타내는 다음 문자열 중 하나입니다.  <ul><li>**Free**</li><li>**평가판**</li><li>**유료**</li><li>**프로 모션 코드**</li><li>**Iap**</li><li>**구독 Iap**</li><li>**개인 대상**</li><li>**사전 주문**</li><li>**Xbox Game pass** (또는 3 월 23 일 전에 데이터를 쿼리 2018 하는 경우 **게임 pass** )</li><li>**디스크**</li><li>**선불 코드**</li><li>**청구 된 사전 주문**</li><li>**취소 된 사전 순서**</li><li>**실패 한 사전 주문**</li></ul> |
...
| deviceType | 문자열 | 가져오기를 완료 한 장치 유형을 지정 하는 다음 문자열 중 하나입니다. <ul><li>**컴퓨터**</li><li>**전화**</li><li>**콘솔-Xbox One**</li><li>**콘솔-Xbox 시리즈 X**</li><li>**IoT**</li><li>**서버**</li><li>**태블릿**</li><li>**Holographic**</li><li>**알 수 없음**</li></ul> |
...
| 구매 수량 | 숫자 | 지정 된 집계 수준 중에 발생 한 인수 수입니다. |
| purchasePriceUSDAmount | 숫자 | 월별 환율을 사용 하 여 USD로 변환 된 획득에 대 한 고객의 요금입니다. |
| purchaseTaxUSDAmount | 숫자 | 획득에 적용 되는 세금으로, USD로 변환 됩니다. |
...
| purchasePriceLocalAmount | 숫자 | 해당 하는 경우 XDP에서 제품의 가격 로컬 금액을 구입 합니다.  |
