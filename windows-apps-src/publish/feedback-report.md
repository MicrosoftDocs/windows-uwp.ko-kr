...
ms.locfileid: "5982934"
---
# <a name="feedback-report"></a>피드백 보고서

파트너 센터에서 **피드백 보고서** 문제, 제안 및 Windows 10 고객이 피드백 허브를 통해 제출한 찬성을 볼 수 있습니다. 파트너 센터에서이 데이터를 보거나 데이터를 오프 라인으로 내보낼 수 있습니다.
...
> [!TIP]
> 에 대 한 빠른 리뷰, 평점 및 앱의 모든 사용자에 게 피드백 지난 30 일의 왼쪽된 탐색 메뉴에서 **참여** 를 확장 하 고 선택 **리뷰 및 피드백.** 
