...
1. 하기 전에 수 있는 문제를 해결 하려면 소스 코드 패치를 제공 QFE를 배포할 수 있습니다.

## <a name="to-compile-the-xdk-c-xsapi-project-for-yourself"></a>자신을 위해 c + + XSAPI XDK 프로젝트를 컴파일하는 데

<ol>
  <li> Microsoft.Xbox.Services 소스를 가져옵니다. 이렇게 하려면에서 모든 파일을 추출 "%XboxOneExtensionSDKLatest%\ExtensionSDKs\Xbox 서비스 API\8.0\SourceDist\Xbox.Services.zip"를 "C:\Program Files (x86)" 또는 외부 쓰기 가능한 폴더에서 소스를 복제할 수<a href ="https://github.com/Microsoft/xbox-live-api">https://github.com/Microsoft/xbox-live-api</a></li>
...
Visual Studio 2012: <ul>
    ...
    <li> 원본 프로젝트에서 프로젝트를 선택 하 여 참조로 참조...-> 선택한 "참조 추가"를 추가 합니다. "솔루션 프로젝트->", 아래 두 프로젝트 모두 위의 확인을 클릭 한 다음에 대 한 항목을 확인 합니다.</li>
    ...
    <li> {SDK 소스 root}\Include\xsapi\services.h 파일을 선택 하 고 기존 항목 추가 추가 프로젝트를 마우스 오른쪽 단추로 클릭 하 여 앱 소스가 services.h 파일-></li>
...
## <a name="to-compile-the-xdk-winrt-xsapi-project-for-yourself"></a>자신을 위해 XDK WinRT XSAPI 프로젝트를 컴파일하는 데

<ol>
  <li> Microsoft.Xbox.Services 소스를 가져옵니다. 이렇게 하려면에서 모든 파일을 추출 하면 "%XboxOneExtensionSDKLatest%\ExtensionSDKs\Xbox 서비스 API\8.0\SourceDist\Xbox.Services.zip"를 "C:\Program Files (x86)" 또는 외부 쓰기 가능한 폴더에서 소스를 복제할 수<a href ="https://github.com/Microsoft/xbox-live-api">https://github.com/Microsoft/xbox-live-api</a></li>
  <li> 참조를 제거 해야 하는 프로젝트 빌드 전 DLL을 참조 하는 경우</li>
    <ul>
      <li> Visual Studio 2012: 선택 "프로젝트-> 참조..." Visual Studio에서. Xbox 서비스 API에 대 한 참조로 나열 되는 경우 선택 하 고 "참조 제거"를 클릭 합니다. "확인"를 클릭 하 고 프로젝트 파일을 저장 합니다.</li>
      <li> Visual Studio 2015 또는 2017: 선택 "프로젝트-> 참조... 추가" 만들면 됩니다. Xbox 서비스 API 확인란이 선택 취소 합니다. "확인"를 클릭 하 고 프로젝트 파일을 저장 합니다.</li>
