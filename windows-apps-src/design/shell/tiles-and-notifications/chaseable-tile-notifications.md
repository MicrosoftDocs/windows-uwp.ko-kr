...
데스크톱 [브리지](https://developer.microsoft.com/windows/bridges/desktop)를 사용 하는 데스크톱 응용 프로그램 (예: WIN32, WPF 등)은 chaseable 타일을 사용할 수 있습니다. 유일한 차이점은 OnLaunched 된 인수에 액세스 하는 것입니다. 먼저 [데스크톱 브리지를 사용](/windows/msix/desktop/source-code-overview)하 여 앱을 패키지 해야 합니다.
