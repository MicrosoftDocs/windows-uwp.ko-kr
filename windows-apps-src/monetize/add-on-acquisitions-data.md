...
| purchasePriceUSDAmount | number | 추가 기능에 대 한 고객의 지불 금액으로, USD로 변환 됩니다.  |
| purchasePriceLocalAmount | number | 추가 기능에 적용 되는 세금입니다.  |
| purchaseTaxUSDAmount | number | USD로 변환 된 추가 기능에 적용 되는 세금입니다.  |
