...
ms.locfileid: "5924075"
---
# <a name="configure-access-policies-on-dev-center"></a>개발자 센터에서 액세스 정책 구성

다른 서비스, 게임 및 앱 타이틀의 Xbox Live 설정 및 데이터에 액세스할 수 있도록 [Windows 개발자 센터](https://developer.microsoft.com/dashboard/windows/overview) 를 사용할 수 있습니다. 예를 들어, 순위표, 웹 사이트에 표시할 웹 서비스를 할 수 있습니다 또는 보거나 저장 된 게임 데이터를 수정 하는 게임의 타이틀 저장소에 액세스할 수 있는 도우미 앱을 할 수 있습니다.
