...
탐색은 사용자 경험과 일관되어야 합니다. [표준 컨트롤](#use-the-right-controls) 사용자는 익숙한 및 아이콘에 대 한 다음과 같은 표준 규칙을 사용 하 여 위치 및 스타일 지정을 해 탐색 예측 가능 하 고 직관적인 사용자.
...
2. 전체 탐색 계층을 하지 마십시오. 탐색이 3개 수준을 넘어가면 사용자가 깊은 계층에서 빠져나오기 어려울 수 있습니다.
...
:::row:::
    ...
    :::column span="2":::
        ...
        - 모든 탐색 옵션 화면에 표시 하려는 경우
        - 원하는 앱의 콘텐츠에 대 한 더 많은 공간이 있습니다.
        - 아이콘 탐색 범주를 명확히 설명할 수 없습니다.
        
        사용 시기는 탭:

        - 탐색 기록 및 페이지 상태를 유지 하려는.
        - 원하는 사용자가 자주 탭 사이 전환할 수 있습니다.
