...
ms.locfileid: "63813495"
---
# <a name="create-customer-segments"></a>고객층 만들기

프로모션 및 참여를 목적으로 앱 고객의 하위 집합을 대상으로 지정하려는 경우가 있습니다. 이 수행할 수 있습니다 [파트너 센터](https://partner.microsoft.com/dashboard) 의 형식을 만들어 [고객 그룹](create-customer-groups.md) 라고는 *세그먼트* 인구를 충족 하는 Windows 10 고객을 포함 하는 또는 선택 하는 수익 조건입니다.
...
2.  **고객 그룹** 페이지에서 다음 중 하나를 수행합니다.
 - **내 고객 그룹** 섹션에서 **새 그룹 만들기**를 선택하여 처음부터 고객층을 정의합니다. 다음 페이지에서 **세그먼트** 라디오 단추를 선택합니다.
...
5.  **포함 조건 정의** 섹션에서 세그먼트에 대한 필터 조건을 지정합니다.
    ...
    다양 한 필터 조건 포함 하 여 선택할 수 있습니다 **합병**, **취득 소스**를 **Demographic**를 **등급**, **변동 예측**, **구매를 저장할**, **획득 저장**, 및 **저장소 소비**합니다.
