...
| 장치 유형| 예| 때 사용자의 deviceType 없거나 또는 비-콘솔을에 일치 하는 제목으로 설정 하 고 콘솔 전용 제목 않아야 합니다. | 403|
...
세션을 만든 후 제목 해당 세션에 대 한 티켓을 만드는 다른 서비스를 호출할 수 있습니다.


> [!NOTE] 
> 타이틀이이 호출을 다시 시도 하려면 사용자가 수행할 수 있지만 해야 다시 시도 하지이 자동으로 데이터에 실패 합니다.  
