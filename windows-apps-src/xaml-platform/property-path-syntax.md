...
1.  데이터 컨텍스트 개체(또는 동일한 [**Binding**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Data.Binding)에서 지정된 [**Source**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.data.binding.source))가 "Customer" 속성에 대해 검색됩니다.
