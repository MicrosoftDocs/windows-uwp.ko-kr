...
Unity 5.6 이상을 설치 하 고 Xbox One 편집기 확장 설치 되어 있어야 합니다.
...
**7)는 Xbox One 적절 한 시스템 라이브러리는 모두 자동으로 추가 프로젝트 및 플랫폼 바이너리를 포함 하는 데 필요한 단계를 추가 하지 합니다.**
