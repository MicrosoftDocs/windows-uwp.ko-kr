---
author: normesta
Description: "데스크톱 앱과 UWP 앱 간의 코드 공유"
...
![Windows 장치](images/desktop-to-uwp/windows-devices.png)
...
```
하지만 [.NET API 브라우저](https://docs.microsoft.com/dotnet/api/?view=netstandard-2.0)가 대안을 보여 줍니다. .NET Standard 2.0에서 사용할 수 있는 클래스이기 때문에 대신 ``DbConnection``, ``DbCommand`` 및 ``DbDataReader`` 클래스를 사용할 수 있습니다.  
...
UWP를 시작하려면 [유니버설 Windows 플랫폼 개요](https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide)를 참조하세요.
...
질문이 있으세요? Stack Overflow에서 질문해 주세요. 저희 팀은 이러한 [태그](http://stackoverflow.com/questions/tagged/project-centennial+or+desktop-bridge)를 모니터링합니다.
