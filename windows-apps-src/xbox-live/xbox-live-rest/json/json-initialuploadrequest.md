...
| 멤버| 유형| 설명| 
| --- | --- | --- | 
| <b>greatestMomentId</b>| string| 클립에 대 한 이름으로 사용 하 여 텍스트 문자열 ID입니다. 관리 이며 제목의 개발자가 제목에 대 한 구성 파일의 지역화 합니다.| 
...
| <b>type</b>| [GameClipType 열거형](../enums/gvr-enum-gamecliptypes.md)| 쉼표로 구분 되는 열거형의 문자열 값으로 마샬링 클립의 형식입니다.| 
