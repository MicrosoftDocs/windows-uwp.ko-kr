...
ms.locfileid: "2790162"
---
# <a name="add-on-acquisitions-report"></a>추가 기능 구입 보고서


Windows 개발자 센터 대시보드에서 **추가 기능 합병** 보고서를 사용 하면 신상 함께 판매 했을 때 얼마나 많은 추가 기능을 참조 하 고 플랫폼 세부 정보 및 Windows 10 (Xbox 포함)에 고객을 위한 변환 정보를 표시 합니다. 마지막 시간 또는/72 2 시간 기간에 대 한 실시간 취득 데이터 근처도 볼 수 있습니다.
...
페이지 위쪽에서 데이터가 표시되는 기간을 선택할 수 있습니다. 기본 설정은 **30D**(30일)이지만, 3개월, 6개월 또는 12개월 동안 데이터를 표시하거나 사용자가 지정한 데이터 범위에서 데이터를 표시하도록 선택할 수 있습니다. **1 H** 또는 **72 H** 1 시간 또는/72 2 시간; 거의 실시간으로 취득 데이터를 표시 하도록 선택할 수도 있습니다. 이러한 기간 **시장** 차트의 **합병** 탭 및 **추가 기능 합병** 차트의 **매일 추가 기능** 탭에에 적용 됩니다. 
