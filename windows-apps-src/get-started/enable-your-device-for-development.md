...
> [!NOTE]
> 개발자 모드를 제대로 설치 하지 않는 경우 피드백 요청 파일을 권장 합니다. **피드백 허브** 응용 프로그램에서 **추가 새 피드백** **개발자 플랫폼** 범주와 하위 범주 **들** 은 선택. 피드백 제출 Microsoft 발생 하는 문제를 해결 하는 데 도움이 됩니다.
