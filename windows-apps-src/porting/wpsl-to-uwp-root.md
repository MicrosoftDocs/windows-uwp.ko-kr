---
author: stevewhims
description: 여러분이 WindowsPhone Silverlight 앱을 사용 하 여 개발자 Windows10를 이동 하는 멋진 활용 자신의 기술과 소스 코드를 생성할 수 있습니다.
...
|[사례 연구: Bookstore1](wpsl-to-uwp-case-study-bookstore1.md) | 이 항목에서는 매우 간단한 WindowsPhone Silverlight 앱을 Windows10UWP 앱으로 포팅하는 사례 연구를 제공 합니다. Windows10를 만들 수 있습니다 단일 앱 패키지는이 사례 연구에서 작업을 어떻게 수행 되는 및 고객이 다양 한 장치에 설치할 수 있습니다. |
