...
| 지불               | 유료 또는 보류 중을 선택 하 고 원하는 대로 정렬 합니다. 특정 결제에 대한 자세한 정보를 추가로 보려면 보기를 선택합니다. 지급 송금 명세서의 복사본을 다운로드하려면 다운로드를 선택합니다. 트랜잭션 기록 데이터를 표시 하는 데 최대 24 시간이 걸릴 수 있으므로 관련 소득을 즉시 볼 수 없습니다. |
