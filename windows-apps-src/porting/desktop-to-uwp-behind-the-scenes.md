...
데스크톱 응용 프로그램에 대 한 만든 패키지는 데스크톱 전용으로 완전 신뢰 응용 프로그램 및 가상화 되거나 샌드박스가 적용 되지 않습니다. 이렇게 하면 기존의 데스크톱 응용 프로그램이 수행한 방식과 동일하게 다른 앱을 조작할 수 있습니다.
...
*HKLM\Software*의 키만 패키지에 포함됩니다. *HKCU* 또는 레지스트리의 다른 부분에 있는 키는 포함되지 않습니다. 패키지에서 키 또는 값에 대한 기록은 허용되지 않습니다. 씁니다 키 또는 값에 패키지의 일부가 아니라 사용자에 게 권한이 허용 됩니다.
