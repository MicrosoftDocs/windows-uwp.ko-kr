...
description: 파트너 센터에 등록 된 앱에 대 한 앱 내 구매에 대 한 정보를 검색할 Microsoft Store 제출 API에서에서이 메서드를 사용 합니다.
...
|  이름  |  형식  |  설명  |  필수  |
|------|------|------|------|
|  applicationId  |  string  |  추가 기능을 검색하려는 앱의 스토어 ID입니다. 스토어 ID에 대한 자세한 내용은 [앱 ID 세부 정보 보기](https://docs.microsoft.com/windows/uwp/publish/view-app-identity-details)를 참조하세요.  |  예  |
