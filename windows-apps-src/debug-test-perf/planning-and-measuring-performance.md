...
| 조작 클래스 레이블 | 사용자 인식                 | 적합함            | 최대값          | 예                                                                     |
|-------------------------|---------------------------------|------------------|------------------|------------------------------------------------------------------------------|
| 패스트                    | 최소한의 인지할 수 있는 지연      | 100 밀리초 | 200밀리초 | 앱 바 표시, 단추 누르기(첫 응답)                        |
| 일반                 | 적당히 빠름             | 300밀리초 | 500밀리초 | 크기 조정, 시맨틱 줌                                                        |
| 응답              | 신속하지 않지만 응답성 있음 | 500밀리초 | 1초         | 다른 페이지로 이동, 일시 중단 상태에서 앱 다시 시작          |
| Launch                  | 경쟁 환경          | 1초         | 3초        | 처음으로 또는 이전에 종료된 후 앱 실행 |
| 지속적              | 더 이상 응답 없음      | 500밀리초 | 5초        | 인터넷에서 파일 다운로드                                            |
