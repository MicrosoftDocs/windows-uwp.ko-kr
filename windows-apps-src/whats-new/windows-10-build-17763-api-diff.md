...
메뉴 모음 <br> menubar.items <br> menubar.itemsproperty <br> menubar.menubar
...
분할 단추 <br> splitbutton.click <br> splitbutton.command <br> splitbutton.commandparameter <br> splitbutton.commandparameterproperty <br> splitbutton.commandproperty <br> splitbutton.flyout <br> splitbutton.flyoutproperty <br> splitbutton.splitbutton
...
#### [<a name="tooltip"></a>도구 설명](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)
...
#### [<a name="brush"></a>브러시](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
