...
| --- | --- | --- | --- | --- | --- | --- | 
| 사용자| 예| Xbox LIVE는 요청 작업이 수행 누구를 위해에 유효한 사용자입니다.| 403 사용할 수 없음| 
...
| 헤더| 유형| 설명| 
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | 
| X RequestedServiceVersion| string| 이 요청은 전송 Xbox LIVE 서비스의 이름/번호를 빌드하십시오. 요청만으로 라우팅되는 서비스의 인증 토큰을 클레임 헤더의 유효성을 확인 한 후에 있습니다. 기본값: 1입니다.| 
