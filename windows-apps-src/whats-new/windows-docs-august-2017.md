...
[Windows 스토어 제출 API](../monetize/create-and-manage-submissions-using-windows-store-services.md)가 이제 앱 제출에 [비디오 예고편](../monetize/manage-app-submissions.md#trailer-object)과 [게임 옵션](../monetize/manage-app-submissions.md#gaming-options-object)을 포함하도록 지원합니다.
