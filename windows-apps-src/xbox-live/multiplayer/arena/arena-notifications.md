...
ms.locfileid: "8342950"
---
# <a name="arena-notifications"></a>아레나 알림

참가자에 게 Xbox 아레나 표면 알림 아레나 토너먼트 토너먼트 단계를 도입 하에 등록 합니다. 타이틀에서 모든 추가 경고, 홍보, 또는 게임 관련 세부 정보를 제공 해야 합니다.

등록 | 팀 형성 | 토너먼트 상태
--- | --- | ---
팀에 등록할 준비가 되었습니다. | 플레이어가 팀에 연결 | 체크 인 시작
팀 등록 | 플레이어가 팀을 떠난 | 토너먼트 시작
체크 인 시작 | 초대를 보낼/거부 | 토너먼트 완료
