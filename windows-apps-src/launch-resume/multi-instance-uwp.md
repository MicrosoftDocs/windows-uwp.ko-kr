...
Windows 10, 버전 1803 (10.0; 빌드 17134) UWP 앱이 여러 인스턴스를 지원 하도록 옵트인 수 이후, 합니다. 다중 인스턴스 UWP 앱의 인스턴스를 실행 중이며 후속 정품 인증을 요청하는 경우 플랫폼은 기존 인스턴스를 활성화하지 않습니다. 대신 다른 프로세스에서 실행 중인 인스턴스를 새로 만듭니다.
