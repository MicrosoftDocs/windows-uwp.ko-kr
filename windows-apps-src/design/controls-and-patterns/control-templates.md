...
> **중요 한 Api**: [**ControlTemplate 클래스**](https://msdn.microsoft.com/library/windows/apps/br209391)하십시오 [ **Control.Template 속성**](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.controls.control.template.aspx)
...
> [!NOTE]
> Windows 10 버전 1809부터 ([SDK 17763](https://developer.microsoft.com/windows/downloads/windows-10-sdk))를 사용할 수 있습니다 [ **X:bind** ](https://msdn.microsoft.com/library/windows/apps/Mt204783) 사용 하는 위치에서 태그 확장 [TemplateBinding](../../xaml-platform/templatebinding-markup-extension.md) . 자세한 내용은 [TemplateBinding 태그 확장](../../xaml-platform/templatebinding-markup-extension.md)을 참조하세요.
...
이 XAML은 `Checked`, `Unchecked` 및 `Indeterminate` 상태의 [**VisualState**](https://msdn.microsoft.com/library/windows/apps/br209007) 개체를 보여 줍니다. 이 예제에서는 [**Border**](https://msdn.microsoft.com/library/windows/apps/hh738505)에 [**ControlTemplate**](https://msdn.microsoft.com/library/windows/apps/br209250)의 루트 요소인 [**VisualStateManager.VisualStateGroups**](https://msdn.microsoft.com/library/windows/apps/br209391) 연결된 속성을 설정합니다. `Checked` **VisualState** 지정 된 [ **불투명도** ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) 의 [ **경로** ](/uwp/api/Windows.UI.Xaml.Shapes.Path) 라는 `CheckGlyph` (이전 예제에 표시)는 1입니다. `Indeterminate` **VisualState** 지정 합니다 **불투명도** 의 [ **타원** ](/uwp/api/Windows.UI.Xaml.Shapes.Ellipse) 라는 `IndeterminateGlyph` 는 1입니다. 합니다 `Unchecked` **VisualState** 되지 [ **Setter** ](https://msdn.microsoft.com/library/windows/apps/br208817) 하거나 [ **스토리 보드**](https://msdn.microsoft.com/library/windows/apps/br210490)이므로 합니다 [ **CheckBox** ](https://msdn.microsoft.com/library/windows/apps/br209316) 기본 모양에 반환 합니다.
...
| `Unchecked`에서 `Checked`로       | [ **Setter** ](https://msdn.microsoft.com/library/windows/apps/br208817) 값을 `Checked` [ **VisualState** ](https://msdn.microsoft.com/library/windows/apps/br209007) 적용 된 하므로 [ **불투명도**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) 의 `CheckGlyph` 1입니다.                                                                                                                                                         | X가 표시됩니다.                                |
| `Checked`에서 `Indeterminate`로   | [ **Setter** ](https://msdn.microsoft.com/library/windows/apps/br208817) 값을 `Indeterminate` [ **VisualState** ](https://msdn.microsoft.com/library/windows/apps/br209007) 적용 된 하므로 [ **불투명도**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) 의 `IndeterminateGlyph` 1입니다. **Setter** 값을 `Checked` **VisualState** 제거 되 하므로 [ **불투명도** ](https://msdn.microsoft.com/library/windows/apps/br228078) 의 `CheckGlyph` 은 0입니다. | 원이 표시됩니다.                            |
| `Indeterminate`에서 `Unchecked`로 | [ **Setter** ](https://msdn.microsoft.com/library/windows/apps/br208817) 의 값을 `Indeterminate` [ **VisualState** ](https://msdn.microsoft.com/library/windows/apps/br209007) 제거 되 면 하므로 [ **불투명도**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) 의 `IndeterminateGlyph` 은 0입니다.                                                                                                                                           | 아무것도 표시되지 않습니다.                             |
