...
<td align="left">리뷰 데이터를 검색할 앱의 제품 ID입니다. 제품 ID는 개발자 센터 대시보드의 [앱 ID 페이지](https://msdn.microsoft.com/library/windows/apps/mt148561)에서 사용할 수 있는 앱 목록 링크에 포함되어 있습니다. 제품 ID의 예로는 9WZDNCRFJ3Q8이 있습니다.</td>
<td align="left">예</td>
</tr>
<tr class="even">
