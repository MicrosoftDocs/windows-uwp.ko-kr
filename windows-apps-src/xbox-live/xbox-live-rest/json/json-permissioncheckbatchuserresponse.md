...
| 사용 권한| [PermissionCheckResponse (JSON)](json-permissioncheckresponse.md) 의 배열| 필수. [PermissionCheckResponse (JSON)](json-permissioncheckresponse.md) 요청 에서처럼 동일한 순서로 원래 요청에 요청 된 각 권한에 대 한 합니다.| 
