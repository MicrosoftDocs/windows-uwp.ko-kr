...
ms.locfileid: "3964727"
---
# <a name="insights-report"></a>인 사이트 보고서


Windows 개발자 센터 대시보드의 **인 사이트** 보고서에 구입, 상태, 및/또는 사용 현황 데이터에서 지난 30 일 동안의 감지 하는 중요 한 변경 (증가 또는 감소에 특정 메트릭)를 강조 표시 합니다. 이 모든 차트의 각 이러한 보고서에 표시 하지 않고 잠재적으로 중요 한 변경 사항 빠르게 살펴볼을 얻을 수 있습니다.
...
이 데이터에 중대 한 변경을 감지 되 면 정보 표시 됩니다. 각 통찰력에 대 한 다음 하겠습니다.
...
- **전체에 영향을 줄**: 백분율 전체 고객 기반 간에 늘어나거나 값입니다. 이렇게 하면 어떻게 광범위 하 게 특정 변경의 영향 수에 표시 된 백분율 정보를 비교할 때 특히 이해 **참가자 Top.**
...
- **작업**:
   ...
   - 사용자 의견을 보내주시면 제공 통찰력 정확 하 게 보일 경우에 **이 정확 하 게 하는 경우 알려주세요** 을 선택 합니다. 이 피드백 여기에 입력 데이터를 개선 하기 위해 계속 하는 데 도움이 됩니다. 
