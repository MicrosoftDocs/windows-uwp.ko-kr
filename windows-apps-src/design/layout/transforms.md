...
-   [**TranslateTransform**](https://msdn.microsoft.com/library/windows/apps/BR243027): x, y 공간 요소에 대 한 값을 설정 하 여 변환 [ **X** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.translatetransform.x.aspx) 고 [ **Y** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.translatetransform.y).
-   [**ScaleTransform**](https://msdn.microsoft.com/library/windows/apps/BR242940): 확장에 대 한 값을 설정 하 여 중간 지점에 따라 변환을 [ **CenterX**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.scaletransform.centerx.aspx)하십시오 [ **CenterY** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.scaletransform.centery.aspx)하십시오 [ **ScaleX** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.scaletransform.scalex.aspx) 하 고 [ **ScaleY**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.scaletransform.scaleyproperty)합니다.
-   [**RotateTransform**](https://msdn.microsoft.com/library/windows/apps/BR242932): x, y 공간에 대 한 값을 설정 하 여 회전 [ **각도**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.rotatetransform.angle.aspx)하십시오 [ **CenterX** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.rotatetransform.centerx.aspx) 및 [ **CenterY**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.rotatetransform.centery)합니다.
-   [**SkewTransform**](https://msdn.microsoft.com/library/windows/apps/BR242950): 오차 또는 값을 설정 하 여 x, y 공간에서 전단 [ **AngleX**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.skewtransform.anglex.aspx)를 [ **AngleY**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.skewtransform.angley.aspx), [ **CenterX** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.skewtransform.centerx.aspx) 하 고 [ **CenterY**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.media.scaletransform.centeryproperty)합니다.
...
변환, 결합할 수 있습니다 이며이 지 원하는 두 개의 Windows 런타임 클래스: [**CompositeTransform** ](https://msdn.microsoft.com/library/windows/apps/BR228105) 하 고 [ **TransformGroup**](https://msdn.microsoft.com/library/windows/apps/BR243022)합니다. **CompositeTransform**에서는 크기 조정, 기울이기, 회전, 변환 순으로 변형이 적용됩니다. 다른 순서로 변형을 적용하려는 경우 **CompositeTransform** 대신 **TransformGroup**을 사용합니다. 자세한 내용은 [**CompositeTransform**](https://msdn.microsoft.com/library/windows/apps/BR228105)을 참조하세요.
...
변환을 사용 하 여 사용할 때마다 [ **UIElement.RenderTransform**](https://msdn.microsoft.com/library/windows/apps/BR208980), 다른 속성 임을 기억 [ **UIElement** ](https://msdn.microsoft.com/library/windows/apps/BR208911) 는 변환의 동작 방식에 영향을 줍니다. [**RenderTransformOrigin**](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.uielement.rendertransformorigin.aspx)합니다. **RenderTransformOrigin**에서 선언하는 사항은 요소의 기본(0, 0) 지점 또는 해당 요소의 상대 좌표 공간 내 다른 원점에 전체 변형을 적용할지 여부입니다. 일반적인 요소의 경우 (0, 0)은 왼쪽 맨 위에 변형을 적용합니다. 원하는 효과에 따라 변형의 **CenterX** 및 **CenterY** 값을 조정하는 대신 **RenderTransformOrigin**을 변경할 수도 있습니다. **RenderTransformOrigin** 및 **CenterX** / **CenterY** 값을 모두 적용하는 경우 특히 값에 애니메이션 효과를 적용하면 결과가 혼란스러울 수 있습니다.
...
-   [**Brush.Transform**](https://msdn.microsoft.com/library/windows/apps/BR228082)하십시오 [ **Brush.RelativeTransform**](https://msdn.microsoft.com/library/windows/apps/BR228080): 이러한 영향을 어떻게를 [ **브러시** ](/uwp/api/Windows.UI.Xaml.Media.Brush) 좌표 영역 내에서 공간을 사용 하는 **브러시** foregrounds 및 배경과 같은 시각적 속성 설정에 적용 됩니다. 이러한 변형은 일반적으로 [**SolidColorBrush**](https://msdn.microsoft.com/library/windows/apps/BR242962)를 사용하여 단색을 설정하는 대부분의 일반 브러시와 관련이 없지만, [**ImageBrush**](https://msdn.microsoft.com/library/windows/apps/BR210101) 또는 [**LinearGradientBrush**](https://msdn.microsoft.com/library/windows/apps/BR210108)를 사용하여 영역을 그릴 때 유용할 수 있습니다.
-   [**Geometry.Transform**](https://msdn.microsoft.com/library/windows/apps/BR210066): 이 속성을 사용 하 여 변환 된 기 하 도형에 해당 기 하 도형을 사용 하 여 이전에 적용할 수는 [ **Path.Data** ](https://msdn.microsoft.com/library/windows/apps/BR243356) 속성 값입니다.
...
[**UIElement** ](https://msdn.microsoft.com/library/windows/apps/BR208911) 라는 메서드가 [ **TransformToVisual**](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.uielement.transformtovisual.aspx)를 생성할 수 있는 한 [ **변환** ](https://msdn.microsoft.com/library/windows/apps/BR243006) 두 가지 UI 요소에 대 한 좌표 프레임의 참조를 상호 연결합니다. 루트 시각적 모양을 첫 번째 매개 변수로 전달하는 경우 이 메서드를 사용하여 요소를 앱의 기본 참조 좌표 프레임과 비교할 수 있습니다. 이 기능은 다른 요소에서 입력 이벤트를 캡처한 경우 또는 실제로 레이아웃 단계를 요청하지 않고 레이아웃 동작을 예측하려는 경우에 유용할 수 있습니다.
...
변형의 수학적 설명은 수학적 배경 지식이 있거나 행렬을 사용하여 좌표 공간 변형을 설명하는 그래픽 프로그래밍 기술에 익숙한 경우 유용할 수 있습니다. [ **변환**](https://msdn.microsoft.com/library/windows/apps/BR243006)-해당 3 × 3 매트릭스를 기준으로 직접 변환 표현할 수 있도록 하는 클래스를 파생 합니다. [**MatrixTransform**](https://msdn.microsoft.com/library/windows/apps/BR210137)합니다. **MatrixTransform** 에 [ **행렬** ](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.media.matrixtransform.matrix.aspx) 6 개의 속성이 있는 구조를 포함 하는 속성: [**M11**](https://msdn.microsoft.com/library/windows/apps/Hh673847)하십시오 [ **M12**](https://msdn.microsoft.com/library/windows/apps/Hh673853)하십시오 [ **M21**](https://msdn.microsoft.com/library/windows/apps/Hh673851)하십시오 [ **M22** ](https://msdn.microsoft.com/library/windows/apps/Hh673849)하십시오 [ **OffsetX** ](https://msdn.microsoft.com/library/windows/apps/Hh673810) 하 고 [ **OffsetY**](https://msdn.microsoft.com/library/windows/apps/Hh673816)합니다. 각 [**Matrix**](https://msdn.microsoft.com/library/windows/apps/BR210127) 속성은 **Double** 값을 사용하며 행렬 유사 변환의 6개 관련 값(1열, 2열)에 해당합니다.
...
* [**변환**](https://msdn.microsoft.com/library/windows/apps/BR243006)
