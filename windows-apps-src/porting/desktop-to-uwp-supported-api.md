...
| XAML UI | Windows 10 버전 1809, 및 이전 릴리스에 패키지 된 데스크톱 앱에서 호스팅 UWP XAML 콘텐츠를 지원 하지 않습니다. Windows 10 버전 1903부터 사용할 수 있습니다 [XAML 제도](../xaml-platform/xaml-host-controls.md) UWP XAML 콘텐츠를 호스트 합니다.  |
...
다음은 패키지 앱에서 지원되는 UWP API의 전체 목록입니다. 볼 수 있습니다 [패키지 된 앱 에서만에서 지원 되는 Api](#new) 하거나 [패키지 된 앱 및 데스크톱 응용 프로그램에서 지원 되는 Api](#both)합니다.
