...
> **중요 API**: [Pivot 클래스](https://msdn.microsoft.com/library/windows/apps/dn608241)

![탭 예](images/pivot_Hero_main.png)
...
- **최상위 또는 하위 수준 탐색.**  피벗은 두 탐색 수준에 사용할 수 있습니다. 필요에 따라 피벗이 보조 역할을 하면서 [탐색 창](navigationview.md)은 기본 수준 역할을 할 수 있습니다.
...
> 참고&nbsp;&nbsp; [3m 환경](../input-and-devices/designing-for-tv.md)에서는 피벗 헤더가 회전하면 안 됩니다. Xbox에서 실행되는 앱일 경우 [IsHeaderItemsCarouselEnabled](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Pivot#Windows_UI_Xaml_Controls_Pivot_IsHeaderItemsCarouselEnabled) 속성을 **false**로 설정합니다.
...
사용자 지정된 피벗이 있고 헤더 선택 시각적 개체에 밑줄을 적용하는 앱은 [HeaderFocusVisualPlacement](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.pivot#Windows_UI_Xaml_Controls_Pivot_HeaderFocusVisualPlacement) 속성을 사용하여 기본값을 변경할 수 있습니다. `HeaderFocusVisualPlacement="ItemHeaders"`일 경우 전체 헤더 패널 주변으로 포커스가 그려집니다.
