...
- **기본값 사용** -DropShadow 셰이프 기본적으로 CompositionDropShadowSourcePolicy에서 '기본' 모드에 의해 정의 됩니다. SpriteVisual에 대 한 기본값은 마스크는 제공 하지 않는 한 사각형입니다. LayerVisual, 기본값은 상속 알파 시각적 개체의 브러시를 사용 하 여 마스크입니다.
...
시각적 계층에 갖추어져 효과 효율적이 고 사용할 수 있도록 여러 최적화, 그림자 생성 어떤 옵션을 설정에 따라 상대적으로 비용이 많이 드는 작업 될 수 있습니다. 다음은 다양 한 유형의 그림자에 대 한 높은 수준 '비용'입니다. 참고는 특정 그림자 비용이 많이 드는 수도 있지만 경우에 따라서는 여전히 특정 시나리오에서 자주 사용 하 여 적절할 수 있습니다.
