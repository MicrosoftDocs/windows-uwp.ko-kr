...
C# 앱 포팅 | C# 애플리케이션을 C++/WinRT로 포팅하는 프로세스를 문서화했습니다. [C#에서 C++/WinRT로 클립보드 샘플 포팅](../cpp-and-winrt-apis/clipboard-to-winrt-from-csharp.md)은 상황에 따라 다를 수 있으며, 특정 실제 포팅 환경을 기반으로 합니다. 해당 부록 항목 [C#에서 C++/WinRT로 이동](../cpp-and-winrt-apis/move-to-winrt-from-csharp.md)에는 포팅에 관련된 기술 세부 정보 및 단계가 백과사전식으로 설명되어 있습니다. 
C++/WinRT | [최신 개선 사항/추가 롤업](../cpp-and-winrt-apis/news.md#rollup-of-recent-improvementsadditions-as-of-march-2020)에서 빌드 시간 및 런타임 성능 향상(Visual C++ 컴파일러 팀과 협력하여 실현)과 관련된 C++/WinRT 업데이트를 참조하세요. </br> C++/WinRT의 경우 다음 항목에 대한 정보를 추가했습니다. [C++/CX에서 포팅](../cpp-and-winrt-apis/move-to-winrt-from-cx.md#boxing-and-unboxing), [C#에서 포팅](../cpp-and-winrt-apis/move-to-winrt-from-csharp.md#boxing-and-unboxing), [간단한 C++/WinRT Windows UI 라이브러리 예제](../cpp-and-winrt-apis/simple-winui-example.md), [동시성](../cpp-and-winrt-apis/concurrency.md), [get_unknown()](/uwp/cpp-ref-for-winrt/get-unknown), [C++/WinRT에서 XAML 사용자 지정(템플릿 적용) 제어](../cpp-and-winrt-apis/xaml-cust-ctrl.md).
