---
Windows 스토어 앱 시작
이 항목에서는 ms-windows-store URI 체계에 대해 설명합니다. 이 URI 스키마로 Windows 스토어 앱을 실행하여 스토어의 특정 페이지를 표시할 수 있습니다.
...
<tr>
<td rowspan="4">제품에 대한 PDP(제품 세부 정보 페이지)를 실행합니다. <p>제품 ID는 Windows 10 고객에게 권장되지만 이전 방식(예: PFN)도 여전히 작동합니다.</p>
