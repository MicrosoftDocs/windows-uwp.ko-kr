...
다음 예는 두 개의 입력 이미지와 Low Light Fusion 알고리즘을 적용한 결과 출력된 이미지를 보여줍니다.

> [!div class="mx-tableFixed"] 
| 프레임 1 | 프레임 2 | Low Light Fusion 출력 | 
|---------|---------|-------------------------|
| ![Low Light Fusion 알고리즘에 첫 번째로 입력한 프레임](./images/LLF-Input1.png) | ![Low Light Fusion 알고리즘에 두 번째로 입력한 프레임](./images/LLF-Input2.png) | ![Low Light Fusion 알고리즘의 결과 프레임](./images/LLF-Output.png) |

입력 프레임과 출력 프레임을 보면, 컵의 조도와 선명도가 향상되었으며 카펫 옆의 몰딩과 같은 주변의 선명도가 향상된 것을 알 수 있습니다.
