...
* * 파일 형식으로 제공 하는 방법에 대 한 참고: * *는 BC6H 및 BC7 질감 압축 형식 압축 된 질감 데이터를 저장 하기 위해 DD 파일 형식을 사용 합니다. 자세한 내용은 [DDS 프로그래밍 가이드](https://msdn.microsoft.com/library/windows/desktop/bb943991)를 참조하세요.
