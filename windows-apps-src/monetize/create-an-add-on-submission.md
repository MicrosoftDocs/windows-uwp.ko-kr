...
description: 파트너 센터에 등록 된 앱에 대 한 새 추가 기능 제출을 만들려면 Microsoft Store 제출 API 사용 하 여이 메서드를 사용 합니다.
title: 추가 기능 제출 만들기
ms.date: 02/08/2017
ms.topic: article
...
* 앱 중 하나에 대 한 추가 기능을 만듭니다. 파트너 센터에서이 수행할 수 있는 또는 사용 하 여 이렇게 합니다 [추가 기능 만들기](create-an-add-on.md) 메서드.
