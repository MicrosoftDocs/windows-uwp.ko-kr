...
ms.locfileid: "8340505"
---
# <a name="compile-the-xbox-developer-kit-xdk-xbox-live-api-source"></a>Xbox 개발자 키트 (XDK) Xbox Live API 소스 컴파일

(XDK (Xbox 개발자 키트) Microsoft.Xbox.Services.dll (XSAPI)를 구축 하기 위한 소스를 포함 합니다. 개발자는 DLL의 로컬 빌드를 사용 하도록 프로젝트를 업데이트 하는 이러한 지침을 따라 수 있습니다.
...
<ol>
  ...
  <li> 참조를 제거 해야 하는 사전 빌드 DLL 프로젝트에서 참조 하는 경우</li>
    <ul>
