---
Description: 이 가이드에는 편집, 디버그 및 데스크톱 응용 프로그램 패키지를 Visual Studio 솔루션을 구성 하는 방법을 설명 합니다.
...
ms.locfileid: "57655968"
---
# <a name="package-a-desktop-application-by-using-visual-studio"></a>Visual Studio를 사용 하 여 데스크톱 응용 프로그램 패키지

Visual Studio를 사용하여 데스크톱 앱용 패키지를 만들 수 있습니다. 그런 다음이 패키지는 Microsoft Store 또는 테스트용으로 로드 하려면 하나 이상의 Pc에는 게시할 수 있습니다.
...
6. 오류가 표시되지 않도록 패키징 프로젝트를 빌드합니다.  오류가 발생할 경우 엽니다 **Configuration Manager** 프로젝트는 동일한 플랫폼 대상 있는지 확인 합니다.

   ![구성 관리자](images/desktop-to-uwp/config-manager.png)

7. [앱 패키지 만들기](../packaging/packaging-uwp-apps.md) 마법사를 사용해 appxupload 파일을 생성합니다.

   저장소에 직접 해당 파일을 업로드할 수 있습니다.
...
**UWP Api를 추가 하 여 데스크톱 응용 프로그램을 향상 합니다.**

[Windows 10용 데스크톱 응용 프로그램 개선](desktop-to-uwp-enhance.md) 참조

**Windows 런타임 구성 요소 및 UWP 프로젝트를 추가 하 여 데스크톱 응용 프로그램 확장**
