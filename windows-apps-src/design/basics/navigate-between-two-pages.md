...
-   전후 루트 [**Grid**](https://msdn.microsoft.com/library/windows/apps/br242704) 의 자식 요소로 [**HyperlinkButton**](https://msdn.microsoft.com/library/windows/apps/br242739) 요소는 `pageTitle` [**TextBlock**](https://msdn.microsoft.com/library/windows/apps/br209652) 요소입니다.
```xaml
...
Page1.xaml에서 추가한 **HyperlinkButton** 다음 [**StackPanel**](https://msdn.microsoft.com/library/windows/apps/br209635)을 사용 하 여 이전 바꿉니다.
...
에 `HyperlinkButton_Click` Page1.xaml 코드 숨김 파일의 이벤트 처리기를 참조 하는 매개 변수 추가 `Text` 속성은 `name` **텍스트 상자** 에 `Navigate` 메서드.
