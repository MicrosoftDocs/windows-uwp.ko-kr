...
게임 및 응용 프로그램에서 실행 되는 Xbox 360에서, Windows Phone 디바이스에서 SmartGlass, Xbox.com이이 서비스를 사용할 수 있습니다.
...
&nbsp;&nbsp;전체 목록을 검색 하지 않고 일련의 항목 (지정 된 itemId) 목록에 포함 되어 있는지 여부를 결정 합니다.
