...
앞서 언급했듯이 InteractionTracker는 4개의 상태로 구성된 상태 시스템으로서, 각각의 상태는 다른 4개의 상태 중 하나로 전환할 수 있습니다. (InteractionTracker가 이러한 상태 사이에서 전환하는 방식에 대한 자세한 내용은 [InteractionTracker](https://docs.microsoft.com/uwp/api/windows.ui.composition.interactions.interactiontracker) 클래스 설명서를 참조하세요.)
