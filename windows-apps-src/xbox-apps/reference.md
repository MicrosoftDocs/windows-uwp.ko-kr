...
|[/ ext/스크린 샷](wdp-media-capture-api.md)| 현재 콘솔에 표시되는 화면의 PNG 표현을 캡처합니다. |
|[/ ext/설정](wdp-xboxsettings-api.md)| Xbox One 개발자 설정에 액세스합니다. |
|[/ext/smb/developerfolder](wdp-smb-api.md)| 개발 PC에서 파일 탐색기를 통해 콘솔의 개발자 폴더에 액세스합니다. |
|[/ ext/사용자](wdp-user-management.md)| Xbox One 콘솔에서 사용자를 관리합니다. |
...
- [Windows 디바이스 포털](../debug-test-perf/device-portal.md)