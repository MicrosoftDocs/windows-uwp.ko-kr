...
1. 경우 QFE을 배포할 수 있는 것,는 문제를 해결 하려면 소스 코드 패치를 제공 합니다.

## <a name="to-compile-the-xdk-c-xsapi-project-for-yourself"></a>자신을 위해 c + + XSAPI XDK 프로젝트를

<ol>
  <li> Microsoft.Xbox.Services 소스를 가져옵니다. 이렇게 하려면 모든 파일에서 추출 "%XboxOneExtensionSDKLatest%\ExtensionSDKs\Xbox 서비스 API\8.0\SourceDist\Xbox.Services.zip"를 "C:\Program Files (x86)" 하거나 외부 쓰기 가능한 폴더에서 소스를 복제할 수<a href ="https://github.com/Microsoft/xbox-live-api">https://github.com/Microsoft/xbox-live-api</a></li>
  <li> 참조를 제거 해야 하는 프로젝트 빌드 전 DLL에서 참조 하는 경우</li>
    <ul>
      ...
      <li> Visual Studio 2015 또는 2017: 선택 "-> 프로젝트 참조를... 추가" 만들면 됩니다. Xbox 서비스 API을 선택 하는 경우 선택 취소 합니다. "확인"를 클릭 하 고 프로젝트 파일을 저장 합니다.</li>
    </ul>
...
<ol>
  ...
  <li> Visual Studio에서 참조를 추가 합니다.</li>
    <ul>
      ...
      <li> Visual Studio 2015 또는 2017: 선택 "-> 프로젝트 참조를... 추가" 만들면 됩니다. 프로젝트에서 위의 두 프로젝트에 대 한 항목을 확인 하 고 확인을 클릭 합니다.</li>
    </ul>
  <li> 응용 프로그램 프로젝트와 Xbox 서비스 프로젝트의 "출력 폴더" 동일한 지 확인 합니다. 이 설정을 구성 속성-> 일반 하는 속성-> Visual Studio 프로젝트에서 찾을 수 있습니다 출력 디렉터리-> 합니다.</li>
  <li> Visual Studio 솔루션을 다시 작성</li>
</ol>
