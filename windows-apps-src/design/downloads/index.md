...
이 섹션에는 UWP 앱용 디자인 및 UI 관련 다운로드가 들어 있습니다. Visual Studio 같은 추가 도구는 <a href="https://developer.microsoft.com/downloads">Microsoft 기본 다운로드 페이지</a>를 참조하세요. 
...
* <a href="https://aka.ms/adobexdtoolkit">Adobe XD 도구 키트(v1803, 2018년 3월)</a>
* <a href="https://aka.ms/adobeillustratortoolkit">Adobe Illustrator 도구 키트(v1803, 2018년 3월)</a>
* <a href="https://aka.ms/sketchtoolkit">Sketch 도구 키트(v1803, 2018년 3월)</a>
* <a href="https://aka.ms/adobephotoshoptoolkit">Adobe Photoshop 도구 키트(v1705, 2017년 5월)</a>
* <a href="https://aka.ms/framertoolkit">Framer 도구 키트(GitHub에서 지원)(v1710, 2017년 8월)</a>
...
이 Adobe Photoshop용 작업들은 단 7개의 파일에서 68개의 권장 타일 및 아이콘 자산을 생성합니다. <br/><a href="http://go.microsoft.com/fwlink/p/?LinkId=760394">타일 및 아이콘 생성기 다운로드</a></p>    
  </div>
...
<div class="side-by-side-content">
  <div class="side-by-side-content-left">
            <p><b>BuildCast</b> <br/>
BuildCast는 유니버설 Windows 플랫폼의 다른 기능과 함께 Fluent 디자인 시스템을 소개하기 위해 고안된 종합적인 샘플입니다. 이 샘플에서는 Channel 9 및 일부 Windows 기술 매니아 피드에서 가장 인기 있는 샘플을 비롯한 비디오 팟캐스트를 검색하고 다운로드하고 재생할 수 있습니다. 또한 잉크 메모, 책갈피 및 원격 재생을 제공합니다. 이 샘플은 <a href="https://channel9.msdn.com/Events/Build/2017/B8034">Fluent 디자인으로 멋진 앱 만들기</a> 동안 2017 빌드 회의에서 처음 제공되었습니다. <br/><a href="https://github.com/Microsoft/BuildCast/archive/master.zip">BuildCast 샘플 다운로드</a> <br/><a href="https://github.com/Microsoft/BuildCast">GitHub에서 BuildCast 샘플 확인</a></p>    
  </div>
  <div class="side-by-side-content-right">
...
이 UWP 샘플 앱은 Azure Active Directory(AAD) 인증, UI 컨트롤(데이터 표 포함) 및 ASP.NET Core 및 Entity Framework를 사용한 클라우드 데이터베이스 및 API 통합 등 엔터프라이즈 개발자에게 유용한 기능을 소개합니다. <br/><a href="https://github.com/Microsoft/Windows-appsample-customers-orders-database/archive/master.zip">고객이 주문 데이터베이스 샘플 다운로드</a><br/><a href="https://github.com/Microsoft/Windows-appsample-customers-orders-database">GitHub에서 고객 주문 데이터베이스 샘플 확인</a></p>   
  </div>
  <div class="side-by-side-content-right">
...
<b>더 많은 코드가 필요하세요?</b> Windows 샘플 페이지에서 모든 UWP 앱 샘플의 전체 목록을 확인하세요. <a href="https://developer.microsoft.com/samples">샘플 포털로 이동</a>
