...
Windows 10, Windows 8.1 및/또는 Windows Phone 8.1을 대상으로 하는 앱에 대 한 Visual Studio는 사용자가 다운로드 하는 앱의 크기를 줄이려면 앱 번들 (.appxbundle)을 생성할 수 있습니다. 언어별 자산, 다양한 이미지 스케일 자산 또는 특정 Microsoft DirectX 버전에 적용되는 리소스를 정의한 경우 이렇게 하면 유용할 수 있습니다.
