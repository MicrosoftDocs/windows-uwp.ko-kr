...
기본적으로 앱 릴리스 날짜는 Microsoft Store에 게시된 날짜입니다. 이를 무시하고 사용자 지정 릴리스 날짜를 제공하려면, 이 섹션의 확인란에 표시를 한 후 릴리스 날짜를 입력하세요. Microsoft Store 목록에 릴리스 날짜가 표시되지 않을 수도 있다는 점에 유의하세요.
