...
패키지의 복사본을 유지 하는 경우에 롤백하려면 앱의 패키지 스토어에서 이전 Windows 10 패키지로 릴리스에 문제가 발견 해야 하는 경우 옵션을 해야 합니다. 이 방법은 문제를 해결 하는 데 시간이 걸릴 동안 고객에 게 방편 임시입니다.
