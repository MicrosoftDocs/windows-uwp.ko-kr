...
* **서비스**입니다. 비즈니스 환경의 컨텍스트에서 안전 하 게 실행 하는 응용 프로그램 이며 선택 하면 모든 개발 플랫폼을 사용 하 여 구현할 수 있습니다. API 및 구매 API 시나리오 및 Microsoft Store 컬렉션 REST Uri를 호출 하는 데 필요한 Azure AD 액세스 토큰 만들기에 대 한 서비스는 해야 합니다.
