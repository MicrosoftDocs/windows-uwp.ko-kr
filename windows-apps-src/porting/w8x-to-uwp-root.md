...
8.1 유니버설 Windows 앱에서 동일한 기능을 제공 하는 종종-동일한 코드 및 태그를 사용 하 여-Windows8.1 및 Windows Phone 8.1 형식입니다. 앱 단일 Windows10 앱 유니버설 디바이스 패밀리를 대상으로 하는 (및 가장 넓은 범위의 장치에 설치할 수 있는)에 적합 됩니다. 공유 프로젝트의 콘텐츠를 기본적으로 포팅하게 되며, 다른 두 프로젝트에는 콘텐츠가 거의 없거나 전혀 없으므로 포팅할 필요가 없습니다.
