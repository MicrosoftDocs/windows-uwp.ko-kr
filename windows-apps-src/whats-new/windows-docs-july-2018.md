...
description: 새로운 기능, 동영상, 샘플 및 개발자 지침 2018 년 7 월에 대 한 Windows 10 개발자 설명서 추가한 합니다.
...
![작업의 Pwa의 이미지](images/progressive-web-apps.jpg)

PWA 가이드를 살펴보세요.

* [간단한 웹 앱을 PWA로 빌드](https://docs.microsoft.com/microsoft-edge/progressive-web-apps/get-started)
* [Windows 런타임 통한에 PWA 향상](https://docs.microsoft.com/en-us/microsoft-edge/progressive-web-apps/windows-features)
...
Windows 10 참가자 미리 보기 빌드 17713, [많은 새로운 기능을 사용 하 여 업데이트 되었습니다 메모장에서](http://aka.ms/ant-man)에서 사용할 수 있습니다. 확대/축소, 찾기/바꾸기, 랩어라운드 및 Unix/Linux (LF) 및 Mac (CR) 줄의 끝에 대 한 지원을 [Windows 참가자](https://insider.windows.com/)에 게 제공 됩니다. 

## <a name="developer-guidance"></a>개발자 지침

### <a name="design-landing-page"></a>디자인 방문 페이지

확인 된 [방문 페이지 디자인 업데이트](https://developer.microsoft.com/windows/apps/design) UWP 디자인 영역 및 Fluent 디자인을 최신 추가 기능에 대 한 정보에 요약 개요 하세요.

### <a name="design-toolkits"></a>디자인 도구 키트

Adobe XD 및 Adobe Illustrator 도구 키트 새로운 기능으로 업데이트 되었습니다. 이러한 디자인 도구 키트는 UWP 앱 디자인을 위한 컨트롤 및 레이아웃 템플릿을 제공 합니다. [여기서 체크 합니다.](../design/downloads/index.md)
...
* [점진적 웹 앱에 WebVR](https://docs.microsoft.com/microsoft-edge/webvr/webvr-in-pwas): WebVR을 점진적 웹 앱 (PWA)를 추가 하는 방법을 알아봅니다.
...
* [WebVR 데모](https://docs.microsoft.com/microsoft-edge/webvr/demos): Microsoft Edge 및 Windows Mixed Reality 몰입 형 헤드셋을 사용 하 여 일부 WebVR 데모를 확인 합니다.

또한 일부 업데이트 기존 페이지를 변경한 내용:

* 목차 이제 더 잘으로 구성 되어 있고 네 가지 최상위 버킷으로: **기본 사항**, **개발**, **리소스**및 **데모**합니다.
...
* [이유 하지 않는 것을 통해 개발자 기본 오디오 장치 변경?](https://www.youtube.com/watch?v=6aNUoVfbnmg&feature=youtu.be)
...
사진 편집기 샘플 앱을 사용 하 여 개발을 보여 주는 합니다 [C + + WinRT](../cpp-and-winrt-apis/intro-to-using-cpp-with-winrt.md) 언어 프로젝션입니다. 앱을 사용 하 여 **사진** 라이브러리에서 사진을 검색 한 다음 관련된 사진 효과 사용 하 여 선택 된 이미지를 편집 수 있습니다. [복제 또는 다음 샘플을 다운로드 합니다.](https://github.com/Microsoft/Windows-appsample-photo-editor)

![작업의 샘플의 예](images/photo-editor-banner.png)
