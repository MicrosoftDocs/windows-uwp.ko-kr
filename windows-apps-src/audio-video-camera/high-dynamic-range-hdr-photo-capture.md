...
> [!IMPORTANT]
> [**OptionalReferencePhotoCaptured** ](https://msdn.microsoft.com/library/windows/apps/mt181392) 참조 프레임을 생성 하지 않습니다 및 HDR 하드웨어를 지 원하는 장치에서 발생 하지 않습니다. 앱은 이 이벤트가 발생하지 않는 경우를 처리해야 합니다.
