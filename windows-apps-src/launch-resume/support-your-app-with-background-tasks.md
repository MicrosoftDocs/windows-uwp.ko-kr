...
Out of process 백그라운드 작업은 없기 때문에 백그라운드 프로세스 앱 프로세스 문제가 발생 하면 훨씬 복원성이 큽니다. 그러나 가격으로 앱 사이의 백그라운드 작업 프로세스 간 통신 관리가 더 복잡 합니다.
...
> [!TIP]
> Windows10 부터는 더 이상 해야 백그라운드 작업을 등록 하는 것에 대 한 필수 조건으로 잠금 화면에서 앱을 배치 합니다.
