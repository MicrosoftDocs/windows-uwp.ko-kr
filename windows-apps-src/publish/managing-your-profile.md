...
계정 설정을 보려면 대시보드의 오른쪽 위 모서리에서 기어 아이콘을 클릭 하 고 **개발자 설정**을 선택 합니다. 여기에서 계정 정보를 확인 하 고 다양 한 계정 관련 작업을 수행할 수 있는 다른 페이지 링크에 대 한 세부 정보를 찾을 수 있습니다.
