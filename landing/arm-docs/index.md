...
<ul class="cols cols3">
    ...
    <li>
        ...
        <h3>개발자를 위한 arm 빌드 2018 Windows 10</h3><p>알아보기 Windows 10에 ARM 장치 어떻게 x86의 매직 에뮬레이션 작동 하 고 마지막으로 ARM에서 Windows 10 용 앱 빌드 및 제출 하는 방법. 데스크톱과 UWP에 대 한 a r m 64 앱을 빌드하는 방법을 보여 줄 것입니다.</p>
    </li>
    <li>
...
<li>
        <a class="card" href="feedback-hub://?tabid=2&contextid=803" data-linktype="absolute-path">
            ...
            <div class="cardText">
                ...
                <p>며칠이에서는 누락 문제가 있나요? 아이디어가 있습니까? 피드백 허브에 알려 주십시오.</p>
            </div>
        </a>
    </li>
    <li>
