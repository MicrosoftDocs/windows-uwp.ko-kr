# [유니버설 Windows 플랫폼 시작](https://developer.microsoft.com/windows/getstarted)
...
# [디자인 및 UI](https://developer.microsoft.com/windows/design)
...
### [연락처 카드에서 앱에 동작 연결](contacts-and-calendar/integrating-with-contacts.md)
### [피플 앱에 소셜 피드 제공](contacts-and-calendar/integrating-social-feeds-into-contact-cards.md)
...
#### [별도 프로세스에서 실행되는 백그라운드 작업 만들기 및 등록](launch-resume/create-and-register-a-background-task.md)
#### [단일 프로세스에서 실행되는 백그라운드 작업 만들기 및 등록](launch-resume/create-and-register-a-singleprocess-background-task.md)
#### [다중 프로세스 백그라운드 작업을 단일 프로세스 백그라운드 작업으로 변환](launch-resume/convert-multiple-process-background-task.md)
...
### [원격 앱 서비스와 통신](launch-resume/communicate-with-a-remote-app-service.md)
### [앱 서비스가 호스트 앱과 동일한 프로세스에서 실행되도록 변환](launch-resume/convert-app-service-single-process.md)
...
### [Microsoft 스토어 서비스 SDK](monetize/microsoft-store-services-sdk.md)
...
#### [변환된 데스크톱 앱 확장](porting/desktop-to-uwp-extensions.md)
#### [변환된 데스크톱 앱을 지원하는 UWP API](porting/desktop-to-uwp-supported-api.md)
