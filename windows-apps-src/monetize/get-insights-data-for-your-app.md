...
| 데이터 형식     | string | 이 정보를 설명 하는 일반 분석 영역을 지정 하는 다음 문자열 중 하나입니다.<p/><ul><li><strong>취득</strong></li><li><strong>상태</strong></li><li><strong>사용</strong></li></ul>   |
