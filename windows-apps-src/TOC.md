...
### [Windows 10 Anniversary SDK Preview의 새로운 기능](whats-new/windows-10-sdk-preview.md)
...
#### [앱 및 추가 기능에 대한 정보 가져오기](monetize/get-info-for-apps-and-add-ons.md)
#### [앱 또는 추가 기능 구입](monetize/purchase-an-app-or-add-on.md)
#### [앱에 대한 라이선스 정보 가져오기](monetize/get-license-info-for-your-app.md)
#### [앱의 평가판 구현](monetize/implement-a-trial-version-of-your-app.md)
#### [소모성 추가 기능 관리](monetize/manage-consumable-add-ons.md)
#### [Windows 10 버전 1607 이전의 앱에서 바로 구매 및 평가판](monetize/in-app-purchases-and-trials-before-windows-10-version-1607.md)
...
#### [액세스 기능](porting/hwa-access-features.md)
...
### [대량으로 LAP 관리](publish/manage-iaps-in-bulk.md)
