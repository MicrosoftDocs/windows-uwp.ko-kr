...
-   **값이 특수한 공통 컨트롤이 있는 데이터 형식을 나타내나요?** 그렇다면 텍스트 입력 컨트롤 대신 적절한 컨트롤을 사용합니다. 예를 들어 데이터 입력을 수락하려면 텍스트 입력 컨트롤 대신 [DatePicker](/previous-versions/windows/apps/br211681(v=win.10))를 사용합니다.
-   데이터가 엄격히 숫자인 경우
...
자세한 내용은 [입력 범위를 사용해서 터치 키보드 변경](../input/use-input-scope-to-change-the-touch-keyboard.md)을 참조하세요.
...
자세한 내용은 [IsColorFontEnabled](/uwp/api/windows.ui.xaml.controls.textblock.iscolorfontenabled) 속성을 참조하세요.
