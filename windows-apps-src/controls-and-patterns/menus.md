...
반드시 모든 메뉴 항목에 대해 아이콘을 제공할 필요는 없습니다. 특히 메뉴가 길거나 명령에 표준 시각화가 없는 경우가 여기에 해당합니다. 모호한 아이콘은 도움이 되지 않으며, 화면을 복잡하게 만들고, 사용자가 중요한 메뉴 항목에 집중하지 못하게 합니다.
