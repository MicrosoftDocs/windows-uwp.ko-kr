...
업데이트를 제출하려면 대시보드에서 추가 기능 페이지로 이동하고 **업데이트**를 클릭합니다. 시작 지점으로 이전 제출의 정보를 사용 하 여 추가 기능에 대 한 새 제출을 만들어집니다. 를 선택한 후 **스토어에 제출**을 클릭 변경 내용을 확인 합니다.
