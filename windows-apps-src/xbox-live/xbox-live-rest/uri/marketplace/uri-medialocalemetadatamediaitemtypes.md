...
ms.locfileid: "57622618"
---
# <a name="mediamarketplaceidmetadatamediaitemtypes"></a>/media/{marketplaceId}/metadata/mediaItemTypes
지정된 된 EDS 버전에 대 한 모든 지원 되는 mediaItemTypes에 액세스합니다. 이러한 Uri에 대 한 도메인은 `eds.xboxlive.com`합니다.
...
[GET (/media/ {marketplaceId} / 메타 데이터/mediaItemTypes)](uri-medialocalemetadatamediaitemtypesget.md)

&nbsp;&nbsp;지정된 된 EDS 버전에 대 한 모든 지원 되는 mediaItemTypes를 나열합니다.
