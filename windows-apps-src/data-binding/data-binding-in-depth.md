...
---
# <a name="data-binding-in-depth"></a>Data binding in depth
...
## <a name="every-binding-involves-these-pieces"></a>Every binding involves these pieces
...
### <a name="binding-source"></a>Binding source
...
### <a name="binding-target"></a>Binding target
...
### <a name="binding-object-declared-using-xbind"></a>Binding object declared using {x:Bind}
...
### <a name="binding-object-declared-using-binding"></a>Binding object declared using {Binding}
...
## <a name="what-if-the-source-and-the-target-are-not-the-same-type"></a>What if the source and the target are not the same type?
...
## <a name="value-converters"></a>Value Converters
...
## <a name="function-binding-in-xbind"></a>Function binding in {x:Bind}

{x:Bind} enables the final step in a binding path to be a function. This can be used to perform conversions, and to perform bindings that depend on more than one property. See [**{x:Bind} Markup Extension**](https://msdn.microsoft.com/en-us/windows/uwp/xaml-platform/x-bind-markup-extension)

<span id="resource-dictionaries-with-x-bind"/>
## <a name="resource-dictionaries-with-xbind"></a>Resource dictionaries with {x:Bind}
...
## <a name="event-binding-and-icommand"></a>Event binding and ICommand
...
## <a name="binding-to-a-collection-of-folders-or-files"></a>Binding to a collection of folders or files
...
## <a name="binding-to-data-grouped-by-a-key"></a>Binding to data grouped by a key
...
<span id="debugging"/>
## <a name="diagnosing-and-debugging-data-binding-problems"></a>Diagnosing and debugging data binding problems
...
## <a name="creating-bindings-in-code"></a>Creating bindings in code
...
## <a name="xbind-and-binding-feature-comparison"></a>{x:Bind} and {Binding} feature comparison
