...
| activity| [ActivityRecord](json-activityrecord.md)| 제목에 대 한 사용자의 활동입니다. 깊이 "all" 인 경우에 반환 합니다.| 
...
| 상태| string| 제목의 상태입니다. "활성" 또는 "비활성" 될 수 있습니다 (기본값). 제목 활동 및 비활성 상태에 대 한 조건에 따라 상태를 설정 합니다.| 
