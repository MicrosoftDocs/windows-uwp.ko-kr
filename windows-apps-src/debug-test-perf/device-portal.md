...
앱 관리자는 설치/제거 제공 및 관리 기능을 앱 패키지 및 번들의 등급을 호스트 장치에 있습니다.
...
- **실행 중인 앱**: 현재 실행 중인 및 필요에 따라 지연을 닫습니다 하는 앱에 대 한 정보를 가져옵니다.
...
3.  드롭다운 메뉴에서 앱을 선택 하 고 **제거**를 클릭 합니다.
...
추적을 중지하려면 **중지**를 클릭합니다. 추적 파일 될 때까지이 페이지에 계속 (합니다. ETL) 다운로드를 완료 합니다.
...
- **사용 가능한 네트워크**: WiFi 네트워크 장치 수를 보여 줍니다. 네트워크에서 클릭 또는 탭하면 여기에 연결되며 필요한 경우 암호를 제공합니다. Device Portal 아직 엔터프라이즈 인증을 지원 하지 않습니다. 또한 장치에 알려진 WiFi 프로필 중 하나에 연결 하려고 **프로필** 드롭다운을 사용할 수 있습니다.
