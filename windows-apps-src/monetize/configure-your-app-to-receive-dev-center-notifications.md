...
title: "Windows 개발자 센터 푸시 알림을 받도록 앱 구성"
ms.author: mcleans
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, Microsoft 스토어 서비스 SDK, 대상 푸시 알림, Windows 개발자 센터"
