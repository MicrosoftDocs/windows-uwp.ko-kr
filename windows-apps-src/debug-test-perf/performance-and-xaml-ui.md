...
하지 않은 경우, 아직 단계는까지 살펴본 중요 한 성능 향상을 대상으로 windows 10 앱을 이식 것입니다. 여러 XAML 최적화 (예를 들어 [{x: Bind}](https://msdn.microsoft.com/library/windows/apps/Mt204783))은 windows 10 앱에서 사용할 수만 있습니다. [Windows 10으로 포인팅 앱](https://msdn.microsoft.com/library/windows/apps/Mt238321) 및 [유니버설 Windows 플랫폼으로 전환](https://channel9.msdn.com/Events/Build/2015/3-741)//build/ 세션을 참조 하세요.
