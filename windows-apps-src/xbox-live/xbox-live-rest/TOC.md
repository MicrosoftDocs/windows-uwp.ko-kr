...
## [도전 과제 URI](uri/achievements/atoc-reference-achievementsv2.md)
...
## [게임 서버 URI](uri/gsdk/atoc-gsdk-uri-reference.md)
...
## [게임 DVR URI](uri/dvr/atoc-reference-dvr.md)
...
## [목록 URI](uri/lists/atoc-reference-lists.md)
...
## [매치 메이킹 URI](uri/matchtickets/atoc-reference-matchtickets.md)
...
## [피플 URI](uri/people/atoc-reference-people.md)
...
## [상태 URI](uri/presence/atoc-reference-presence.md)
...
## [개인 정보 URI](uri/privacy/atoc-reference-privacyv2.md)
...
## [프로필 URI](uri/profileV2/atoc-reference-profiles.md)
...
## [평판 URI](uri/reputation/atoc-reference-reputation.md)
...
## [세션 디렉터리 URI](uri/sessiondirectory/atoc-reference-sessiondirectory.md)
...
## [도전 과제 타이틀 기록 URI](uri/titlehistory/atoc-reference-titlehistoryv2.md)
...
## [타이틀 저장소 URI](uri/storage/atoc-reference-storagev2.md)
...
## [시스템 문자열 유효성 검사 URI](uri/stringserver/atoc-reference-systemstringsvalidate.md)
...
## [사용자 URI](uri/users/atoc-reference-users.md)
...
## [사용자 통계 URI](uri/userstats/atoc-reference-userstats.md)
...
## [GameClipSource 열거형](enums/gvr-enum-gameclipsource.md)
## [GameClipState 열거형](enums/gvr-enum-gameclipstate.md)
## [GameClipType 열거형](enums/gvr-enum-gamecliptypes.md)
## [GameClipUriType 열거형](enums/gvr-enum-gameclipuritype.md)
## [GameClipVisibility 열거형](enums/gvr-enum-gameclipvisibility.md)
## [ThumbnailSource 열거형](enums/gvr-enum-thumbnailsource.md)
## [ThumbnailType 열거형](enums/gvr-enum-thumbnailtype.md)
## [PermissionId 열거형](enums/privacy-enum-permissionid.md)
# [추가 참조](additional/atoc-xboxlivews-reference-additional.md)
## [권한 부여 유형](additional/authorizationtypes.md)
## [데이터 형식 개요](additional/datatypeoverview.md)
## [보조 EDS API](additional/eds-apis.md)
## [EDS 권한 부여](additional/edsauthorization.md)
## [EDS 공통 헤더](additional/edscommonheaders.md)
## [EDS 매개 변수](additional/edsparameters.md)
## [EDS 쿼리 구체화](additional/edsqueryrefiners.md)
## [비디오에 대한 EDS 역방향 조회](additional/edsreverselookup.md)
## [EDS 테이블](additional/edstables.md)
## [페이징 매개 변수](additional/pagingparameters.md)
## [표준 HTTP 요청 및 응답 헤더](additional/httpstandardheaders.md)
## [표준 HTTP 상태 코드](additional/httpstatuscodes.md)
