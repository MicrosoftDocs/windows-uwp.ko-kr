...
영구 문자열 데이터를 업로드 하기 전에 준수 또는 사용 약관 위반 하지 되도록 확인 해야 합니다. 이 REST 리소스 문자열의 배열 하며 각 줄을 허용 되는지 여부는 초기화 하 고 있는 용어를 포함 하는 문자열에 대 한 결과 코드를 반환 합니다.
