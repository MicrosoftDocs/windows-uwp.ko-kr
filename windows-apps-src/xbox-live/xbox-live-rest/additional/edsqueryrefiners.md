...
더욱 효과적인된 일련의 항목에는 엔터테인먼트 검색 서비스 (EDS) 쿼리를 구체화 하는 다음 매개 변수를 사용할 수 있습니다. 모든 API에 매개 변수가 필요 하지만 쿼리 구체화를 허용 하는 모든 API에서 허용 하는 것입니다.
...
실제로 어떻게 작동 수 다음과 같습니다.
   ...
   * API는 8 게임을 반환합니다. 항목을 외에도 항목이 된 각 장르 목록이 반환 됩니다 함께 얼마나 많은 항목 해당 장르에 속합니다. 이 게임에서는 될 "슈팅: 3, 퍼즐: 5".
