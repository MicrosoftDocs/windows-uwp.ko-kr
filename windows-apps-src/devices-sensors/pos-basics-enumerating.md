...
다음 코드 조각은 **DevicePicker**만듭니다, 그리고 사용자 선택, 디바이스에, 바코드 스캐너 필터를 추가 하 한 후 장치 ID에 따라 **BarcodeScanner** 개체를 만듭니다.
