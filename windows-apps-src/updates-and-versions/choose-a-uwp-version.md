...
최신 버전의 Visual Studio 2017에서 만든 모든 UWP 프로젝트는 Visual Studio 2015에서 열 수 없다는 점에 유의하세요.
...
| 버전 | 설명 |
| --- | --- |
| 빌드 17134(버전 1803) | 2018년 4월에 출시된 최신 버전의 Windows 10입니다. **이 Windows 버전을 대상으로 지정하려면 반드시 Visual Studio 2017을 사용_해야 합니다_.** 이 릴리스의 몇 가지 주요 기능은 다음과 같습니다. </br> \* **Windows 기계 학습:** Windows 기계 학습은 미리 숙련된 기계 학습 모델을 Windows 10 장치에서 평가하는 앱을 빌드할 수 있습니다. 플랫폼에 대한 자세한 내용은 [Windows 기계 학습](../machine-learning/index.md)을 참조하세요. </br> \* **흐름 디자인:** 트리 보기, 당겨서 새로 고침 및 탐색 보기와 같은 새로운 기능이 Windows 10에 추가되었습니다. [흐름 디자인 개요](../design/fluent-design-system/index.md)에서 최신 정보를 참조하세요. </br> \* **콘솔 UWP 앱:** 이제 DOS 또는 PowerShell 콘솔 창 등의 콘솔 창에서 실행되는 C++ /WinRT 또는 /CX UWP 콘솔 앱을 작성할 수 있습니다. </br> 이러한 사항과 Windows의 이 릴리스에 추가된 다른 많은 기능에 대한 자세한 내용은 [개발자 센터](https://developer.microsoft.com/windows/windows-10-for-developers) 또는 [개발자를 위한 Windows 10의 새로운 기능](../whats-new/windows-10-build-17134.md)에 있는 세부 정보 페이지를 방문하세요.
