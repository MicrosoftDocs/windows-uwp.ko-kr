...
keywords: 새 소식, 새 기능, 업데이트, 새로운 내용, Windows 10, 1511, 11월, 10586
ms.date: 11/02/2017
ms.topic: article
...
업데이트된 저장소 API | [Windows.Storage.DownloadsFolder 클래스](https://docs.microsoft.com/uwp/api/windows.storage.downloadsfolder)에서 이제 앱은 특정 [사용자](https://docs.microsoft.com/uwp/api/windows.storage.downloadsfolder.createfileforuserasync)에 대해 다운로드 폴더 내에 [파일을 생성](https://docs.microsoft.com/uwp/api/windows.storage.downloadsfolder.createfolderforuserasync)하거나 [폴더를 생성](https://docs.microsoft.com/uwp/api/windows.system.user)할 수 있습니다. [Windows.Storage.StorageLibrary 클래스](https://docs.microsoft.com/uwp/api/windows.storage.storagelibrary)에서 이제 앱은 특정 [사용자](https://docs.microsoft.com/uwp/api/windows.storage.storagelibrary.getlibraryforuserasync)에 대해 [지정된 라이브러리를 가져올 수 있습니다](https://docs.microsoft.com/uwp/api/windows.system.user).
