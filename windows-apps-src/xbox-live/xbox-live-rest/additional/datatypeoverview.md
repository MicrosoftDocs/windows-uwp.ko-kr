...
ms.locfileid: "6194306"
---
# <a name="data-type-overview"></a>데이터 형식 개요
 
Xbox Live 서비스는 다양 한 id 및 인증 관련 된 데이터 형식 사용 합니다. 이 항목에서는 이러한 유형에 대 한 개요를 제공 합니다.
...
| profile| 프로필 URI 주소 및 일반적으로 사용자의 UserSettings HTTP 메서드를 통해 액세스 하지만, 또한 gamercard, 게이머 태그, XUID, 등에 포함 하 여 사용자에 대 한 정보를 제공 합니다.| 
| 설정| UserSettings 개체의 제목 관련 설정 중 하나입니다.| 
| UserClaims| 사용자의 XUID 및 게이머를 포함 하는 간단한 JSON 개체입니다.| 
| UserSettings| 제목 관련 설정 또는 현재 인증 된 사용자에 대 한 기본 설정의 컬렉션을 포함 하는 JSON 개체입니다. UserSettings 가능 게임 내 작업에 관련 된 임의 데이터를 포함할 수 있습니다.| 
