...
제거는 `EntryPoint` 에서 특성은 `<Application>` 요소 이므로 이제 [OnBackgroundActivated()](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.application.onbackgroundactivated.aspx) 응용 프로그램 서비스를 호출할 때 사용 되는 진입점입니다.
