...
[항목 샘플 작업 만들기는 ThreadPool](http://go.microsoft.com/fwlink/p/?LinkID=328569) Windows8.1, 용으로 작성 된의이 빠른 시작에서 코드를 다운로드 하 여 자세히 알아볼 수 있습니다 win\_unap Windows10 앱에서 소스 코드를 다시 사용 합니다.
