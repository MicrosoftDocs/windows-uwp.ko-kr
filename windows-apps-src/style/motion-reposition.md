...
<b>중요 API</b><br/>
<ul>
<li>[**RepositionThemeAnimation 클래스**](https://msdn.microsoft.com/library/windows/apps/br210421)</li>
<li>[**RepositionThemeTransition 클래스**](https://msdn.microsoft.com/library/windows/apps/br210429)</li>
</ul>
</div>
