...
[아크릴 소재](../style/acrylic.md)는 투명한 텍스처를 만드는 브러시 유형입니다. 

![밝은 테마의 아크릴](../style/images/Acrylic_DarkTheme_Base.png)

[시차 효과](../style/parallax.md)는 앱에 3차원 깊이 및 관점을 추가합니다.

![목록 및 배경 이미지를 사용한 시차의 예](../style/images/_Parallax_v2.gif)

[표시](../style/reveal.md)는 앱의 중요한 요소를 강조 표시합니다. 

![Visual 표시](../style/images/Nav_Reveal_Animation.gif)
...
[색 선택 컨트롤](../controls-and-patterns/color-picker.md)은 사용자를 색상을 검색해서 선택할 수 있도록 해줍니다.  

![기본 색 선택](../controls-and-patterns/images/color-picker-default.png)

[탐색 보기 컨트롤](../controls-and-patterns/navigationview.md)는 앱에 최상위 탐색을 손쉽게 추가할 수 있게 해줍니다.

![NavigationView 섹션](../controls-and-patterns/images/navview_sections.png)

[사람 그림 컨트롤](../controls-and-patterns/person-picture.md)은 사람에 대한 아바타 이미지를 표시합니다.

![사람 사진 컨트롤](../controls-and-patterns/images/person-picture/person-picture_hero.png)

[등급 컨트롤](../controls-and-patterns/rating.md)은 사용자가 콘텐츠 및 서비스에 대한 만족도를 반영하는 등급을 손쉽게 확인 및 설정할 수 있도록 해줍니다.

![등급 컨트롤의 예](../controls-and-patterns/images/rating_rs2_doc_ratings_intro.png)
...
* [Windows 스토어 분석 API](../monetize/access-analytics-data-using-windows-store-services.md)에서 이제 [앱 오류에 대한 CAB 파일을 다운로드](../monetize/download-the-cab-file-for-an-error-in-your-app.md)할 수 있는 방법을 제공합니다.
...
SDK Preview 빌드의 [Windows 참가자](https://insider.windows.com/)에서 사용할 수 있는 새 TaskbarManager 클래스를 사용하여 사용자에게 [작업 표시줄에 앱을 고정](../controls-and-patterns/pin-to-taskbar.md)하도록 요청할 수 있습니다.
...
docs.microsoft.com의 [UWP 개념](../get-started/whats-a-uwp.md) 및 [API 참조](https://docs.microsoft.com/en-us/uwp/api/) 문서에 "UWP" 범위가 추가되었습니다. 이 범위를 비활성화하지 않으면 이 영역 내에서 수행한 검색이 UWP 문서만 반환합니다.
