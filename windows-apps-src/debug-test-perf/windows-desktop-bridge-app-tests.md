...
[데스크톱 브리지 앱](https://docs.microsoft.com/en-us/windows/uwp/porting/desktop-to-uwp-root) Windows 데스크톱 응용 프로그램을 사용 하는 유니버설 Windows 플랫폼 (UWP) 앱으로 변환 되는 [데스크톱 브리지](https://developer.microsoft.com/en-us/windows/bridges/desktop)합니다. 변환 후에는 Windows 데스크톱 응용 프로그램이 Windows 10 데스크톱을 대상으로 하는 UWP 앱 패키지(.appx 또는 .appxbundle)의 형태로 패키징되고, 서비스되고, 배포됩니다.
...
**정정 작업**  
참조 [UWP 브리지에 데스크톱: 앱 확장](https://docs.microsoft.com/en-us/windows/uwp/porting/desktop-to-uwp-extensions) 올바르게 사용 하는 방법과 이러한 확장에 대 한 설명은 합니다. 
