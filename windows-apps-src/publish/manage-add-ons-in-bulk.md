...
> [!IMPORTANT]
> 이 기능은 이전에 [개발자 센터 참가자 프로그램](dev-center-insider-program.md)에 가입한 개발자 계정에는 제공되었지만, 현재는 지원되지 않습니다.
...
| 기본 가격    | 추가 기능을 제공하려는 기준 가격입니다. **무료** 또는 **0.99USD** 형식의 유효한 기준 가격이어야 합니다. |  예 |
