...
- 사용자 id
- 개발 콘솔 구성
- TitleID 및 서비스 안내를 위해 이진 파일에 추가
...
## <a name="add-the-titleid-and-scid-to-your-binary"></a>TitleID 및 서비스 안내를 위해 이진 파일에 추가
...
**RequireXboxLive 플래그** Windows.Networking.Connectivity 연결 수준 하지 않는 한 플래그가 제목 true로 설정 되어 RequireXboxLive 시작 되지 않는 XboxLiveAccess 반환 및 제목 인증 Xbox live를 지웁니다. 그러면, 제목 콘텐츠 최신 업데이트를 수행 했습니다. 제목을 실행 되는 동안 연결이 끊기면, 제목 일시 중단 됩니다.
