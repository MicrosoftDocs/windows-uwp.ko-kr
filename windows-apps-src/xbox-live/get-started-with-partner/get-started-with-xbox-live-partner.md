...
ms.locfileid: "5161730"
---
# <a name="get-started-with-xbox-live-as-a-managed-partner-or-an-idxbox-developer"></a>Xbox Live 관리 파트너로 시작 또는 ID@Xbox 개발자

이 섹션에서는 관리 파트너 또는 Xbox live 시작 된 ID@Xbox 개발자. 파트너 및 ID 개발자의 전체 범위 Xbox Live 기능, 도전 과제, 멀티 플레이어, 등을 포함 하 여 액세스할 수 있습니다.

관리 파트너 및 ID@Xbox 개발자가 유니버설 Windows 플랫폼 (UWP) 또는 Xbox 개발자 키트 (XDK) 플랫폼 모두에 대 한 Xbox Live 타이틀을 개발할 수 있습니다.

사용 가능한 콘텐츠 외에도 여기서은 권한 있는 개발자 센터 계정으로 파트너에 게 사용할 수 있는 추가 설명서. 여기에 해당 콘텐츠를 액세스할 수 있습니다: [Xbox Live 파트너 콘텐츠](https://developer.microsoft.com/en-us/games/xbox/docs/xboxlive/xbox-live-partners/partner-content).
...
- Xbox Live 도전 과제는 게이머가 도전 과제를 잠금 해제에 Xbox Live 소셜 그래프에 게임 무료 프로 모션을 제공 하 여 인기 있는 가져오기 게임 도움이 됩니다.
...
개발 키트 XDK (Xbox), 유니버설 Windows 플랫폼 (UWP), 또는 크로스 플레이 게임을 만드는 중 하나를 선택 합니다.
