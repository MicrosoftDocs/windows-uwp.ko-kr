...
## <a name="entries"></a>항목
이 표는 ">" 문자를 사용하여 입력 계층의 수준을 나타냅니다.  또한 어떤 버전의 Windows 각 항목을 지원 하 고 무시는 보여 줍니다.
...
| >> area                      | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 설명 하는 육지 영역을 사용 합니다.  이러한 구조 항목의 아래에 실제 건물와 혼동를 안 됩니다. |
...
| >>> indigenousPeoplesReserve | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 토착 개인적 포괄 하는 영역을 예약 합니다. |
...
| >>> military                 | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 군사 사용 하거나 호스팅하 군사 기지 영역입니다. |
| >>> nautical                 | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 관련된 항해 목적에 사용 되는 영역입니다. |
| >>> neighborhood             | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 주변 영역의 레이블입니다. |
...
| >>> naturalPoint             | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 자연 스러운 기능을 나타내는 아이콘입니다. |
...
| >>> pointOfInterest          | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 관심 있는 모든 위치를 나타내는 아이콘입니다. |
| >>>> business                | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 모든 비즈니스 locaiton를 나타내는 아이콘입니다. |
| >>>>> attractionPoint        | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 박물관, zoos 등과 같은 여행자 명소를 나타내는 아이콘입니다. |
| >>>>> communityPoint         | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 커뮤니티 범용의 위치를 나타내는 아이콘입니다. |
| >>>>> educationPoint         | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 학교 및 기타 교육을 나타내는 아이콘 위치와 관련이 있습니다. |
| >>>>> entertainmentPoint     | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 극장, 시네마 및 등과 같은 엔터테인먼트 장소를 나타내는 아이콘입니다. |
| >>>>> essentialServicePoint  | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 주차, 은행, 사례를 살펴보자면 등과 같은 필수 서비스를 나타내는 아이콘. |
| >>>>> foodPoint              | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 음식점, 카페 등을 나타내는 아이콘입니다. |
| >>>>> lodgingPoint           | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 호텔 및 기타 숙박 회사를 나타내는 아이콘입니다. |
| >>>>> realEstatePoint        | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 부동산 비즈니스를 나타내는 아이콘입니다. |
| >>>>> shoppingPoint          | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 호텔 및 기타 숙박 회사를 나타내는 아이콘입니다. |
...
| >>> adminDistrict            | [BorderedMapElement](#borderedmapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Admin1, 상태, 주 등에 테두리 및 레이블을. |
...
| rasterRegionsVisible         | 부울    |  ✔   |  ✔   |  ✔   |  ✔   | 벡터 (일본 및 한국) 보다 더 나은 표현이 있을 래스터 지역 그릴 것인지 여부를 나타내는 플래그입니다. |
...
| useDefaultImageColors        | 부울    |  ✔   |  ✔   |  ✔   |  ✔   | SVG의 원래 색 이미지에서에서 색상에 대 한 색상표 항목을 조회 하는 대신 사용 해야 하는지 여부를 나타내는 플래그입니다. |
...
| borderVisible                | 부울    |  ✔   |  ✔   |  ✔   |  ✔   |  |
| borderWidthScale             | 부동   |  ✔   |  ✔   |  ✔   |  ✔   | 테두리 스트로크는 크기를 조정 하는 금액입니다. 예를 들어 기본값에 *1*, 대형의 두 배 값에 *2*를 사용합니다. |
...
| 속성                     | 형식    | 1506 | 1629 | 1713 | Next | 설명 |
|------------------------------|---------|------|------|------|------|-------------|
| 셰이프 배경             | 부동   |      |      |      |  ✔️   | -모양이 존재 하는 대체 아이콘의 배경으로 사용 하 여 셰이프입니다. |
