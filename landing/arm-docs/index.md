...
ms.locfileid: "5980066"
---
# <a name="windows-10-on-arm"></a>ARM 기반 Windows 10
Windows 10 ARM 프로세서로 구동 되는 Pc에서 실행 됩니다. 이 페이지는 앱 개발 시작 및 플랫폼에 대해 알아볼 수에 대 한 정보를 제공 합니다. 또한 좋습니다 페이지의 맨 아래에 링크를 사용 하 여 피드백을 제공할 수 있습니다.
...
<ul class="cols cols3">
    <li>
        ...
        <h3>ARM64 Win32 c + + 앱 빌드</h3><p>Visual Studio에 대 한 ARM64 도구를 설치 하는 방법을 알아봅니다. 그런 다음 살펴보겠습니다 하면 만들고 새 ARM 64 프로젝트를 컴파일하는 단계를 합니다.</p>
    </li>
    <li>
        ...
        <h3>개발자를 위한 arm 빌드 2018 Windows 10</h3><p>알아봅니다 Windows 10에 ARM 장치를 어떻게 x86의 매직 에뮬레이션 작동 하 고 마지막 제출 및 ARM에서 Windows 10 용 앱을 작성 하는 방법. 데스크톱과 UWP 용 ARM64 앱을 빌드하는 방법을 보여 줄 했습니다.</p>
    </li>
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <div class="cardText">
                    ...
                    <p class="x-hidden-focus">기본 사항을 이해 하는 설명서를 확인 합니다.</p>
                </div>
            </div>
        </div>
    </li>
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <div class="cardText">
                    <h3>자세한 어떻게 x86 에뮬레이션 작동</h3>
                    <p class="x-hidden-focus">Arm 기반 Windows 10의 주요이 기능에 대 한 모든에 대해 알아봅니다.</p>
                </div>
            </div>
        </div>
    </li>
...
## <a name="developing-for-windows-10-on-arm"></a>Arm 기반 Windows 10 용으로 개발
        ...
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <div class="cardText">
                    ...
                    <p class="x-hidden-focus">여기서 것을 안내 arm 기반 Windows 10에서 기본적으로 실행 되도록 a r m 64로 앱 컴파일이 블로그 게시물을 확인 합니다.</p>
                </div>
            </div>
        </div>
    </li>
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <div class="cardText">
                    <h3>Arm 기반 UWP 앱</h3>
                    <p class="x-hidden-focus">성공으로 유니버설 Windows 플랫폼 (UWP) 앱을 설정 하려면이 지침을 따릅니다.</p>                    
                </div>
            </div>
        </div>
    </li>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <div class="cardText">
                    <h3>x86 arm 기반 앱</h3>
                    <p class="x-hidden-focus">개발 x86 앱의 가장 arm 기반 Windows 10에서 수행할 수 있습니다.</p>
                </div>
            </div>
        </div>
    </li>
...
기존 고객의 의견을 활용 하 여 제품을 지속적으로 향상는 것입니다. 에 대해 알게 되었습니다, 문제가에서 멈춤 또는 어떻게 제대로 공유 하려는 경우 환경에는 이러한 링크는 데 도움이 됩니다.
...
<li>
        <a class="card" href="feedback-hub://?tabid=2&contextid=803" data-linktype="absolute-path">
            ...
            <div class="cardText">
                <h3>피드백 허브를 사용 합니다.</h3>
                <p>며칠이 우리 누락 문제가 있나요? 아이디어가 있으십니까? 피드백 허브에 알려 주십시오.</p>
            </div>
        </a>
    </li>
    <li>
