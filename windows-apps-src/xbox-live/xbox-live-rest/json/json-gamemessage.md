...
| 일련 번호| 32 비트의 부호 있는 정수| 게임 메시지의 시퀀스 번호입니다. 이 값은 서버에 의해 할당 됩니다. 시퀀스 번호 단조롭게 증가 보장이 하지만 연속 되지 않을 수 있습니다. 시퀀스 번호는 고유한 메시지 큐 내에서 있지만 메시지 큐 간에 그렇지 않습니다. | 
| queueIndex| 32 비트의 부호 있는 정수| 메시지에 대 한 세션 메시지 큐의 인덱스입니다. 가능한 값은 0-3입니다.| 
