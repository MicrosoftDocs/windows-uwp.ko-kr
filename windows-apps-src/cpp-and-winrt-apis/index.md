---
author: stevewhims
description: Windows SDK에는 C++/WinRT가 포함됩니다. 이는 Windows 런타임 API용 표준 C++ 언어 프로젝션으로서 헤더 파일에서만 구현되며, 오늘날 Windows API에 대해 최고 수준의 액세스를 제공하도록 설계되었습니다. C++/WinRT에서는 모든 표준과 호환되는 C++ 컴파일러를 통해 Windows 런타임 API를 작성하고 사용할 수 있습니다.
title: C++/WinRT
ms.author: stwhi
ms.date: 04/10/2018
ms.topic: article
...
Windows SDK는 버전 10.0.17134.0(Windows 10, 버전 1803)에서 도입되기 시작하여 현재는 C++/WinRT까지 포함되어 있습니다. C++/WinRT는 Windows 런타임(WinRT) API용 최신 표준 C++17 언어 프로젝션으로서 헤더 파일에서만 구현되며, 오늘날 Windows API에 대해 최고 수준의 액세스를 제공하도록 설계되었습니다. C++/WinRT에서는 모든 표준과 호환되는 C++17 컴파일러를 통해 Windows 런타임 API를 작성하고 사용할 수 있습니다.
