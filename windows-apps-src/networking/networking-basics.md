...
-   [**ConnectAsync** ](https://msdn.microsoft.com/library/windows/apps/hh701504) -네트워크 서비스에 초기 연결을 확인 하 고 즉시 모든 통신에 SSL/TLS를 사용 하려면 협상 합니다.
-   [**UpgradeToSslAsync** ](https://msdn.microsoft.com/library/windows/apps/br226922) -암호화 되지 않은 네트워크 서비스에 처음 연결 합니다. 앱은 데이터를 보내거나 받을 수 있습니다. 그런 다음 이후의 모든 통신에 SSL/TLS를 사용하도록 연결을 업그레이드합니다.
...
[**ConnectAsync** ](https://msdn.microsoft.com/library/windows/apps/hh701504) 네트워크 서비스를 사용 하 여 초기 연결에 사용할 수 있으며 즉시 모든 통신에 SSL/TLS를 사용 하려면 다음을 협상 합니다. *protectionLevel* 매개 변수 전달을 지원하는 두 가지 **ConnectAsync** 메서드는 다음과 같습니다.

-   [**(EndpointPair, SocketProtectionLevel) ConnectAsync** ](https://msdn.microsoft.com/library/windows/apps/hh701511) -비동기 작업에서 시작을 [ **StreamSocket** ](https://msdn.microsoft.com/library/windows/apps/br226882) 원격 네트워크 대상에 연결 하는 개체 로 지정 된 프로그램 [ **EndpointPair** ](https://msdn.microsoft.com/library/windows/apps/hh700953) 개체와 [ **SocketProtectionLevel**](https://msdn.microsoft.com/library/windows/apps/br226880)합니다.
-   [**(호스트 이름, 문자열, SocketProtectionLevel) ConnectAsync** ](https://msdn.microsoft.com/library/windows/apps/br226916) -비동기 작업에서 시작을 [ **StreamSocket** ](https://msdn.microsoft.com/library/windows/apps/br226882) 원격 대상에 연결 하는 개체 원격 호스트 이름, 원격 서비스 이름으로 지정 된와 [ **SocketProtectionLevel**](https://msdn.microsoft.com/library/windows/apps/br226880)합니다.
...
| **배포** | [**SyndicationClient(PasswordCredential)**](https://msdn.microsoft.com/library/windows/apps/hh702355) |
