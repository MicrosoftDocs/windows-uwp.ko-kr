...
description: "Windows 스토어 분석 API에서 이 메서드를 사용하여 지정된 날짜 범위 및 다른 선택적 필터에 대한 집계 하드웨어 오류 보고 데이터를 가져옵니다. 이 메서드는 OEM용으로만 제공됩니다."
...
Windows 스토어 분석 API에서 이 메서드를 사용하여 지정된 날짜 범위 및 다른 선택적 필터에 대한 OEM 하드웨어 오류의 집계 오류 보고 데이터를 가져옵니다. [OEM 하드웨어 오류에 대한 세부 정보 가져오기](get-details-for-an-oem-hardware-error.md) 메서드를 사용하여 추가 오류 정보를 검색할 수 있습니다.
...
| deviceType      | string  | 오류가 발생한 디바이스 유형을 나타내는 다음 문자열 중 하나입니다.<p/><ul><li><strong>PC</strong></li><li><strong>Phone</strong></li><li><strong>콘솔</strong></li><li><strong>IoT</strong></li><li><strong>Holographic</strong></li><li><strong>Unknown</strong></li></ul>    |
