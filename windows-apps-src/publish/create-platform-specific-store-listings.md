...
고객에 게 Windows10 (Xbox 포함)에 항상 기본 [스토어 목록](create-app-store-listings.md)표시 됩니다. 하나 이상의 이전 OS 버전을 지 원하는 패키지를 사용 하 여 앱을 이미 게시 하지 않는 한 플랫폼별 스토어 목록을 만드는 옵션이 표시 되지 않습니다. 
