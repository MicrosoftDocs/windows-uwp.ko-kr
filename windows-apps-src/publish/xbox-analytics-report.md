...
> [!IMPORTANT]
> Xbox용 게임이나 Xbox Live 서비스를 사용하는 게임을 게시하는 경우에만 이 보고서가 표시됩니다. 이렇게 하려면 [개념 승인 프로세스](../gaming/concept-approval.md)를 통해 [Microsoft 파트너](../xbox-live/developer-program-overview.md#microsoft-partners) 에 의해 게시 된 게임 및 게임을 통해 서 제출 하는 이동 해야 하면 [ ID@Xbox 프로그램](../xbox-live/developer-program-overview.md#id). 게임을 [Xbox Live 작성자 프로그램](../xbox-live/get-started-with-creators/get-started-with-xbox-live-creators.md) 을 통해 게시 된 현재이 보고서에 표시 되지 않습니다.
