...
description: 앱 스토어에 제출 하기 전에 파트너 센터에서 응용 프로그램 ID 및 ad 단위 ID 값을 앱에 추가 하는 방법에 알아봅니다.
title: 앱에서 광고 단위 설정
ms.date: 05/11/2018
ms.topic: article
...
테스트를 마친 후에 UWP 앱 파트너 센터에 전송할 준비를 해야 [라이브 광고 단위를 만듭니다](#live-ad-units) 에서 합니다 [앱 내 광고](../publish/in-app-ads.md) 파트너 센터에서 페이지 및 응용 프로그램을 사용 하도록 앱 코드 업데이트 ID 및 ad 단위 ID 값이 ad 단위입니다.
...
가져오고 라이브 광고 단위 파트너 센터에서 응용 프로그램에서 사용 합니다.

1.  [Ad 단위 만들기](../publish/in-app-ads.md#create-ad-unit) 에 **앱 내 광고** 파트너 센터의 페이지입니다. 엡에서 사용하는 광고 컨트롤에 대해 올바른 광고 단위 유형을 지정해야 합니다.
    > [!NOTE]
...
2.  새 ad 단위를 만든 후 검색 합니다 **응용 프로그램 ID** 하 고 **Ad 할당 단위 ID** ad 단위에서 사용할 수 있는 ad 단위의 테이블에 대 한 합니다 **Monetize** &gt;  **앱 내 광고** 페이지입니다.
    > [!NOTE]
