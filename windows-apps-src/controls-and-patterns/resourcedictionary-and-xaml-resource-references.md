...
> **참고** &nbsp;&nbsp;[**ResourceDictionary**](https://msdn.microsoft.com/library/windows/apps/br208794) 관련된 개념을 **리소스** 빌드 작업, 리소스(.resw) 파일 또는 앱 패키지를 생성하는 코드 프로젝트 구성 컨텍스트에서 설명되는 다른 "리소스"와 혼동하지 마세요.
