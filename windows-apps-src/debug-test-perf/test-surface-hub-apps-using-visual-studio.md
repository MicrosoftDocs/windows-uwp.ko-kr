...
자세한 내용은 [시뮬레이터에서 Windows 스토어 앱 실행](https://msdn.microsoft.com/en-us/library/hh441475.aspx)을 참조하세요.

## 시뮬레이터에 Surface Hub 해상도 추가
...
4. Visual Studio 시뮬레이터에서 앱을 실행합니다. 팔레트에서 **해상도 변경** 단추를 클릭하고 목록에서 Surface Hub 구성을 선택합니다.
   ...
   > **팁**&nbsp;&nbsp;Surface Hub의 환경을 더 효과적으로 시뮬레이트하려면 [태블릿 모드를 켭니다](http://windows.microsoft.com/en-us/windows-10/getstarted-like-a-tablet).
   
## Visual Studio에서 Surface Hub에 앱 배포 
...
### Visual Studio에서 앱 배포
자세한 내용은 [UWP(유니버설 Windows 플랫폼) 앱 배포 및 디버그](https://msdn.microsoft.com/en-us/windows/uwp/debug-test-perf/deploying-and-debugging-uwp-apps)를 참조하세요.
