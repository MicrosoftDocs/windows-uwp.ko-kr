...
게임에 대한 전체 클라우드 백엔드 솔루션을 찾고 있는 경우에는 [게임 백 엔드를 위한 SaaS(Software as a Service)](#software-as-a-service-for-game-backend)를 참조하세요.
...
##  <a name="how-game-companies-use-the-cloud-technology"></a>게임 회사에서 클라우드 기술을 사용하는 방법
...
<table>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li>기존 PC 게임은 전 세계 사용자에게 클라우드 게임으로 제공됨 <li>최적화된 게임 전달 프로세스 <li>마이크로 서비스로 격리되어 복잡성을 줄이는 게임 기능, 종속성으로 인한 워크로드 반복 횟수 감소, 새로운 기능을 독립적으로 업그레이드할 수 있는 기능 <li>최신 게임 콘텐츠를 실행할 수 있는 소규모 설치 패키지 다운로드(GB에서 MB로 감소된 패키지 크기) <li>유지 관리 비용 절감 </ul>
        </td>
        <td>
            <ul>
                <li><a href="https://customers.microsoft.com/story/tencent-telecommunications-azure-service-fabric-windows-server-en">Tencent 게임과 Microsoft가 구축한 클라우드 게임 솔루션</a>
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=38m33s">서비스 패브릭으로 게임 구축: Tencent의 구현에 대한 세부 정보(동영상)</a>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-halo-5-guardians-implemented-social-gameplay-using-azure-documentdb/">Azure Cosmos DB(DocumentDB API를 통함)를 사용하여 구현된 소셜 게임 플레이</a>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=06m52s">서비스 패브릭으로 게임 구축: Age of Ascent MMO 게임(동영상)</a>
                <li><a href="https://channel9.msdn.com/Events/Build/2016/KEY02#time=57m20s">Azure 서비스 패브릭을 사용하여 게임 구성 요소를 마이크로 서비스로 관리(동영상)</a> 
                <li><a href="https://channel9.msdn.com/Shows/Azure-Friday/Age-of-Ascent-from-Illyriad-Powered-by-Azure-Service-Fabric-and-ASPNET">Age of Ascent 개발자 인터뷰(동영상)</a>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li>플랫폼 간 <li>순서 기반 멀티 플레이 <li>탄력적인 성능 확장 <li>게이머 사기 방지 <li>동적인 콘텐츠 전달 </ul>
        </td>
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-we-built-it-next-games-global-online-gaming-platform-on-azure/">구축 방법: Azure의 Next Games 글로벌 온라인 게임 플랫폼(블로그 동영상 포함)</a>
                <li><a href="https://azure.microsoft.com/blog/the-walking-dead-no-mans-land-game-soars-to-1-with-azure-documentdb/">Walking Dead는 보다 빠른 개발 주기와 매력적인 게임 플레이를 위해 Azure Cosmos DB(DocumentDB API를 통함)를 사용합니다.</a>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><a href="https://channel9.msdn.com/Blogs/The-Game-Blog/BizSpark-Interview-with-Pixel-Squad-How-the-used-Azure-Cloud-Services-to-make-an-MMO-with-a-3-man-te">Crime Coast MMO 게임에서 Azure 클라우드 서비스를 사용한 방법</a>
            </ul>
        </td>
    </tr> 
</table>
...
### <a name="design-your-game-infrastructure-using-azure"></a>Azure를 사용하여 게임 인프라 디자인

다음은 Azure 클라우드 서비스를 게임에 사용할 수 있는 몇 가지 방법입니다. Azure는 Windows, Linux 및 Ruby, Python, Java, PHP 등의 익숙한 오픈 소스 기술에서 작동합니다. 자세한 내용은 [게임용 Azure](https://azure.microsoft.com/solutions/gaming/)를 참조하세요.
...
| 모바일 앱 개발, 배포 및 베타 테스트 | 모바일 앱을 테스트하고 배포합니다. 앱 성능 및 사용자 경험 관리. | [HockeyApp](https://azure.microsoft.com/services/hockeyapp/)| 충돌 보고 및 사용자 메트릭을 앱 배포 및 사용자 피드백 플랫폼과 통합합니다. Android, Cordova, iOS, OS X, Unity, Windows 및 Xamarin 앱을 지원합니다. 또한 [Visual Studio Mobile Center](https://www.visualstudio.com/vs/mobile-center/) &mdash; 다양한 분석, 충돌 보고, 푸시 알림, 앱 배포 등을 결합한 앱의 필수 제어 기능을 고려해 보세요. |
...
* [스타트업용 Microsoft](https://startups.microsoft.com)
    ...
    스타트업용 Microsoft는 스타트업 기업의 성장을 가속화하기 위해 제품, 기술 및 출시 측면에서 혜택을 제공합니다. Azure 무료 계정을 얻을 수 있는 것도 이러한 혜택 중 하나입니다. 200달러 크레딧만 있으면 30일 동안 서비스를 탐색하고 12개월 동안 인기 서비스를 무료로 이용하며 25개 이상의 무료 서비스를 언제든 이용할 수 있습니다. 자세한 내용은 [Azure 무료 계정을 통해 스타트업의 아이디어 실현](https://azure.microsoft.com/free/startups/)을 참조하세요.
...
* [클라우드 기반 로드 테스트 도구](https://www.visualstudio.com/team-services/cloud-load-testing/)
...
[Playfab](https://playfab.com/)는 현재 8,000만 명의 월별 활성 플레이어에게 1,200개가 넘는 라이브 게임을 제공하고 있습니다. 이것은 실시간 제어와 함께 전체 스택 LiveOps가 포함된 완벽한 백 엔드 플랫폼입니다. 

모바일, PC 또는 SDK를 사용하는 콘솔 게임에 이 솔루션을 통합할 수 있습니다. Android, iOS, Unreal, Unity, Windows 같은 인기 게임 엔진 및 플랫폼에서 사용할 수 있는 SDK가 나와 있습니다. 시작하려면 [설명서](https://api.playfab.com/)를 참조하세요.
...
Microsoft는 꾸준한 혁신을 통해 새로운 기능을 추가하고 있습니다. 자세한 내용은 [기능](https://playfab.com/features/)을 참조하고 가격은 [단순한 종량제 가격 체계](https://playfab.com/pricing/)를 참조하세요.
