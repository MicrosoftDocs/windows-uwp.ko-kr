...
> [!NOTE]
> 이 예제에 표시된 *applicationId* 및 *adUnitId* 값은 [테스트 모드 값](test-mode-values.md)입니다. 앱을 제출하기 전에 Windows 개발자 센터에서 [이러한 값을 라이브 값으로 교체](set-up-ad-units-in-your-app.md)해야 합니다.
