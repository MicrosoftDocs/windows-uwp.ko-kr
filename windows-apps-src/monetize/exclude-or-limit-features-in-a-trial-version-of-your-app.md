...
이 경로와 파일이 없는 경우 설치 중에 또는 런타임에 만들어야 합니다. 이 특정 위치에 WindowsStoreProxy.xml이 없는 상태에서 [CurrentAppSimulator.LicenseInformation](https://msdn.microsoft.com/library/windows/apps/hh779768) 속성에 액세스하면 오류가 발생합니다.
...
> [!IMPORTANT]
> 앱을 스토어로 제출할 때 앱에서 **CurrentApp** 개체를 사용해야 합니다. 그러지 않으면 앱 인증에 실패합니다.
