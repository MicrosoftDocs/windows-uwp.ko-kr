...
> [!WARNING]
> 최신 버전의 Visual Studio 만든 UWP 프로젝트 2015 Visual Studio에서 열 수 없습니다.
...
| 버전 | 설명 |
| --- | --- |
| 17763 (1809 버전) 구축 | 2018 년 10 월에에서 출시 되는 Windows 10의 최신 버전입니다. **이 Windows 버전을 대상으로 지정하려면 반드시 Visual Studio 2017을 사용_해야 합니다_.** 이 릴리스의 몇 가지 주요 기능은 다음과 같습니다. </br> \* **Windows 컴퓨터 학습:** Windows 컴퓨터 학습 이제 공식적으로 장군이, 최첨단 컴퓨터 학습 모델에 대 한 빠른 평가 및 지원 등의 기능을 제공 합니다. 플랫폼에 대한 자세한 내용은 [Windows 기계 학습](https://docs.microsoft.com/windows/ai/)을 참조하세요. </br> \* **Fluent 디자인:** 10 Windows 메뉴 모음, 명령 모음 팝업 창, XAML 속성 애니메이션 같은 새로운 기능이 추가 되었습니다. [흐름 디자인 개요](../design/fluent-design-system/index.md)에서 최신 정보를 참조하세요. </br> 이러한 문제 및이 버전의 Windows에 추가 된 많은 기능에 대 한 내용은 자세한 페이지 또는 [개발자 센터](https://developer.microsoft.com/windows/windows-10-for-developers) 에 방문 [개발자를 위한 Windows 10의 새로운 기능](../whats-new/windows-10-build-17763.md)
| 빌드 17134(버전 1803) | 이 버전의 Windows 10 2018 년 4 월에에서 릴리스 되었습니다입니다. **이 Windows 버전을 대상으로 지정하려면 반드시 Visual Studio 2017을 사용_해야 합니다_.** 이 릴리스의 몇 가지 주요 기능은 다음과 같습니다. </br> \* **흐름 디자인:** 트리 보기, 당겨서 새로 고침 및 탐색 보기와 같은 새로운 기능이 Windows 10에 추가되었습니다. [흐름 디자인 개요](../design/fluent-design-system/index.md)에서 최신 정보를 참조하세요. </br> \* **콘솔 UWP 앱:** 이제 DOS 또는 PowerShell 콘솔 창 등의 콘솔 창에서 실행되는 C++ /WinRT 또는 /CX UWP 콘솔 앱을 작성할 수 있습니다. </br> 이러한 사항과 Windows의 이 릴리스에 추가된 다른 많은 기능에 대한 자세한 내용은 [개발자 센터](https://developer.microsoft.com/windows/windows-10-for-developers) 또는 [개발자를 위한 Windows 10의 새로운 기능](../whats-new/windows-10-build-17134.md)에 있는 세부 정보 페이지를 방문하세요.
...
새로운 개발자와 일반 고객에 게 항상 코드를 작성 하는 개발자 (17763) Windows의 최신 빌드를 사용 하는 것이 좋습니다. 엔터프라이즈 앱을 작성하는 개발자는 이전 **최소 버전**을 지원하는 것을 고려해야 합니다.
...
## <a name="net-api-availability-in-uwp-versions"></a>UWP 버전에서.NET API 사용 가능성

UWP **대상 버전** 또는 프로젝트의 **최소 버전** 관계 없이 사용할 수 있는.NET Api의 제한 된 하위 집합을 지원 합니다. [사용할 수 있는 형식에 대해 자세한 정보를 제공](https://msdn.microsoft.com/library/windows/apps/xaml/mt185501(d=robot).aspx)합니다.

재사용 가능한 플랫폼 라이브러리를 만들려면 원하는 경우 표준.NET은 UWP에서 지원 됩니다. [표준.NET 설명서](https://docs.microsoft.com/dotnet/standard/net-standard) 는 표준.NET 지원 됩니다 UWP 버전에 설명 합니다.

데스크톱 응용 프로그램을 개발 하는 경우 참조 대신 [.NET Framework 버전 및 종속성](https://docs.microsoft.com/dotnet/framework/migration-guide/versions-and-dependencies) .NET framework 사용 가능성에 대 한 자세한 내용은.
