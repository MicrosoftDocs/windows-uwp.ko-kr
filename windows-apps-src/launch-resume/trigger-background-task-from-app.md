...
유의 **ApplicationTrigger.RequestAsync** 자체는 백그라운드 작업에서 또는 상태를 실행 하는 백그라운드에서 앱을 호출할 수 없습니다 ( [앱 수명 주기](app-lifecycle.md) 응용 프로그램 상태에 대 한 자세한 내용은 참조).
