...
| [사례 연구: Bookstore2](w8x-to-uwp-case-study-bookstore2.md) | [SemanticZoom](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.SemanticZoom) 컨트롤에 제공된 정보를 기반으로 하는 이 사례 연구입니다. 보기 모델에서 Author 클래스의 각 인스턴스는 해당 저자가 쓴 책의 그룹을 나타내며, SemanticZoom에서 저자가 그룹화한 책 목록을 보거나 저자의 점프 목록을 축소할 수 있습니다. |
...
**설명서**
* [Windows 런타임 참조](https://docs.microsoft.com/uwp/api/)
* [모든 Windows 장치에 대 한 유니버설 Windows 앱 빌드](https://go.microsoft.com/fwlink/p/?LinkID=397871)
* [앱을 위한 UX 디자인](https://docs.microsoft.com/previous-versions/windows/hh767284(v=win.10))
