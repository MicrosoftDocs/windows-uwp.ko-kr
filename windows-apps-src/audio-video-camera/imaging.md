...
-   [**CapturedFrame** ](https://msdn.microsoft.com/library/windows/apps/dn278725) 으로 카메라로 캡처한 프레임을 가져올 수 있습니다를 **SoftwareBitmap**합니다.

-   [**VideoFrame** ](https://msdn.microsoft.com/library/windows/apps/dn930917) 를 얻을 수 있도록를 **SoftwareBitmap** 표현한 것을 **VideoFrame**합니다.

-   [**FaceDetector** ](https://msdn.microsoft.com/library/windows/apps/dn974129) 사용 하면에서 얼굴을 감지 하는 **SoftwareBitmap**합니다.
