...
<table>
    ...
    <tr>
        ...
        <td>[Windows 개발자 센터](https://dev.windows.com)</td>
    </tr>
    <tr>
        <td>Windows 앱 개발</td>
        <td>[Windows 앱 개발](https://dev.windows.com/develop)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>게임용 Azure</td>
        <td>[Azure를 사용하여 게임 빌드 및 확장](https://azure.microsoft.com/solutions/gaming/)</td>
    </tr>
    <tr>
        <td>Xbox One의 UWP</td>
    ...
    <tr>
        <td>HoloLens의 UWP</td>
        <td>[HoloLens의 UWP 앱 빌드](https://developer.microsoft.com/windows/mixed-reality/development_overview)</td>
    </tr>
    <tr>
        <td>Xbox Live 설명서</td>
...
<table>
    ...
    <tr>
        ...
        <td>[Xbox One용 단독 개발자 프로그램](http://go.microsoft.com/fwlink/p/?LinkID=526271)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>[DirectX로 간단한 UWP 게임 만들기](tutorial--create-your-first-metro-style-directx-game.md)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[JavaScript 및 HTML5 터치 게임 샘플](https://code.msdn.microsoft.com/windowsapps/JavaScript-and-HTML5-touch-d96f6031)</td>
    </tr>      
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Windows 스토어 및 앱 포럼](https://social.msdn.microsoft.com/Forums/en-us/home?category=windowsapps)</td>
    </tr>
    <tr>
        <td>UWP 앱 개발자 포럼</td>
        <td>[유니버설 Windows 플랫폼 앱 개발](https://social.msdn.microsoft.com/Forums/en-us/home?forum=wpdevelop)</td>
    </tr>

    <tr>
        <td>데스크톱 응용 프로그램 개발자 포럼</td>
        <td>[Windows 데스크톱 응용 프로그램 포럼](https://social.msdn.microsoft.com/Forums/en-us/home?category=windowsdesktopdev)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>DirectX 포럼</td>
        <td>[DirectX 12 포럼](http://forums.directxtech.com/index.php)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Visual Studio 블로그](http://blogs.msdn.com/b/visualstudio/)</td>
    </tr>
    <tr>
        <td>Visual Studio 개발자 도구 블로그</td>
        <td>[개발자 도구 블로그](http://blogs.msdn.com/b/developer-tools/)</td>
    </tr>
    <tr>
        <td>Somasegar의 개발자 도구 블로그</td>
        <td>[Somasegar의 블로그](http://blogs.msdn.com/b/somasegar/)</td>
    </tr>
    <tr>
        <td>DirectX 개발자 블로그</td>
        <td>[DirectX 개발자 블로그](http://blogs.msdn.com/b/directx)</td>
    </tr>
    <tr>
        <td>DirectX 12 소개(블로그 게시물)</td>
        <td>[DirectX 12입니다.](http://blogs.msdn.com/b/directx/archive/2014/03/20/directx-12.aspx)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>[UWP 앱용 게임 기술](game-development-platform-guide.md)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>XAML 플랫폼 개요</td>
        <td>[XAML 플랫폼](https://msdn.microsoft.com/library/windows/apps/mt228259)</td>
    </tr>
    <tr>
        <td>XAML UI 및 컨트롤</td>
        <td>[컨트롤, 레이아웃 및 텍스트](https://msdn.microsoft.com/library/windows/apps/mt228348)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[HTML 및 DOM 참조](https://msdn.microsoft.com/library/windows/apps/br212882.aspx)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>C++/CX 참조 및 개요</td>
        <td>[Visual C++ 언어 참조(C++/CX)](https://msdn.microsoft.com/library/windows/apps/hh699871.aspx)</td>
    </tr>
    <tr>
        <td>Visual C++ 프로그래밍 가이드 및 참조</td>
        <td>[Visual Studio 2015의 Visual C++](https://msdn.microsoft.com/library/60k1461a.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[C# 언어 참조](https://msdn.microsoft.com/library/kx37x362.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[JavaScript 참조](https://msdn.microsoft.com/library/windows/apps/jj613794)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Direct3D 12란?](https://msdn.microsoft.com/library/windows/desktop/dn899228)</td>
    </tr>
    <tr>
        <td>Direct3D 11 개요</td>
        <td>[Direct3D 11 그래픽](https://msdn.microsoft.com/library/windows/desktop/ff476080)</td>
    </tr>
    <tr>
        <td>12에서 Direct3D 11 개요</td>
        <td>[12에서 Direct3D 11](https://msdn.microsoft.com/library/windows/desktop/dn913195)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[게임 개발 미들웨어가 무엇인가요? 필요한가요?](http://blogs.msdn.com/b/wsdevsol/archive/2014/05/02/game-development-middleware-what-is-it-do-i-need-it.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>UWP 브리지</td>
        <td>[Windows로 코드 가져오기](https://dev.windows.com/bridges/)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>Unity 게임 엔진</td>
        <td>[Unity - 게임 엔진](http://unity3d.com/)</td>
    </tr>
    <tr>
        <td>Unity 5 다운로드</td>
        <td>[Unity 다운로드](http://unity3d.com/get-unity)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Unity 게임을 UWP 앱으로 게시하는 방법](https://channel9.msdn.com/Blogs/One-Dev-Minute/How-to-publish-your-Unity-game-as-a-UWP-app)</td>
    </tr>
    <tr>
        <td>Unity로 Windows 게임 및 앱 만들기(동영상)</td>
        <td>[Unity로 Windows 게임 및 앱 만들기](https://channel9.msdn.com/Blogs/One-Dev-Minute/Making-games-and-apps-with-Unity)</td>
    </tr>
    <tr>
        <td>Visual Studio를 사용한 Unity 게임 개발(동영상 시리즈)</td>
        <td>[Visual Studio 2015에서 Unity 사용](http://go.microsoft.com/fwlink/?LinkId=722359)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Havok 도구 제품군</td>
        <td>[Havok 제품 개요](http://www.havok.com/products/)</td>
    </tr>
    <tr>
        <td>Havok 지원 포럼</td>
...
<table>
    ...
    <tr>
        <td>MonoGame</td>
        <td>[MonoGame 웹 사이트](http://www.monogame.net)</td>
    </tr>
    <tr>
        <td>MonoGame 설명서</td>
        <td>[MonoGame 설명서(최신)](http://www.monogame.net/documentation/)</td>
    </tr>
    <tr>
        <td>Monogame 다운로드</td>
        <td>MonoGame 웹 사이트에서 [릴리스, 개발 빌드 및 소스 코드를 다운로드](http://www.monogame.net/downloads/)하거나 [NuGet을 통해 최신 릴리스를 다운로드](https://www.nuget.org/profiles/MonoGame)합니다.
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Cocos2d-x</td>
        <td>[Cocos2d-X란?](http://www.cocos2d-x.org/)</td>
    </tr>
    <tr>
        <td>Cocos2d-x 프로그래머 가이드</td>
        <td>[Cocos2d-x 프로그래머 가이드 v3.8](http://www.cocos2d-x.org/programmersguide/)</td>
    </tr>
    <tr>
        <td>Windows 10의 Cocos2d-x(블로그 게시물)</td>
        <td>[Windows 10에서 Cocos2d-x 실행](https://blogs.windows.com/buildingapps/2015/06/15/running-cocos2d-x-on-windows-10/)</td>
    </tr>
    <tr>
        <td>Cocos2d-x Windows 스토어 게임(동영상)</td>
        <td>[Cocos2d-x로 Windows 장치용 게임 빌드](http://www.microsoftvirtualacademy.com/training-courses/build-a-game-with-cocos2d-x-for-windows-devices)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[iOS에서 UWP로 이동](https://msdn.microsoft.com/library/windows/apps/mt238320)</td>
    </tr>
    <tr>
        <td>Silverlight 앱을 유니버설 Windows 플랫폼 앱으로 포팅</td>
        <td>[Windows Phone Silverlight에서 UWP로 이동](https://msdn.microsoft.com/library/windows/apps/mt238323)</td>
    </tr>
    <tr>
        <td>XAML 또는 Silverlight에서 유니버설 Windows 플랫폼 앱으로 포팅(동영상)</td>
        <td>[앱을 XAML 또는 Silverlight에서 Windows 10으로 포팅](https://channel9.msdn.com/Events/Build/2015/3-741)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[DirectX 9에서 UWP(유니버설 Windows 플랫폼)로 포팅](porting-your-directx-9-game-to-windows-store.md)</td>
    </tr>
    <tr>
        <td>Direct3D 11에서 Direct3D 12로 포팅</td>
        <td>[Direct3D 11에서 Direct3D 12로 포팅](https://msdn.microsoft.com/library/windows/desktop/mt431709)</td>
    </tr>
    <tr>
        <td>OpenGL ES에서 Direct3D 11로 포팅</td>
        <td>[OpenGL ES 2.0에서 Direct3D 11로 포팅](port-from-opengl-es-2-0-to-directx-11-1.md)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[UWP(유니버설 Windows 플랫폼) 앱의 Windows API에 대한 대안](https://msdn.microsoft.com/library/windows/apps/hh464945)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[유니버설 Windows 플랫폼 앱이란?](https://msdn.microsoft.com/library/windows/apps/dn726767)</td>
    </tr>
    <tr>
        <td>UWP의 개요</td>
        <td>[UWP 앱 가이드](https://msdn.microsoft.com/library/windows/apps/dn894631)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>UWP 개발 시작</td>
        <td>[Windows 앱 시작](https://dev.windows.com/getstarted)</td>
    </tr>
    <tr>
        <td>UWP 개발 설정</td>
        <td>[설정 방법](https://msdn.microsoft.com/library/windows/apps/dn726766)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[네트워킹 및 웹 서비스](https://msdn.microsoft.com/library/windows/apps/mt280378)</td>
    </tr>
    <tr>
        <td>게임에서 Windows.Web.HTTP 및 Windows.Networking.Sockets 사용</td>
        <td>[게임의 네트워킹](work-with-networking-in-your-directx-game.md)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>앱 수명 주기 전환 처리</td>
        <td>[앱 수명 주기](https://msdn.microsoft.com/library/windows/apps/mt243287)</td>
    </tr>
    <tr>
        <td>Microsoft Visual Studio를 사용하여 앱 전환 트리거</td>
        <td>[Visual Studio에서 Windows 스토어 앱에 대한 일시 중단, 다시 시작 및 백그라운드 이벤트를 트리거하는 방법](https://msdn.microsoft.com/library/hh974425.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[UWP 앱 디자인](https://dev.windows.com/design)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>색 가이드</td>
        <td>[모범 사례: 색](https://assets.windowsphone.com/499cd2be-64ed-4b05-a4f5-cd0c9ad3f6a3/101_BestPractices_Color_InvariantCulture_Default.zip)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>입력 체계 가이드</td>
        <td>[모범 사례: 입력 체계](http://go.microsoft.com/fwlink/?LinkId=535007)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>타일 및 배지 개발</td>
        <td>[타일, 배지 및 알림](https://msdn.microsoft.com/library/windows/apps/mt185606)</td>
    </tr>
    <tr>
        <td>라이브 타일 및 알림을 보여 주는 샘플</td>
        <td>[알림 샘플](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/Notifications)</td>
    </tr>
    <tr>
        <td>적응형 타일 템플릿(블로그 게시물)</td>
        <td>[적응형 타일 템플릿 - 스키마 및 설명서](http://blogs.msdn.com/b/tiles_and_toasts/archive/2015/06/30/adaptive-tile-templates-schema-and-documentation.aspx)</td>
    </tr>
    <tr>
        <td>타일 및 배지 디자인</td>
...
<table>
    ...
    <tr>
        ...
        <td>[앱에서 바로 구매 제품 구매 사용](https://msdn.microsoft.com/library/windows/apps/mt219684)</td>
    </tr>
    <tr>
        <td>앱에서 바로 구매 소모성 제품</td>
        <td>[앱에서 바로 구매 소모성 제품 사용](https://msdn.microsoft.com/library/windows/apps/mt219683)</td>
    </tr>
    <tr>
        <td>앱에서 바로 구매 제품 세부 정보 및 제출</td>
        <td>[IAP 제출](https://msdn.microsoft.com/library/windows/apps/mt148551)</td>
    </tr>
    <tr>
        <td>게임에 대한 IAP 판매 및 인구 통계 모니터링</td>
        <td>[IAP 구입 보고서](https://msdn.microsoft.com/library/windows/apps/mt148538)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[WPA를 사용한 중요 경로 분석](https://channel9.msdn.com/Shows/Defrag-Tools/Defrag-Tools-156-Critical-Path-Analysis-with-Windows-Performance-Analyzer)</td>
    </tr>
    <tr>
        <td>Windows Performance Recorder를 사용하여 메모리 사용량 및 누수 진단(비디오)</td>
        <td>[메모리 공간 및 누수](https://channel9.msdn.com/Shows/Defrag-Tools/Defrag-Tools-154-Memory-Footprint-and-Leaks)</td>
    </tr>
    <tr>
        <td>ProcDump 가져오기</td>
    ...
    <tr>
        ...
        <td>[덤프 파일 생성을 위한 ProcDump 구성](https://channel9.msdn.com/Shows/Defrag-Tools/Defrag-Tools-131-Windows-10-SDK)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[글로벌 고객을 대상으로 개발 시 지침](https://msdn.microsoft.com/library/windows/apps/xaml/mt186453.aspx)</td>
    </tr>
    <tr>
        <td>언어, 문화 및 기술 브리징</td>
        <td>[언어 규칙 및 표준 Microsoft 용어에 대한 온라인 리소스](http://www.microsoft.com/Language/Default.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[앱 개발자 계약](https://msdn.microsoft.com/library/windows/apps/hh694058)</td>
    </tr>
    <tr>
        <td>Windows 스토어에 앱을 게시하기 위한 정책</td>
        <td>[Windows 스토어 정책](https://msdn.microsoft.com/library/windows/apps/dn764944)</td>
    </tr>
    <tr>
        <td>몇 가지 일반적인 앱 인증 문제를 방지하는 방법</td>
        <td>[일반적인 인증 실패 방지](https://msdn.microsoft.com/library/windows/apps/jj657968)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>고객 리뷰에 응답</td>
        <td>[고객 리뷰에 응답](https://msdn.microsoft.com/library/windows/apps/mt148546)</td>
    </tr>
    <tr>
        <td>게임 홍보 방법</td>
        <td>[앱 홍보](https://dev.windows.com/store-promotion)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[패키지 버전 번호](https://msdn.microsoft.com/library/windows/apps/mt188602)</td>
    </tr>
    <tr>
        <td>게임 패키지 관리 지침</td>
        <td>[앱 패키지 관리 지침](https://msdn.microsoft.com/library/windows/apps/mt188602)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Windows 10용 Xbox Live로 개발](http://channel9.msdn.com/Events/GDC/GDC-2015/Developing-with-Xbox-Live-for-Windows-10)</td>
    </tr>
    <tr>
        <td>플랫폼 간 매치 메이킹(동영상)</td>
        <td>[Xbox Live 멀티플레이어: 플랫폼 간 매치 메이킹 및 게임 플레이용 서비스 소개](http://channel9.msdn.com/Events/GDC/GDC-2015/Xbox-Live-Multiplayer-Introducing-services-for-cross-platform-matchmaking-and-gameplay)</td>
    </tr>
    <tr>
        <td>Fable Legends의 장치 간 게임 플레이(동영상)</td>
        <td>[Fable Legends: Xbox Live로 장치 간 게임 플레이](http://channel9.msdn.com/Events/GDC/GDC-2015/Fable-Legends-Cross-device-Gameplay-with-Xbox-Live)</td>
    </tr>
    <tr>
