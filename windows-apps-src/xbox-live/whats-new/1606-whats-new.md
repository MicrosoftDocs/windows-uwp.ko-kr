...
ms.locfileid: "4746724"
---
# <a name="whats-new-for-the-xbox-live-sdk---june-2016"></a>새로운 기능에 대 한 Xbox Live SDK-6 월 2016

추가 된 항목에 대 한 [새로운 기능-2016 년 4 월](1604-whats-new.md) 문서를 참조 하십시오 2016 년 4 월 릴리스에 합니다.

> **참고:** (XDK (Xbox 개발자 키트)를 사용 하는 경우 *새로운 기능-2016 년 4 월* 문서 3 월 XDK 릴리스 이후 추가 된 새 기능을 설명 합니다.
...
추가한 다음 새 클래스는 `contextual_search` 게임 클립을 검색 하는 API:
...
이 비활성화할 수 호출 하 여 어설션 `disable_asserts_for_maximum_number_of_websockets_activated()`.
