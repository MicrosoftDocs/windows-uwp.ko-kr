...
게임 채팅 2에서 앱을 검색 하는 버퍼의 오디오 형식을 사용 하 여 검사할 수 있습니다 `pre_encode_audio_stream::get_pre_processed_format()`. 사전 처리 된 오디오 형식은 항상 모노 됩니다. 앱 되는 32 비트 부동 소수점, 16 비트 정수 및 32 비트 정수도 표현 되는 데이터를 처리 합니다.
