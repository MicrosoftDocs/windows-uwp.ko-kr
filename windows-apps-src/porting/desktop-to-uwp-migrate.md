...
자세한 내용은 [코드에서 MSIX 패키지 빌드](/windows/msix/desktop/desktop-to-uwp-root) 및 [패키지 Id가 필요한 기능](/windows/apps/desktop/modernize/modernize-packaged-apps)을 참조 하세요.
