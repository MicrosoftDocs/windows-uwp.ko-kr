...
CreateWindowSizeDependentResources 메서드는 창 크기, 방향, 스테레오 활성화 렌더링, 또는 해상도 변경 시마다 호출됩니다. 샘플 게임에서 __ConstantBufferChangeOnResize__에서 투영 행렬을 업데이트 됩니다.
