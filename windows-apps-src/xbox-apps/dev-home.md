...
description: Xbox One 용 개발자 홈 앱에 대 한 정보를 제공합니다.
ms.date: 08/09/2017
ms.topic: article
...
ms.locfileid: "8194739"
---
# <a name="developer-home-on-the-console-dev-home"></a>(개발자 홈) 콘솔의 개발자 홈
   
  
개발자 홈은 개발자의 생산성을 지원 하도록 설계 된 Xbox One 개발 키트의 도구 환경입니다. 개발자 홈 캡처하고 추적 관리 및 개발 키트를 구성, 사용자 관리, 설치 된 제목 시작 및 수행 하는 기능을 제공 합니다. 여러분의 의견에 따라 추가 기능을 사용 하도록 및 확장성 및 고유한 도구 추가 기능을 확장 하려면 동안 계속 릴리스 이후   
...
개발자 홈 멀티 플레이어, 네트워킹 등의 일부 기존 및 향후 도구 테스트 하는 동안에 도구에 쉽게 액세스할 수를 가질 수 있도록 제목을 실행 하는 동안 측면에 스냅 사용 하도록 설계 되었습니다.   
   
  
끌기 모드에 액세스 하려면 제목의 적절 한 도구를 강조 표시, 컨트롤러, **보기** 단추를 눌러 하 고 상황에 맞는 메뉴에서 **맞춤** 을 선택 합니다.  
...
개발자 홈은 사용자 지정 가능하고 개인적으로 설계되었습니다. 앱에 맞게 워크플로 구성 하 고 작업 영역으로 저장 하는 수 있습니다. 이 작업 영역 내보내고 필요한 레이아웃으로 다른 콘솔에 복사할 수를 가져온 수 있습니다. 이러한 옵션은 **작업 영역**에서 주 메뉴에 있습니다. 내보낸된 파일에서 임시 시스템 드라이브에 있을 합니다 `Dev Home\Workspaces` 디렉터리입니다.   
...
패키지에 여러 응용 프로그램에 포함 된 기본 응용 프로그램 실행 되도록 설정할 수 개발자 홈 하면 있습니다. 시작 관리자의 패키지를 강조 표시 하 고 **A** 단추를 사용할 수 있는 응용 프로그램 목록을 엽니다. 기본값으로 설정 하 고 **보기** 단추를 선택한 다음 상황에 맞는 메뉴에서 **기본으로 설정** 를 선택 하 고 싶은 하나를 선택 합니다.   
...
이러한 저장 된 자격 증명 관리 (추가 하는 추가) 주 메뉴의 **네트워크 자격 증명 관리** 옵션을 통해 콘솔에서 합니다.   
