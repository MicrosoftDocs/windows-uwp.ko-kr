...
| 매개 변수     | 유형   | 설명     | 필수 |
|---------------|--------|-----------------|----------|
| applicationId   | 문자열    | 광고 성과 데이터를 검색할 앱의 스토어 ID입니다. 스토어 ID는 개발자 센터 대시보드의 [앱 ID 페이지](../publish/view-app-identity-details.md)에서 사용할 수 있습니다. 예를 들어 스토어 ID는 9NBLGGH4R315입니다. |    아니요      |
