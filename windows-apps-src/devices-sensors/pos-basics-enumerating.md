...
<br/>
장치 선택기 UI를 표시 하 고 사용자가 연결 된 장치를 선택 합니다. 이 메서드는 장치를 연결 하 고 제거 때 목록 업데이트를 처리 하 고 더 간단 하 고 다른 방법 보다 안전 하 게.
...
> [!CAUTION]
> **GetDefaultAsync** 다음 세션 간에 다른 장치를 반환할 수 있습니다 그대로 주의 해 서 사용 해야 합니다. 많은 이벤트가 이 열거에 영향을 주어 다음을 포함하여 첫 번째 사용할 수 있는 장치를 변경할 수 있습니다. 
> - 컴퓨터에 연결된 카메라 변경 
