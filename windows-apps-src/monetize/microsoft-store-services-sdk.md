...
ms.locfileid: "5984912"
---
# <a name="engage-customers-with-the-microsoft-store-services-sdk"></a>Microsoft Store Services SDK를 사용하여 고객과 소통

Microsoft Store Services SDK에 도움이 되는 기능, 앱에 대상된 알림 보내기는 실행 등 유니버설 Windows 플랫폼 (UWP) 앱에서 고객과 소통 제공 / B 실험 앱. 이 SDK는 Visual Studio 2015 이상에 대한 확장입니다.
