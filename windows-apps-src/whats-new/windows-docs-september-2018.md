...
[The Windows Machine Learning 문서](https://docs.microsoft.com/windows/ai/) 는 이제 자신의 사이트에 상주 하 고 최신 Windows 참가자 SDK에 대 한 업데이트 됩니다. 데스크톱 및 c + +와 C#의 데 도움이 되는 UWP 자습서 WinML 응용 프로그램에 추가 시작 있습니다.
...
[The Windows 컴퓨터 학습 GitHub 리포지토리](https://github.com/Microsoft/Windows-Machine-Learning) 최신 SDK와 함께 작동 하는 새 샘플으로 업데이트 되었습니다.
...
하나는 작성자 esteemed Mike Jacobs 비전 사진 앱 및 게임 디자인에서 흐림 효과 대 한 미디어에 대 한 문서를 시작 했습니다. 이 어디에서 나 시각 효과 대해 자세히 알고 싶으면 [비전과 사진에 첫 번째 문서](https://medium.com/microsoft-design/science-in-the-system-how-blur-effects-work-8b0590996e09) 를 확인 하 고 [앤티앨리어싱을 그래픽에서 두 번째.](https://medium.com/microsoft-design/science-in-the-system-how-blur-effects-work-part-2-c5589a738515)
