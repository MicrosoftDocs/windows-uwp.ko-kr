...
description: Microsoft Store 제출 API에서 이 메서드를 사용하여 Windows 개발자 센터 계정에 등록된 앱의 추가 기능을 삭제합니다.
title: 추가 기능 삭제
ms.author: mhopkins
ms.date: 02/08/2017
ms.topic: article
...
ms.locfileid: "4619220"
---
# <a name="delete-an-add-on"></a>추가 기능 삭제

Microsoft Store 제출 API에서 이 메서드를 사용하여 Windows 개발자 센터 계정에 등록된 앱의 추가 기능(앱에서 바로 구매 제품 또는 IAP라고도 함)을 삭제합니다.
...
| 이름        | 유형   | 설명                                                                 |
|---------------|--------|-----------------------------------------------------------------------------|
| id | string | 필수. 삭제할 추가 기능의 스토어 ID입니다. 스토어 ID는 개발자 센터 대시보드에서 사용할 수 있습니다.  |
...
| 409  | 지정된 추가 기능을 찾았지만 현재 상태에서 삭제할 수 없거나 추가 기능이 [현재 Microsoft Store 제출 API에서 지원되지 않는](create-and-manage-submissions-using-windows-store-services.md#not_supported) 개발자 센터 대시보드 기능을 사용합니다. |   
