...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>앱에서 바로 구매 테스트.</strong> <br><br>스토어에 앱을 추가하지 않고 앱에서 바로 구매 코드를 테스트할 수 있습니다.</td>
