...
description: Microsoft Store analytics API에서이 메서드를 사용 하 여 지정 된 날짜 범위 및 기타 선택적 필터에 대 한 일별 앱 사용 데이터를 가져올 수 있습니다.
...
다음 예제에서는 일별 앱 사용 데이터를 가져오는 요청을 보여 줍니다. *ApplicationId* 값을 앱의 스토어 ID로 바꿉니다.
...
| dailySessionCount         | long    | 해당 일의 사용자 세션 수입니다.                                  |
...
| dailyActiveUsers          | long    | 하루에 앱을 사용 하는 고객 수입니다.                           |
| dailyActiveDevices        | long    | 모든 사용자가 앱과 상호 작용 하는 데 사용 되는 매일의 장치 수입니다.  |
| dailyNewUsers             | long    | 하루에 처음으로 앱을 사용한 고객 수입니다.    |
...
* [월간 앱 ussage 가져오기](get-app-usage-monthly.md)
