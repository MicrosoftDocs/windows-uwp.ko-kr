...
기술 측면에서 Xbox Live의 컬렉션인 REST 끝점 및 액세스할 수 있는 보안 websocket을 사용 하 여 매치 메이 킹 및 프로필, 친구 및 상태, 통계, 순위표, 도전 과제, 멀티 플레이어와 같은 Xbox Live 기능을 노출 하는 마이크로 서비스 게임 개발자를 위한 클라이언트 쪽 Api의 집합입니다.
