...
다운로드할 수도 있습니다 보고서 또는 특정 앱, 모든 앱에 대 한 확장 하 여 **분석** 의 왼쪽된 탐색 메뉴에서 [파트너 센터](https://partner.microsoft.com/dashboard)를 선택한 다음 **보고서다운로드**. **앱 선택** 드롭다운 목록에서 **모든 앱** 또는 특정 앱을 선택합니다. 다운로드 하려는 보고서를 선택한 다음, 원하는 집계 수준과 날짜 범위를 선택합니다. **보고서 다운로드** 버튼을 클릭하여 다운로드가 가능한 .tsv 파일을 생성하면 Microsoft Excel 또는 탭으로 구분된 값(TSV) 파일을 지원하는 다른 프로그램에서 이 파일을 열 수 있습니다.
