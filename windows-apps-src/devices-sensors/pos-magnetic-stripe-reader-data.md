...
ms.locfileid: "5992292"
---
# <a name="obtain-and-understand-magnetic-stripe-data"></a>자기 띠 데이터 가져오기 및 이해

에 자기 띠 판독기 [서비스 지점 시작](pos-basics.md)에 설명 된 단계를 사용 하 여 응용 프로그램에서 설정한 후 여기에서 데이터를 가져오려는 시작할 준비가 되었습니다.
...
**AamvaCardDataReceived** 및 **BankCardDataReceived** 이벤트 *args* 개체에서 직접 데이터의 일부 얻을 수 있습니다. 다음 예제에서는 몇 가지 속성 가져오기 멤버 변수를 할당 하 고 보여 줍니다.
