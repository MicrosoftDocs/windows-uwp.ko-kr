...
**열거형**  
열거형은 일부 게임에서 차원의 목록. 이러한 게임에서 크기에는 무기, 문자 클래스, 지도, 및 등이 있습니다. 모든 가능한 문자 클래스 또는 지도, 목록 게임에서 가능한 무기의 목록을 보려면 등에 하려고 합니다.

**로캘 문자열 쌍**  
모든 가능한 다양 한 상태 문자열 지역을 문자열 사용 수/해야 지정 되도록와 관련 된 로캘이 있어야 합니다. 각 열거형도 로캘 문자열 쌍도 집합이 있습니다.
