...
Xbox Live 서비스 및 일반적인 의미의 의해 반환 된 상태 코드의 목록은 다음과 같습니다.
...
| 200| 확인| 요청이 성공 했습니다.| 
| 201| 생성| 엔터티를 만들었습니다.| 
| 202| Accepted| 요청을 수락 하지만 아직 완료 되지 않았습니다.| 
...
> [!NOTE] 
> 일부 리소스 및 메서드는 해당 리소스 또는 메서드의 컨텍스트 내에서 특정 상태 코드의 의미에 대 한 특정 정보를 제공합니다. 자세한 정보를 사용 하는 리소스에 대 한 설명서를 참조 하세요. 
