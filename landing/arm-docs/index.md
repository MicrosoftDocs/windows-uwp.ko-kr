---
layout: LandingPage
description: 이 페이지는 ARM64 win32 및 UWP 앱 개발 시작에 대 한 정보를 제공 합니다.
...
ms.locfileid: "8340107"
---
# <a name="windows-10-on-arm"></a>ARM 기반 Windows 10
Windows 10 ARM 프로세서로 구동 되는 Pc에서 실행 됩니다. 이 페이지는 앱 개발을 시작 하 고 플랫폼에 대 한 자세한 정보를 제공 합니다. 또한 좋습니다 페이지의 맨 아래에 링크를 사용 하 여 피드백을 제공할 수 있습니다.
...
<ul class="cols cols3">
    ...
    <li>
        ...
        <h3>개발자를 위한 arm 빌드 2018 Windows 10</h3><p>알아봅니다 Windows 10에 ARM 장치 어떻게 매직의 x86 에뮬레이션 작동 하는 방법과 마지막 제출 하 고 ARM에서 Windows 10 용 앱 빌드 합니다. 데스크톱과 UWP에 대 한 ARM64 앱을 빌드하는 방법을 보여 줄 것입니다.</p>
    </li>
    <li>
...
기존 고객의 의견을 활용 하 여 제품을 지속적으로 향상는 것입니다. 이해, 문제가에서 멈춤 또는 어떻게 제대로 공유 하려는 경우 환경에는 이러한 링크는 데 도움이 됩니다.
