...
| [out of process 백그라운드 작업을 In-process 백그라운드 작업으로 포팅](convert-out-of-process-background-task.md) | Out of process 백그라운드 작업을 포그라운드 앱과 동일한 프로세스에서 실행 되는 in-process 백그라운드 작업으로 포팅 하는 방법을 알아봅니다.|
