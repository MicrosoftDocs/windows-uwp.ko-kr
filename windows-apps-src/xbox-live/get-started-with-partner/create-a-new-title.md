...
3. Unity 또는 사용자 지정 게임 엔진을 사용 하 여 Visual Studio를 사용 하는 있습니다.
4. 개발 컴퓨터에 Windows 10을 실행 중입니다.

해당 위의 않는 경우,이 문서의 나머지 부분에서는 Windows 개발자 센터, 새 프로젝트를 만든 및 Xbox Live 로그인 코드 작성 되어 테스트 된 구성 타이틀을 얻는 데 필요한 모든 안내 합니다.
...
모든 Xbox Live 기능 작업을 필수로 [Windows 개발자 센터](http://dev.windows.com) 에서 생성 하는 Xbox Live가 지원 제목이 필요 합니다.
...
그런 다음 앱에 대 한 *앱 개요* 페이지로 이동 됩니다.  여기서 있습니다 됩니다 구성할 Xbox Live 기본 페이지 중인 서비스 아래 표시 된 Xbox Live 메뉴-> 합니다.
