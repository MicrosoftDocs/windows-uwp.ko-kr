...
description: NuGet을 사용 하 여 Xbox Live Api 이진 패키지 UWP 프로젝트를 추가 하는 방법을 알아봅니다.
...
3. **[Visual Studio](https://www.visualstudio.com/)** 합니다. Visual Studio 2015 업데이트 3 이상에 UWP 앱을 빌드할 수 있습니다. 개발자 및 보안 업데이트에 대 한 Visual Studio의 최신 릴리스를 사용 하는 것이 좋습니다.
