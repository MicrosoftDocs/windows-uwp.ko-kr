---
author: anbare
Description: "UWP 앱의 보조 타일을 고정하는 방법을 알아보세요."
title: "보조 타일 고정"
...
보조 타일에 대한 자세한 내용은 [보조 타일 개요](tiles-and-notifications-secondary-tiles.md)를 참조하세요.
...
> [!IMPORTANT]
> 데스크톱 브리지를 사용하는 Windows 데스크톱 응용 프로그램인 경우 가장 먼저 [데스크톱 응용 프로그램에서 고정](tiles-and-notifications-secondary-tiles-desktop-pinning.md)에 설명된 대로 추가 단계를 수행해야 합니다.
...
타일 알림을 통해 타일에 다양한 콘텐츠를 표시하는 방법을 알아보려면 [로컬 타일 알림 보내기](tiles-and-notifications-sending-a-local-tile-notification.md)를 참조하세요.


## <a name="related"></a>관련 항목

* [보조 타일 개요](tiles-and-notifications-secondary-tiles.md)
* [보조 타일 지침](tiles-and-notifications-secondary-tiles-guidance.md)
