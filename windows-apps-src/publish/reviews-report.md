...
- **리뷰 내용**: 기본적 **으로 평가**검토 콘텐츠로 평점을 표시 됨을 의미 하는 됩니다. **모든** 모든 평가 표시를 리뷰 텍스트를 포함 하지 않는 비롯 선택할 수 있습니다. 참고 **평점 분석** 차트 선택에 관계 없이 모든 리뷰를 항상 표시 됩니다.
...
이 차트는 [평점 보고서](ratings-report.md)와 앱의 등급에 대 한 자세한 내용에서은에서 볼 수도 있습니다.
