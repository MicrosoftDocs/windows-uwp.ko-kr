---
description: ListView 컨트롤과 함께 사용할 수 있는 항목 템플릿을 가져와 단일, 이중, 삼중, 표 형식 목록 항목을 표시합니다.
title: 목록 보기의 항목 템플릿
template: detail.hbs
ms.date: 11/03/2017
ms.topic: article
...
ms.locfileid: "89172677"
---
# <a name="item-templates-for-list-view"></a>목록 보기의 항목 템플릿

이 섹션에는 [**ListView**](/uwp/api/Windows.UI.Xaml.Controls.ListView) 컨트롤로 사용할 수 있는 항목 템플릿이 포함되어 있습니다. 이 템플릿을 사용하여 일반적인 앱 유형의 모양을 확인합니다. 
