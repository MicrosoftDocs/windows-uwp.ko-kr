...
ms.locfileid: "4502219"
---
# <a name="updated-flows-for-multiplayer-game-invites"></a>멀티 플레이 게임 초대를 위한 업데이트 된 흐름

Xbox One 베타 피드백으로 인해 사용자 환경을 흐름 멀티 플레이 게임 초대에 대 한 변경 되었습니다 Xbox One 복구 업데이트 24 2013 년 11 월 6에 릴리스된 기준. **사용자 환경 (UX)만** 변경 이며 게임 타이틀의 관점에서 기능 이나 동작에 영향을 주지 않습니다. 제목 개발자는 모든 코드를 변경할 필요가 없습니다.
...
-   새로운 알림은 보낸 사람의 있는 "게임에 \ [*번호*\] 친구 추가" 라고 표시 되는 추가 되었습니다. 따라서 지울 때 사용자의 상대와 연결 된 게임 세션 아웃 초대 보내진 있습니다.

자세한 사용자 환경을 흐름은 다음 예제에 설명 되어 있습니다. 각 테이블 David 및 숙 사용자에 대 한 예제 흐름을 보여 줍니다. 이러한 흐름 각 열에 표시 되 고 동시에 발생 합니다. <b style="background-color: #FFFF00">강조 표시 된 텍스트</b> 이전 UX 흐름에서 변경 된 조정 보여 줍니다.
...
숙 다른 게임을 재생 합니다.
  ...
  <tr>
    <td></td>
    <td>
알림 메시지에서 David, <b style="background-color: #FFFF00">게임 이름 및 아이콘을 표시</b>하 고 초대를 나타내는 팝업 됩니다. (타사 앱은 하지 자동-끌기.) <p><br>
...
게임 시작 하 고 타사 앱 스냅 되지 않습니다.
  ...
  <tr>
    <td></td>
    <td>알림은 보유할에 대 한 게임을를 찾을 수를 나타내는 팝업 됩니다.
    <p><br>
알림 센터에서 숙 선택할 수 있습니다. <ul>
    <li>   <b>게임 초대를 수락:</b> 게임을 시작 합니다.
    <li>   <b>게임 초대 거절:</b> 게임이 실행합니다. 숙은 보유할에서 여전히 이며 후속 게임 초대를 받게 됩니다.         
    <li>   <b style="background-color: #FFFF00">타사 유지: 게임 실행 수 없습니다. 숙은 보유할에서 제거 됩니다.</b>
    </ul>
    </td>
  </tr>
</table>

## <a name="in-game-invite-flow-in-a-party-and-switching-titles"></a>게임 초대 흐름:는 타사 및 제목 전환
...
David 다른 게임으로 전환 하 고 멀티 플레이 메뉴로 이동 합니다.
     <p><br>
Xbox 시스템 UI 그 자신의 타사 새로운 전환 하려는 경우 게임에는 그 응답할 수 <b>예</b> 또는 <b>아니요</b>David 요청 합니다.
    </td>
...
알림 센터에서 숙 선택할 수 있습니다. <ul>
     ...
     <li><b style="background-color: #FFFF00"><b>파티 유지:</b> 게임 시작 및 숙 없음 보유할에서 제거 됩니다.</b>
     </ul>
     </td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td>
David가 <b>홈</b>, 검색 및 숙 온라인 상태 인지 느껴질 그 <b>친구</b> 목록에 있습니다.
    <p><br>
...
알림은 David 숙 자신의 자에 초대를 나타내는 팝업 됩니다.
    <p><br>
알림 센터에서 숙은 <b>초대를 수락</b>합니다.
    <p><br>
숙 수락 하면 타사 앱이 맞춥니다.                                                                         </td>
  </tr>
  <tr>
    <td>
알림 숙 보유할에 연결 하 고 있는지를 나타내는 팝업 됩니다.
    <p><br>
David 및 숙 재생 하려는 게임에 설명 합니다. David 게임을 시작 하 고 멀티 플레이 게임 모드를 시작 합니다.
    <p><br>
게임, 친구 또는 자동 끌어오기를 초대 하는 옵션이 파티 구성원 제공 하거나 합니다.
    <p><br>
    <b style="background-color: #FFFF00">게임 초대 전송 되었음을 나타내는 알림을 표시 합니다.</b>
    </td>
    <td>
알림 자는 게임에서 발견 했음을 나타내는 팝업 됩니다.
    <p><br>
알림 센터에 다음과 같은 숙 수 있습니다. <ul>
    <li>   <b>게임 초대를 수락:</b> 게임 시작 <li>   <b>게임 초대 거절:</b> 게임 실행 수 없음, 숙은 파티에서 여전히 이며 후속 초대를 받게 됩니다.
    <li>   <b style="background-color: #FFFF00">타사 유지: 게임이 시작 숙 보유할에서 제거 됩니다.</b>
    </ul>  
    </td>
  </tr>
</table>
...
**게임 초대 전송** 알림 게임 세션이 원격 대상 멤버를 사용 하 여 설정 된 처음으로 표시 됩니다. 원격 대상 구성원에 게 전송 하는 후속 요청이이 알림을 생성 되지 않습니다. 이렇게 하면 사용자가 제목 **PullReservedPlayersAsync**를 여러 번 호출에서 반복 해 서 **게임 초대 전송** 토스트와 스팸 화 되 수 없습니다.

**참고** 친구 보류,으로 원하는 추가 하 고 **PullReservedPlayersAsync** 를 한 번만 호출 하는 것이 좋습니다.
