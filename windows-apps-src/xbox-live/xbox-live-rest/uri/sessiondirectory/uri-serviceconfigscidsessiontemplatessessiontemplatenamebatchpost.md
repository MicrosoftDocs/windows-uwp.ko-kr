...
이 HTTP/REST 메서드 Xbox 사용자 세션 템플릿 수준에서 Id가 여러 일괄 처리 쿼리를 만듭니다. 이 메서드는로 래핑할 수 있습니다 **Microsoft.Xbox.Services.Multiplayer.MultiplayerService.GetSessionsForUsersFilterAsync**합니다.
