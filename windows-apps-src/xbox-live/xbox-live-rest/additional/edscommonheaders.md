...
| <b>xbl 클라이언트 유형 x</b>| 클라이언트 유형 헤더| 예| 고유한 클라이언트 형식을 가져올 팀에 게 말하십시오.|
...
| <b>xbl 부모 ig x</b>| "Chained" 호출에 대 한 이전 인상을 Guid| 아니요 (이지만 권장)| BI 관련성에 대 한 중요 합니다. 예를 들어 찾아보기 호출의 IG는 호출 세부 정보는 다음에 대 한 부모 IG 합니다.|
