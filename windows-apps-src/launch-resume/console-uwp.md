...
**Program.cpp** 의 다음 예제에서 추가 되는 **콘솔 앱 C + WinRT** 서식 파일:
...
- UWP 콘솔 앱은 창을 만들 수 없습니다. 사용자 동의 프롬프트 같은 만드는 messagebox (), 또는 Location(), 어떤 이유로 든 창을 만들 수 있는 다른 API를 사용할 수 없습니다.
