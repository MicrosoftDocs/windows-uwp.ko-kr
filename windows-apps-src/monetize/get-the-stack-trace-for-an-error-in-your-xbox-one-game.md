...
이 메서드를 사용 하려면 먼저 스택 추적을 검색 하려는 오류와 연결 된 CAB 파일의 ID를 검색할 [Xbox One 게임에서 오류에 대 한 세부 정보 가져오기](get-details-for-an-error-in-your-xbox-one-game.md) 메서드를 먼저 사용 해야 합니다.
