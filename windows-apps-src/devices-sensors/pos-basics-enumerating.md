...
<br/>
장치 선택기 UI를 표시 하 고 사용자 연결된 된 장치를 선택 합니다. 이 메서드는 장치를 연결 하 고 제거 때 목록 업데이트를 처리 하 고 더 간단 하 고 다른 방법 보다 안전 하 게 합니다.
...
다음 코드 조각은 **DevicePicker**를 만들고, 사용자 선택을 장치에 바코드 스캐너 필터를를 추가 하는 장치 ID에 따라 **BarcodeScanner** 개체를 만듭니다.
