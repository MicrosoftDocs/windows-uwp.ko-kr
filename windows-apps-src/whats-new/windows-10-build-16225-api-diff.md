...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16225"></a>Windows 10 SDK Preview 빌드 16225의 새로운 API

새로운 API 네임스페이스와 업데이트된 API 네임스페이스는 Windows 10 SDK Preview 빌드 16225의 [Windows 참가자](https://insider.windows.com/)에서 사용할 수 있습니다.

다음은 마지막 공개 Windows 10 릴리스인 [버전 1703](windows-10-version-1703-api-diff.md) 이후에 추가되거나 수정된 네임스페이스에 대해 게시된 시험판 설명서의 전체 목록입니다. **시험판 설명서는 완전하지 않거나 변경될 수 있으며, 후속 빌드에서 이름이 바뀌거나 제거될 수 있습니다.**
