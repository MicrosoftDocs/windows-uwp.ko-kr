...
description: Windows 10 디바이스 개발에 대한 다양한 접근 방식이 있습니다.
키워드: 시작
키워드: 개발자 라이선스
키워드: Visual Studio, 개발자 라이선스
키워드: 디바이스 사용
---
# 장치를 개발에 사용하도록 설정
...
이후에도 이 장치에서 계속 개발하려면 이 항목에 설명된 대로 장치를 개발용으로 설정해야 합니다. 그러지 않으면 앱을 디버그하거나 앱의 패키지를 만들려고 할 때 오류가 발생할 수 있습니다. 다음은 이러한 오류의 예입니다.
