...
| 매개 변수        | 형식   |  설명      |  필수  
|---------------|--------|---------------|------|
| applicationId | string | Xbox Live 게임 허브 데이터를 검색하려는 게임의 [Store ID](in-app-purchases-and-trials.md#store-ids)입니다.  |  예  |
| metricType | string | 검색할 Xbox Live 분석 데이터의 유형을 지정하는 문자열입니다. 이 메서드의 경우 값 **communitymanagergamehub**를 지정합니다.  |  예  |
...
| 값               | 형식   | 설명                           |
|---------------------|--------|-------------------------------------------|
| date                | string | 이 개체의 게임 허브 데이터에 대한 날짜입니다. |
| applicationId       | string | 게임 허브 데이터를 검색할 게임의 Store ID입니다.     |
| gameHubLikeCount     | number |   지정된 날짜에 게임 허브 페이지에 추가된 좋아요 수입니다.   |
| gameHubCommentCount          | number |  지정된 날짜에 앱의 게임 허브 페이지에 댓글 수입니다.  |
| gameHubShareCount           | number | 지정된 날짜에 고객이 앱의 게임 허브 페이지를 공유한 횟수입니다.   |
| gameHubFollowerCount          | number | 앱의 게임 허브 페이지에 대한 최고 기록 팔로워 수입니다.   |
