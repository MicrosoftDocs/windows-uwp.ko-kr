...
않았다면 아직, 단계는 상당한 성능 개선에서 결과 대상 Windows 10 앱을 이식 하 고 방금 살펴보았습니다. 몇 가지 XAML 최적화 (예를 들어 [{X:bind}](https://msdn.microsoft.com/library/windows/apps/Mt204783))만 Windows 10 앱에 제공 됩니다. 참조 [Windows 10 앱을 포팅](https://msdn.microsoft.com/library/windows/apps/Mt238321) //build/ 세션과 [유니버설 Windows 플랫폼으로 이동 하려면](https://channel9.msdn.com/Events/Build/2015/3-741)합니다.
