...
> [!NOTE]
> 검토 해야 합니다 [Microsoft Store 정책](store-policies.md) 앱 모두 여기에 나열 된 요구 사항을 충족 하도록 합니다.
