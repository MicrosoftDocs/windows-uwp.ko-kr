...
이 소개에서는 앱 설정을 로컬로 저장 및 로드하고 디바이스 간에 복합 글꼴/글꼴 크기 설정을 로밍하는 단순한 두 가지 시나리오에 중점을 둡니다.
...
| 코드 샘플 | 설명 |
|-----------------|---------------|
| [애플리케이션 데이터 샘플](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/ApplicationData) | 설정의 시나리오 2-4 포커스 |