...
| **사용자 계정 정보**\* | **userAccountInformation** 접근 권한 값을 통해 앱은 사용자의 이름 및 사진에 액세스할 수 있습니다.<br /><br />[
