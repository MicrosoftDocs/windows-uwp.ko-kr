...
한 번 만든 타이틀이 있고 작업의 기본 사항,이 섹션에서는 필요한 백그라운드에서 이동 하 고 코딩을 시작 하기 전에 합니다.

| 항목                                                                                                                                             | 설명                                                                                                   |
|:--------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------|
| [Xbox Live를 사용 하 여](using-xbox-live/using-xbox-live.md) | 후 설치 프로그램 제목 Xbox Live SDK 통합, 준비가 구현에 로그인 하 고 Xbox Live 프로그래밍에 자세히 알아보세요.
...
| 항목                                                                                                                                             | 설명                                                                                                   |
|:--------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------|
| [Xbox Live 소셜 플랫폼](social-platform/social-platform.md) | 사용자 로그인 할 수는 사용자를 다음 시작할 수 있습니다 Xbox Live의 소셜 기능을 사용 하는 사용자의 소셜 그래프, 다양 한 상태 등을 활용 하는 등. |
...
멀티 플레이어는 타이틀의 수명을 연장 하 고 게임 플레이 환경을 최신 상태로 유지 하는 훌륭한 방법입니다.  Xbox Live 멀티 플레이어 및 매치 메이 킹 광범위 한 기능을 제공합니다.  API의 다양 한 수준의 단순성 vs 유연성을 제공 하는 여러 옵션이 있습니다.
...
| [멀티 플레이 시나리오](multiplayer/multiplayer-scenarios.md) | 제안 및 어떻게 수 멀티 플레이어에 통합할 타이틀에 대 한 지침입니다. |
...
| [멀티 플레이어 관리자](multiplayer/multiplayer-manager.md) | 멀티 플레이어 관리자 일반적인 멀티 플레이 시나리오에 초점을 맞춘 API를 제공 합니다. |

### <a name="xbox-live-storage-platform"></a>Xbox Live 저장소 플랫폼

Xbox Live 저장소 플랫폼 타이틀 저장소와 연결 된 저장소를 제공합니다.  이들은 두 서로 다르지만 상호 보완적 서비스입니다.  연결 된 저장소를 사용 하면 게임 저장은 로그인 사용자가 위치에 관계 없이 디바이스 간에 로밍 하는 클라우드에 구현할 수 있습니다.  타이틀 저장소 blob 제목 및 공유에서 다른 사용자 또는 사용자 마다 될 수 있는 데이터를 저장할 수 있습니다.
