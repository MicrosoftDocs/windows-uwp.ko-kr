...
<tbody>
<tr class="odd">
<td align="left"><p>[DirectX 게임용 2D 그래픽](working-with-2d-graphics-in-your-directx-game.md)</p></td>
<td align="left"><p>DirectX를 사용하여 2D 그래픽을 만듭니다.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[Direct3D 그래픽 학습 가이드](https://msdn.microsoft.com/windows/uwp/graphics-concepts/index)</p></td>
<td align="left"><p>Direct3D 그래픽 개념을 이해합니다.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[DirectX 게임용 기본 3D 그래픽](an-introduction-to-3d-graphics-with-directx.md)</p></td>
<td align="left"><p>기본 3D DirectX 그래픽을 만듭니다.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[DirectX 게임에 리소스 로드](load-a-game-asset.md)</p></td>
