...
ms.locfileid: "4340187"
---
# <a name="paging-parameters"></a>페이징 매개 변수
 
일부 Xbox Live 서비스 Uri는 JavaScript 개체 Notation (JSON) 개체의 컬렉션을 반환 합니다. URI에 연결 된 쿼리 문자열의 일부로 페이징 매개 변수를 지정 하 여 이러한 컬렉션을 통해 페이징 될 수 있습니다. 페이징 매개 변수의 전체 목록은 다음과 같습니다. 페이징 매개 변수를 허용 하는 모든 Uri는이 페이지의 아래쪽에 연결 됩니다.
