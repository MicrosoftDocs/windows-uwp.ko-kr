...
장치 제거 오류에 대한 검사를 렌더링 루프에 포함합니다. [
...
> **참고** DXCap와 해당 지원 DLL이 Windows SDK를 통해 더 이상 배포되지 않는 Windows 10용 그래픽 도구의 일부로 system32/syswow64에 설치됩니다. 대신 선택적 OS 구성 요소인 주문형 그래픽 도구 기능을 통해 제공되며 Windows 10에서 그래픽 도구를 사용하기 위해 설치되어야 합니다. Windows 10용 그래픽 도구 설치 방법에 대한 자세한 내용은 여기(<https://msdn.microsoft.com/library/mt125501.aspx#InstallGraphicsTools>)에서 찾을 수 있습니다.
