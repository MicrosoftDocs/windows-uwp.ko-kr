...
경우에 따라 백그라운드 작업을 완료 하려면 백그라운드 작업에 대 한 충족 하기 위한 특정 조건 필요 합니다. 백그라운드 작업을 등록할 때 [**SystemConditionType**](https://msdn.microsoft.com/library/windows/apps/br224835)에 지정된 조건을 하나 이상 지정할 수 있습니다. 트리거가 발생 했음을 조건을 확인 됩니다. 백그라운드 작업은 대기 다음, 되지만 모든 필요한 조건이 충족 될 때까지 실행 되지 않습니다.
...
다음 조각은 만들기 및 백그라운드 작업을 등록의 컨텍스트에서 여러 조건을 보여 줍니다.
