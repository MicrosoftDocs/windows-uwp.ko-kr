...
아직 수행하지 않은 경우 Windows 10을 대상으로 앱을 포팅하기만 해도 성능이 훨씬 향상됩니다. 여러 XAML 최적화(예: [{x:Bind}](../xaml-platform/x-bind-markup-extension.md))는 Windows 10 앱에서만 사용할 수 있습니다. [Windows 10으로 앱 포팅](../porting/index.md) 및 //build/ 세션 [유니버설 Windows 플랫폼으로 전환](https://channel9.msdn.com/Events/Build/2015/3-741)을 참조하세요.
...
| [ListView 및 GridView UI 최적화](optimize-gridview-and-listview.md) | UI 가상화, 요소 감소, 항목에 대한 점진적 업데이트를 통해 [<strong>GridView</strong>](/uwp/api/Windows.UI.Xaml.Controls.GridView)의 성능과 시작 시간을 개선합니다. |
| [ListView 및 GridView 데이터 가상화](listview-and-gridview-data-optimization.md) | 데이터 가상화를 통해 [<strong>GridView</strong>](/uwp/api/Windows.UI.Xaml.Controls.GridView) 성능과 시작 시간이 향상됩니다. |
