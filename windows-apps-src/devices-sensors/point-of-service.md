...
| [하드웨어 지원](pos-device-support.md) | 호환 되는 알려진된 장치 목록 [Windows.Devices.PointOfService](https://aka.ms/pointofservice-api) UWP Api. |
| [바코드 스캐너](pos-barcodescanner.md) | 바코드 스캐너에 대 한 문서의 인덱스입니다. |
| [마그네틱 띠 판독기](pos-magnetic-stripe-reader.md) | 마그네틱 띠 판독기에서 문서의 인덱스입니다.
| [POSPrinter](pos-printer.md) | 인덱스 POSPrinter에 대 한 문서입니다. |