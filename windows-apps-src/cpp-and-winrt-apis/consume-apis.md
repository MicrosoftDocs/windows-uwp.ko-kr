...
할당을 만듭니다 **TextBlock**, 즉시 사용 하 여 덮어씁니다 `value`합니다. 해결 방법은 다음과 같습니다.
...
다음은 프로젝션된 형식과 인터페이스가 사용하는 프로젝트에서 어떻게 보이는지 나타낸 예제입니다. 프로젝션 된 형식 (예: 한이 예제의)를 도구에서 생성 하지 않는 경우 직접 작성은 기억 하세요.
