...
| 404| 유효한 XUID 없거나, 또는 메시지 ID를 찾을 수 없는 올바르게 구문 분석 합니다.|
...
성공적으로 호출 하는 경우 서비스는 JSON 형식 결과 데이터를 반환 합니다. 루트 개체 UserMessageHeader 개체가입니다.
...
| 속성| 형식| 최대 길이| 설명|
| --- | --- | --- | --- |
| 전송| DateTime|  | 날짜 및 시간 보낸 메시지입니다. (서비스에서 제공).|
