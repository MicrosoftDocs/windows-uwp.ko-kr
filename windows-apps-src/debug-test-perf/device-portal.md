...
ETW 로깅을 사용에 대 한 자세한 내용은 [디버그 로그를 보는 데 사용 하 여 디바이스 포털](https://blogs.windows.com/buildingapps/2016/06/10/using-device-portal-to-view-debug-logs-for-uwp/) 블로그 게시물을 참조 하세요. 
