...
[휴대폰용 Continuum](http://go.microsoft.com/fwlink/p/?LinkID=699431), 호환 Windows10 모바일 장치에 대 한 새로운 환경을 사용 하 여 사용자가 마우스 및 키보드는 휴대폰을 노트북 처럼 작동 하도록 휴대폰이 연결할 수 있습니다.
...
**참고**OSK 있는지 표시 되지 않습니다 터치 키보드를 통해 OSK는 우선 합니다.
