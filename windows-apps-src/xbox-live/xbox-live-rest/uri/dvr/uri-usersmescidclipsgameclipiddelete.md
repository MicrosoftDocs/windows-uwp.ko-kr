...
GameClips 서비스에서 사용자의 비디오를 삭제 하는 메커니즘을 제공 합니다. 삭제 시 모든 메타 데이터 및 실제 비디오 자산 (생성 하 고 원래) 시스템에서 제거 됩니다. 영구 작업입니다. 
...
| 404| 찾을 수 없음| URL에 지정 된 클립 없었던 (또는 짧게 지워졌습니다).| 
