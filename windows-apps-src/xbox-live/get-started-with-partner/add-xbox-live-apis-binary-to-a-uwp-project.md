...
3. **[Visual Studio](https://www.visualstudio.com/)** 를 시작 합니다. Visual Studio 2015 업데이트 3 이상 UWP 앱을 빌드할 수 있습니다. 개발자 및 보안 업데이트에 대 한 Visual Studio의 최신 릴리스를 사용 하는 것이 좋습니다.
...
> [!NOTE]
> XDK 하지 지원 되는 Xbox Live 크리에이터 스 프로그램 개발자가 Xbox Live SDK의 UWP 버전 중 하나 사용 해야 합니다.
