...
제품 범주를 **게임**으로 선택했을 때만 표시되는 범주입니다. 게임이 지원하는 기능을 지정할 수 있습니다. 제품의 저장소에 표시할이 섹션에서 제공 하는 정보를 나열 합니다.
...
- **고객의 Windows 8.x 및 이전 버전 또는 Windows Phone 8.x 및 이전 버전:**
