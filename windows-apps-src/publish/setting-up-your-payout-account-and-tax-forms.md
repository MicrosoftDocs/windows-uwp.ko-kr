...
완성해야 하는 세금 양식의 온라인 버전이 표시됩니다. 거주 국가 또는 국적과 관계없이 Windows 스토어를 통해 앱 또는 추가 기능을 판매하려면 미국 세금 양식을 작성해야 합니다. 특정 미국 영주권 요구 사항을 충족하는 개발자는 IRS W-9 양식을 작성해야 합니다. 미국 이외 지역의 다른 개발자는 IRS W-8 양식을 작성해야 합니다. 세금 프로필을 완성하면 온라인으로 이러한 양식을 작성할 수 있습니다.
