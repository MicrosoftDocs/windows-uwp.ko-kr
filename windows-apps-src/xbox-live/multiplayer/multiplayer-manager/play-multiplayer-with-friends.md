...
title: 친구와 멀티 플레이 게임
author: KevinAsgari
description: Xbox Live 멀티 플레이어 관리자를 사용 하 여 친구와 멀티 플레이 게임을 플레이 하는 플레이어 하도록 하는 방법을 알아봅니다.
...
다음 프로세스의 순서도 표시: [순서도-친구와 멀티 플레이/협동 게임을 실행](mpm-flowcharts/mpm-play-with-friends.md)합니다.
...
### <a name="3-send-invites-to-friends-a-namesend-invites"></a>친구를 초대 보내기 3)<a name="send-invites">
...
초대를 수락한 호스트는 게임을 시작할 준비가 되 고, 호출 하 여 로비 세션의 멤버를 포함 하는 새 게임을 시작할 수 있습니다 `join_game_from_lobby()`.
