...
ms.locfileid: "5434161"
---
# <a name="get-add-on-acquisitions"></a>추가 기능 구입 정보 가져오기

Microsoft Store 분석 API에서 이 메서드를 사용하여 지정된 날짜 범위 및 다른 선택 필터 동안 앱 추가 기능의 집계 취득 데이터를 JSON 형식으로 가져옵니다. 이 정보는 Windows 개발자 센터 대시보드의 [추가 기능 보고서](../publish/add-on-acquisitions-report.md)를 통해서도 사용할 수 있습니다.
