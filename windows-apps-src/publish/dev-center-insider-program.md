...
|**대상이 지정된 푸시 알림**: 앱의 고객에게 보낼 사용자 지정 알림을 만듭니다. 고객 모두에게 보내거나 정의한 특정 조건에 따라 선택된 부문에만 보낼 수 있습니다.|앱에 대한 푸시 알림 페이지(서비스 아래)로 이동합니다. **새 알림**을 클릭하여 알림을 만들고 예약합니다. 모든 앱의 사용자에게 알림을 보내거나, **새 고객 그룹 만들기**를 클릭하여 앱 고객의 특정 부문을 정의할 수 있습니다. [세부 정보](http://go.microsoft.com/fwlink/p/?LinkId=718017)|2016년 6월|
