---
author: QuinnRadich
title: "Windows 10 빌드 16257 API 변경 사항"
description: "개발자는 다음 목록을 사용하여 현재 Windows10 SDK Preview 빌드에 새로 추가되었거나 변경된 네임스페이스를 식별할 수 있습니다."
keywords: "새로운 기능, 새 기능, 업데이트, 플라이트 빌드, 플라이트, API, 16257"
ms.author: quradic
ms.date: 8/17/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16257"></a>Windows 10 SDK Preview 빌드 16257의 새로운 API

새로운 API 네임스페이스와 업데이트된 API 네임스페이스는 Windows 10 SDK Preview 빌드 16257의 [Windows 참가자](https://insider.windows.com/)에서 사용할 수 있습니다.

다음은 마지막 공개 Windows 10 릴리스인 [버전 1703](windows-10-version-1703-api-diff.md) 이후에 추가된 네임스페이스에 대해 게시된 시험판 설명서의 전체 목록입니다. **시험판 설명서는 완전하지 않거나 변경될 수 있으며, 후속 빌드에서 이름이 바뀌거나 제거될 수 있습니다.** 또한 이전 SDK Preview 빌드에서 변경되거나 이름이 바뀐 API 네임스페이스 목록도 나열되어 있습니다.
...
## <a name="apis-changed-or-removed-since-build-16232"></a>빌드 16232 이후 변경되거나 제거된 API

다음 API는 빌드 16232 이하에서는 사용할 수 있지만 현재 이 빌드에서는 더는 사용할 수 없습니다. 이름이 바뀌었거나 완전히 제거되었으며, 이에 대한 설명서도 이제 제공되지 않습니다.
...
## <a name="apis-changed-or-removed-since-build-16225"></a>빌드 16225 이후 변경되거나 제거된 API

다음 API는 빌드 16225 이하에서는 사용할 수 있지만 현재 이 빌드에서는 더는 사용할 수 없습니다. 이름이 바뀌었거나 완전히 제거되었으며, 이에 대한 설명서도 이제 제공되지 않습니다.
