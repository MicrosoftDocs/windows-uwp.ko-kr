...
**30d** 기간을 선택 하면 **사용자**, **장치**또는 **기간** 탭 볼 때 원 마커를 볼 수 있습니다. 이러한 크게 증가 개발자나에 대해 알아야 할 생각 하는 특정된 값 감소 합니다. 원이 표시 되는 날짜 크게 증가 또는 감소 하는 이전 주에 비해 감지 하는 주의 끝을 나타냅니다. 변경 된 내용에 대 한 자세한 정보를 보려면 원 위로 가져갑니다.  
