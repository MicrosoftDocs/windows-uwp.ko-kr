...
앱이 로드될 때 및 이후 런타임에 테마가 변경될 때마다 [{ThemeResource} 태그 확장](../xaml-platform/themeresource-markup-extension.md)이 평가됩니다. 이것은 일반적으로 사용자가 장치 설정을 변경하거나 앱 내의 프로그래밍 방식이 변경되어 현재 테마가 바뀔 때 발생합니다.
