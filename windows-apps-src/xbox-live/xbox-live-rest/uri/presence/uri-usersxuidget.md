...
소비자 전체 개체에 관심이 없는 경우 [PresenceRecord](../../json/json-presencerecord.md) 의 일부를 제공 하기 위해 응답을 필터링 할 수 있습니다.
...
사용자에 대 한 기존 레코드가 없는 경우에 없는 장치와 레코드 반환 됩니다.
