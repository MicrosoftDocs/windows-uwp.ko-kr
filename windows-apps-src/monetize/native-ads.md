...
4.  코드에서 테스트 광고 단위 값을 (즉, *응용 프로그램 Id* 및 *adUnitId* 매개 변수 [NativeAdsManagerV2](https://docs.microsoft.com/uwp/api/microsoft.advertising.winrt.ui.nativeadsmanagerv2.-ctor) 생성자의) 파트너 센터에서 생성 한 라이브 값으로 바꿉니다.
