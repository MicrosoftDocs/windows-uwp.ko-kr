...
| [UWP 응용 프로그램을 실행](launch-store-app.md) | 이 항목에서는 ms-windows-store URI 스키마에 대해 설명합니다. 이 URI 스키마로 UWP 앱을 실행하여 Microsoft Store의 특정 페이지를 표시할 수 있습니다. |
...
| [화면 캡처 시작](launch-screen-snipping.md) | 새 캡처를 열려고 하거나 스케치 & 캡처 응용 프로그램 URI 체계를 사용 하는 방법에 알아봅니다. |
| [응용 프로그램 URI 처리기를 사용 하 여 웹 사이트에 대 한 응용 프로그램을 사용 합니다.](web-to-app-linking.md) | 웹 사이트 기능에 대 한 응용 프로그램을 지원 하 여 사용자의 커뮤니케이션 앱을 구동 합니다. |
