...
사용자 및 앱과 관련된 파일 선택기 개체에서 속성을 설정합니다. 이 예제에서는 세 가지 속성을 설정합니다. [**SuggestedStartLocation**](https://msdn.microsoft.com/library/windows/apps/br207880)하십시오 [ **FileTypeChoices** ](https://msdn.microsoft.com/library/windows/apps/br207875) 고 [ **SuggestedFileName**](https://msdn.microsoft.com/library/windows/apps/br207878)합니다.
     
...
> [!NOTE]
> [**FileSavePicker** ](https://msdn.microsoft.com/library/windows/apps/br207871) 개체를 사용 하 여 파일 선택기를 표시 합니다 [ **PickerViewMode.List** ](https://msdn.microsoft.com/library/windows/apps/br207891) 보기 모드입니다.
