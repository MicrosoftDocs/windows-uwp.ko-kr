...
타기팅 프로필과 광고 캠페인, 배달 라인, 크리에이티브 간의 관계에 대한 자세한 내용은 [Windows 스토어 서비스를 사용하여 광고 캠페인 실행](run-ad-campaigns-using-windows-store-services.md#call-the-windows-store-promotions-api)을 참조하세요.
