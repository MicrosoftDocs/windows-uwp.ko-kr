...
ms.locfileid: "4466841"
---
# <a name="xboxservicesconfig-file-description"></a>XboxServices.config 파일 설명

개발할 때 Xbox Live UWP 게임에 사용 하도록 설정, 프로젝트 XboxServices.config 파일을 포함 해야 합니다.  이 파일에는 Xbox Live SDK 게임 개발자 센터 앱에서 Xbox Live 서비스 구성와 연결할 수 있습니다. 이 파일 서비스 구성 ID, 제목 ID 등과 같은 세부 정보는 JSON 개체를 포함 합니다.
...
XboxLiveCreatorsTitle  |  "True" 하는 앱은 Xbox Live 크리에이터 스 프로그램 앱을 나타냅니다. 그렇지 않으면 "false"입니다.
