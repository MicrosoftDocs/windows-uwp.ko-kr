...
Unity 게임을 개발 하는 데 사용 하는 Xbox Live 크리에이터 스 프로그램 개발자를 위한는 Xbox Live Unity 플러그 인은 GitHub에서 사용할 수 있습니다.

* [Xbox Live Unity 플러그 인](https://github.com/Microsoft/xbox-live-unity-plugin)

> [!WARNING]
> Xbox Live 크리에이터 스 프로그램 도구 이기 때문에 Xbox Live Unity 플러그 인 Xbox Live 기능 전체 집합을 제공 하지 않습니다. 참조는 [개발자 프로그램 개요 기능 테이블을](developer-program-overview.md#feature-table) Xbox Live 서비스를 사용할 수 있습니다.
...
Xbox Live에 대 한 설명서 일부 관리 파트너 에게만 제공 됩니다. 이 정보에 액세스 하는 Microsoft 계정 (MSA) Xbox Live 전체 액세스에 대 한 활성화 되어 있어야 합니다.
