...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, Windows 스토어 구매 API, 제품 권한 부여"
...
* Windows 스토어 ID 키는 무료 제품 권한을 부여하려는 사용자의 ID를 나타냅니다.
...
| 매개 변수      | 유형   | 설명        | 필수 |
|----------------|--------|---------------------|----------|
| availabilityId | 문자열 | Windows 스토어 카탈로그에서 권한을 부여할 제품의 가용성 ID입니다.         | 예      |
| b2bKey         | 문자열 | 제품의 권한을 부여하려는 사용자의 ID를 나타내는 [Windows 스토어 ID 키](view-and-grant-products-from-a-service.md#step-4)입니다.    | 예      |
| devOfferId     | 문자열 | 구매 후 컬렉션 항목에 표시되는 개발자가 지정한 제품 ID입니다.        |
| language       | 문자열 | 사용자의 언어입니다.  | 예      |
| market         | 문자열 | 사용자의 지역/국가입니다.       | 예      |
| orderId        | GUID   | 주문에 대해 생성된 GUID입니다. 이 값은 사용자에 대해 고유하지만 모든 주문에서 고유할 필요는 없습니다.    | 예      |
| productId      | 문자열 | Windows 스토어 카탈로그의 [제품](in-app-purchases-and-trials.md#products-skus-and-availabilities)에 대한 [스토어 ID](in-app-purchases-and-trials.md#store-ids)입니다. 제품에 대한 스토어 ID의 예는 9NBLGGH42CFD입니다. | 예      |
| quantity       | 정수    | 구매할 수량입니다. 현재, 1 값만 지원됩니다. 지정되지 않은 경우 기본값은 1입니다.   | 아니요       |
| skuId          | 문자열 | Windows 스토어 카탈로그의 제품 [SKU](in-app-purchases-and-trials.md#products-skus-and-availabilities)에 대한 [스토어 ID](in-app-purchases-and-trials.md#store-ids)입니다. SKU에 대한 스토어 ID의 예는 0010입니다.     | 예      |
...
| productId               | 문자열         | Windows 스토어 카탈로그에서 품목을 나타내는 [제품](in-app-purchases-and-trials.md#products-skus-and-availabilities)에 대한 [스토어 ID](in-app-purchases-and-trials.md#store-ids)입니다. 제품에 대한 스토어 ID의 예는 9NBLGGH42CFD입니다.   | 예      |
...
| skuId                   | 문자열         | Windows 스토어 카탈로그에서 품목을 나타내는 [SKU](in-app-purchases-and-trials.md#products-skus-and-availabilities)에 대한 [스토어 ID](in-app-purchases-and-trials.md#store-ids)입니다. SKU에 대한 스토어 ID의 예는 0010입니다.                                                                   | 예      |
