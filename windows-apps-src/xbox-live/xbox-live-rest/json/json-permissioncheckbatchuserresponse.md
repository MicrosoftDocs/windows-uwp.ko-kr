...
| 사용 권한| [PermissionCheckResponse (JSON)](json-permissioncheckresponse.md) 의 배열| 필수. [PermissionCheckResponse (JSON)](json-permissioncheckresponse.md) 에 대 한 요청에서와 동일한 순서로 원래 요청을 하 라는 메시지가 표시 된 각 권한에 대 한 합니다.| 
