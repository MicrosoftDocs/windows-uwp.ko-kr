...
| **제한된 접근 권한 값**     | 제품 모든 [제한 된 기능]를 선언 하는 경우 필요한 (.. /packaging/app-capability-declarations.md#restricted-capabilities    | [제한된 접근 권한 값](manage-submission-options.md#publishing-hold-options)       
