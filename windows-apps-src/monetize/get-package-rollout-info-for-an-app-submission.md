...
# Windows 스토어 제출 API를 사용하여 앱 제출에 대한 패키지 출시 정보 가져오기
...
| submissionId | 문자열 | 필수. 가져올 패키지 출시 정보가 있는 제출 ID입니다. 이 ID는 개발자 센터 대시보드에서 사용할 수 있으며 [앱 제출 만들기](create-an-app-submission.md) 요청에 대한 응답 데이터에 포함되어 있습니다.  |
...
|--------|------------------|
| 404  | 제출을 찾을 수 없습니다. |
| 409  | 제출이 지정된 앱에 속하지 않거나 앱이 [현재 Windows 스토어 제출 API에서 지원되지 않는](create-and-manage-submissions-using-windows-store-services.md#not_supported) 개발자 센터 대시보드 기능을 사용합니다. |   
