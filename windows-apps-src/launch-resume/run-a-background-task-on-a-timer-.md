...
데스크톱 또는 모바일 장치 패밀리를 대상으로 하는 UWP(유니버설 Windows 플랫폼) 앱에 대한 기본 제공 타이머는 15분 간격으로 백그라운드 작업을 실행합니다. (타이머가 15 분 간격으로 시스템만 15 분 마다 한 번씩 TimerTriggers-전원을 요청한 앱 절전 모드를 시작 해야 할 수 있도록 합니다.)
...
- CPU 시간: 백그라운드 작업 트리거 유형에 따라 가져오는 벽 시계 시간으로 제한 됩니다.
