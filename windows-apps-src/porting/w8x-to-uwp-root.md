...
-   AppName\_81.Windows 합니다. Windows 8.1 대 한 앱 패키지를 빌드하는 프로젝트입니다.
-   AppName\_81.WindowsPhone 합니다. Windows Phone 8.1용 앱 패키지를 빌드하는 프로젝트입니다.
-   AppName\_81.Shared 합니다. 두 프로젝트 모두에서 사용되는 소스 코드, 태그 파일, 기타 자산 및 리소스가 포함된 프로젝트입니다.
