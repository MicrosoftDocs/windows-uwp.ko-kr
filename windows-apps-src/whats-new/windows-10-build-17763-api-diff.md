---
title: Windows 10 빌드 17763 API 변경 내용
description: 개발자 수 목록을 사용 하 여 다음 새롭거나 변경 된 Windows 10 빌드 17763 네임 스페이스를 식별 합니다.
keywords: 새로운 기능, 새로운 기능, 새 업데이트를 최신 Windows 10, api, 17763 년 10 월
ms.date: 10/02/2018
ms.topic: article
...
ms.locfileid: "57596328"
---
# <a name="new-apis-in-windows-10-build-17763"></a>Windows 10에서 새 Api 17763 빌드

신규 및 업데이트 된 API 네임 스페이스 사용할 수 있게 된 개발자가 Windows 10 빌드 17763에서에서 (10 월 2018 라고도 업데이트나 1809 버전). 아래는 이 릴리스에서 추가 또는 수정된 네임스페이스에 게시된 설명서의 전체 목록입니다.

공용 이전 릴리스에서 추가 된 Api에 대 한 정보를 참조 하세요 [Windows 10 년 4 월 업데이트에서 새로운 Api](windows-10-build-17134-api-diff.md)합니다.
...
#### <a name="packagehttpsdocsmicrosoftcomuwpapiwindowsapplicationmodelpackage"></a>[패키지](https://docs.microsoft.com/uwp/api/windows.applicationmodel.package)
...
#### <a name="displaypathhttpsdocsmicrosoftcomuwpapiwindowsdevicesdisplaycoredisplaypath"></a>[표시 경로](https://docs.microsoft.com/uwp/api/windows.devices.display.core.displaypath)

표시 경로 <br> DisplayPath.ApplyPropertiesFromMode <br> DisplayPath.FindModes <br> DisplayPath.IsInterlaced <br> DisplayPath.IsStereo <br> DisplayPath.PresentationRate <br> DisplayPath.Properties <br> DisplayPath.Rotation <br> DisplayPath.Scaling <br> DisplayPath.SourcePixelFormat <br> DisplayPath.SourceResolution <br> DisplayPath.Status <br> DisplayPath.Target <br> DisplayPath.TargetResolution <br> DisplayPath.View <br> DisplayPath.WireFormat
...
#### <a name="bitmapdecoderhttpsdocsmicrosoftcomuwpapiwindowsgraphicsimagingbitmapdecoder"></a>[Bitmapdecoder에서](https://docs.microsoft.com/uwp/api/windows.graphics.imaging.bitmapdecoder)
...
#### <a name="launcherhttpsdocsmicrosoftcomuwpapiwindowssystemlauncher"></a>[시작 관리자](https://docs.microsoft.com/uwp/api/windows.system.launcher)
...
#### <a name="borderhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsborder"></a>[테두리](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### <a name="controlhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscontrol"></a>[제어](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### <a name="framehttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsframe"></a>[프레임](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)
...
#### <a name="menubarhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsmenubar"></a>[메뉴 모음](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

MenuBar <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> 메뉴 모음. #ctor
...
#### <a name="panelhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolspanel"></a>[패널](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.panel)
...
#### <a name="tooltiphttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstooltip"></a>[도구 설명](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)
...
#### <a name="focusmanagerhttpsdocsmicrosoftcomuwpapiwindowsuixamlinputfocusmanager"></a>[참조](https://docs.microsoft.com/uwp/api/windows.ui.xaml.input.focusmanager)
...
#### <a name="brushhttpsdocsmicrosoftcomuwpapiwindowsuixamlmediabrush"></a>[브러시](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
...
#### <a name="datatemplatehttpsdocsmicrosoftcomuwpapiwindowsuixamldatatemplate"></a>[데이터 템플릿](https://docs.microsoft.com/uwp/api/windows.ui.xaml.datatemplate)
