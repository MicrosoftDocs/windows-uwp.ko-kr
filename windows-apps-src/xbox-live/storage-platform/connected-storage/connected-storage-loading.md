...
1.  검색은 `ConnectedStorageSpace` 를 호출 하 여 사용자에 대 한 `GetForUserAsync`.
    ...
    반환 된 XDK 예제에서 `ConnectedStorageSpace` 쉽게 관리할 수 있도록 지도에 추가 되는 `ConnectedStorageSpace` 여러 사용자에 대 한 개체.
