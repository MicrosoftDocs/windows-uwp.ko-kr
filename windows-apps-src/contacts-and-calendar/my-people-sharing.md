...
“appId”는 패키지 패밀리 이름이며, 그 뒤에 ‘!’ 그리고 활성화 가능한 클래스 ID가 붙습니다. 패키지 제품군 이름을 찾으려면 **Package.appxmanifest** 기본 편집기를 사용 하 여 열고 "패키징" 탭에서를 확인 합니다. 여기에서 "App"는 공유 대상 보기에 해당 하는 활성화할 수 있는 클래스입니다.
