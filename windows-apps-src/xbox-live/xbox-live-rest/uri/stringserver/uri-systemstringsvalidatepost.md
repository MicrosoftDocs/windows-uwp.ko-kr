...
> [!NOTE] 
> <b>VerifyStringResult</b> 결과만 문자열에 있는 첫 번째 단어를 보고 합니다. 문자열에서 단어를 잘못 된 추가 수 있습니다. 문자열을 사용할 수 있는 단어를 교체 하려는 경우에 잘못 된 단어 또는 하위 문자열을 대체 하 고 있는 문자열을 추가 하는 문자열을 다시 확인 해야 합니다.  
...
| 406| 허용할 수 없음| 없음 <b>콘텐츠 유형: 응용 프로그램/j</b> 헤더.| 
