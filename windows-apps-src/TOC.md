...
#### [MediaCapture의 장면 분석](audio-video-camera/scene-analysis-for-media-capture.md)
...
#### [원격 디바이스 검색](launch-resume/discover-connected-devices.md)
...
#### [개발자 센터 대시보드에서 프로젝트 만들기 및 원격 변수 정의](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
