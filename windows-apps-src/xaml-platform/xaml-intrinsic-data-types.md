...
**참고**  by 규칙에서는 xaml 및 다른 모든 xaml 언어 요소에 대 한 언어 기본 형식이 "x:" 접두사로 표시 됩니다. 이는 XAML 언어 요소가 실제 태그에서 일반적으로 어떻게 사용되는지를 보여 줍니다. 이는 XAML용 설명서 및 XAML 사양에서도 준수됩니다.
