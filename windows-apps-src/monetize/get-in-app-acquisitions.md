...
ms.locfileid: "57650988"
---
# <a name="get-add-on-acquisitions"></a>추가 기능 구입 가져오기

Microsoft Store 분석 API에서 이 메서드를 사용하여 지정된 날짜 범위 및 다른 선택 필터 동안 앱 추가 기능의 집계 취득 데이터를 JSON 형식으로 가져옵니다. 이 정보를 사용할 수 있습니다 합니다 [추가 기능 구매 보고서](../publish/add-on-acquisitions-report.md) 파트너 센터에서.
...
| groupby | 문자열 | 지정된 필드에 대한 데이터 집계에만 적용되는 문입니다. 다음 필드를 지정할 수 있습니다.<ul><li><strong>날짜</strong></li><li><strong>ApplicationName</strong></li><li><strong>inAppProductName</strong></li><li><strong>acquisitionType</strong></li><li><strong>연령대</strong></li><li><strong>storeClient</strong></li><li><strong>성별</strong></li><li><strong>시장</strong></li><li><strong>osVersion</strong></li><li><strong>장치 유형</strong></li><li><strong>orderName</strong></li></ul><p>반환되는 데이터 행은 <em>groupby</em> 매개 변수에서 지정된 필드 및 다음을 포함합니다.</p><ul><li><strong>날짜</strong></li><li><strong>응용 프로그램 Id</strong></li><li><strong>inAppProductId</strong></li><li><strong>구매 수량</strong></li></ul><p><em>groupby</em> 매개 변수는 <em>aggregationLevel</em> 매개 변수와 함께 사용할 수 있습니다. 예: <em>&amp;groupby=ageGroup,market&amp;aggregationLevel=week</em></p> |  아니오  |
...
-   *필터 시장 eq = 'US' 및 성별 eq 여기 '*
-   *필터 = ('US' 시장 ne) 및 (ne '알 수 없는' 성별) 및 (성별 ne 여기 ') 및 ('아니요' ne 시장) 및 (연령대 ne '55 보다 큰' 또는 연령대 ne '보다 작거나 13')*

지원되는 필드 목록은 다음 표를 참조하세요. 문자열 값은 *filter* 매개 변수에서 단일 따옴표로 묶여야 합니다.

| 필드        |  설명        |
|---------------|-----------------|
| acquisitionType | 다음 문자열 중 하나입니다.<ul><li><strong>무료</strong></li><li><strong>평가판</strong></li><li><strong>유료</strong></li><li><strong>프로 모션 코드</strong></li><li><strong>Iap</strong></li></ul> |
| ageGroup | 다음 문자열 중 하나입니다.<ul><li><strong>보다 작거나 13</strong></li><li><strong>13-17</strong></li><li><strong>18 ~ 24</strong></li><li><strong>25 34</strong></li><li><strong>35 44</strong></li><li><strong>44-55</strong></li><li><strong>55 보다 큼</strong></li><li><strong>알 수 없음</strong></li></ul> |
| storeClient | 다음 문자열 중 하나입니다.<ul><li><strong>Windows Phone 스토어 (클라이언트)</strong></li><li><strong>Microsoft Store (클라이언트)</strong></li><li><strong>Microsoft Store (웹)</strong></li><li><strong>조직에서 볼륨 구매</strong></li><li><strong>다른</strong></li></ul> |
...
| deviceType | 다음 문자열 중 하나입니다.<ul><li><strong>PC</strong></li><li><strong>전화</strong></li><li><strong>콘솔</strong></li><li><strong>IoT</strong></li><li><strong>홀로그램</strong></li><li><strong>알 수 없음</strong></li></ul> |
...
* [채널에서 추가 기능 변환 가져오기](get-add-on-conversions-by-channel.md)
