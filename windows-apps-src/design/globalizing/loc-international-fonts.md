...
| 벨라루스어 | 일 대 | Segoe UI |
| 보스니아어(라틴 문자) | Latn-BA | Segoe UI |
| 불가리아어 | bg-BG | Segoe UI |
| 카탈로니아어 | ca-ES | Segoe UI |
| 중부 쿠르드어 (아랍어) | ku-IQ | Segoe UI |
...
| 그루지야 문자 | 카-GE | Segoe UI |
| 독일어 | de-DE | Segoe UI |
| 그리스어 | el-GR | Segoe UI |
| 구자라트어 | gu-IN | Nirmala UI |
| 하우사어 (라틴 문자) | ha-Latn | Segoe UI |
| 히브리어 | he-IL | Segoe UI |
...
| 펀잡어 (아랍어) | pa-PK | Segoe UI |
| 케추아어 | 엔터프라이즈급 z-PE | Segoe UI |
| 루마니아어 | ro-RO | Segoe UI |
| 러시아어 | ru-RU | Segoe UI |
| 스코틀랜드 게일어 | gd-GB | Segoe UI |
| 세르비아어 (키릴 자모, 보스니아 헤르체고비나) | Cyrl-BA | Segoe UI |
| 세르비아어(키릴 자모, 세르비아) | Cyrl-CS | Segoe UI |
| 세르비아어(라틴 문자) | Latn-CS | Segoe UI |
| 북부 소토어 | nin-ZA | Segoe UI |
| 세츠와나어 | tn-ZA | Segoe UI |
| 신디어 (아랍어) | sd-아랍-PK | Segoe UI |
| 스리랑카어 | si-LK | Nirmala UI |
| 슬로바키아어 | sk-SK | Segoe UI |
| 슬로베니아어 | sl-SI | Segoe UI |
| 스페인어 | es-ES | Segoe UI |
| 스웨덴어 | sv-SE | Segoe UI |
| 타지키스탄어 (키릴 자모) | tg-Cyrl-TJ | Segoe UI |
