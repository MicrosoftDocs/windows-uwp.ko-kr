...
description: 이 자습서는 간단한 JavaScript 및 HTML을 사용 하는 방법에 설명 &\#0034; Hello, world &\#0034; Windows 플랫폼 (UWP (유니버설) Windows 10을 대상으로 하는 앱입니다.
ms.date: 03/06/2017
ms.topic: article
...
ms.locfileid: "57620428"
---
# <a name="create-a-hello-world-app-js"></a>"Hello, world" 앱 만들기(JS)

이 자습서는 간단한 JavaScript 및 HTML을 사용 하는 방법에 설명 "Hello, world" Windows 플랫폼 (UWP (유니버설) Windows 10을 대상으로 하는 앱입니다. Microsoft Visual Studio에서 단일 프로젝트를 사용 하 여 모든 Windows 10 장치에서 실행 되는 앱을 빌드할 수 있습니다.
...
-   이 자습서를 완료 하려면 Windows 10 및 Visual Studio 2017이 필요 합니다. [설정 방법](get-set-up.md)
...
## <a name="step-3-adding-some-javascript"></a>3단계: 일부 JavaScript를 추가합니다.
...
## <a name="step-4-run-the-app"></a>4단계: 앱을 실행 합니다.
...
축, Windows 10 및 UWP 용 JavaScript 앱을 만들었습니다! 아주 간단한 예제였지만 이제 여러분은 원하는 JavaScript 라이브러리와 프레임워크를 추가하여 여러분만의 앱을 만들 수 있을 것입니다. 그리고 이 앱은 UWP 앱이므로 스토어에 게시할 수 있습니다. 타사 프레임워크를 추가하는 방법은 다음 프로젝트를 참조하세요.

* [간단한 2D UWP JavaScript 및 CreateJS로 작성 하는 Microsoft Store 대 한 게임](get-started-tutorial-game-js2d.md)
* [3D UWP JavaScript 및 threeJS로 작성 하는 Microsoft Store 대 한 게임](get-started-tutorial-game-js3d.md)
