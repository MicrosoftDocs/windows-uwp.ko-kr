...
.Msix (또는.appx) 파일이 이미 있으면 패키지에 대 한 준비 영역으로 사용할 레이아웃 폴더에 내용이 압축을 풀 수 있습니다. SDK의 설치 경로에 따라 MakeAppx 도구를 사용 하 여 명령 프롬프트에서이 수행할 수 있습니다,이 경우 Windows 10 PC에서 makeappx.exe 도구를 알게 됩니다: x86: C:\Program 파일 (x86) \Windows Kits\10\bin\x86\makeappx.exe x64: C:\Program 파일 (x86) \Windows Kits\10\bin\x64\makeappx.exe
