...
모든 쓰기는 패키지 업그레이드 하는 동안 유지 되며만 응용 프로그램을 완전히 제거 되 면 삭제 합니다.
...
사용자가 패키지 제거 되 면 모든 파일 및 폴더 *C:\Program Files\WindowsApps\package_name* 아래에 있는 제거 됩니다, 패키징 과정 캡처된 레지스트리 또는 AppData로 리디렉션된 쓰기 뿐만 아니라.
