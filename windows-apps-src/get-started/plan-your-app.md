...
-   **카메라 및 외부 저장 디바이스**  기본 제공되거나 연결된 카메라에 사용자를 연결하여 채팅 및 회의에 참여하거나, vlog를 녹화하거나, 프로필 사진을 찍거나, 주변 소식을 기록하거나, 앱에서 제공하는 여러 기능을 이용할 수 있게 합니다. [이동식 저장소의 콘텐츠 액세스](https://docs.microsoft.com/previous-versions/windows/apps/hh465189(v=win.10))에 대해 자세히 알아보세요.
