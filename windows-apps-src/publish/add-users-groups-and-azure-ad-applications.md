...
-   **새 사용자 만들기**: 새로운 사용자 계정을 모두 조직의 디렉터리에 추가 하 고 개발자 센터 계정 만들기
...
2.  페이지의 맨 아래에 있는 **암호 재설정** 단추를 선택 합니다.
...
1.  ( **계정 설정**)에 따라 **사용자가** 페이지에서 **그룹 추가**클릭 합니다.
...
4.  많은 수의 키를 만들려는 경우 **다른 키 추가**선택 합니다.
...
( **계정 설정**)에 따라 **사용자가** 페이지에서 해당 검색 기록을 검토할 사용자에 대 한 **마지막 작업** 아래에 표시 된 링크를 선택 합니다. 지난 30일 동안 사용자가 방문한 모든 페이지의 URL을 볼 수 있습니다.
