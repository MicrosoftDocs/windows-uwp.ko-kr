...
ms.locfileid: "57595118"
---
# <a name="get-usersmegroupsmoniker-"></a>GET (/users/me/groups/{moniker} )
내 그룹에 대 한는 PresenceRecord를 가져옵니다. 이러한 Uri에 대 한 도메인은 `userpresence.xboxlive.com`합니다.
...
사용자와 관련 된, 클레임에 모니커가 지정 된 그룹의 사용자를 검색 하 고 해당 사용자에 대 한 PresenceRecord를 반환 합니다. 데이터 개인 정보 또는 콘텐츠 격리에 의해 제어 되므로 단순히 반환 되지 않습니다.
...
이 API는 요청에서 XUIDs 마다 하나씩 PresenceRecord 개체의 배열을 반환합니다.
