...
![전경 색 선택에 대 한 분할 단추](../design/controls-and-patterns/images/split-button-rtb.png)
...
250 추가한 [C + + WinRT](../cpp-and-winrt-apis/index.md) 코드 목록 항목에서 우리의 문서를 함께 기존 C + + CX 코드 예제입니다.
