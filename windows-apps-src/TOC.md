...
### [연결된 앱 및 디바이스](launch-resume/connected-apps-and-devices.md)
...
#### [ms-tonepicker URI 스키마를 사용하여 신호음 선택 및 저장](launch-resume/launch-ringtone-picker.md)
...
### [앱 Uri 처리기로 웹과 앱 연결 처리](launch-resume/web-to-app-linking.md)
...
#### [Out-of-process 백그라운드 작업 만들기 및 등록](launch-resume/create-and-register-an-outofproc-background-task.md)
...
#### [데스크톱 앱 변환기](porting/desktop-to-uwp-run-desktop-app-converter.md) 
...
### [Windows10 버전 1607의 API 추가](whats-new/windows-10-version-1607-api-diff.md)
### [Windows10 버전 1607 Preview의 새로운 기능](whats-new/windows-10-sdk-preview.md)
### [Windows10, 버전 1511의 새로운 기능](whats-new/windows-10-version-1511.md)
### [Windows10 버전 1507의 새로운 기능](whats-new/windows-10-version-1507.md)
## [Windows8.x 가이드](https://msdn.microsoft.com/library/windows/apps/mt244353.aspx)
...
### [앱이 Windows10 고객용 스토어에 표시되는 방법](publish/how-your-app-appears-in-the-store-for-windows-10-customers.md)
