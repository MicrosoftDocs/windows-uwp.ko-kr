...
UWP 앱에 알림에 보내는 데 사용할 수 있는 세 가지 유형의 푸시 채널이 있습니다. 해당 보고서는 다음과 같습니다. 
...
* [응용 프로그램을 실행 하는 것에 대 한 알림을 차단 하는 방법](https://msdn.microsoft.com/library/windows/apps/hh465450)
