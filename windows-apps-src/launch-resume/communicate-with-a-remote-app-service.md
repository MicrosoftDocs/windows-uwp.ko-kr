...
이 **uap3** 네임 스페이스의 요소를 사용 하기 위해 추가 해야 합니다 네임 스페이스 정의 매니페스트 파일의 위쪽에 있지 않은 경우 있습니다.
