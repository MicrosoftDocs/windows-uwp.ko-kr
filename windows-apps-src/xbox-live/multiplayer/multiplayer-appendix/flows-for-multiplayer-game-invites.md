...
ms.locfileid: "8943330"
---
# <a name="updated-flows-for-multiplayer-game-invites"></a>멀티 플레이 게임 초대를 위한 업데이트 된 흐름

Xbox One 베타 피드백의 결과로 사용자 환경을 흐름 멀티 플레이 게임 초대에 대 한 변경 된 경우 Xbox One 복구 업데이트 24 2013 년 11 월 6에 릴리스된 기준이 **사용자 환경 (UX)만** 변경 사항이 며 동작이 나 게임 타이틀의 관점에서 기능에 영향을 주지 않습니다. 제목 개발자는 모든 코드를 변경할 필요가 없습니다.
...
-   타사 앱은 기본적으로 맞춰지지 새 선택 하면 "&lt;제목 게임&gt; 보겠습니다 재생" 옵션입니다. 사용자가 게임 플레이에 오른쪽을 이동할 수 있도록 변경도 됩니다.

-   새로운 알림은 보낸 사람의 있는 "게임을 \ [*번호*\] 친구 추가" 라고 표시 되는 추가 되었습니다. 따라서 지우기 초대 아웃 보낸 게임 세션을 사용자의 상대와 연결 되어 있습니다.

자세한 사용자 환경을 흐름은 다음 예제에 설명 되어 있습니다. 각 테이블 David 및 숙 두 사용자에 대 한 예제 흐름을 보여 줍니다. 이러한 흐름 각 열에 표시 되 고 동시에 발생 합니다. <b style="background-color: #FFFF00">강조 표시 된 텍스트</b> 이전 UX 흐름에서 변경 된 조정 보여 줍니다.
...
David 다른 게임으로 전환 하 고 멀티 플레이 메뉴로 이동 합니다.
     <p><br>
Xbox 시스템 UI가 자신의 타사 새로운 전환 하려는 경우 게임에는 그 응답할 수 <b>예</b> 또는 <b>아니요</b>David 요청 합니다.
    </td>
...
멀티 플레이 로비에서 David 게임을 시작합니다.
  ...
  <tr>
    ...
    <p><br>
알림 센터에서 숙 선택할 수 있습니다. <ul>
     <li><b>수락 게임 초대</b>: 새 게임 시작 <li><b>게임 초대 거절:</b> 게임이 실행 하지만 숙은 여전히 보유할 하 고 후속 게임 초대를 받게 됩니다.
     <li><b style="background-color: #FFFF00"><b>타사 유지:</b> 게임 시작 및 숙 없는 보유할에서 제거 됩니다.</b>
     </ul>
     </td>
  </tr>
  <tr>
...
자신의 파티 구성원 없이 David 멀티 플레이 모드에서 재생 됩니다.
David 보유할입니다.
    </td>
    <td>
    </td>
...
**게임 초대 전송** 알림 게임 세션 원격 대상 멤버를 사용 하 여 설정 된 처음만 표시 됩니다. 원격 대상 구성원에 게 전송 하는 후속 요청이이 알림을 생성 되지 않습니다. 이 제목 **PullReservedPlayersAsync**를 여러 번 호출에서 반복 된 **게임 초대 전송** 토스트와 스팸 화 되에서 사용자를 방지 합니다.
