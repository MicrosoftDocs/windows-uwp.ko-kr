...
이 **uap3** 네임 스페이스의 요소를 사용 하기 위해 추가 해야 네임 스페이스 정의 매니페스트 파일의 맨 되어 있지 않으면 있습니다.
