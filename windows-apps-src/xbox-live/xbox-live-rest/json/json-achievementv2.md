...
| progressState| **ProgressState** 열거형| 진행 상태를 지정 합니다. <ul><li>잘못 된 (0): 도전 과제 진행은 알 수 없는 상태가 됩니다.</li><li>(1)을 달성: 도전 과제를 잠금 해제 되었습니다.</li><li>진행 중 (2): 도전 과제 잠겨 있지만 사용자 잠금을 해제 하는 진행률 했습니다.</li><li>(3) notStarted: 도전 과제 잠기고 사용자를 모든 진행률 잠금을 해제 했습니다.</li></ul> | 
...
| achievementType| **AchievementType** 열거형| 유형 도전 과제 (같지 레거시 도전 과제는 이전 형식)입니다. <ul><li>잘못 된 (0): 알 수 없는 및 지원 되지 않는 도전 과제 유형입니다.</li><li>영구 (1): 종료 날짜 없음 않았으며 언제 든 지 잠금을 해제할 수 있는 달성 합니다.</li><li>질문 (2): 특정 시간 창을 하는 동안이 잠금을 해제할 수 있는 성과 합니다.</li></ul> |
