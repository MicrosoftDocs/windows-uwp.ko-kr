...
# Windows 스토어 제출 API를 사용하여 앱 제출에 대한 패키지 출시 중지
...
| submissionId | 문자열 | 필수. 중지할 패키지 출시가 있는 제출 ID입니다. 이 ID는 개발자 센터 대시보드에서 사용할 수 있으며 [앱 제출 만들기](create-an-app-submission.md) 요청에 대한 응답 데이터에 포함되어 있습니다.  |
