...
ms.locfileid: "5945128"
---
# <a name="rich-presence-appendix"></a>다양 한 상태 부록

## <a name="data-platform"></a>데이터 플랫폼

데이터 플랫폼의 기본 사항을 서비스 이니셔티브도 엔터테인먼트의 일부입니다. 아이디어는 게임의 모든 작업 수 것 이벤트로 설명 해당 이벤트와 관련 된 특성을 갖는 합니다. 개발자는 서비스에서 게임의 환경에 중요 한 통계 및 상태 값을 구성할 수 있습니다.
