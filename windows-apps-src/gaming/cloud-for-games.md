...
* [ID@Xbox](http://www.xbox.com/Developers/id)
    ...
    멀티 플레이 게임, 플랫폼 간 연결, 게임 점수, 도전 과제, 순위표 등의 Xbox Live 기능을 Windows10 게임에 추가하려는 경우 ID@Xbox에 등록하여 창의력을 발휘하고 성공을 극대화하는 데 필요한 도구와 지원을 받으세요. ID@Xbox에 신청하기 전에 [Windows 개발자 센터](https://developer.microsoft.com/windows/programs/join)에서 개발자 계정을 등록하세요.
