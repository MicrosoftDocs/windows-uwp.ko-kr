...
| 매개 변수 | 형식 | 필수 | 설명 |
| --- | --- | --- | --- |
| 원본 | 문자열 | 아니요 | URI를 실행 하는 소스를 나타내는 자유 형식 문자열입니다. |
| delayInSeconds | int | 아니요 | 1 ~ 30의 정수 값입니다. 지연 되는 URI 호출과 캡처 시작 되 면 사이 전체 초를 지정 합니다. |
...
다음 예제에서는 **ms 스크린샷** 의 **secondaryFileAccessToken** 매개 변수로 지정 된 파일에 포함 될 수 있습니다.
