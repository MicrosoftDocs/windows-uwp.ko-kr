...
[**CreateTimer** ](https://msdn.microsoft.com/library/windows/apps/windows.system.threading.threadpooltimer.createtimer.aspx) 반환 된 [ **ThreadPoolTimer** ](https://msdn.microsoft.com/library/windows/apps/BR230587) 개체입니다. 타이머를 취소해야 하는 경우를 위해 이 개체를 저장합니다.
