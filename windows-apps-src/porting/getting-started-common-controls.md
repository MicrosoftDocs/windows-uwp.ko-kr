...
| 이미지 보기(UIImageView) | [Image](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Image) <br/> [Image 및 ImageBrush](https://docs.microsoft.com/windows/uwp/controls-and-patterns/images-imagebrushes) 참조 |
...
| 웹 보기(UIWebView) 및 웹 보기 대리자(UIWebViewDelegate) | [웹 보기](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.WebView) <br/>  [XAML WebView 컨트롤 샘플](https://code.msdn.microsoft.com/windowsapps/XAML-WebView-control-sample-58ad63f7) 참조 |
