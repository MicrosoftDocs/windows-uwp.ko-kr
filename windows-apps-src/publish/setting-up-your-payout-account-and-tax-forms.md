...
translationtype: HT
---
# <a name="setting-up-your-payout-account-and-tax-forms"></a>지급 계좌 및 세금 양식 설정
...
> **참고**  몇몇 지역/국가에서는 PayPal을 지급 계좌에 사용할 수 있습니다. 특정 지역/국가에서 PayPal이 지원되는지 확인하려면 [계정 유형, 위치 및 수수료](account-types-locations-and-fees.md#developer-account-and-app-submission-markets)를 참조하고, 자세한 내용은 [PayPal 정보](#paypal-info)를 읽어보세요.
...
[개발자 계정을 등록](opening-a-developer-account.md)하고 [지급 계좌](#payout-account)를 설정한 후 다음 단계를 완료하여 Windows 스토어용 *세금 프로필*을 만들 수 있습니다.
