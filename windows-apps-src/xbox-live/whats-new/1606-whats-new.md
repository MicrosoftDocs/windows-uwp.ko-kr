...
> **참고:** (XDK (Xbox 개발자 키트)를 사용 하는 경우 *새로운-2016 년 4 월* 문서 3 월 XDK 릴리스 이후 추가 된 새 추가 기능을 설명 합니다.
...
## <a name="tools"></a>도구
* Xbox Live 복원 력 플러그 인에 대 한 Fiddler 이제 Xbox Live SDK에 포함 됩니다.  
