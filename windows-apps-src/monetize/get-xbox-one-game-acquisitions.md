...
| 메서드 | 요청 URI       |
|--------|----------------------|
| 가져오기    | ```https://manage.devcenter.microsoft.com/v1.0/my/analytics/xbox/acquisitions``` |
...
| 매개 변수        | 형식   |  설명      |  필수  
|---------------|--------|---------------|------|
| applicationId | string | 취득 데이터를 검색할 Xbox One 게임의 제품 ID입니다. 이 Store ID 및 XDP 제품 ID 하지 note 게임의 제품 ID를 가져오려면 XDP 분석 프로그램의 게임을 찾아 URL에서 제품 ID를 검색 합니다. 또는 파트너 센터 분석 보고서에서 구매 데이터를 다운로드 하는 경우 제품 ID.tsv 파일에 포함 됩니다.  |  예  |
...
| top | ssNoversion | 반환할 데이터의 행 수입니다. 지정되지 않은 경우 최대값 및 기본값은 10000입니다. 쿼리에 더 많은 행이 있는 경우 응답 본문에 데이터의 다음 페이지를 요청하는 데 사용할 수 있는 다음 링크가 포함되어 있습니다. |  아니요  |
...
| applicationId       | string | 취득 데이터를 검색할 Xbox One 게임의 제품 ID입니다. 이 Store ID 및 XDP 제품 ID 하지 note  |
| applicationName     | string | 게임의 표시 이름입니다.       |
| acquisitionType     | string | 취득 유형을 나타내는 다음 문자열 중 하나입니다.<ul><li><strong>무료</strong></li><li><strong>평가판</strong></li><li><strong>유료</strong></li><li><strong>프로 모션 코드</strong></li><li><strong>Iap</strong></li><li><strong>구독 Iap</strong></li><li><strong>개인 사용자</strong></li><li><strong>사전 순서</strong></li><li><strong>Xbox Game Pass</strong>(또는 2018년 3월 23일 이전에 데이터를 쿼리한 경우에는 <strong>Game Pass</strong>임)</li><li><strong>디스크</strong></li><li><strong>선불된 코드</strong></li><li><strong>청구 전 순서</strong></li><li><strong>취소 된 사전 순서</strong></li><li><strong>실패 한 이전 순서</strong></li></ul>    |
| age                 | string | 취득한 사용자 연령 그룹을 나타내는 다음 문자열 중 하나입니다.<ul><li><strong>보다 작거나 13</strong></li><li><strong>13-17</strong></li><li><strong>18-24</strong></li><li><strong>25-34</strong></li><li><strong>35-44</strong></li><li><strong>44-55</strong></li><li><strong>55 보다 큼</strong></li><li><strong>알 수 없음</strong></li></ul>     |
| deviceType          | string | 취득을 완료한 장치 유형을 나타내는 다음 문자열 중 하나입니다.<ul><li><strong>PC</strong></li><li><strong>Phone</strong></li><li><strong>콘솔</strong></li><li><strong>IoT</strong></li><li><strong>Server</strong></li><li><strong>Tablet</strong></li><li><strong>홀로그램</strong></li><li><strong>알 수 없음</strong></li></ul>  |
| gender              | string | 취득한 사용자의 성별을 나타내는 다음 문자열 중 하나입니다.<ul><li><strong>m</strong></li><li><strong>f</strong></li><li><strong>알 수 없음</strong></li></ul>     |
| 출시              | string | 구입이 발생한 시장의 ISO 3166 국가 코드입니다.  |
| osVersion           | string | 구입이 발생한 OS 버전입니다. 이 메서드에서 이 값은 항상 **Windows 10**입니다.</li></ul>    |
| paymentInstrumentType           | string | 취득에 사용된 결제 방법을 나타내는 다음 문자열 중 하나입니다.<ul><li><strong>신용 카드</strong></li><li><strong>직접 직불 카드</strong></li><li><strong>유추 된 구매</strong></li><li><strong>MS 잔액</strong></li><li><strong>모바일 운영자</strong></li><li><strong>온라인 계좌 이체</strong></li><li><strong>PayPal</strong></li><li><strong>트랜잭션 분합니다</strong></li><li><strong>토큰 상환</strong></li><li><strong>지불 금액 0</strong></li><li><strong>eWallet</strong></li><li><strong>알 수 없음</strong></li></ul>    |
| sandboxId              | string | 게임에 대해 생성된 샌드박스 ID입니다. 이는 값 **RETAIL**이거나 개인용 샌드박스의 ID일 수 있습니다.  |
...
| xboxTitleIdHex              | string | Xbox Live 지원 게임의 Xbox 개발자 포털(XDP)에서 할당한 Xbox Live 타이틀 ID(16진 값으로 표시)입니다.  |
...
| taxUSDAmount     | number | 취득에 적용된 세금이며 USD로 변환됩니다. |
