...
Bookstore2\_81 솔루션은 8.1 유니버설 앱 프로젝트입니다. Bookstore2\_81.Windows 프로젝트 Windows8.1에 대 한 앱 패키지를 빌드하고 bookstore2_\81.windowsphone 프로젝트는 Windows Phone 8.1 용 앱 패키지를 빌드하 합니다. Bookstore2\_81.Shared는 두 프로젝트 모두에서 사용되는 소스 코드, 태그 파일, 기타 자산 및 리소스가 포함된 프로젝트입니다.

포트는 [유니버설 8.1 앱이 있는 경우](w8x-to-uwp-root.md)에 설명 된 것) (of 살펴보겠습니다 옵션 이전 사례 연구와 마찬가지로 프로젝트의 내용을 Shared는 Windows10를 대상으로 하는 범용 디바이스 패밀리입니다.
