...
### [UWP 앱에서 잉크 지원](get-started/ink-walkthrough.md)
### [UWP 앱에서 Surface Dial(및 기타 휠 장치) 지원](get-started/radialcontroller-walkthrough.md)
### [단일 페이지 웹앱 + REST API](get-started/get-started-tutorial-fullstack-web-app.md)
### [JavaScript로 작성된 2D UWP 게임](get-started/get-started-tutorial-game-js2d.md)
### [JavaScript로 작성된 3D UWP 게임](get-started/get-started-tutorial-game-js3d.md)
### [MonoGame으로 작성된 UWP 게임](get-started/get-started-tutorial-game-mg2d.md)
### [Babylon.js 게임에 WebVR 추가](get-started/adding-webvr-to-a-babylonjs-game.md)
...
#### [기본 탐색 구현](layout/navigate-between-two-pages.md)
#### [기록 및 뒤로 탐색 지원](layout/navigation-history-and-backwards-navigation.md)
...
### [색](style/color.md)
### [아이콘](style/icons.md)
### [동작 및 애니메이션](style/motion.md)
#### [연결된 애니메이션](style/connected-animation.md)
#### [콘텐츠 전환](style/content-transition-animations.md)
#### [추가 및 삭제](style/motion-list.md)
#### [페이드](style/motion-fade.md)
#### [누르기 피드백](style/motion-pointer.md)
### [시차](style/parallax.md)
### [표시](style/reveal.md)
### [소리](style/sound.md)
...
##### [보조 타일](controls-and-patterns/tiles-and-notifications-secondary-tiles.md)
###### [지침](controls-and-patterns/tiles-and-notifications-secondary-tiles-guidance.md)
###### [보조 타일 고정](controls-and-patterns/tiles-and-notifications-secondary-tiles-pinning.md)
###### [데스크톱 응용 프로그램](controls-and-patterns/tiles-and-notifications-secondary-tiles-desktop-pinning.md)
##### [타일 콘텐츠](controls-and-patterns/tiles-and-notifications-create-adaptive-tiles.md)
##### [타일 콘텐츠 스키마](controls-and-patterns/tiles-and-notifications-adaptive-tiles-schema.md)
##### [특수 타일 템플릿](controls-and-patterns/tiles-and-notifications-special-tile-templates-catalog.md)
##### [로컬 타일 알림 보내기](controls-and-patterns/tiles-and-notifications-sending-a-local-tile-notification.md)
##### [기본 타일 API](controls-and-patterns/tiles-and-notifications-primary-tile-apis.md)
#### [작업 표시줄에 앱 고정](controls-and-patterns/pin-to-taskbar.md)
#### [알림 메시지](controls-and-patterns/tiles-and-notifications-adaptive-interactive-toasts.md)
##### [알림 내용](controls-and-patterns/tiles-and-notifications-adaptive-interactive-toasts.md)
##### [알림 콘텐츠 스키마](controls-and-patterns/tiles-and-notifications-toast-schema.md)
##### [로컬 알림 메시지 보내기](controls-and-patterns/tiles-and-notifications-send-local-toast.md)
...
##### [알림 채널 유형](controls-and-patterns/tiles-and-notifications/channel-types.md)
...
##### [사용자 지정 키보드 조작](input-and-devices/custom-keyboard-interactions.md)
##### [키보드 이벤트](input-and-devices/keyboard-events.md)
...
#### [포커스 탐색 관리](input-and-devices/managing-focus-navigation.md)
...
#### [레거시 리소스 마이그레이션](globalizing/using-mrt-for-converted-desktop-apps-and-games.md)
...
## [Fluent 디자인 시스템](http://fluent.microsoft.com/)
## [디자인 도구 키트](design-downloads/index.md)
# Windows 앱 개발
## [개발자용 Windows 10 버전 1703의 새로운 기능](whats-new/windows-10-version-latest.md)
### [Windows10 버전 1703의 API 추가](whats-new/windows-10-version-1703-api-diff.md)
### [Windows 10 SDK Preview 빌드 16257의 시험판 API](whats-new/windows-10-latest-preview-api-diff.md)
### [Windows 10 빌드 2017 Preview의 새로운 기능](whats-new/windows-10-build-16190.md)
### [Windows10 버전 1607의 새로운 기능](whats-new/windows-10-version-1607.md)
...
## [2017 8월 Windows 문서의 새로운 내용](whats-new/windows-docs-latest.md)
### [2017 7월 Windows 문서의 새로운 내용](whats-new/windows-docs-july-2017.md)
...
### [C# 앱용 SQLite를 사용하는 Entity Framework Core](data-access/entity-framework-7-with-sqlite-for-csharp-apps.md)
...
#### [POS 시작 하기](devices-sensors/pos-get-started.md)
#### [POS 디바이스 지원](devices-sensors/pos-device-support.md)
...
#### [바코드 스캐너 프로필 배포](devices-sensors/deploy-scanner-profiles-with-mdm.md)
...
#### [앱 개체](gaming/about-the-metro-style-user-interface-and-directx.md)
...
#### [간단한 UWP 게임](gaming/tutorial--create-your-first-metro-style-directx-game.md)
##### [프로젝트 설정](gaming/tutorial--setting-up-the-games-infrastructure.md)
##### [UWP 프레임워크](gaming/tutorial--building-the-games-metro-style-app-framework.md)
##### [주 게임 개체](gaming/tutorial--defining-the-main-game-loop.md)
##### [렌더링 프레임워크](gaming/tutorial--assembling-the-rendering-pipeline.md)
...
## [수익 창출, 참여 및 스토어 서비스](monetize/index.md)
...
#### [스토어 제품용 데이터 스키마](monetize/data-schemas-for-store-products.md)
...
#### [시작](monetize/get-started-with-microsoft-advertising-libraries.md)
##### [Microsoft Advertising SDK 설치](monetize/install-the-microsoft-advertising-libraries.md)
##### [최신 라이브러리로 앱 업데이트](monetize/update-your-app-to-the-latest-advertising-libraries.md)
...
##### [C#의 AdControl 이벤트](monetize/adcontrol-events-in-c.md)
...
##### [대시보드에서 실험 프로젝트 만들기](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
...
#### [앱에서 대상 푸시 알림 구성](monetize/configure-your-app-to-receive-dev-center-notifications.md)
...
##### [채널 별 추가 기능 변환 가져오기](monetize/get-add-on-conversions-by-channel.md)
##### [앱 설치 받기](monetize/get-app-installs.md)
...
##### [앱에 대한 오류 보고 데이터 가져오기](monetize/get-error-reporting-data.md)
...
##### [대상 제품 요청](monetize/claim-a-targeted-offer.md)
...
### [스토어에 요청 보내기](monetize/send-requests-to-the-store.md)
...
### [선택적 패키지 및 관련 집합 제작](packaging/optional-packages.md)
...
### [데스크톱 브리지](porting/desktop-to-uwp-root.md)
...
##### [Windows 10 S용 테스트](porting/desktop-to-uwp-test-windows-s.md)
...
### [연습: C++로 기본적인 Windows 런타임 구성 요소를 만들고 JavaScript 또는 C#에서 호출](winrt-components/walkthrough-creating-a-basic-windows-runtime-component-in-cpp-and-calling-it-from-javascript-or-csharp.md)
...
#### [지역/국가 선택 정의](publish/define-pricing-and-market-selection.md)
