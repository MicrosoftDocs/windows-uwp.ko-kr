...
앱이 실행 중이면 장치를 이동하거나 에뮬레이터 도구를 사용하여 방향을 변경할 수 있습니다.
...
* [OrientationSensor 샘플](http://go.microsoft.com/fwlink/p/?linkid=241382)
* [SimpleOrientation 센서 샘플](http://go.microsoft.com/fwlink/p/?linkid=241383)
