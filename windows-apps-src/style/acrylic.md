...
## <a name="acrylic-and-the-fluent-design-system"></a>아크릴 및 Fluent 디자인 시스템
 ...
 Fluent 디자인 시스템을 사용하면 조명, 깊이, 움직임, 재질 및 배율이 통합된 선명한 현대식 UI를 만들 수 있습니다. 아크릴은 앱에 물리적 텍스처(재질)과 깊이를 추가하는 Fluent 디자인 시스템 구성 요소입니다. 
...
앱 테마를 준수하고 필요한 경우 단색으로 대체하는 배경 및 인앱 아크릴 유형을 위한 브러시 리소스 모음을 만들어 두었습니다. *Acrylic\ * WindowBrush* 리소스는 배경 아크릴을 나타내고 *Acrylic\ * ElementBrush*는 인앱 아크릴을 나타냅니다.
...
## <a name="extending-acrylic-into-your-title-bar"></a>아크릴을 제목 표시줄로 확장

앱 창 내에서 물 흐르듯 원활한 모양을 내기 위해 앱의 제목 표시줄 영역에 아크릴을 배치하는 것이 좋습니다. 이렇게 하려면 App.xaml.cs에 다음 코드를 추가합니다.
...
또한 앱 제목을 그려야 합니다. 앱 제목은 일반적으로 `CaptionTextBlockStyle`을 사용하는 TextBlock을 통해 제목 표시줄에 자동으로 표시됩니다.
