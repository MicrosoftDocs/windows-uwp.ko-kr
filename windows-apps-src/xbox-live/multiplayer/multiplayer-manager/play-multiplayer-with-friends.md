...
ms.locfileid: "4358354"
---
# <a name="play-a-multiplayer-game-with-friends"></a>친구와 멀티 플레이 게임

간단한 멀티 플레이어 시나리오 중 하나는 게이머가 친구와 온라인 게임을 플레이할 수 있도록 합니다. 이 시나리오는 멀티 플레이어 관리자를 사용 하 여 구현 해야 하는 기본 단계를 다룹니다.
...
여기에 프로세스의 순서도 볼 수: [순서도-친구와 멀티 플레이/협동 게임을 실행](mpm-flowcharts/mpm-play-with-friends.md)합니다.
