...
# Windows 스토어 제출 API를 사용하여 앱 제출 삭제




Windows 스토어 제출 API에서 이 메서드를 사용하여 기존 앱 제출을 삭제합니다.
...
| submissionId | 문자열 | 필수. 삭제할 제출의 ID입니다. 이 ID는 개발자 센터 대시보드에서 사용할 수 있으며 [앱 제출 만들기](create-an-app-submission.md) 요청에 대한 응답 데이터에 포함되어 있습니다.  |
