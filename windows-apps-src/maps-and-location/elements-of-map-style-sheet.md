...
ms.locfileid: "2892306"
---
# <a name="map-style-sheet-reference"></a>지도 스타일 시트 참조

Microsoft 매핑 기술을 사용 하 여 지도의 모양을 정의에 스타일 시트를 매핑합니다.  맵 스타일 시트를 표기법 JSON (JavaScript Object)를 사용 하 여 정의 된 및 다양 한 방법으로 포함 하 여 Windows 스토어 응용 프로그램의 [MapControl](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.maps.mapcontrol) 에서 [MapStyleSheet.ParseFromJson](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.maps.mapstylesheet.parsefromjson#Windows_UI_Xaml_Controls_Maps_MapStyleSheet_ParseFromJson_System_String_) 메서드를 통해에서 사용할 수 있습니다.
...
## <a name="entries"></a>항목
이 표는 ">" 문자를 사용하여 입력 계층의 수준을 나타냅니다.  또한 Windows의 버전과 소프트웨어의 각 항목을 지원 하 고이 무시 하는 보여줍니다.
...
| >> area                      | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 작업을 설명 하는 영역을 사용 합니다.  이러한 경우 구조 항목 아래에 있는 실제 건물과 혼동 해서는 해야 합니다. |
| >>> airport                  | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 공항을 포함 하는 영역을 선택 합니다. |
| >>> areaOfInterest           | [MapElement](#mapelement) |      |  ✔   |  ✔   |  ✔   | 비즈니스 또는 흥미로운 포인트가 집중된 영역입니다. |
| >>> cemetery                 | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Cemeteries를 포함 하는 영역을 선택 합니다. |
| >>> continent                | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 대륙 영역 레이블 합니다. |
| >>> education                | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 학교와 다른 교육 시설을 포함 하는 영역입니다. |
| >>> indigenousPeoplesReserve | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 토착 사용자를 포함 하는 영역을 예약 합니다. |
| >>> industrial               | [MapElement](#mapelement) |      |  ✔   |  ✔   |  ✔   | 산업 목적을 위해 사용 되는 영역입니다. |
| >>> island                   | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 아일랜드 영역 레이블 합니다. |
| >>> medical                  | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 의료 목적을 위해 사용 되는 영역 (예: 병원 캠퍼스). |
| >>> military                 | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 군사 진수로 포함할 또는 군사 용도로 사용 하는 영역입니다. |
| >>> nautical                 | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 항해 용 관련된 목적을 위해 사용 되는 영역입니다. |
| >>> neighborhood             | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 환경 영역 레이블 합니다. |
| >>> runway                   | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 비행기 활주로로 사용 되는 영역을 선택 합니다. |
...
| >> point                     | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 모든 일종의 아이콘을 사용 하 여 그린는 기능을 가리킵니다. |
| >>> address                  | [PointStyle](#pointstyle) |      |      |  ✔   |  ✔   | 주소 레이블 번호를 매깁니다. |
| >>> naturalPoint             | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 자연 스러운 기능을 표시 하는 아이콘을 선택 합니다. |
...
| >>> pointOfInterest          | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 관심 있는 모든 위치를 표시 하는 아이콘을 선택 합니다. |
| >>>> business                | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 모든 비즈니스 locaiton을 표시 하는 아이콘을 선택 합니다. |
| >>>>> attractionPoint        | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 여행자 점은 박물관, zoos 등 등을 표시 하는 아이콘을 선택 합니다. |
| >>>>> communityPoint         | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 커뮤니티에 일반적으로 사용의 위치를 표시 하는 아이콘을 선택 합니다. |
| >>>>> educationPoint         | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 학교와 다른 교육을 표시 하는 아이콘 관련 위치입니다. |
| >>>>> entertainmentPoint     | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 엔터테인먼트 교육 장소 극장, 시네마 및 등 등을 표시 하는 아이콘을 선택 합니다. |
| >>>>> essentialServicePoint  | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 통화 대기, 은행, 가스 필수적인 서비스를 표시 하는 아이콘을 선택 합니다. |
| >>>>> foodPoint              | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | 식당, 카페 등을 표시 하는 아이콘을 선택 합니다. |
| >>>>> lodgingPoint           | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 호텔 및 기타 숙박 기업용을 표시 하는 아이콘을 선택 합니다. |
| >>>>> realEstatePoint        | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 부동산 기업용을 표시 하는 아이콘을 선택 합니다. |
| >>>>> shoppingPoint          | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | 호텔 및 기타 숙박 기업용을 표시 하는 아이콘을 선택 합니다. |
...
| >>> countryRegion            | [BorderedMapElement](#borderedmapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 국가 영역 테두리 및 레이블 합니다. |
| >>> adminDistrict            | [BorderedMapElement](#borderedmapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Admin1, 상태, /도, 등, 테두리 및 레이블을 지정 합니다. |
...
| >>>> educationBuilding       | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 교육에 사용 되는 건물 합니다. |
| >>>> medicalBuilding         | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 건물 병원 같은 의료 용도로 사용 합니다. |
| >>>> transitBuilding         | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 공항 같은 전송에 사용 되는 건물 합니다. |
| >> transportation            | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 교통망의 일부인 줄(예: 도로, 기차, 및 여객선). |
| >>> road                     | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 모든 도로를 표시하는 줄. |
| >>>> controlledAccessHighway | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 크게 표시 하는 줄 고속도 액세스를 제어 합니다. |
| >>>>> highSpeedRamp          | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 줄에 연결 하는 일반적으로 고속 경사를 표시 하는 고속도 액세스를 제어 합니다. |
| >>>> highway                 | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 고속도 표시 하는 줄 수입니다. |
| >>>> majorRoad               | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 주요도 표시 하는 줄 수입니다. |
| >>>> arterialRoad            | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Arterial도 표시 하는 줄 수입니다. |
| >>>> street                  | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 거리를 표시 하는 줄 수입니다. |
| >>>>> ramp                   | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 고속도 연결 하는 일반적으로 경사를 표시 하는 줄 수입니다. |
| >>>>> unpavedStreet          | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Unpaved 거리를 표시 하는 줄 수입니다. |
| >>>> tollRoad                | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 사용 하 여 비용으로로 표시 하는 줄 수입니다. |
| >>> railway                  | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 철로길. |
| >>> trail                    | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 공원 또는 자국 하이킹 코스 산책로. |
| >>> 연결부                  | [MapElement](#mapelement) |      |  ✔   |  ✔   |  ✔   | 상승 된 연결부 합니다. |
...
| > routeMapElement            | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 모든 라우팅 관련된 항목입니다. |
| >> routeLine                 | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 선 라우팅 항목을 관련 합니다. |
| >>> drivingRoute             | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 구동 경로 표시 하는 줄 수입니다. |
| >>> scenicRoute              | [MapElement](#mapelement) |      |  ✔   |  ✔   |  ✔   | Scenic 구동 경로 표시 하는 줄 수입니다. |
| >>> walkingRoute             | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | 줄 이동 경로 나타냅니다. |
...
| shadedReliefDarkColor        | 색상   |  ✔   |  ✔   |  ✔   |  ✔   | 음영기복의 어두운 면의 색상.  알파 채널 최대 알파 값을 나타냅니다. |
| shadedReliefLightColor       | 색상   |  ✔   |  ✔   |  ✔   |  ✔   | 음영기복의 밝은 면의 색상.  알파 채널 최대 알파 값을 나타냅니다. |
| shadowColor                  | 색상   |      |      |      |  ✔️   | 전체 기능을 사용 하는 아이콘 뒤에 그림자의 색입니다. |
| spaceColor                   | 색상   |  ✔   |  ✔   |  ✔   |  ✔   | 지도 주위의 영역에 대한 ARGB 색 값. |
| useDefaultImageColors        | 부울    |  ✔   |  ✔   |  ✔   |  ✔   | 이미지의 색에 대 한 색상표 항목을 조회 하는 대신 사용 되는 SVG에서 원래 색 수 있는지 여부를 나타내는 플래그입니다. |
...
| borderVisible                | 부울    |  ✔   |  ✔   |  ✔   |  ✔   |  |
| borderWidthScale             | 부동   |  ✔   |  ✔   |  ✔   |  ✔   | 테두리의 선 배율이 양입니다. 예를 들어 기본값에 *1*, 대형의 두 배 값에 *2*를 사용합니다. |
...
| 속성                     | 형식    | 1506 | 1629 | 1713 | Next | 설명 |
|------------------------------|---------|------|------|------|------|-------------|
| 도형 배경             | 부동   |      |      |      |  ✔️   | 다음과 같은 존재 하는 모든 셰이프를 교체 아이콘-의 배경으로 사용 하 여 셰이프입니다. |
