...
2.  기존 알림의 테이블에 **진행 중에서** 또는 **완료**를 선택 하 고 각 알림의 높은 수준의 성능 보려면 **배달 속도** 및 **앱 시작 속도** 열을 봅니다.
...
데이터를 분석할 사용자 활동에 대 한 모든 알림:

1.  Windows 개발자 센터 대시보드에서 **참여** 섹션을 확장하고 **알림**을 선택합니다.
2.  **알림** 페이지에서 **분석** 탭을 클릭 합니다. 이 탭에는 다음 데이터가 표시 됩니다.
    * 그래프 보기는 다양 한 사용자 작업에 대 한 상태 알림 및 알림 센터 알림입니다.
