...
ms.locfileid: "7162084"
---
# <a name="join-a-tournament-by-using-the-arena-ui"></a>아레나 UI를 사용 하 여 한 토너먼트 참가
...
아레나 UI 게이머 나 조인 팀에 게 메서드를 제공합니다. 제목에 대 한 요구 사항은 없습니다.

###### <a name="ui-example-create-a-team"></a>UI 예: 팀 만들기

![팀 화면을 형성 합니다.](../../images/arena/arena-ux-create-team.png)

#### <a name="when-forming-a-team-a-gamer-can"></a>팀을 형성 하는, 게이머를 수 있습니다.
...
* 전체 팀 등록 취소 합니다. *참고 팀을 유지 하는 개별 사용자 등록 전체 팀을 취소 합니다.*
* 한 대로 등록 합니다.
