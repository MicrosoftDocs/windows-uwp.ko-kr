...
ms.locfileid: "5991781"
---
# <a name="bluetooth"></a>Bluetooth
이 섹션에서는 유니버설 Windows 플랫폼 (UWP) 앱에 Bluetooth를 통합 하는 방법에 대 한 문서가 포함 되어 있습니다. 앱에 구현를 선택할 수 있는 두 가지 다른 bluetooth 기술이 있습니다.
...
Bluetooth LE (저 에너지) 검색 및는 효율적인 에너지 사용량 요구 사항이 있는 장치 간 통신 프로토콜을 정의 하는 사양입니다. 코드 샘플을 비롯 한 자세한 내용은 [Bluetooth 저 에너지](bluetooth-low-energy-overview.md) 항목을 참조 하세요.
