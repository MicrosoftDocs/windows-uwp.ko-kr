...
description: 2018 년 7 월에 대 한 Windows 10 개발자 설명서 새로운 기능, 동영상, 샘플 및 개발자 지침 추가 되었습니다.
...
[점진적 웹 앱 (Pwa)은](https://developer.microsoft.com/windows/pwa) 단순히 플랫폼 및 homescreen에서 시작 설치, 오프 라인 지원 및 푸시 등의 브라우저 엔진에서 네이티브 앱과 유사한 기능을 사용 하 여 [점진적으로 향상](https://wikipedia.org/wiki/Progressive_enhancement) 된 웹 앱 알림입니다. Microsoft Edge (EdgeHTML) 엔진을 사용 하 여 Windows 10 Pwa 즐길 실행의 추가 장점 [UWP 앱으로 브라우저 창을 독립적으로.](https://docs.microsoft.com/microsoft-edge/progressive-web-apps/windows-features)
...
Adobe XD 및 Adobe Illustrator 도구 키트 새로운 기능으로 업데이트 되었습니다. 이러한 디자인 도구 키트는 UWP 앱 디자인을 위한 레이아웃 템플릿을 제공 합니다. [여기에 확인 합니다.](../design/downloads/index.md)
...
) WebVR는, 이유를 사용할지 및이 대 한 개발을 시작 하는 방법을 설명 합니다.
...
* 목차 이제 더 나은으로 구성 되어 있고 네 가지 최상위 버킷으로: **기본 사항**, **개발**, **리소스**및 **데모**합니다.

* [WebVR 개발자 가이드 (방문 페이지)](https://docs.microsoft.com/microsoft-edge/webvr/): 새로 고친된 모양과 느낌을 더 큰 이미지 및 아이콘 및 새 데모 합니다.
...
* [개발자가 기본 오디오 장치를 변경 하도록 것 하는 이유 하지?](https://www.youtube.com/watch?v=6aNUoVfbnmg&feature=youtu.be)
