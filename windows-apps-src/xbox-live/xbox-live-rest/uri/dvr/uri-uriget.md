...
클라이언트 클립 또는 게시 상태에 도달한 **GameClipUri** 개체에 지정 된 대로 다운로드 가능한 형식의 하는 미리 보기를 다운로드할 수 있습니다. 파일을 요청 URI 사용자나 공개 클립의 목록을 검색 하는 경우 응답 본문에 포함 됩니다.
