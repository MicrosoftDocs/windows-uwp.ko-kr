...
Windows 개발자 센터 대시보드의 **피드백** 보고서에서 Windows 10 고객이 피드백 허브를 통해 제출한 문제, 제안 및 찬성을 볼 수 있습니다. 대시보드에서 이 데이터를 보거나 데이터를 내보내서 오프라인으로 볼 수 있습니다. 
...
- **장치 유형**: 기본 설정은 **모든 장치**입니다. 해당 유형의 디바이스에서 남겨진 피드백만 표시하려면 **휴대폰**, **PC** 또는 **태블릿**을 선택할 수 있습니다.
