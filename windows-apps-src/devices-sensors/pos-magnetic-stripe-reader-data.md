...
ms.locfileid: "5698924"
---
# <a name="obtain-and-understand-magnetic-stripe-data"></a>자기 띠 데이터 가져오기 및 이해

[서비스 지점 시작](pos-basics.md)에 설명 된 단계를 사용 하 여 응용 프로그램에서 자기 띠 판독기에 설정한 후 시작 여기에서 데이터를 가져오려는 준비가 되었습니다.

## <a name="subscribe-to-datareceived-events"></a>구독할 * DataReceived 이벤트

리더 민된 카드를 인식 하면 때마다 세 가지 이벤트 중 하나 발생 합니다.
...
**AamvaCardDataReceived** / **BankCardDataReceived** 이벤트 *args* 개체에서 직접 일부 데이터를 얻을 수 있습니다. 다음 예제에는 몇 가지 속성 가져오기 멤버 변수를 할당 하 고 보여 줍니다.
