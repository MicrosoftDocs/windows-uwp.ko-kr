...
ms.locfileid: "5986414"
---
# <a name="post-usersbatch"></a>POST (/users/batch)
사용자의 일괄 처리에 대 한 상태를 가져옵니다.
...
이 메서드는 모든 클라이언트, 서비스 또는 사용자의 일괄 처리에 대 한 상태 정보를 보려면 하고자 하는 제목에서 사용 해야 합니다.

이 일괄 처리 요청에 대 한 응답 깊이 및 경로 필터 수 있습니다. 소비자와 사용자의 집합에 대 한 존재 여부를 표시 합니다.이 사용할 수 있습니다. 이 API에 필터 작동 Or로은 속성이 아니라 And에서 속성 합니다.
...
| 멤버| 설명|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 사용자| 사용자의 존재 여부 1100 XUIDs 한 번에 최대 자세한 목록 XUIDs 합니다.|
...
| 멤버| 설명|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| deviceTypes| 목록에 대해 알아야 할 사용자가 사용 되는 장치 유형입니다. 배열 비어 있으면 기본적으로 모든 가능한 장치 유형 (즉, none 필터링 됩니다).|
| 제목| 장치 목록을 형식 사용자를 알아야 합니다. 배열 비어 있으면 모든 가능한 타이틀을 기본값으로 (즉, none 필터링 됩니다).|
