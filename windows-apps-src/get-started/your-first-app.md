...
title: 첫 번째 앱 만들기
description: 원하는 프로그래밍 언어를 사용 하 여 Windows 10 용 유니버설 Windows 플랫폼 (UWP) 앱을 만듭니다.
ms.date: 01/25/2017
ms.topic: article
...
* [만들기는 "Hello, world" 앱을 사용 하 여 XAML을 사용 하 여C#](create-a-hello-world-app-xaml-universal.md)

기본적인 내용을 배우거나 기억을 되살리려면 다음 내용을 읽어보세요.

* [C#초보자를 위한 기본 사항](https://go.microsoft.com/fwlink/?linkid=850801)
...
* [간단한 2D UWP 게임 작성, Microsoft Store 대 한 C# 및 MonoGame](get-started-tutorial-game-mg2d.md)


## <a name="visualc-component-extensions-ccx-and-xaml"></a>Visual c + + 구성 요소 확장 (C + + /cli CX) 및 XAML

C + + 프로그래밍 지식이 Visual c + + 구성 요소 확장을 사용 하 여 앱 빌드를 활용 하기 위해 (C + + /cli CX) XAML을 사용 하 여 합니다.

* [만들기는 "Hello, world" 앱 XAML을 사용 하 여 C + + /cli CX](create-a-basic-windows-10-app-in-cpp.md)
...
* [만들기는 "Hello, world" HTML 및 JavaScript를 사용 하 여 앱](create-a-hello-world-app-js-uwp.md)
...
* [Microsoft Edge를 사용 하 여 WebVR 사용](https://docs.microsoft.com/en-us/microsoft-edge/webvr/)
...
* [UWP 앱에 웹 응용 프로그램으로 변환](../porting/hwa-create-windows.md)
...
* [HTML5 및 CSS3 Fundamentals for Absolute Beginners](https://www.microsoftvirtualacademy.com/training-courses/html5-css3-fundamentals-development-for-absolute-beginners)
* [Microsoft Virtual Academy](https://go.microsoft.com/fwlink/p/?LinkID=389916)
