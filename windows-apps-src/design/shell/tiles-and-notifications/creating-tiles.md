...
-   표시 이름: 이 값을 타일에 표시 하려는 이름으로 바꿉니다.
-   짧은 이름: 타일에 맞게 표시 이름에 대 한 제한 된 공간에 있기 때문에 고 짧은 이름 되도록 앱의 이름을 지정할 수 없습니다 잘릴 하는 것이 좋습니다.
-   로고 이미지:
    ...
    *&lt;이미지 이름&gt;*.scale-*&lt;배율&gt;*. *&lt;이미지 파일 확장명&gt;* 

    예를 들어 다음과 같은 가치를 제공해야 합니다. SplashScreen.scale-100.png
