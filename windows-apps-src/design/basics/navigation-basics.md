...
탐색은 사용자 경험과 일관되어야 합니다. 사용자는 익숙한 및 아이콘에 대 한 표준 규칙을 다음 [표준 컨트롤](#use-the-right-controls) 을 사용 하 여, 위치 및 스타일 지정 됩니다 탐색 예측 가능 하 고 직관적인 사용자를 위해로 합니다.
