...
-   다양한 **Cortana** 화면의 “&lt;앱&gt;(으)로 이동” 링크
-   다양한 **Cortana** 화면의 콘텐츠 타일에 포함된 링크
-   프로그래밍 방식으로 백그라운드 앱 서비스에서 포그라운드 앱 시작

## <span id="Go_to__app__deep_link"></span><span id="go_to__app__deep_link"></span><span id="GO_TO__APP__DEEP_LINK"></span>“&lt;앱(으)&gt;로 이동” 딥 링크
...
“&lt;앱&gt;(으)로 이동” 링크처럼 시작 인수를 제공하여 앱 서비스와 유사한 컨텍스트로 앱을 수 있습니다. 시작 인수를 제공하지 않으면 콘텐츠 타일이 앱에 연결되지 않습니다.
