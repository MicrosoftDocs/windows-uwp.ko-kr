...
-   3D 그래픽 - Windows 10에서는 두 가지 3D 그래픽 API 집합, 즉 Direct3D 11과 [Direct3D 12](https://msdn.microsoft.com/library/windows/desktop/dn899121)를 지원합니다. 이러한 API는 둘 다 3D 및 2D 그래픽을 만들 수 있는 기능을 제공합니다. Direct3D 11과 Direct3D 12는 함께 사용되지 않지만 2D 그래픽 및 UI 그룹의 모든 API와 함께 사용될 수 있습니다. 게임에서 그래픽 API를 사용하는 방법에 대한 자세한 내용은 [DirectX 게임의 기본 3D 그래픽](an-introduction-to-3d-graphics-with-directx.md)을 참조하세요.
    ...
    <p>[Direct3d 12](https://msdn.microsoft.com/library/windows/desktop/dn899121) 설명서를 참조하세요.</p></td>
    </tr>
    <tr class="even">
    ...
    <p><strong>자세한 정보</strong></p>
    <p>[Direct3D 11](https://msdn.microsoft.com/library/windows/desktop/ff476080) 설명서를 참조하세요.</p></td>
    </tr>
    </tbody>
    </table>
...
-   2D 그래픽 및 UI - 텍스트 및 사용자 인터페이스와 같은 2D 그래픽 관련 API입니다. 모든 2D 그래픽 및 UI API는 옵션입니다.
    ...
    <p></p>
    <p><strong>자세한 정보</strong></p>
    <p>[DirectWrite](https://msdn.microsoft.com/library/windows/desktop/dd368038) 설명서를 참조하세요.</p></td>
    </tr>
    <tr class="odd">
...
-   오디오 - 오디오 재생 및 오디오 효과 적용과 관련된 API입니다. 게임에서 오디오 API를 사용하는 방법에 대한 자세한 내용은 [게임의 오디오](working-with-audio-in-your-directx-game.md)를 참조하세요.
    ...
    <p><strong>자세한 정보</strong></p>
    <p>[XAudio2](https://msdn.microsoft.com/library/windows/desktop/hh405049) 설명서를 참조하세요.</p></td>
    </tr>
    <tr class="even">
    ...
    <p><strong>자세한 정보</strong></p>
    <p>[Microsoft Media Foundation 개요](https://msdn.microsoft.com/library/windows/desktop/ms694197)를 참조하세요.</p></td>
    </tr>
    </tbody>
    </table>
...
-   입력 - 키보드, 마우스, 게임 패드 및 기타 사용자 입력 소스에서의 입력과 관련된 API입니다.
    ...
    <p><strong>자세한 정보</strong></p>
    <p>[XInput](https://msdn.microsoft.com/library/windows/desktop/hh405053) 설명서를 참조하세요.</p></td>
    </tr>
    <tr class="even">
    ...
    <li>트리거 진동 모터와 같은 추가 Xbox One 게임 패드 기능에 액세스</li>
...
-   지원 유틸리티 - Windows 10 API를 기반으로 하는 라이브러리입니다.
    ...
    <p><strong>자세한 정보</strong></p>
    <p>Win2D 프로젝트 페이지([https://github.com/Microsoft/Win2D](https://github.com/Microsoft/Win2D))를 참조하세요.</p></td>
    </tr>
    </tbody>
    </table>
