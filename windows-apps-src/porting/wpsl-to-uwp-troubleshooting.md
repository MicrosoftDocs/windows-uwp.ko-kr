...
| _시스템에서 'System.Runtime.InteropServices.COMException' 형식의 첫 번째 예외가 발생 했습니다. NI 합니다. DLL입니다. 추가 정보: 응용 프로그램이 다른 스레드에 대 한 마샬링된 된 인터페이스를 호출 합니다. (예외가 발생한 HRESULT: 0x8001010E (RPC_E_WRONG_THREAD))._ | 수행 중인 작업을 UI 스레드에서 수행해야 합니다. [  **CoreWindow.GetForCurrentThread**](https://msdn.microsoft.com/library/windows/apps/hh701589)를 호출합니다. |
