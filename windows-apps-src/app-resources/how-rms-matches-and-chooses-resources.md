...
배율 및 고대비 등의 일부 한정자의 경우 항상 최소한의 어느 정도의 일치가 있습니다. 예를 들어, 비록 없습니다 "확장-100"을 작은 어느 정도 "확장-400"의 컨텍스트에서 일치에 대 한 정규화 된 후보 뿐만 "확장-200" 또는 (완벽 하 게 일치) "확장-400"에 대 한 정규화 된 후보입니다.
