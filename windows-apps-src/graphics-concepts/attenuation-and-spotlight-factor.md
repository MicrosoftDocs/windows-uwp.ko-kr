...
Atten = 1 / (att0<sub>있습니까</sub> + att1 인<sub>합니까</sub> \* d + att2<sub>있나요</sub> \* d²)
...
## <a name="span-idspotlight-factorspanspan-idspotlight-factorspanspan-idspotlight-factorspanspotlight-factor"></a><span id="Spotlight-Factor"></span><span id="spotlight-factor"></span><span id="SPOTLIGHT-FACTOR"></span>추천 비율
...
| phi<sub>i</sub>   | 0.0           | 부동 소수점 | 스포트라이트 i의 반영 각도(라디안 단위) | \[세타<sub>있습니까</sub>, pi) |
