...
3.  **읽기 액세스를 위해 사용자의 파일 선택 열고 파일 스트림을 대 한 원본으로 설정의** [**MediaElement**](https://msdn.microsoft.com/library/windows/apps/br242926)및 다음 파일을 재생 합니다.
    ```cs
    if (file != null)
    {
