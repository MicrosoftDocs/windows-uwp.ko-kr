...
성공적으로, 플레이어가 친구를 인지를 플레이어에 게 사용자 메시지를 보내는 200의 결과 코드에 발생 합니다. 그러나 차단한 사람에 게 메시지를 보내는 수신자의 메시지를 받지 하며 메시지 메시지 되지 않았지만 하는 표시 되지 않습니다.

또한 제한이 있습니다 얼마나 많은 메시지를 받을 하루 및 친구와 얼마나 많은 친구에 게 다음과 같습니다.
