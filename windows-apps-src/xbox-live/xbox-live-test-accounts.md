...
기존 Xbox Live 계정을 하지 않거나 추가 msa Msa를 필요로 하는 경우에 일부를 만들 수 있습니다 [https://account.microsoft.com/account](https://account.microsoft.com/account).
...
모든 테스트 계정을 만든 개발 샌드박스를 이름의 접두사가 고 액세스 개발 샌드박스를 자동으로 됩니다.
