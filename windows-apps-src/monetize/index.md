...
description: "Windows SDK, Microsoft Advertising SDK, Microsoft Store Services SDK 및 Windows 스토어는 앱에서 더 큰 수익을 창출하고 사용자 참여를 통해 고객을 확보할 수 있게 해주는 다양한 기능을 제공합니다."
...
Windows SDK, Microsoft Advertising SDK, Microsoft Store Services SDK 및 Windows 스토어는 앱에서 더 큰 수익을 창출하고 사용자 참여를 통해 고객을 확보할 수 있게 해주는 다양한 기능을 제공합니다. 이 섹션의 항목에서는 이러한 기능을 앱에 빌드하는 방법을 보여 줍니다.
