...
앱의 선택적 패키지는 이제 실행 C# 코드를 포함할 수 있습니다. [Visual Studio를 사용하여 기본 앱 패키지를 지원하도록 선택적 추가 기능 패키지를 구성하는 방법을 알아봅니다](/windows/msix/package/optional-packages).
