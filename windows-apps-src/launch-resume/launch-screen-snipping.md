...
ms.locfileid: "4530995"
---
# <a name="launch-screen-snipping"></a>화면 캡처 시작

**ms screenclip:** 및 **ms screensketch:** URI 스키마를 사용 하면 캡처 또는 편집할 스크린샷을 시작할 수 있습니다.

## <a name="open-a-new-snip-from-your-app"></a>앱에서 새 캡처를 엽니다.

**ms screenclip:** URI에 앱이 자동으로 열고, 하 고 새 캡처를 시작할 수 있도록 합니다. 결과 캡처는 사용자의 클립보드에 복사 하지만 자동으로 앱에 다시 전달 되지 않습니다.

**ms screenclip:** 다음 매개 변수를 사용 합니다.

| 매개 변수 | 형식 | 필수 | 설명 |
| --- | --- | --- | --- |
| 소스 | 문자열 | 아니요 | URI를 실행 하는 소스를 나타내는 자유형 문자열입니다. |
| delayInSeconds | int | 아니요 | 1 ~ 30의 정수 값입니다. 초간 URI 호출과 캡처 시작 되 면 사이에서 지연 시간을 지정 합니다. |
