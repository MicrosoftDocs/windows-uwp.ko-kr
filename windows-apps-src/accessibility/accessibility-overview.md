...
<span id="Accessibility_and_your_app"> </span> <span id="accessibility_and_your_app"> </span> <span id="ACCESSIBILITY_AND_YOUR_APP"> </span>접근성 및 앱
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="UI_Automation"> </span> <span id="ui_automation"> </span> <span id="UI_AUTOMATION"> </span>UI 자동화
-------------------------------------------------------------------------------------------------------------
...
<span id="Assistive_technology"> </span> <span id="assistive_technology"> </span> <span id="ASSISTIVE_TECHNOLOGY"> </span>보조 기술
-----------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Screen_reader_support_and_basic_accessibility_information"> </span> <span id="screen_reader_support_and_basic_accessibility_information"> </span> <span id="SCREEN_READER_SUPPORT_AND_BASIC_ACCESSIBILITY_INFORMATION"> </span>화면 읽기 프로그램 지원 및 기본 접근성 정보
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Keyboard_support"> </span> <span id="keyboard_support"> </span> <span id="KEYBOARD_SUPPORT"> </span>키보드 지원
-------------------------------------------------------------------------------------------------------------------------
...
<span id="Media_and_captioning"> </span> <span id="media_and_captioning"> </span> <span id="MEDIA_AND_CAPTIONING"> </span>미디어 및 캡션
-----------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Accessible_text"> </span> <span id="accessible_text"> </span> <span id="ACCESSIBLE_TEXT"> </span>접근성 있는 텍스트
---------------------------------------------------------------------------------------------------------------------
...
<span id="Supporting_high-contrast_themes"> </span> <span id="supporting_high-contrast_themes"> </span> <span id="SUPPORTING_HIGH-CONTRAST_THEMES"> </span>고대비 테마 지원
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Design_for_alternative_UI"> </span> <span id="design_for_alternative_ui"> </span> <span id="DESIGN_FOR_ALTERNATIVE_UI"> </span>대체 UI 디자인
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Verification_and_publishing"> </span> <span id="verification_and_publishing"> </span> <span id="VERIFICATION_AND_PUBLISHING"> </span>검증 및 게시
---------------------------------------------------------------------------------------------------------------------------------------------------------------------

앱의 접근성 등록 및 게시에 대한 자세한 내용은 [스토어의 접근성](accessibility-in-the-store.md)을 참조하세요.

**참고** 앱을 접근성 있는 앱으로 등록하는 것은 Windows 스토어에만 적합합니다.

<span id="Assistive_technology_support_in_custom_controls"> </span> <span id="assistive_technology_support_in_custom_controls"> </span> <span id="ASSISTIVE_TECHNOLOGY_SUPPORT_IN_CUSTOM_CONTROLS"> </span>사용자 지정 컨트롤의 보조 기술 지원
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
