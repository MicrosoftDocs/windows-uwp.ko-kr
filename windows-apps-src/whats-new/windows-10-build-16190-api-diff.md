---
author: QuinnRadich
title: "Windows 10 빌드 16190 API 변경 사항"
description: "개발자는 다음 목록을 사용하여 Windows10 SDK Preview 빌드 16190에서 새로 추가되었거나 변경된 네임스페이스를 식별할 수 있습니다."
keywords: "새로운 기능, 새 기능, 업데이트, 플라이트 빌드, 플라이트, API, 15021"
ms.author: quradic
ms.date: 5/11/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16190"></a>Windows 10 SDK Preview 빌드 16190의 새로운 API

신규 및 업데이트 API 네임스페이스는 Windows 10 SDK Preview 빌드 16190의 [Windows 참가자](https://insider.windows.com/)에서 제공되어 왔습니다. 이 릴리스는 [Microsoft Build 2017 개발자 회의](https://developer.microsoft.com/windows/projects/events/build/2017?ocid=wdgbld17_intreferral_devcenterhp_null_null_devcenter_hppost&utm_campaign=wdgbld17&utm_medium=internalreferral&utm_source=devcenterhp&utm_content=devcenter_hppost)가 함께 제공됩니다.

다음은 마지막 공개 Windows 10 릴리스인 [버전 1703](windows-10-version-1703-api-diff.md) 이후에 추가되거나 수정된 네임스페이스에 대해 게시된 시험판 설명서의 전체 목록입니다. 시험판 설명서는 불완전하거나 변경될 수 있다는 점에 유의하십시오.
