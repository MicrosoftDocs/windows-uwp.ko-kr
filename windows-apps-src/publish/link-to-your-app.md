...
## <a name="linking-directly-to-your-app-in-the-microsoft-store"></a>Microsoft 스토어의 앱에 직접 연결

Microsoft Store를 시작 하 고 사용 하 여 브라우저를 열지 않고도 앱의 목록 페이지로 직접 이동 하는 링크를 만들 수는 **ms-windows 스토어:** URI 체계입니다.
...
이 URI 체계를 사용 하 여 앱의 스토어 목록에 직접 연결을 앱의 스토어 ID를이 링크를 추가 합니다.
