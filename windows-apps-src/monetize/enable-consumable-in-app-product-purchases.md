---
Description: 사용할 수 있는 앱 내 제품 제공 &\#8212; 구입할 수 있는 항목을 사용 하 고 다시 구매 &\#8212; 스토어를 통해 전자 상거래 플랫폼은 구매를 사용 하 여 고객 환경을 제공 하는 강력 하 고 신뢰할 수 있는 합니다.
...
## <a name="step-2-tracking-local-fulfillment-of-the-consumable"></a>2단계: 사용할 수 있는 로컬 처리를 추적합니다.
...
## <a name="step-3-reporting-product-fulfillment-to-the-store"></a>3단계: 저장소를 보고 제품 fulfillment
...
## <a name="step-4-identifying-unfulfilled-purchases"></a>4단계: 충족 되지 않은 구매를 식별합니다.
