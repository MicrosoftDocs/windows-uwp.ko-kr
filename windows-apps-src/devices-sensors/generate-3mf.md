...
3D 제조 형식 문서의 구조와 [**Windows.Graphics.Printing3D**](https://msdn.microsoft.com/en-us/library/windows/apps/windows.graphics.printing3d.aspx) API를 사용하여 이 구조를 만들고 조작하는 방법을 설명합니다.
...
**Printing3D3MFPackage** 클래스는 전체 3MF 문서를 나타내며 3MF 문서의 핵심에 [**Printing3DModel**](https://msdn.microsoft.com/en-us/library/windows/apps/windows.graphics.printing3d.printing3dmodel.aspx) 클래스로 표시되는 모델 부분이 있습니다. 3D 모델에 대해 지정하려는 대부분의 정보는 **Printing3DModel** 클래스의 속성과 해당하는 기본 클래스의 속성을 설정하여 저장합니다.
...
이 가이드의 컨텍스트에서 메시는 단일 꼭짓점 집합에서 생성된 3D 기하 도형의 본체입니다(단일 입체로 표시할 필요 없음). 메시 부분은 [**Printing3DMesh**](https://msdn.microsoft.com/en-us/library/windows/apps/windows.graphics.printing3d.printing3dmesh.aspx) 클래스에 의해 표시됩니다. 유효한 메시 개체에는 모든 꼭짓점과 특정 꼭짓점의 집합 사이에 있는 삼각형의 모든 면의 위치에 대한 정보가 포함되어야 합니다. 
...
여기에서 인쇄 작업을 앱 내에서 시작하거나([앱에서 3D 인쇄](https://msdn.microsoft.com/en-us/library/windows/apps/mt204541.aspx) 참조) 이 **Printing3D3MFPackage**를 .3mf 파일로 저장할 수 있습니다.
...
[앱에서 3D 인쇄](https://msdn.microsoft.com/en-us/library/windows/apps/mt204541.aspx)
