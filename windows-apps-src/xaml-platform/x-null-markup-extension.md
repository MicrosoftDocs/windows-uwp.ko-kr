...
일부 Windows 런타임 형식은 nullable 형식입니다. nullable 형식에 기본값으로 **null**이 아직 포함되어 있지 않으면 XAML에서 **{x:Null}** 을 사용하여 **null** 값으로 설정할 수 있습니다. /Cx (C++비주얼 C++ 구성 요소 확장)를 사용 하는 경우 nullable 형식은 [Platform:: ibox @ no__t-4](https://docs.microsoft.com/cpp/cppcx/platform-ibox-interface)로 표시 됩니다. Microsoft .NET 언어를 사용하는 경우 nullable 형식은 [**Nullable<T>** ](https://docs.microsoft.com/dotnet/api/system.nullable-1)로 표현됩니다.
