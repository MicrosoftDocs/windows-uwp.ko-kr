...
-   꼭 짓 점 color1 경우 AMBIENTMATERIALSOURCE D3DMCS =\_COLOR1, 첫 번째 꼭 짓 점 색 꼭 짓 점 선언에서 제공 됩니다.
-   꼭 짓 점 color2 경우 AMBIENTMATERIALSOURCE D3DMCS =\_COLOR2, 및 두 번째 꼭 짓 점 색 꼭 짓 점 선언에서 제공 됩니다.
-   재질 주변 색

**참고**    AMBIENTMATERIALSOURCE 옵션 중 하나를 사용 하 고 들어온 꼭지점 색상을 제공 하지 않으면 경우 재질 주변 색이 사용 됩니다.

 

재질 주변 색을 사용하려면 아래 예제 코드처럼 SetMaterial을 사용합니다.

Gₐ는 전역 주변 색입니다. SetRenderState를 사용 하 여 설정 됩니다 (D3DRS\_주변광). Direct3D 장면에 1개의 전역 주변 색이 있습니다. 이 매개 변수는 Direct3D 조명 개체와 연결되어 있지 않습니다.
