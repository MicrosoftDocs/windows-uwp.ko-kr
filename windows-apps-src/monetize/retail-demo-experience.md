...
ms.locfileid: "8347627"
---
# <a name="add-retail-demo-rdx-features-to-your-app"></a>소매 데모 (RDX) 기능을 앱 추가

고객에 게 Pc 및 장치를 판매 바닥 사용해에서 바로 이동할 수 있도록 Windows 앱에서 소매 데모 모드를 포함 합니다.
...
* **오프 라인 경험 Memorable**합니다. 소매점 장치의 50% 정도 오프 라인으로 오프 라인 경험을 보여 주기 위해 앱이 필요 합니다. 이는 오프라인으로 앱을 조작하는 고객도 의미 있고 긍정적인 경험을 하도록 하려는 것입니다.
...
정리는 구매자 장치와 상호 작용 중지 되 면 2 분 시작 됩니다. 소매 데모를 재생 하 고 Windows 연락처, 사진 및 다른 앱에서 샘플 데이터 초기화를 시작 합니다. 장치에 따라 간에 되돌려 모든 다시 설정 하는 데 1 ~ 5 분이 걸릴 수 있습니다. 이렇게 하면 모든 고객은 소매점에서 장치를 이용 하 고 디바이스와 상호 작용할 때 동일한 환경에 수 있습니다.
...
다운로드 및 데이터를 캐시 하는 경우 또는 *LocalState* 데이터 삭제를 광범위 한 설치를 실행 하는 사용자 지정 정리 논리가 필요한 시나리오 포함 되어 있습니다.
