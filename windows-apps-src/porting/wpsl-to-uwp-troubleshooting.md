...
| _XamlCompiler 오류 WMC0055: 텍스트 값을 할당할 수 없습니다. '&lt;스트림 형상&gt;' 속성 'RectangleGeometry' 형식의 ' 클립'으로_ | UWP에서는 [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) 및 XAML C++ UWP 앱의 형식입니다. |
| _XamlCompiler 오류 WMC0001: 알 수 없는 형식 'RadialGradientBrush' XML 네임 스페이스 [...]_ | UWP에는 **RadialGradientBrush** 형식이 없습니다. 태그에서 **RadialGradientBrush**를 제거하고 [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) 및 XAML C++ UWP 앱의 일부 다른 형식을 사용합니다. |
| _XamlCompiler 오류 WMC0011: 알 수 없는 멤버 'OpacityMask' 요소의 '&lt;UIElement 형식이&gt;'_ | UWP  [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) 및 XAML C++ UWP 앱입니다. |
| _시스템에서 'System.Runtime.InteropServices.COMException' 형식의 첫 번째 예외가 발생 했습니다. NI 합니다. DLL입니다. 추가 정보: 응용 프로그램이 다른 스레드에 대 한 마샬링된 된 인터페이스를 호출 합니다. (예외가 발생한 HRESULT: 0X8001010E (RPC_E_WRONG_THREAD))입니다._ | 수행 중인 작업을 UI 스레드에서 수행해야 합니다. [  **CoreWindow.GetForCurrentThread**](https://msdn.microsoft.com/library/windows/apps/hh701589)를 호출합니다. |
