...
ms.locfileid: "58174181"
---
# <a name="using-the-visual-layer-with-windows-forms"></a>시각적 계층을 사용 하 여 Windows Forms를 사용 하 여

Windows 런타임 구성 Api를 사용할 수 있습니다 (라고도 합니다 [시각적 계층](visual-layer.md))는 Windows 10 사용자에 대해 간단한 최신 환경을 만들기 위해 Windows Forms 앱에서.
...
![실행 중인 앱 UI](images/interop/wf-comp-interop-app-ui.png)
