...
|---------------|--------------------|---------------------|
| 복사 | Command+C | Ctr+C |
| 잘라내기 | Command+X | Ctr+X |
| 붙여넣기 | Command+V | Ctr+V |
...
| Switch between apps | 해당 없음 | Slow three finger sideways swipe |
...
| Open extra information | Three finger tap | 해당 없음 |
 ...
 **App** | **Mac** | **Windows** |
|---------------|--------------------|---------------------|
| Settings and Preferences | System Preferences | 설정 |
| 작업 관리자 | Activity Monitor | 작업 관리자 |
| Disk formatting | Disk Utility | 디스크 관리 |
| Text editing | TextEdit | Windows 메모장 |
| Event viewing | 콘솔 | 이벤트 뷰어 |
| Find files/apps | Command+Space | Windows 키 |
