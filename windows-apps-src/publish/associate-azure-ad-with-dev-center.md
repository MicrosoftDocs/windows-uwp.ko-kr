...
1.  [Windows 개발자 센터 대시보드](https://partner.microsoft.com/dashboard)(근처 대시보드의 오른쪽 위 모서리) 기어 아이콘을 선택 하 고 **계정 설정**를 선택 합니다. **설정** 메뉴의 **테 넌 트**를 선택 합니다.
