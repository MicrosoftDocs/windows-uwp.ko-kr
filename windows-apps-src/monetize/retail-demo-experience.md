...
소매점을 둘러보는 고객은 최신 PC와 휴대폰이 진열되어 있을 것이라고 기대합니다. 이처럼 소매점에 진열된 장치를 소매 데모 장치라고 합니다. 대개 고객은 소매 데모 장치를 오랫동안 사용하므로 어떤 장치에 어떤 콘텐츠를 설치했느냐가 소매점에서의 고객 경험을 크게 좌우합니다.
...
* 온라인 장치: Windows 스토어에서 장치로 소매 데모 자산이 푸시될 수 있습니다.
