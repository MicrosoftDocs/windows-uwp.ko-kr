...
계정 설정을 확인 하려면 대시보드에의 오른쪽 위 모서리에 기어 아이콘을 클릭 한 다음 **개발자 설정**을 선택 합니다. 여기 계정 및 정보를 확인 하 고 다양 한 계정 관련 작업을 수행할 수 있는 다른 페이지로 연결 하는 방법에 대 한 세부 정보를 찾을 수 있습니다.

**계정 세부 정보** 섹션에서는 계정의 상태 및 유형을 확인할 수 있습니다. 또한 판매자 ID 및 여기에 다른 publisher ID 정보를 볼 수 있습니다. 이러한 값 고유 하 게 개발자 계정을 식별 하기 위해 Microsoft에서 할당 된 및 편집할 수 없습니다.
...
- **확인 상태**: 계정에서 진행 되 고 때 확인 하는 프로세스 (처음 등록 하는 경우에 같이 또는 크게 사용자 연락처 정보를 업데이트 한 후에), 여기에 확인 상태를 검토할 수 있습니다.
- **개발자 센터 내부 인 프로그램**: 또는 주에서 [개발자 센터 내부 인 프로그램](dev-center-insider-program.md) 로그를 선택할 수 있는 **계정 설정** 페이지입니다.
...
- **테 넌 트**: 여 Azure AD 테 넌 트 연결을 관리 합니다. 자세한 정보에 대 한 [개발자 센터 계정 사용 하 여 Azure AD 연결](associate-azure-ad-with-dev-center.md)을 참조 합니다.
- **프로그램**: 참여 중인 프로그램에 대한 세부 정보를 확인하고 관심이 있는 다른 프로그램에 대해 알아봅니다.
- **계약**: 계정을 수락한 계약을 확인합니다.
- **개발 장치**: 보기 [테스트에 대 한 잠금을 해제 했을 때 Windows Phone 8.x 장치](http://go.microsoft.com/fwlink/p/?LinkId=533897) 및 [Xbox 하나의 콘솔 개발에 대해 활성화](../xbox-apps/devkit-activation.md)하 고 관리 합니다. 
