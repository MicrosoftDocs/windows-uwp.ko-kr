...
> [!NOTE]
> 개발자 모드가 제대로 설치 하지 않는 경우 새 피드백 요청 합니다. **피드백 허브** 앱에 **추가 새 피드백**을 선택 하 고 **개발자 플랫폼** 범주와 **개발자 모드** 하위 범주를 선택 합니다. 피드백 제출 Microsoft 발생 한 문제를 해결 하는 데 도움이 됩니다.
