...
* 가져오려는 제품을 소유한 사용자의 ID를 나타내는 Windows 스토어 ID 키.
...
| productSkuIds     | 목록&lt;ProductSkuId&gt; | 지정한 경우 서비스는 제공된 제품/SKU 쌍에 해당하는 제품만 반환합니다. 자세한 내용은 아래 표를 참조하세요.      | 아니요       |
...
| identityValue        | 문자열 | 제품을 쿼리하려는 사용자의 ID를 나타내는 [Windows 스토어 ID 키](view-and-grant-products-from-a-service.md#step-4).  | 예      |
...
| 매개 변수 | 유형   | 설명          | 필수 |
|-----------|--------|----------------------|----------|
| productId | 문자열 | Windows 스토어 카탈로그의 [제품](in-app-purchases-and-trials.md#products-skus-and-availabilities)에 대한 [스토어 ID](in-app-purchases-and-trials.md#store-ids). 제품에 대한 스토어 ID의 예는 9NBLGGH42CFD입니다. | 예      |
| skuID     | 문자열 | Windows 스토어 카탈로그의 제품 [SKU](in-app-purchases-and-trials.md#products-skus-and-availabilities)에 대한 [스토어 ID](in-app-purchases-and-trials.md#store-ids). SKU에 대한 스토어 ID의 예는 0010입니다.       | 예      |
