...
참조가 제대로 구성되면 다음 작업은 서버의 기능을 구현하는 것입니다. MSDN 항목 [Windows 런타임 구성 요소와의 상호 운용성 모범 사례(C\#/VB/C++ 및 XAML을 사용하는 UWP 앱)](https://msdn.microsoft.com/library/windows/apps/hh750311.aspx)를 참조하세요.
...
일반 UWP 앱 패키지 내부에서 사용하기 위해 프록시 및 스텁을 만들고 등록하는 프로세스는 [Windows 런타임 구성 요소에서 이벤트 발생](https://msdn.microsoft.com/library/windows/apps/dn169426.aspx) 항목에서 설명되어 있습니다.
