...
>**참고**&nbsp;&nbsp;피드백 허브는 Windows 10 버전 10.0.14271 이상을 실행하는 디바이스에서만 사용할 수 있습니다. 사용자 디바이스에서 피드백 허브를 사용할 수 있는 경우에만 앱에 피드백 컨트롤을 표시하는 것이 좋습니다. 이 항목의 코드는 이 작업을 수행하는 방법을 보여 줍니다.

## 앱에서 피드백 허브를 시작하는 방법

앱에서 피드백 허브를 시작하려면

1. [Microsoft Store Services SDK](http://aka.ms/store-em-sdk)를 설치합니다. 피드백 허브를 시작하는 API 외에, 이 SDK는 A/B 테스트로 앱에서 실험 실행, 광고 표시 등의 다른 기능을 위한 API도 제공합니다. 이 SDK에 대한 자세한 내용은 [Microsoft Store Services SDK](microsoft-store-services-sdk.md)를 참조하세요.
