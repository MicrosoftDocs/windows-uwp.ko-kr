---
PropertyPath 클래스 및 문자열 구문을 사용하여 XAML이나 코드에서 PropertyPath 값을 인스턴스화할 수 있습니다.
속성 경로 구문'
...
**참고** C++ 데이터 원본에 대한 인덱싱 지원은 제한됩니다. [데이터 바인딩 심층 분석](https://msdn.microsoft.com/library/windows/apps/mt210946)를 참조하세요.
