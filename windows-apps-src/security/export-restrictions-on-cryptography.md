...
> **참고**  여기에 제공 된 정보는 몇 가지 지침을 제공 하지만 앱이 적용 가능한 모든 법률 및 규정을 준수 하도록 Microsoft Store에 앱을 게시 하는 앱 개발자의 책임입니다.
...
> **중요**  앱에 대해 작성 한 코드 뿐만 아니라 앱에 포함 되거나 연결 되는 모든 소프트웨어 라이브러리, 유틸리티 및 운영 체제 구성 요소를 고려 합니다.
