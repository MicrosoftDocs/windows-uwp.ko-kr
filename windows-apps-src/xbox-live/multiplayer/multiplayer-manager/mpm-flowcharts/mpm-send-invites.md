...
아래 순서도 일반적으로 나타내는 제목 호출할 수 사용자 인터페이스를 위해 TCUI 스탠드 친구 선택기에 대 한 초대장 같은 UI 요소를 사용 합니다. 시스템은 TCUI를 Xbox One 및 Windows 10에서 사용할 수 있거나 타이틀을 온라인 친구를 보고 하 라는 사용자 지정 TCUI를 구현할 수를 제공 합니다.
