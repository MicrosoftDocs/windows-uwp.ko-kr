...
3.  **새 캠페인** 페이지의 **캠페인 목표** 섹션에서 다음 중 하나를 선택합니다.
    ...
    -   **회원님의 앱에서 참여 늘리기**. 광고 캠페인을 통해 고객의 앱 사용을 증가시키려면 이 옵션을 선택합니다.

4.  **캠페인의 세부 정보** 섹션에서 캠페인에 대한 전반적인 설정을 정의합니다.
    ...
    -   **캠페인 기간**에서 다음 옵션 중 하나를 선택합니다.
        - **사용자 지정**. 이 옵션을 선택하는 경우 캠페인 예산은 지정한 날짜와 기간 동안 사용됩니다.
...
6.  캠페인 목표로 **앱 참여 늘리기**를 선택한 경우 대상으로 지정할 고객층 중 하나를 선택할 수 있습니다.
    ...
    > **참고** 이 캠페인을 사용하여 만든 광고는 세그먼트에 포함된 고객에게만 표시됩니다. 세그먼트는 광고 캠페인 당 하나만 선택할 수 있습니다.
...
7.  **광고 디자인** 섹션에서 다음 옵션 중 하나를 선택합니다.
    ...
    -   **자동 생성**. 기본 템플릿 목록의 광고를 사용하려면 이 옵션을 선택합니다. 다음 옵션을 사용하여 광고 콘텐츠를 사용자 지정할 수 있습니다. 선택을 하면 광고 미리 보기가 자동으로 업데이트됩니다.
        ...
        -   광고를 세부적으로 사용자 지정하려면 **광고 디자인 사용자 지정/모든 광고 크기 보기**를 확장하고 다음 중 하나를 선택합니다.
            ...
            - **동작 호출**. **열기**, **재생**, **읽기**, **듣기** 또는 **쇼핑**을 선택합니다.


8. Kochava 또는 Tune을 사용하여 앱에 대한 설치 분석을 측정하는 경우 **타사 설치 추적 URL(Kochava 또는 Tune)**을 클릭하고 Kochava 또는 Tune에서 설치 추적 URL을 입력합니다. 캠페인을 저장하는 경우 추적 URL이 Windows 스토어에서 앱의 목록 페이지로 확인되는지 확인하기 위해 추적 URL의 유효성이 검사됩니다. Kochava 및 Tune을 사용한 설치 추적에 대한 자세한 내용은 [Kochava](http://support.kochava.com/) 및 [Tune](https://help.tune.com/) 설명서를 참조하세요.
