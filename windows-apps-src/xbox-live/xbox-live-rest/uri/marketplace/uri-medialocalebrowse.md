...
이 API를 사용 하면 지정 된 항목의 자식 내에서 검색 합니다. 예를 들어, ID 및 MediaItemType 매개 변수는 Xbox 360 게임에 대 한 전달 하 여 따라서 검색 및 diltering DLC 게임에 대 한 아바타 항목 등의 해당 항목의 자식에 있습니다.
