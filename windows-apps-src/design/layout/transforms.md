...
title: 변환 개요
description: Windows 런타임에서 변환을 사용 하는 방법을 알아봅니다 &\#160; UI에서 요소의 상대 좌표 시스템을 변경 하 여 API입니다.
ms.date: 02/08/2017
ms.topic: article
...
## <a name="span-idwhatisatransformspanspan-idwhatisatransformspanspan-idwhatisatransformspanwhat-is-a-transform"></a><span id="What_is_a_transform_"></span><span id="what_is_a_transform_"></span><span id="WHAT_IS_A_TRANSFORM_"></span>변환 이란?
...
-   [**TranslateTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.TranslateTransform): x, y 공간 요소에 대 한 값을 설정 하 여 변환 [ **X** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.translatetransform.x) 고 [ **Y** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.translatetransform.y).
-   [**ScaleTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.ScaleTransform): 확장에 대 한 값을 설정 하 여 중간 지점에 따라 변환을 [ **CenterX**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centerx)하십시오 [ **CenterY** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centery)하십시오 [ **ScaleX** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.scalex) 하 고 [ **ScaleY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.scaleyproperty)합니다.
-   [**RotateTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.RotateTransform): x, y 공간에 대 한 값을 설정 하 여 회전 [ **각도**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.angle)하십시오 [ **CenterX** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.centerx) 및 [ **CenterY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.rotatetransform.centery)합니다.
-   [**SkewTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.SkewTransform): 오차 또는 값을 설정 하 여 x, y 공간에서 전단 [ **AngleX**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.anglex)를 [ **AngleY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.angley), [ **CenterX** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.skewtransform.centerx) 하 고 [ **CenterY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.scaletransform.centeryproperty)합니다.
...
변환, 결합할 수 있습니다 이며이 지 원하는 두 개의 Windows 런타임 클래스: [**CompositeTransform** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.CompositeTransform) 하 고 [ **TransformGroup**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.TransformGroup)합니다. **CompositeTransform**에서는 크기 조정, 기울이기, 회전, 변환 순으로 변형이 적용됩니다. 다른 순서로 변형을 적용하려는 경우 **CompositeTransform** 대신 **TransformGroup**을 사용합니다. 자세한 내용은 [**CompositeTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.CompositeTransform)을 참조하세요.

## <a name="span-idtransformsandlayoutspanspan-idtransformsandlayoutspanspan-idtransformsandlayoutspantransforms-and-layout"></a><span id="Transforms_and_layout"></span><span id="transforms_and_layout"></span><span id="TRANSFORMS_AND_LAYOUT"></span>변환 및 레이아웃
...
**마이그레이션 참고:**  Windows Presentation Foundation (WPF)가를 **LayoutTransform** 레이아웃 패스 전에 변환을 적용 하는 속성입니다. 그러나 Windows 런타임 XAML은 **LayoutTransform** 속성을 지원하지 않습니다. Microsoft Silverlight에도 이 속성이 없었습니다.

## <a name="span-idapplyingatransformtoauielementspanspan-idapplyingatransformtoauielementspanspan-idapplyingatransformtoauielementspanapplying-a-transform-to-a-ui-element"></a><span id="Applying_a_transform_to_a_UI_element"></span><span id="applying_a_transform_to_a_ui_element"></span><span id="APPLYING_A_TRANSFORM_TO_A_UI_ELEMENT"></span>UI 요소에 변환 적용
...
-   [**Brush.Transform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.transform), [**Brush.RelativeTransform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.relativetransform): 이러한 영향을 어떻게를 [ **브러시** ](/uwp/api/Windows.UI.Xaml.Media.Brush) 좌표 영역 내에서 공간을 사용 하는 **브러시** foregrounds 및 배경과 같은 시각적 속성 설정에 적용 됩니다. 이러한 변형은 일반적으로 [**SolidColorBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.SolidColorBrush)를 사용하여 단색을 설정하는 대부분의 일반 브러시와 관련이 없지만, [**ImageBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.ImageBrush) 또는 [**LinearGradientBrush**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.LinearGradientBrush)를 사용하여 영역을 그릴 때 유용할 수 있습니다.
-   [**Geometry.Transform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.geometry.transform): 이 속성을 사용 하 여 변환 된 기 하 도형에 해당 기 하 도형을 사용 하 여 이전에 적용할 수는 [ **Path.Data** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.shapes.path.data) 속성 값입니다.

## <a name="span-idanimatingatransformspanspan-idanimatingatransformspanspan-idanimatingatransformspananimating-a-transform"></a><span id="Animating_a_transform"></span><span id="animating_a_transform"></span><span id="ANIMATING_A_TRANSFORM"></span>변환에 애니메이션 적용

[**변환** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Transform) 개체에 애니메이션을 적용할 수 있습니다. **Transform**에 애니메이션 효과를 주려면 애니메이션 효과를 줄 속성에 호환되는 형식의 애니메이션을 적용합니다. 모든 변형 속성은 [**Double**](https://docs.microsoft.com/dotnet/api/system.double?redirectedfrom=MSDN) 형식이므로, 일반적으로 [**DoubleAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.DoubleAnimation) 또는 [**DoubleAnimationUsingKeyFrames**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.doubleanimationusingkeyframes) 개체를 사용하여 애니메이션을 정의합니다. [  **UIElement.RenderTransform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.rendertransform) 값에 사용되는 변형에 영향을 주는 애니메이션은 기간이 0이 아닌 경우에도 종속 애니메이션으로 간주되지 않습니다. 종속 애니메이션에 대한 자세한 내용은 [스토리보드 애니메이션](/windows/uwp/design/motion/storyboarded-animations)을 참조하세요.
...
## <a name="span-iddescribingatransformmathematicallyspanspan-iddescribingatransformmathematicallyspanspan-iddescribingatransformmathematicallyspandescribing-a-transform-mathematically"></a><span id="Describing_a_transform_mathematically"></span><span id="describing_a_transform_mathematically"></span><span id="DESCRIBING_A_TRANSFORM_MATHEMATICALLY"></span>수학적으로 변환을 설명 하는
...
변형의 수학적 설명은 수학적 배경 지식이 있거나 행렬을 사용하여 좌표 공간 변형을 설명하는 그래픽 프로그래밍 기술에 익숙한 경우 유용할 수 있습니다. [ **변환**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Transform)-해당 3 × 3 매트릭스를 기준으로 직접 변환 표현할 수 있도록 하는 클래스를 파생 합니다. [**MatrixTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.MatrixTransform)합니다. **MatrixTransform** 에 [ **행렬** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrixtransform.matrix) 6 개의 속성이 있는 구조를 포함 하는 속성: [**M11**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.m11)하십시오 [ **M12**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.m12)하십시오 [ **M21**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.m21)하십시오 [ **M22** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.m22)하십시오 [ **OffsetX** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.offsetx) 하 고 [ **OffsetY**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.matrix.offsety)합니다. 각 [**Matrix**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Matrix) 속성은 **Double** 값을 사용하며 행렬 유사 변환의 6개 관련 값(1열, 2열)에 해당합니다.
...
## <a name="span-id3-dtransformsspanspan-id3-dtransformsspanspan-id3-dtransformsspan3-d-transforms"></a><span id="3-D_transforms"></span><span id="3-d_transforms"></span><span id="3-D_TRANSFORMS"></span>3 차원 변환
...
## <a name="span-idrelatedtopicsspanrelated-topics"></a><span id="related_topics"></span>관련된 항목

* [**UIElement.Transform3D**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.transform3d)
* [XAML UI에 대 한 3 차원 관점 효과](3-d-perspective-effects.md)
