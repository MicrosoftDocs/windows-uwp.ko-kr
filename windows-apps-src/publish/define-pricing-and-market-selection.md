---
Windows 스토어는 전 세계 200여 이상의 국가와 지역에 있는 고객에게 다가갑니다.
가격 책정 및 지역/국가 선택 정의
...
> **참고** 이러한 기준 가격은 [IAP(앱에서 바로 구매 제품)](iap-submissions.md)에도 적용됩니다.
...
> **참고** [IAP 제출](iap-submissions.md)을 위해 특정 지역/국가에 대한 사용자 지정 가격을 설정할 수 있습니다.
...
다음 지역/국가 중 하나 이상에 앱 또는 IAP를 나열하도록 선택할 수 있습니다.
