...
이 문서는 관리 코드로 작성된 Windows 런타임 구성 요소의 제한에 대한 추가 정보를 제공합니다. [Winmdexp.exe(Windows 런타임 메타데이터 내보내기 도구)](https://docs.microsoft.com/dotnet/framework/tools/winmdexp-exe-windows-runtime-metadata-export-tool)의 오류 메시지에서 제공되는 정보에 대해 더 자세히 설명하고 [C# 및 Visual Basic에서 Windows 런타임 구성 요소 만들기](creating-windows-runtime-components-in-csharp-and-visual-basic.md)에서 제공되는 제한 사항에 대한 정보를 보충합니다.
...
* [Winmdexp.exe (Windows 런타임 메타 데이터 내보내기 도구)](https://docs.microsoft.com/dotnet/framework/tools/winmdexp-exe-windows-runtime-metadata-export-tool)
