...
이 문서에서는 WPF 앱에서 이러한 컨트롤을 호스트 하는 방법을 보여 주지만 Windows Forms 앱의 프로세스와 비슷합니다.
...
1. Visual Studio 2019에서 새 **Wpf 앱 (.NET Framework)** 또는 **wpf 앱 (.net Core)** 프로젝트를 만듭니다.
