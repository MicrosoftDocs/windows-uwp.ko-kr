...
-   그 밖의 경우에는 **FlushAsync** 패턴 대신 [**Task.WaitAll**](/dotnet/api/system.threading.tasks.task.waitall?view=netcore-2.0&preserve-view=true#System_Threading_Tasks_Task_WaitAll_System_Threading_Tasks_Task___)을 사용합니다.
