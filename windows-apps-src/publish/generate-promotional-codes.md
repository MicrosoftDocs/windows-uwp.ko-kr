...
각 홍보 코드에는 단일 고객 또는 고객 그룹에게 배포할 수 있는 고유한 교환 가능 URL이 있습니다. 고객은 URL을 클릭하여 코드를 교환하고 Microsoft Store에서 앱 또는 추가 기능을 설치할 수 있습니다.
...
Microsoft Store에 게시한 앱 또는 추가 기능에 대한 홍보 코드를 주문하려면
