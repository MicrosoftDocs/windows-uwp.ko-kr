...
[파트너 센터](https://partner.microsoft.com/dashboard) 를 사용 하 여 다른 서비스, 게임 및 앱 타이틀의 Xbox Live 설정 및 데이터에 액세스할 수 있도록 합니다. 예를 들어, 순위표, 웹 사이트에 표시 하는 웹 서비스를 할 수 있습니다 또는 저장 된 게임 데이터를 수정 하거나 게임의 타이틀 저장소에 액세스할 수 있는 도우미 앱을 할 수 있습니다.

기본적으로 자체 제목만 설정 및 Xbox Live 서비스에 저장 된 데이터를 액세스할 수 있습니다. 파트너 센터에서 액세스 정책을 구성 하 여이 변경할 수 있습니다.
...
4. 드롭다운 상자에서 응용 프로그램 또는 서비스의 유형을 선택 하 고 앱, 제목 id 또는 앱 또는 데이터에 액세스 하는 서비스의 서비스 id를 나타내는 정보 상자에 입력 합니다.
