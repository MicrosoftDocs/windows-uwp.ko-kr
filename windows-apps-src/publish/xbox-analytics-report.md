...
> [!IMPORTANT]
> Xbox용 게임이나 Xbox Live 서비스를 사용하는 게임을 게시하는 경우에만 이 보고서가 표시됩니다. 이렇게 하려면 [개념 승인 프로세스](../gaming/concept-approval.md)를 통해 [Microsoft](../xbox-live/developer-program-overview.md#microsoft-partners) 파트너가 게시 게임과 게임을 통해 전송 된를 포함 하는 이동 해야는 [ ID@Xbox 프로그램이](../xbox-live/developer-program-overview.md#id)합니다. 게임 [Xbox Live 작성자 프로그램](../xbox-live/get-started-with-creators/get-started-with-xbox-live-creators.md) 을 통해 게시 된이 보고서에 현재 표시 되지 않습니다.
