...
위에 표시된 코드는 **Label** 및 **LabelProperty** 속성을 구현하고, 종속성 속성 값의 변경을 처리하는 **OnLabelChanged**라는 정적 이벤트 처리기를 추가하고, **LabelProperty**에 대한 지원 필드를 저장하는 프라이빗 멤버를 추가합니다.
