...
| deviceModel           | 문자열  | Xbox One 콘솔 게임 오류가 발생할 때 실행 된 지정 하는 다음 문자열 중 하나입니다.<p/><ul><li><strong>Microsoft Xbox 하나</strong></li><li><strong>Microsoft Xbox 한 S</strong></li><li><strong>Microsoft Xbox One X</strong></li></ul>  |
