...
여기에서 설명하는 텍스트 대비에 대한 권장 사항은 웹 접근성 표준인 [G18: Ensuring that a contrast ratio of at least 4.5:1 exists between text (and images of text) and background behind the text](https://www.w3.org/TR/WCAG20-TECHS/G18.html)(영문)를 기반으로 합니다. 이 지침은 *WCAG 2.0에 대한 W3C 기술* 사양에 있습니다.
