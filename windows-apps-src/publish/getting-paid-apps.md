...
> **참고** 이러한 기준 가격은 앱 내에서 제공하는 추가 기능에도 적용됩니다.
...
> **중요** **지급 보류 상태** 선택은 Windows 개발자 센터(Windows 스토어, Microsoft Advertising, Azure 마켓플레이스 등)를 통해 지급되는 **모든** 수입원에 적용됩니다. 각 수입원에 대해 다른 보류 상태를 선택할 수 없습니다.
