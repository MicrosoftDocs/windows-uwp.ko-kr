...
| 유형| 문자열| 데이터의 형식입니다. 가능한 값은: 이진 파일, 구성 또는 json입니다.| 
...
| customSelector| 문자열| 형식 파일을 구성 합니다. 포함 하도록 사용자 지정 가상 노드를 나타냅니다. 구성 형식 파일에 대 한 자세한 내용은 Title 저장소를 참조 하세요.| 
