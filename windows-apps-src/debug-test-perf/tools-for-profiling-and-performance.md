...
|           |             |
|-----------|-------------|
| [Visual Studio 진단 도구를 사용하여 Windows 스토어 앱의 성능 분석](https://msdn.microsoft.com/en-us/library/windows/apps/xaml/hh696636.aspx) | 프로그램이 실행될 때 앱의 코드가 시간을 소비하는 곳을 보여 줌으로써 Visual Studio 프로파일러는 앱, 기능 및 알고리즘의 성능 병목 현상을 찾을 수 있도록 도와줍니다. |
