...
나타날 때까지 기다려야 [멀티 플레이어 관리자를 초기화](play-multiplayer-with-friends.md)한 하 고 [만든 로컬 사용자를 추가 하 여 로비 세션에](play-multiplayer-with-friends.md)는 `user_added` 이벤트 초대 보내기 시작 하기 전에 합니다.
...
여기에 프로세스의 순서도 볼 수 있습니다: [순서도-다른 플레이어에 게 초대 보내기](mpm-flowcharts/mpm-send-invites.md).
...
### <a name="2-title-implemented-custom-uia-nametitle-implemented-custom-ui"></a>사용자 지정 UI를 구현 2) 제목<a name="title-implemented-custom-ui">

| 메서드 | 트리거되는 이벤트 |
|-----|----------------|
| `multiplayer_lobby_session::invite_users()` | `invite_sent` |

타이틀 보기 온라인 친구 초대 및 사용자 지정 TCUI를 구현할 수 있습니다. 게임에서 사용할 수는 `invite_users()` Xbox Live 사용자 Id가 정의한 사용자 집합에 대 한 보내는 방법을 초대 합니다. Xbox UI 주식 대신 고유한 게임에서 UI를 사용 하려는 경우 유용 합니다.
