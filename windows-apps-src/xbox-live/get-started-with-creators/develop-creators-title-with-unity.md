...
이 섹션에는 Unity 게임 엔진을 사용 하 여 개발 하는 게임에 Xbox Live를 통합 하는 방법을 설명 합니다. Xbox Live Unity 플러그인 [Xbox Live 크리에이터 스 프로그램](../developer-program-overview.md#xbox-live-creators-program) 타이틀에 사용할 위한 것입니다. Unity 프로젝트에 Xbox Live를 통합 하려면 다음이 문서를 진행 합니다.
...
[Xbox Live 프리 팹 컨트롤러 지원 추가](add-controller-support-to-xbox-live-prefabs.md)
