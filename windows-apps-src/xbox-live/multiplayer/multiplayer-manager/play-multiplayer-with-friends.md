---
title: 친구 들과 멀티 플레이어 게임
description: 멀티 플레이 관리자 Xbox Live를 사용 하 여 친구 들과 멀티 플레이어 게임 플레이어 수 있도록 하는 방법에 알아봅니다.
ms.assetid: 6eefee0e-6c0d-473a-97e7-f3e45f574712
ms.date: 04/04/2017
ms.topic: article
keywords: xbox live, xbox, 게임, uwp, windows 10, 하나는 xbox, 멀티 플레이 게임, 멀티 플레이 관리자, 순서도
...
ms.locfileid: "57659968"
---
# <a name="play-a-multiplayer-game-with-friends"></a>친구 들과 멀티 플레이어 게임

간단한 멀티 플레이어 시나리오 중 하나는 게이머 친구 들과 온라인 게임을 재생할 수 있도록 합니다. 이 시나리오에서는 다중 접속 관리자를 사용 하 여 구현 하는 데 필요한 기본 단계를 설명 합니다.
...
프로세스의 순서도 확인할 수 있습니다. [순서도 – 친구 들과 다중 접속/op 공동 게임 플레이](mpm-flowcharts/mpm-play-with-friends.md)합니다.
...
### <a name="3-send-invites-to-friends-a-namesend-invites"></a>친구를 초대합니다. 3) 보내기 <a name="send-invites">
...
### <a name="5-join-a-game-session-from-the-lobby-a-namejoin-game"></a>5) 로비에서 게임 세션을 조인 합니다. <a name="join-game">

| 메서드 | 트리거되는 이벤트 |
|-----|----------------|
| `multiplayer_manager::join_game_from_lobby()` | `join_game_completed_event` |

초대를 수락한 후 호스트는 게임을 재생을 시작할 준비가 되었습니다. 호출 하 여 로비 세션의 멤버를 포함 하는 새 게임을 시작할 수 있습니다 `join_game_from_lobby()`합니다.
