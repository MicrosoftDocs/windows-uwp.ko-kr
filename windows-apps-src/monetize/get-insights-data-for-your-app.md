...
| insightDate                | string | 특정 메트릭 변경을 식별 하는 날짜입니다. 이 날짜 크게 증가 감지 하는 주의 끝을 나타내는 또는 그 전에 주에 비해 메트릭을 감소 합니다. |
...
| Date              | 문자열 |  현재 통찰력 또는 현재 치수 관련 된 변경 내용을 확인 하는 날짜입니다.   |
