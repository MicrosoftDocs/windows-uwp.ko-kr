...
ms.locfileid: "5397693"
---
# <a name="pivot"></a>피벗

[피벗](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Pivot) 컨트롤을 사용 하면 콘텐츠 섹션의 작은 집합 간의 터치 살짝 합니다.
...
<td>
    <p><strong style="font-weight: semi-bold">XAML 컨트롤 갤러리</strong> 앱이 설치 된 경우 여기를 클릭 <a href="xamlcontrolsgallery:/item/Pivot">앱을 열고 작동 중인 피벗 컨트롤을 참조 하세요</a>.</p>
    <ul>
...
일반적인 상단 탐색 및 탭 패턴을 구현 하려면 [NavigationView](navigationview.md)를 자동으로 다양 한 화면 크기를 조정할 수 있도록 하는 큰 사용자 지정을 사용 하는 것이 좋습니다.

그러나 탐색에 필요한 경우 터치 살짝 밀기, 피벗을 사용 하는 것이 좋습니다.
...
이 코드는 콘텐츠 섹션 간에 터치 살짝 경험-피벗 컨트롤의 기본 제공 탐색 경험을 모방합니다. 그러나 알 수 있듯이 사용자 지정할 수 있습니다 애니메이션된 전환, 탐색 매개 변수 및 스택 기능 같은 여러 지점.
