...
다음 표에서 패키지의 일부로 제공된 파일이 앱에 대한 시스템에 오버레이된 위치를 보여 줍니다. 응용 프로그램에 이러한 파일은 *C:\Program Files\WindowsApps\package_name\VFS*내 리디렉션된 위치에 실제로 나열 된 시스템 위치에 있는 것으로 느끼게 됩니다. FOLDERID 위치는 [**KNOWNFOLDERID**](https://msdn.microsoft.com/library/windows/desktop/dd378457.aspx) 상수입니다.
