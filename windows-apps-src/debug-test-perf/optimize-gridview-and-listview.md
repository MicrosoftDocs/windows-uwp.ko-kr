...
**X: 단계를 사용 하 여 점진적인 데이터 템플릿 업데이트**
...
**점진적인 데이터 템플릿 ContainerContentChanging를 사용 하 여 업데이트**
