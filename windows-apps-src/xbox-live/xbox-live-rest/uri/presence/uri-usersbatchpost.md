...
이 일괄 처리 요청에 응답 하 여 깊이 및 경로 필터 수 있습니다. 소비자와 사용자 집합에 대 한 현재 상태를 표시 합니다.이 사용할 수 있습니다. 이 API의 필터 작동 Or로은 속성이 아니라 And에서 속성 합니다.
...
| 멤버| 설명|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| deviceTypes| 목록에 대해 알아야 할 사용자가 사용 하는 장치 유형입니다. 모든 가능한 장치 유형에 기본값으로 배열을 비워 (즉, none 필터링 됩니다).|
| 제목| 장치 목록을 입력 사용자에 대해 알아야 합니다. 모든 가능한 타이틀 기본값으로 배열을 비워 (즉, none 필터링 됩니다).|
