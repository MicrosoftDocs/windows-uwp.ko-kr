...
| isFavorite| 부울 값| 필수. 이 사용자 인지 자세히에 대 한 사용자가 더 관심이 하나. 사용자가 많은 사용자가 사람 목록이 가질 수 있으므로 즐겨찾기 사용자 경험의 우선 순위 고 전에 즐겨찾기 하지 않은 다른 사용자에 게 표시 해야 합니다.| 
