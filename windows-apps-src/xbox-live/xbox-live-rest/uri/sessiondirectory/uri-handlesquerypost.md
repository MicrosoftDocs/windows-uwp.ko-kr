...
이 HTTP/REST 메서드 세션 정보 없이 핸들 데이터만 대 한 쿼리를 만듭니다. **Microsoft.Xbox.Services.Multiplayer.MultiplayerService.GetActivitiesForSocialGroupAsync**으로 래핑할 수 있습니다.

이 메서드에 대 한 요청 본문에서 입력 필드 "작업"으로 설정 되어 있어야 합니다. 응답 본문에 항목 **MultiplayerActivityDetails**속성에 직접 매핑됩니다.
