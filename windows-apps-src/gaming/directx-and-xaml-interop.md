...
4.  [**IDXGISurface**](https://msdn.microsoft.com/library/windows/desktop/bb174565) 개체에 대한 포인터를 [**ISurfaceImageSourceNative::BeginDraw**](https://msdn.microsoft.com/library/windows/desktop/hh848323)에 전달하고 DirectX를 사용하여 해당 표면에 그립니다. *updateRect* 매개 변수에서 업데이트에 대해 지정한 영역에만 그려집니다.
    ...
    이 메서드는 *offset* 매개 변수에서 업데이트된 대상 직사각형의 점(x,y) 오프셋을 반환합니다. 이 오프셋을 사용하여 [**IDXGISurface**](https://msdn.microsoft.com/library/windows/desktop/bb174565) 내에 그릴 위치를 결정합니다.
...
5.  [**ISurfaceImageSourceNative::EndDraw**](https://msdn.microsoft.com/library/windows/desktop/hh848324)를 호출하여 비트맵을 완료합니다. 비트맵은 XAML [**이미지**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.image.aspx) 또는 [**ImageBrush**](https://msdn.microsoft.com/library/windows/apps/br210101)의 원본으로 사용될 수 있습니다.
