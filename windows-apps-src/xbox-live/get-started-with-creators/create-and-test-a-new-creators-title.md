...
> [!NOTE]
> Xbox Live 크리에이터 스 프로그램의 일부인 경우 위의 가정 적용 하 고이 문서에서는 함께 따라야 합니다.
...
> [!IMPORTANT]
> Xbox Live 게임에 대 한 에서만 지원 됩니다. Xbox live 게임을 게시 하기 위해 제출의 제품 유형 속성 섹션에서 "게임"으로 설정 해야 합니다.
...
레코드를 게임에 대 한 Xbox Live 구성과 변경 하는 경우 Xbox Live의 나머지 부분에 의해 선택 된 게임에서 볼 수 되기 전에 특정 환경에 변경 내용을 게시 해야 합니다.
