...
사용자가 메시지를 보내는 사용자 클레임 및 유효한 골드 구독이 있어야 합니다.
...
에 얼마나 많은 메시지를 받을 하루 및 얼마나 많은 친구 및 친구, 다음과 같은 제한도 있습니다.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 200| 성공 합니다.|
| 400| 받는 사람 목록이 비어 있거나; 최대 길이 초과 또는 게이머 태그 및 XUID 지정 되었습니다. 또는 messageText 너무 깁니다.|
| 403| XUID 변환할 수 없습니다.|
