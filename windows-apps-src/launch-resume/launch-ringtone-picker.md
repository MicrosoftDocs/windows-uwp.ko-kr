...
이 항목에서는 사용 하는 방법을 설명 합니다 **ms tonepicker:** URI 체계입니다. 이 URI 스키마는 다음 작업에 사용할 수 있습니다.
...
## <a name="task-determine-if-the-tone-picker-is-available-on-the-device"></a>작업: 어조 선택기 장치에서 사용할 수 있는지 확인
```cs
...
## <a name="task-display-the-tone-picker"></a>작업: 어조 선택기를 표시 합니다.
...
## <a name="task-display-the-tone-saver"></a>작업: 어조 보호기를 표시 합니다.
...
## <a name="task-convert-a-tone-token-to-its-friendly-name"></a>작업: 친숙 한 이름과 톤 토큰 변환
