---
author: mcleanbyron
description: "Windows 스토어 분석 API에서 이 메서드를 사용하여 지정된 날짜 범위 및 다른 선택 필터 동안 추가 기능 채널 데이터별 집계 변환을 가져옵니다."
...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, 저장소 서비스, Windows 스토어 분석 API, 추가 기능 변환, 채널"
...
Windows 스토어 분석 API에서 이 메서드를 사용하여 지정된 날짜 범위 및 다른 선택 필터 동안 추가 기능 채널별 집계 변환을 가져옵니다.
