...
Windows Bluetooth Api에 표시 되는 일반적인 머리글자어 일반 특성 (GATT)입니다. GATT 프로필 데이터의 구조와 두 Bluetooth LE 장치 통신 하는 작업의 모드를 정의 합니다. 특성은 GATT의 주요 빌딩 블록입니다. 특성의 주요 형식은 서비스, 특징 및 설명자입니다. 이러한 특성 관련 섹션에서 상호 작용 찾았으면 더 유용 하므로 클라이언트와 서버 간에 다르게 수행 합니다. 
