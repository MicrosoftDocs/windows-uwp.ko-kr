...
> [!NOTE]
> 프로토콜 계약을 통해 시작 하는 경우 다시 돌아가도록 해야 뒤로 단추는 사용자가 앱의 이전 콘텐츠가 아닌 앱이 시작 된 화면에 있습니다.
...
> [!NOTE]
> 앱에 대 한 새 URI 체계 이름을 만들려는 경우 [RFC 4395](https://go.microsoft.com/fwlink/p/?LinkID=266550)의 지침을 수행 해야 합니다. 그러면 이름이 URI 스키마에 대한 표준을 충족하게 됩니다.
