...
**30 D** 기간을 선택 하면 **사용자**, **장치**또는 **기간** 탭을 볼 때 원형 표식 나타날 합니다. 이러한 크게 증가 나타내거나 알고 하려고 하는 것이 생각 하는 특정된 값 감소 합니다. 원 표시 되는 날짜는 하는데이 크게 증가 또는 그 이전에 주에 비해 감소 주의 끝을 나타냅니다. 변경 된 기능에 대 한 자세한 정보를 보려면 원을 가리킵니다.  
