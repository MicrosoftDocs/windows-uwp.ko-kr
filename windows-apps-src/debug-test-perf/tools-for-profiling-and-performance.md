...
* [Visual Studio 진단 도구를 사용하여 UWP 앱의 성능 분석](/visualstudio/profiling/profiling-tools): 프로그램이 실행될 때 앱의 코드가 시간을 소비하는 곳을 보여 줌으로써 Visual Studio 프로파일러는 앱, 기능 및 알고리즘의 성능 병목 현상을 찾을 수 있도록 도와줍니다.
...
* [Visual Studio의 새로운 XAML 도구](https://channel9.msdn.com/Events/Build/2015/2-697): 이 //빌드 세션에서는 새롭게 디자인된 Blend 환경, UI 디버깅 도구, 향상된 XAML 편집기 기능 등 Visual Studio 2015의 새로운 기능에 대해 알아봅니다. 이러한 도구는 Visual Studio 2019에서도 사용할 수 있습니다.