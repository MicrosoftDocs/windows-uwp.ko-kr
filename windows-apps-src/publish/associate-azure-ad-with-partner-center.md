...
1.  [파트너 센터](https://partner.microsoft.com/dashboard)기어 아이콘 (근처 대시보드의 오른쪽 위 모서리)을 선택 하 고 **개발자 설정**을 선택 합니다. **설정** 메뉴에서 **테 넌 트**를 선택 합니다.
...
파트너 센터 계정에 대 한 **관리자** 역할이 있는 모든 사용자는 계정에서 Azure AD 테 넌 트를 제거할 수 있습니다.
