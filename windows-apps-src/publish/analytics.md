---
author: JnHs
Description: "대시보드를 통해서나 다른 방법으로 Windows 앱에 대한 자세한 분석 결과를 확인하세요."
title: "앱 성능 분석"
...
가장 많이 다운로드 한 앱에 대한 주요 분석을 보려면 **분석**을 확장하고 **개요**를 선택합니다. 기본적으로 **분석 개요** 페이지에는 수명을 가장 높게 획득한 앱 5개에 대한 정보가 표시됩니다. 다른 게시 앱을 표시하도록 선택하려면 **필터**를 선택합니다.
...
### <a name="windows-store-analytics-api"></a>Windows 스토어 분석 API
