...
ms.locfileid: "4615042"
---
# <a name="whats-new-for-the-xbox-live-sdk---november-2016"></a>새로운 기능에 대 한 Xbox Live SDK-2016 년 11 월

추가 된 항목에 대 한 [새로운 기능-2016 년 8 월](1608-whats-new.md) 문서를 참조 하십시오 2016 년 8 월 릴리스에서 합니다.
...
* [세션 찾아보기](../multiplayer/session-browse.md) 멀티 플레이어 게임을 찾으려면 사용자에 게는 새로운 방법을입니다.  세션 검색 플레이어를 지정 된 조건을 충족 하는 열린 멀티 플레이 게임 세션의 목록을 검색할 수 있습니다.
...
* 다양 한 [소셜 관리자](../social-platform/intro-to-social-manager.md) API 변경 내용:
    ...
    * `social_event`
        ...
        * 이 벡터 새 API로 전달할 수 `xbox_social_user_group::get_users_from_xbox_user_ids()`
...
* 소셜 관리자 이제 되지 실패 후 초기화 합니다. 소셜 관리자 연결이 끊긴 상태에서 자동으로 RTA 재시도 됩니다. `error` 및 `rta_disconnect_error` 이벤트 사용 중단 되 고 제거
...
* C + + /winrt 지원을 추가 합니다.   세부 정보를 찾을 수 있습니다 [여기](../introduction-to-xbox-live-apis.md)
...
* [Xbox Live 소개](../get-started-with-partner/get-started-with-xbox-live-partner.md) 섹션 재작성 했습니다.  새 문서를 볼 수 새 Xbox Live가 지원 타이틀을 만드는 된 게임에 다른 Xbox Live 기능을 통합 알고 싶은 경우, [다음과 같습니다](../get-started-with-partner/get-started-with-xbox-live-partner.md).
