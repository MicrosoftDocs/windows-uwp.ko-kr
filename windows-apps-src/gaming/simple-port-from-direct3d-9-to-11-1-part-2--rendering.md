...
> **참고**  HLSL 컴파일러에 대 한 올바른 대상 기능 수준을 설정 해야 합니다: Visual Studio에서 HLSL 소스 파일을 마우스 오른쪽 단추로 클릭 하 고 속성을 선택 **셰이더 모델** 설정 변경 **HLSL 컴파일러-&gt; 일반**. 앱이 Direct3D 셰이더 자원을 만들 때 Direct3D는 하드웨어 기능에 대해 이 속성을 확인합니다.
