        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <ul>
                        <li><a href="//developer.microsoft.com/windows/downloads">도구 및 SDK 다운로드</a></li>
                        <li><a href="//docs.microsoft.com/windows/uwp/get-started/get-set-up">도움이 필요하세요?</a></li>
                    </ul>
                  </div>
                </div>
            </div>
