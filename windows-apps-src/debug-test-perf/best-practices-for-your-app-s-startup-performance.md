...
앱을 활성화하는 다양한 이유가 있고 각 이유를 다르게 처리할 수 있습니다. [
...
초기화 기간이 긴 앱에서는 로드 페이지를 표시해야 합니다. 활성화 프로세스에 대한 확실한 피드백을 제공하는 것 외에 활성화 프로세스가 시작된 후 15초 내에 [**Window.Activate**](https://msdn.microsoft.com/library/windows/apps/BR209046)가 호출되지 않으면 프로세스가 종료됩니다.
