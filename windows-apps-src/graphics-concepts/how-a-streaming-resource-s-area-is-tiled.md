...
<tbody>
<tr class="odd">
<td align="left"><p>[Texture2D 및 Texture2DArray 하위 리소스 타일링](texture2d-and-texture2darray-subresource-tiling.md)</p></td>
<td align="left"><p>이 표는 [<strong>Texture2D</strong>](https://msdn.microsoft.com/library/windows/desktop/ff471525) 및 [<strong>Texture2DArray</strong>](https://msdn.microsoft.com/library/windows/desktop/ff471526) 하위 리소스가 타일링되는 방법을 보여줍니다.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[Texture3D 하위 리소스 타일링](texture3d-subresource-tiling.md)</p></td>
<td align="left"><p>이 표는 [<strong>Texture3D</strong>](https://msdn.microsoft.com/library/windows/desktop/ff471562) 하위 리소스가 타일링되는 방법을 보여줍니다.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[버퍼 타일링](buffer-tiling.md)</p></td>
<td align="left"><p>[버퍼](introduction-to-buffers.md) 리소스는 64KB의 크기로 분할되며, 크기가 64KB의 곱이 아닌 경우 마지막 타일에 약간의 빈 공간이 포함됩니다.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[Mipmap 압축](mipmap-packing.md)</p></td>
