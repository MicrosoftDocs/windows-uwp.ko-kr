...
| [원격 장치를 검색 합니다.](discover-remote-devices.md)  | 연결할 수 있는 장치를 검색하는 방법을 알아봅니다. |
| [원격 앱 서비스와 통신](communicate-with-a-remote-app-service.md) | 원격 장치에서 앱을 조작하는 방법을 알아봅니다. |
| [원격 세션을 통해 장치를 연결 합니다.](remote-sessions.md) | 원격 세션에서 여러 장치를 연결하여 공유되는 환경을 만듭니다. |
| [장치 에서도 사용자 활동을 계속](useractivities.md)| 하 던 작업 앱에서 여러 장치 간에 다시 시작할 수 있도록 합니다.|
