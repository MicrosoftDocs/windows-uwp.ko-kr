...
다음 코드에서는 세 가지 구독할 ***DataReceived** 이벤트:
...
**AamvaCardDataReceived** / **BankCardDataReceived** 이벤트 *args* 개체에서 직접 데이터의 일부 얻을 수 있습니다. 다음 예제에서는 몇 가지 속성 가져오기 멤버 변수를 할당 하 고 보여 줍니다.
