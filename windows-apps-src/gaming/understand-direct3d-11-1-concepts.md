...
리소스에서 만들 뷰 유형과 호환되는 속성을 사용하여 기본 리소스를 만들어야 합니다. 예를 들어 경우는 [ **ID3D11RenderTargetView** ](https://msdn.microsoft.com/library/windows/desktop/ff476582) 적용 됩니다 화면에 사용 하 여 해당 화면 만들어집니다 합니다 [ **D3D11\_바인딩\_렌더링\_ 대상** ](https://msdn.microsoft.com/library/windows/desktop/ff476085) 플래그입니다. 화면에 렌더링을 사용 하 여 호환 되는 DXGI 화면 형식이 있습니다 (참조 [ **DXGI\_형식**](https://msdn.microsoft.com/library/windows/desktop/bb173059)).
...
리소스 뷰 사용 된 DXGI\_픽셀 형식을 나타내는 데 형식 열거형 값입니다. 일부 D3DFMT는 DXGI로 지원 됩니다\_형식입니다. 예를 들어, 형식이 없습니다 24bpp RGB D3DFMT에 해당 하는 DXGI에\_R8G8B8 합니다. 않습니다도 모든 RGB 형식에 해당 하는 BGR (DXGI\_형식\_R10G10B10A2\_UNORM D3DFMT 동일\_A2B10G10R10, D3DFMT에 직접 상응 이지만\_A2R10G10B10). 이러한 레거시 형식의 콘텐츠는 빌드할 때 지원되는 형식으로 변환하도록 계획해야 합니다. DXGI의 전체 목록은 참조 형식에 대 한 합니다 [ **DXGI\_형식** ](https://msdn.microsoft.com/library/windows/desktop/bb173059) 열거형입니다.
