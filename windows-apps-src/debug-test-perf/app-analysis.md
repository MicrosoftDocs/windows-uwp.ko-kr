...
경우에 따라 올바른 애플리케이션 수정은 이름을 제공하는 것이 아니라 UIA 요소를 원시 트리를 제외한 모든 곳에서 제거하는 것입니다. `AutomationProperties.AccessibilityView = "Raw"`를 설정하여 XAML에서 이 작업을 수행할 수 있습니다.
