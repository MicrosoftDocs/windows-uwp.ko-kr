...
더 대상이 지정 된 일련의 항목에는 엔터테인먼트 검색 서비스 (EDS) 쿼리를 구체화 하는 다음 매개 변수를 사용할 수 있습니다. 모든 API에서 매개 변수가 필요 하지만 쿼리 구체화를 허용 하는 모든 API에서 허용 하 게 합니다.
...
| 매개 변수| 데이터 형식| 설명| 
| --- | --- | --- | 
| <b>10 년</b>| string| 10 년 있는 모든 항목 해야 릴리스된 합니다.| 
...
| <b>xboxHasChildMediaItemTypes</b>| 문자열의 배열| 게임의 미디어 그룹을 사용 하 여 반환 된 모든 항목에 제공 된 값 중 하나는 미디어 항목 형식의 자식 있어야 합니다.| 
