...
> [!NOTE]
> 여기에 코드는 앱의 초기 창 프레임에 대 한 탐색이 실패할 경우 앱 예외를 [**Navigate**](https://msdn.microsoft.com/library/windows/apps/br242694) 의 반환 값을 사용 합니다. **Navigate**가 **true**를 반환하면 탐색이 수행됩니다.
