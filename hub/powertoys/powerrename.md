...
| .+? (? = 막대)     | 모든 항목을 "가로 막대형"과 일치                          |
| foo [\s\S] \* 표시줄 | "Foo"와 "bar" 사이의 모든 항목 일치              |
...
| ---------- | ------------- |--------------------------------------------|
| (.\*). n  | foo \_ $1.png   | \_기존 파일 이름 앞에 "foo"를 추가할 수 있습니다. |
| (.\*). n  | $1 \_foo.png   | \_기존 파일 이름에 "foo"를 추가 합니다.  |
