...
-   [**처리**](https://msdn.microsoft.com/library/windows/apps/hh943073)
-   [**OriginalSource** ](https://msdn.microsoft.com/library/windows/apps/br208810) (에서 상속 [ **RoutedEventArgs**](https://msdn.microsoft.com/library/windows/apps/br208809))
...
이미 처리된 것으로 표시된 이벤트에서 작동할 수 있는 처리기를 연결하는 특별한 기술을 사용할 수 있습니다. 이 기술을 사용 하는 [ **AddHandler** ](https://msdn.microsoft.com/library/windows/apps/hh702399) c에서 + = 같은 처리기를 추가 하는 것에 대 한 XAML 특성 또는 특정 언어 구문을 사용 하기 보다는 처리기를 등록 하는 메서드\#합니다.
