...
리더 민된 카드를 인식 될 때마다 발생 세 가지 이벤트 중 하나:

* [AamvaCardDataReceived 이벤트](https://docs.microsoft.com/uwp/api/windows.devices.pointofservice.claimedmagneticstripereader.aamvacarddatareceived): 모터 차량의 카드는 살짝 민 때 발생 합니다.
...
**AamvaCardDataReceived** 및 **BankCardDataReceived** 이벤트 *args* 개체에서 직접 데이터의 일부를 얻을 수 있습니다. 다음 예제에서는 몇 가지 속성 가져오기 멤버 변수를 할당 하 고 보여 줍니다.
...
다음 코드 조각은 보고서 및 추적 데이터를 가져오는 하 고 카드 종류를 확인 합니다.
